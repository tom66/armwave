...
@ armwave.c:281:     for(n = 0; n < npix; n += 1) {
	.loc 1 281 11 view .LVU626
	mov	r3, #0	@ n,
	mov	r2, #-16777216	@ tmp131,
.LVL139:
.L124:
	.loc 1 282 9 is_stmt 1 discriminator 3 view .LVU627
	.loc 1 283 9 discriminator 3 view .LVU628
	.loc 1 285 9 discriminator 3 view .LVU629
@ armwave.c:281:     for(n = 0; n < npix; n += 1) {
	.loc 1 281 28 is_stmt 0 discriminator 3 view .LVU630
	add	r3, r3, #1	@ n, n,
.LVL140:
@ armwave.c:281:     for(n = 0; n < npix; n += 1) {
	.loc 1 281 5 discriminator 3 view .LVU631
	cmp	r5, r3	@ npix, n
@ armwave.c:285:         *out_buffer_base++ = 0xff000000 | (yy << 8) | xx;
	.loc 1 285 28 discriminator 3 view .LVU632
	str	r2, [r4], #4	@ tmp131, MEM[base: out_buffer_base_22, offset: 4294967292B]
.LVL141:
@ armwave.c:281:     for(n = 0; n < npix; n += 1) {
	.loc 1 281 5 discriminator 3 view .LVU633
	bne	.L124		@,
	pop	{r4, r5, r6, pc}	@
.LVL142:
.L129:
.LBB6:
.LBI6:
	.loc 1 263 6 is_stmt 1 view .LVU634
.LBB7:
	.loc 1 272 5 view .LVU635
	ldr	r3, .L130+8	@,
	mov	r2, #272	@,
	ldr	r1, .L130+12	@,
	ldr	r0, .L130+16	@,
.LVL143:
	.loc 1 272 5 is_stmt 0 view .LVU636
	bl	__assert_fail		@
.LVL144:
.L131:
	.loc 1 272 5 view .LVU637
	.align	2
.L130:
	.word	g_armwave_state
	.word	.LC6
...
.LFB65:
	...
	@ args = 0, pretend = 0, frame = 0
	@ frame_needed = 0, uses_anonymous_args = 0
	.loc 1 332 5 view .LVU639
@ armwave.c:331: {
	.loc 1 331 1 is_stmt 0 view .LVU640
	mov	r3, r1	@ fn, fn
...
@ armwave.c:332:     FILE *fp = fopen(fn, "wb");
	.loc 1 332 16 view .LVU641
	ldr	r1, .L144	@,
.LVL146:
	.loc 1 332 16 view .LVU642
	mov	r0, r3	@, fn
.LVL147:
	.loc 1 332 16 view .LVU643
	bl	fopen64		@
.LVL148:
@ armwave.c:339:     fprintf(fp, "%d %d\n", g_armwave_state.target_height, g_armwave_state.target_width);
	.loc 1 339 5 view .LVU644
	ldr	r6, .L144+4	@ tmp154,
@ armwave.c:338:     fputs("P3\n", fp);
	.loc 1 338 5 view .LVU645
	mov	r2, #3	@,
	mov	r1, #1	@,
@ armwave.c:332:     FILE *fp = fopen(fn, "wb");
	.loc 1 332 16 view .LVU646
	mov	r7, r0	@ fp,
.LVL149:
	.loc 1 333 5 is_stmt 1 view .LVU647
	.loc 1 334 5 view .LVU648
	.loc 1 338 5 view .LVU649
	mov	r3, r0	@, fp
	ldr	r0, .L144+8	@,
.LVL150:
	.loc 1 338 5 is_stmt 0 view .LVU650
	bl	fwrite		@
.LVL151:
	.loc 1 339 5 is_stmt 1 view .LVU651
...
.LVL152:
	...
	bl	fwrite		@
.LVL153:
	.loc 1 342 5 view .LVU653
@ armwave.c:342:     for(yy = 0; yy < g_armwave_state.target_height; yy++) {
	.loc 1 342 37 is_stmt 0 view .LVU654
	ldr	r2, [r6, #56]	@ prephitmp_57, g_armwave_state.target_height
@ armwave.c:342:     for(yy = 0; yy < g_armwave_state.target_height; yy++) {
	.loc 1 342 5 view .LVU655
	cmp	r2, #0	@ prephitmp_57,
	beq	.L133		@,
	ldr	r3, [r6, #52]	@ _12, g_armwave_state.target_width
@ armwave.c:347:             fprintf(fp, "%3d %3d %3d\n", data & 0xff, (data >> 8) & 0xff, (data >> 16) & 0xff);
	.loc 1 347 13 view .LVU656
	ldr	r9, .L144+20	@ tmp156,
@ armwave.c:342:     for(yy = 0; yy < g_armwave_state.target_height; yy++) {
	.loc 1 342 12 view .LVU657
	mov	r5, #0	@ yy,
.LVL154:
.L134:
@ armwave.c:343:         for(xx = 0; xx < g_armwave_state.target_width; xx++) {
	.loc 1 343 9 view .LVU658
	cmp	r3, #0	@ _12,
@ armwave.c:343:         for(xx = 0; xx < g_armwave_state.target_width; xx++) {
	.loc 1 343 16 view .LVU659
	movne	r4, #0	@ xx,
@ armwave.c:343:         for(xx = 0; xx < g_armwave_state.target_width; xx++) {
	.loc 1 343 9 view .LVU660
	beq	.L143		@,
.LVL155:
.L135:
	.loc 1 344 13 is_stmt 1 discriminator 3 view .LVU661
@ armwave.c:344:             data = *(buffer + (xx + (yy * g_armwave_state.target_width)));
	.loc 1 344 29 is_stmt 0 discriminator 3 view .LVU662
	mla	r3, r5, r3, r4	@ tmp145, yy, _12, xx
@ armwave.c:347:             fprintf(fp, "%3d %3d %3d\n", data & 0xff, (data >> 8) & 0xff, (data >> 16) & 0xff);
	.loc 1 347 13 discriminator 3 view .LVU663
	mov	r1, r9	@, tmp156
	mov	r0, r7	@, fp
@ armwave.c:344:             data = *(buffer + (xx + (yy * g_armwave_state.target_width)));
	.loc 1 344 18 discriminator 3 view .LVU664
	ldr	r2, [r8, r3, lsl #2]	@ data, *_6
.LVL156:
	.loc 1 347 13 is_stmt 1 discriminator 3 view .LVU665
@ armwave.c:343:         for(xx = 0; xx < g_armwave_state.target_width; xx++) {
	.loc 1 343 58 is_stmt 0 discriminator 3 view .LVU666
	add	r4, r4, #1	@ xx, xx,
.LVL157:
@ armwave.c:347:             fprintf(fp, "%3d %3d %3d\n", data & 0xff, (data >> 8) & 0xff, (data >> 16) & 0xff);
	.loc 1 347 81 discriminator 3 view .LVU667
	lsr	ip, r2, #16	@ tmp150, data,
@ armwave.c:347:             fprintf(fp, "%3d %3d %3d\n", data & 0xff, (data >> 8) & 0xff, (data >> 16) & 0xff);
	.loc 1 347 61 discriminator 3 view .LVU668
	lsr	r3, r2, #8	@ tmp146, data,
@ armwave.c:347:             fprintf(fp, "%3d %3d %3d\n", data & 0xff, (data >> 8) & 0xff, (data >> 16) & 0xff);
	.loc 1 347 13 discriminator 3 view .LVU669
	uxtb	ip, ip	@ tmp151, tmp150
	uxtb	r3, r3	@, tmp146
	str	ip, [sp]	@ tmp151,
	uxtb	r2, r2	@, data
.LVL158:
	.loc 1 347 13 discriminator 3 view .LVU670
	bl	fprintf		@
.LVL159:
@ armwave.c:343:         for(xx = 0; xx < g_armwave_state.target_width; xx++) {
	.loc 1 343 41 discriminator 3 view .LVU671
	ldr	r3, [r6, #52]	@ _12, g_armwave_state.target_width
@ armwave.c:343:         for(xx = 0; xx < g_armwave_state.target_width; xx++) {
	.loc 1 343 9 discriminator 3 view .LVU672
	cmp	r3, r4	@ _12, xx
	bhi	.L135		@,
	ldr	r2, [r6, #56]	@ prephitmp_57, g_armwave_state.target_height
.LVL160:
.L136:
@ armwave.c:342:     for(yy = 0; yy < g_armwave_state.target_height; yy++) {
	.loc 1 342 55 discriminator 2 view .LVU673
	add	r5, r5, #1	@ yy, yy,
.LVL161:
@ armwave.c:342:     for(yy = 0; yy < g_armwave_state.target_height; yy++) {
	.loc 1 342 5 discriminator 2 view .LVU674
	cmp	r5, r2	@ yy, prephitmp_57
	bcc	.L134		@,
.LVL162:
.L133:
	.loc 1 351 5 is_stmt 1 view .LVU675
	mov	r0, r7	@, fp
@ armwave.c:352: }
	.loc 1 352 1 is_stmt 0 view .LVU676
	add	sp, sp, #12	@,,
	.cfi_remember_state
	.cfi_def_cfa_offset 28
	@ sp needed	@
...
@ armwave.c:351:     fclose(fp);
	.loc 1 351 5 view .LVU677
	b	fclose		@
.LVL164:
.L143:
	.cfi_restore_state
@ armwave.c:342:     for(yy = 0; yy < g_armwave_state.target_height; yy++) {
	.loc 1 342 55 view .LVU678
	add	r5, r5, #1	@ yy, yy,
.LVL165:
@ armwave.c:342:     for(yy = 0; yy < g_armwave_state.target_height; yy++) {
	.loc 1 342 5 view .LVU679
...
.LFB66:
	...
	@ args = 0, pretend = 0, frame = 0
	@ frame_needed = 0, uses_anonymous_args = 0
	.loc 1 356 5 view .LVU681
@ armwave.c:356:     mod_depth = mod;
	.loc 1 356 15 is_stmt 0 view .LVU682
	ldr	r3, .L150+20	@ tmp128,
@ armwave.c:355: {
	.loc 1 355 1 view .LVU683
	push	{r4, r5, r6, r7, r8, lr}	@
	.cfi_def_cfa_offset 24
	.cfi_offset 4, -24
	.cfi_offset 5, -20
	...
	.cfi_offset 84, -32
	.cfi_offset 85, -28
	ldr	r4, .L150+24	@ ivtmp.102,
.LBB10:
.LBB11:
@ armwave.c:87:         gamma_table[i] = pow(i / 255.0f, gamma) * 255.0f;
	.loc 1 87 32 view .LVU684
	vldr.32	s20, .L150+16	@ tmp134,
@ armwave.c:87:         gamma_table[i] = pow(i / 255.0f, gamma) * 255.0f;
	.loc 1 87 26 view .LVU685
	vldr.64	d9, .L150	@ tmp143,
@ armwave.c:87:         gamma_table[i] = pow(i / 255.0f, gamma) * 255.0f;
	.loc 1 87 49 view .LVU686
	vldr.64	d8, .L150+8	@ tmp137,
.LBE11:
.LBE10:
@ armwave.c:356:     mod_depth = mod;
	.loc 1 356 15 view .LVU687
	vstr.32	s0, [r3]	@ mod, mod_depth
	.loc 1 358 5 is_stmt 1 view .LVU688
@ armwave.c:355: {
	.loc 1 355 1 is_stmt 0 view .LVU689
	mov	r6, r0	@ render_width, render_width
	mov	r7, r1	@ render_height, render_height
@ armwave.c:358:     test_create_waveform();
	.loc 1 358 5 view .LVU690
	bl	test_create_waveform		@
.LVL167:
	.loc 1 359 5 is_stmt 1 view .LVU691
.LBB13:
.LBI10:
	.loc 1 81 6 view .LVU692
	.loc 1 81 6 is_stmt 0 view .LVU693
	add	r3, r4, #1	@ _34, ivtmp.102,
	add	r8, r4, #256	@ _35, ivtmp.102,
	rsb	r5, r3, #1	@ tmp142, _34,
.LVL168:
.L147:
.LBB12:
	.loc 1 87 9 is_stmt 1 view .LVU694
@ armwave.c:87:         gamma_table[i] = pow(i / 255.0f, gamma) * 255.0f;
	.loc 1 87 32 is_stmt 0 view .LVU695
	add	r3, r5, r4	@ tmp131, tmp142, ivtmp.102
@ armwave.c:87:         gamma_table[i] = pow(i / 255.0f, gamma) * 255.0f;
	.loc 1 87 26 view .LVU696
	vmov.f64	d1, d9	@, tmp143
@ armwave.c:87:         gamma_table[i] = pow(i / 255.0f, gamma) * 255.0f;
	.loc 1 87 32 view .LVU697
	vmov	s15, r3	@ int	@ tmp131, tmp131
	vcvt.f32.s32	s15, s15	@ tmp132, tmp131
	vdiv.f32	s0, s15, s20	@ tmp133, tmp132, tmp134
@ armwave.c:87:         gamma_table[i] = pow(i / 255.0f, gamma) * 255.0f;
	.loc 1 87 26 view .LVU698
	vcvt.f64.f32	d0, s0	@, tmp133
	bl	pow		@
.LVL169:
@ armwave.c:87:         gamma_table[i] = pow(i / 255.0f, gamma) * 255.0f;
	.loc 1 87 49 view .LVU699
	vmul.f64	d0, d0, d8	@ tmp136,, tmp137
@ armwave.c:87:         gamma_table[i] = pow(i / 255.0f, gamma) * 255.0f;
	.loc 1 87 24 view .LVU700
	vcvt.u32.f64	s15, d0	@ tmp138, tmp136
	vmov	r3, s15	@ int	@ tmp138, tmp138
	strb	r3, [r4, #1]!	@ tmp138, MEM[base: _33, offset: 0B]
.LVL170:
@ armwave.c:86:     for(i = 0; i < 256; i++) {
	.loc 1 86 5 view .LVU701
	cmp	r4, r8	@ ivtmp.102, _35
	bne	.L147		@,
.LVL171:
	.loc 1 86 5 view .LVU702
.LBE12:
.LBE13:
	.loc 1 361 5 is_stmt 1 view .LVU703
	mov	r1, r7	@, render_height
	mov	r0, r6	@, render_width
	bl	armwave_setup_render.constprop.1		@
.LVL172:
	.loc 1 363 5 view .LVU704
@ armwave.c:364: }
	.loc 1 364 1 is_stmt 0 view .LVU705
	vldm	sp!, {d8-d10}	@,
	.cfi_restore 84
	.cfi_restore 85
	.cfi_restore 82
...
@ armwave.c:363:     printf("armwave version: %s\n", ARMWAVE_VER);
	.loc 1 363 5 view .LVU706
	ldr	r1, .L150+28	@,
	ldr	r0, .L150+32	@,
@ armwave.c:364: }
	.loc 1 364 1 view .LVU707
...
.LFB67:
	...
	@ args = 0, pretend = 0, frame = 8
	@ frame_needed = 0, uses_anonymous_args = 0
	.loc 1 368 5 view .LVU710
	.loc 1 370 5 view .LVU711
@ armwave.c:367: {
	.loc 1 367 1 is_stmt 0 view .LVU712
	push	{r4, r5, r6, r7, r8, r9, r10, fp, lr}	@
	.cfi_def_cfa_offset 36
	.cfi_offset 4, -36
	.cfi_offset 5, -32
...
@ armwave.c:370:     memset(g_armwave_state.ch1_buffer, 0, g_armwave_state.size);
	.loc 1 370 5 view .LVU713
	mov	r1, #0	@,
	ldr	r4, .L170	@ tmp269,
@ armwave.c:367: {
	.loc 1 367 1 view .LVU714
	sub	sp, sp, #12	@,,
	.cfi_def_cfa_offset 48
@ armwave.c:370:     memset(g_armwave_state.ch1_buffer, 0, g_armwave_state.size);
	.loc 1 370 5 view .LVU715
	ldr	r2, [r4, #48]	@, g_armwave_state.size
	ldr	r0, [r4, #4]	@, g_armwave_state.ch1_buffer
	bl	memset		@
.LVL175:
	.loc 1 372 5 is_stmt 1 view .LVU716
@ armwave.c:372:     for(yy = 0; yy < (2048 / g_armwave_state.slice_height); yy++) {
	.loc 1 372 45 is_stmt 0 view .LVU717
	ldr	r5, [r4, #40]	@ _72, g_armwave_state.slice_height
@ armwave.c:372:     for(yy = 0; yy < (2048 / g_armwave_state.slice_height); yy++) {
	.loc 1 372 5 view .LVU718
	cmp	r5, #2048	@ _72,
	bhi	.L152		@,
	ldr	r6, [r4, #36]	@ prephitmp_171, g_armwave_state.waves
@ armwave.c:372:     for(yy = 0; yy < (2048 / g_armwave_state.slice_height); yy++) {
	.loc 1 372 12 view .LVU719
	mov	r10, #0	@ yy,
.LVL176:
.L158:
	.loc 1 373 9 is_stmt 1 discriminator 3 view .LVU720
	mul	r3, r5, r10	@ _3, _72, yy
.LBB16:
.LBB17:
@ armwave.c:106:     write_buffer_base = g_armwave_state.ch1_buffer + (slice_y * g_armwave_state.target_height);
	.loc 1 106 63 is_stmt 0 discriminator 3 view .LVU721
	ldr	r0, [r4, #56]	@ g_armwave_state.target_height, g_armwave_state.target_height
@ armwave.c:109:     for(w = 0; w < g_armwave_state.waves; w++) {
	.loc 1 109 5 discriminator 3 view .LVU722
...
@ armwave.c:373:         render_nonaa_to_buffer_1ch_slice(yy * g_armwave_state.slice_height, g_armwave_state.slice_record_height);
	.loc 1 373 9 discriminator 3 view .LVU723
	ldr	r9, [r4, #44]	@ _4, g_armwave_state.slice_record_height
.LVL177:
.LBB19:
.LBI16:
	.loc 1 98 6 is_stmt 1 discriminator 3 view .LVU724
.LBB18:
	.loc 1 100 5 discriminator 3 view .LVU725
	.loc 1 101 5 discriminator 3 view .LVU726
	.loc 1 102 5 discriminator 3 view .LVU727
	.loc 1 103 5 discriminator 3 view .LVU728
	.loc 1 104 5 discriminator 3 view .LVU729
	.loc 1 106 5 discriminator 3 view .LVU730
@ armwave.c:106:     write_buffer_base = g_armwave_state.ch1_buffer + (slice_y * g_armwave_state.target_height);
	.loc 1 106 63 is_stmt 0 discriminator 3 view .LVU731
	mul	r0, r0, r3	@ _15, g_armwave_state.target_height, _3
@ armwave.c:106:     write_buffer_base = g_armwave_state.ch1_buffer + (slice_y * g_armwave_state.target_height);
	.loc 1 106 40 discriminator 3 view .LVU732
	ldr	r2, [r4, #4]	@ _13, g_armwave_state.ch1_buffer
.LVL178:
	.loc 1 109 5 is_stmt 1 discriminator 3 view .LVU733
	.loc 1 109 5 is_stmt 0 discriminator 3 view .LVU734
	beq	.L154		@,
@ armwave.c:109:     for(w = 0; w < g_armwave_state.waves; w++) {
	.loc 1 109 11 view .LVU735
	mov	r8, #0	@ w,
	sub	r3, r3, #4	@ _77, _3,
.LVL179:
...
.LVL180:
.L157:
	.loc 1 110 9 is_stmt 1 view .LVU737
@ armwave.c:110:         wave_base = g_armwave_state.wave_buffer + slice_y + (w * g_armwave_state.wave_stride);
	.loc 1 110 64 is_stmt 0 view .LVU738
	ldr	r3, [r4, #32]	@ g_armwave_state.wave_stride, g_armwave_state.wave_stride
@ armwave.c:114:         for(yy = 0; yy < height; yy += 4) {
	.loc 1 114 9 view .LVU739
	cmp	r9, #0	@ _4,
@ armwave.c:110:         wave_base = g_armwave_state.wave_buffer + slice_y + (w * g_armwave_state.wave_stride);
	.loc 1 110 36 view .LVU740
	ldr	lr, [r4, #20]	@ _16, g_armwave_state.wave_buffer
@ armwave.c:110:         wave_base = g_armwave_state.wave_buffer + slice_y + (w * g_armwave_state.wave_stride);
	.loc 1 110 64 view .LVU741
	mul	r3, r3, r8	@ _19, g_armwave_state.wave_stride, w
.LVL181:
	.loc 1 114 9 is_stmt 1 view .LVU742
	.loc 1 114 9 is_stmt 0 view .LVU743
	beq	.L155		@,
	ldr	r1, [sp, #4]	@ _77, %sfp
	add	r3, r3, r1	@ tmp205, _19, _77
.LVL182:
	.loc 1 114 9 view .LVU744
	add	lr, lr, r3	@ ivtmp.108, _16, tmp205
.LVL183:
@ armwave.c:114:         for(yy = 0; yy < height; yy += 4) {
	.loc 1 114 16 view .LVU745
	mov	r1, #0	@ yy,
.LVL184:
.L156:
	.loc 1 115 13 is_stmt 1 view .LVU746
@ armwave.c:115:             word = *(uint32_t*)(wave_base + yy);
	.loc 1 115 18 is_stmt 0 view .LVU747
	ldr	r3, [lr, #4]!	@ word, MEM[base: _183, offset: 0B]
.LVL185:
	.loc 1 117 13 is_stmt 1 view .LVU748
	.loc 1 118 17 view .LVU749
	.loc 1 119 17 view .LVU750
	.loc 1 120 17 view .LVU751
@ armwave.c:118:                 scale_value = (word & 0xff) * g_armwave_state.vscale;
	.loc 1 118 45 is_stmt 0 view .LVU752
	ldr	r7, [r4, #28]	@ g_armwave_state.vscale, g_armwave_state.vscale
@ armwave.c:119:                 write_buffer = write_buffer_base + ((yy + ys) * g_armwave_state.target_height);
	.loc 1 119 63 view .LVU753
	ldr	r6, [r4, #56]	@ g_armwave_state.target_height, g_armwave_state.target_height
@ armwave.c:118:                 scale_value = (word & 0xff) * g_armwave_state.vscale;
	.loc 1 118 37 view .LVU754
	uxtb	ip, r3	@ word, word
@ armwave.c:121:                 word >>= 8;
	.loc 1 121 22 view .LVU755
	lsr	r5, r3, #8	@ word, word,
@ armwave.c:120:                 *(write_buffer + scale_value) += 1;
	.loc 1 120 47 view .LVU756
	mla	ip, r7, ip, r0	@ tmp210, g_armwave_state.vscale, word, _15
@ armwave.c:118:                 scale_value = (word & 0xff) * g_armwave_state.vscale;
	.loc 1 118 37 view .LVU757
	uxtb	r5, r5	@ word, word
@ armwave.c:120:                 *(write_buffer + scale_value) += 1;
	.loc 1 120 47 view .LVU758
	mla	r6, r6, r1, ip	@ tmp214, g_armwave_state.target_height, yy, tmp210
@ armwave.c:119:                 write_buffer = write_buffer_base + ((yy + ys) * g_armwave_state.target_height);
	.loc 1 119 63 view .LVU759
	add	fp, r1, #1	@ tmp226, yy,
@ armwave.c:121:                 word >>= 8;
	.loc 1 121 22 view .LVU760
	lsr	ip, r3, #16	@ word, word,
@ armwave.c:120:                 *(write_buffer + scale_value) += 1;
	.loc 1 120 47 view .LVU761
	ldrb	r7, [r2, r6]	@ zero_extendqisi2	@ *_63, *_63
@ armwave.c:118:                 scale_value = (word & 0xff) * g_armwave_state.vscale;
	.loc 1 118 37 view .LVU762
	uxtb	ip, ip	@ word, word
@ armwave.c:121:                 word >>= 8;
	.loc 1 121 22 view .LVU763
	lsr	r3, r3, #24	@ word, word,
.LVL186:
@ armwave.c:120:                 *(write_buffer + scale_value) += 1;
	.loc 1 120 47 view .LVU764
	add	r7, r7, #1	@ tmp217, *_63,
	strb	r7, [r2, r6]	@ tmp217, *_63
.LVL187:
	.loc 1 121 17 is_stmt 1 view .LVU765
	.loc 1 118 17 view .LVU766
	.loc 1 119 17 view .LVU767
	.loc 1 120 17 view .LVU768
@ armwave.c:118:                 scale_value = (word & 0xff) * g_armwave_state.vscale;
	.loc 1 118 45 is_stmt 0 view .LVU769
	ldr	r6, [r4, #28]	@ g_armwave_state.vscale, g_armwave_state.vscale
@ armwave.c:119:                 write_buffer = write_buffer_base + ((yy + ys) * g_armwave_state.target_height);
	.loc 1 119 63 view .LVU770
	add	r7, r1, #2	@ tmp241, yy,
@ armwave.c:120:                 *(write_buffer + scale_value) += 1;
	.loc 1 120 47 view .LVU771
	mla	r5, r6, r5, r0	@ tmp224, g_armwave_state.vscale, word, _15
@ armwave.c:119:                 write_buffer = write_buffer_base + ((yy + ys) * g_armwave_state.target_height);
	.loc 1 119 63 view .LVU772
	ldr	r6, [r4, #56]	@ g_armwave_state.target_height, g_armwave_state.target_height
@ armwave.c:120:                 *(write_buffer + scale_value) += 1;
	.loc 1 120 47 view .LVU773
	mla	r5, r6, fp, r5	@ tmp229, g_armwave_state.target_height, tmp226, tmp224
@ armwave.c:119:                 write_buffer = write_buffer_base + ((yy + ys) * g_armwave_state.target_height);
	.loc 1 119 63 view .LVU774
	add	r6, r1, #3	@ tmp255, yy,
@ armwave.c:114:         for(yy = 0; yy < height; yy += 4) {
	.loc 1 114 37 view .LVU775
	add	r1, r1, #4	@ yy, yy,
.LVL188:
@ armwave.c:120:                 *(write_buffer + scale_value) += 1;
	.loc 1 120 47 view .LVU776
	ldrb	fp, [r2, r5]	@ zero_extendqisi2	@ *_83, *_83
@ armwave.c:114:         for(yy = 0; yy < height; yy += 4) {
	.loc 1 114 9 view .LVU777
	cmp	r9, r1	@ _4, yy
@ armwave.c:120:                 *(write_buffer + scale_value) += 1;
	.loc 1 120 47 view .LVU778
	add	fp, fp, #1	@ tmp232, *_83,
	strb	fp, [r2, r5]	@ tmp232, *_83
.LVL189:
	.loc 1 121 17 is_stmt 1 view .LVU779
...
@ armwave.c:120:                 *(write_buffer + scale_value) += 1;
	...
	.loc 1 121 17 is_stmt 1 view .LVU786
.LVL190:
...
@ armwave.c:120:                 *(write_buffer + scale_value) += 1;
	...
	.loc 1 121 17 is_stmt 1 view .LVU793
.LVL191:
@ armwave.c:114:         for(yy = 0; yy < height; yy += 4) {
	.loc 1 114 9 is_stmt 0 view .LVU794
	bhi	.L156		@,
	ldr	r6, [r4, #36]	@ prephitmp_171, g_armwave_state.waves
.LVL192:
.L155:
@ armwave.c:109:     for(w = 0; w < g_armwave_state.waves; w++) {
	.loc 1 109 44 view .LVU795
	add	r8, r8, #1	@ w, w,
.LVL193:
@ armwave.c:109:     for(w = 0; w < g_armwave_state.waves; w++) {
	.loc 1 109 5 view .LVU796
...
.LBE19:
@ armwave.c:372:     for(yy = 0; yy < (2048 / g_armwave_state.slice_height); yy++) {
	.loc 1 372 28 discriminator 3 view .LVU798
	mov	r1, r5	@, _72
	mov	r0, #2048	@,
.LVL195:
	.loc 1 372 28 discriminator 3 view .LVU799
	bl	__aeabi_uidiv		@
.LVL196:
@ armwave.c:372:     for(yy = 0; yy < (2048 / g_armwave_state.slice_height); yy++) {
	.loc 1 372 63 discriminator 3 view .LVU800
	add	r10, r10, #1	@ yy, yy,
.LVL197:
@ armwave.c:372:     for(yy = 0; yy < (2048 / g_armwave_state.slice_height); yy++) {
	.loc 1 372 5 discriminator 3 view .LVU801
	cmp	r0, r10	@, yy
	bhi	.L158		@,
.LVL198:
.L152:
...
.LFB68:
	...
	@ args = 0, pretend = 0, frame = 0
	@ frame_needed = 0, uses_anonymous_args = 0
	.loc 1 379 5 view .LVU804
	.loc 1 380 5 view .LVU805
@ armwave.c:378: {
	.loc 1 378 1 is_stmt 0 view .LVU806
	push	{r4, r5, r6, r7, lr}	@
...
@ armwave.c:378: {
	...
	.cfi_def_cfa_offset 32
@ armwave.c:380:     Py_buffer *buf = malloc(sizeof(Py_buffer));
	.loc 1 380 22 view .LVU810
	bl	malloc		@
.LVL199:
	.loc 1 382 3 is_stmt 1 view .LVU811
	ldr	r6, [r5, #68]	@ out_buffer_base, g_armwave_state.out_pixbuf
.LVL200:
.LBB24:
.LBI24:
	.loc 1 263 6 view .LVU812
.LBB25:
	.loc 1 265 5 view .LVU813
	.loc 1 266 5 view .LVU814
	.loc 1 267 5 view .LVU815
	.loc 1 268 5 view .LVU816
	.loc 1 269 5 view .LVU817
	.loc 1 270 5 view .LVU818
	.loc 1 272 5 view .LVU819
	cmp	r6, #0	@ out_buffer_base,
	beq	.L179		@,
	.loc 1 276 5 view .LVU820
@ armwave.c:276:     npix = g_armwave_state.target_width * 256; //g_armwave_state.target_height;
	.loc 1 276 27 is_stmt 0 view .LVU821
	ldr	r4, [r5, #52]	@ _12, g_armwave_state.target_width
@ armwave.c:277:     vscale = g_armwave_state.target_height / 256;
	.loc 1 277 44 view .LVU822
	ldr	r3, [r5, #56]	@ g_armwave_state.target_height, g_armwave_state.target_height
@ armwave.c:279:     printf("np=%d w=%d v=%d\n", npix, g_armwave_state.target_width, vscale);
	.loc 1 279 5 view .LVU823
	mov	r2, r4	@, _12
@ armwave.c:276:     npix = g_armwave_state.target_width * 256; //g_armwave_state.target_height;
	.loc 1 276 41 view .LVU824
	lsl	r4, r4, #8	@ npix, _12,
.LVL201:
	.loc 1 277 5 is_stmt 1 view .LVU825
	.loc 1 279 5 view .LVU826
	lsr	r3, r3, #8	@, g_armwave_state.target_height,
.LVL202:
	.loc 1 279 5 is_stmt 0 view .LVU827
	mov	r7, r0	@ buf,
	mov	r1, r4	@, npix
	ldr	r0, .L180+4	@,
.LVL203:
	.loc 1 279 5 view .LVU828
	bl	printf		@
.LVL204:
	.loc 1 281 5 is_stmt 1 view .LVU829
	.loc 1 281 5 is_stmt 0 view .LVU830
	cmp	r4, #0	@ npix,
@ armwave.c:281:     for(n = 0; n < npix; n += 1) {
	.loc 1 281 11 view .LVU831
	movgt	r3, #0	@ n,
	movgt	r2, #-16777216	@ tmp146,
@ armwave.c:281:     for(n = 0; n < npix; n += 1) {
	.loc 1 281 5 view .LVU832
	ble	.L175		@,
.LVL205:
.L174:
	.loc 1 282 9 is_stmt 1 view .LVU833
	.loc 1 283 9 view .LVU834
	.loc 1 285 9 view .LVU835
@ armwave.c:281:     for(n = 0; n < npix; n += 1) {
	.loc 1 281 28 is_stmt 0 view .LVU836
	add	r3, r3, #1	@ n, n,
.LVL206:
@ armwave.c:281:     for(n = 0; n < npix; n += 1) {
	.loc 1 281 5 view .LVU837
	cmp	r4, r3	@ npix, n
@ armwave.c:285:         *out_buffer_base++ = 0xff000000 | (yy << 8) | xx;
	.loc 1 285 28 view .LVU838
	str	r2, [r6], #4	@ tmp146, MEM[base: out_buffer_base_26, offset: 4294967292B]
.LVL207:
@ armwave.c:281:     for(n = 0; n < npix; n += 1) {
	.loc 1 281 5 view .LVU839
	bne	.L174		@,
.LVL208:
.L175:
	.loc 1 281 5 view .LVU840
.LBE25:
.LBE24:
	.loc 1 392 5 is_stmt 1 view .LVU841
@ armwave.c:392:     PyBuffer_FillInfo(buf, NULL, g_armwave_state.out_pixbuf, sizeof(uint32_t) * g_armwave_state.size, true, PyBUF_ND);
	.loc 1 392 79 is_stmt 0 view .LVU842
	ldr	r3, [r5, #48]	@ g_armwave_state.size, g_armwave_state.size
@ armwave.c:392:     PyBuffer_FillInfo(buf, NULL, g_armwave_state.out_pixbuf, sizeof(uint32_t) * g_armwave_state.size, true, PyBUF_ND);
	.loc 1 392 5 view .LVU843
	mov	r0, #8	@ tmp143,
	mov	r1, #1	@ tmp144,
	str	r0, [sp, #4]	@ tmp143,
	str	r1, [sp]	@ tmp144,
...
.LVL209:
	.loc 1 394 5 is_stmt 1 view .LVU844
@ armwave.c:394:     mv = PyMemoryView_FromBuffer(buf);
	.loc 1 394 10 is_stmt 0 view .LVU845
	mov	r0, r7	@, buf
@ armwave.c:395: }
	.loc 1 395 1 view .LVU846
	add	sp, sp, #12	@,,
	.cfi_remember_state
	.cfi_def_cfa_offset 20
	@ sp needed	@
...
.LBB26:
.LBI26:
	.loc 1 263 6 is_stmt 1 view .LVU848
.LBB27:
	.loc 1 272 5 view .LVU849
	ldr	r3, .L180+8	@,
	mov	r2, #272	@,
	ldr	r1, .L180+12	@,
	ldr	r0, .L180+16	@,
.LVL212:
	.loc 1 272 5 is_stmt 0 view .LVU850
	bl	__assert_fail		@
.LVL213:
.L181:
	.loc 1 272 5 view .LVU851
	.align	2
.L180:
	.word	g_armwave_state
	.word	.LC6
...
.LFB69:
	...
	@ frame_needed = 0, uses_anonymous_args = 0
	@ link register save eliminated.
	.loc 1 399 5 view .LVU853
	ldr	r3, .L183	@ tmp112,
	mov	r1, r0	@, fn
	ldr	r0, [r3, #68]	@, g_armwave_state.out_pixbuf
.LVL215:
	.loc 1 399 5 is_stmt 0 view .LVU854
	b	armwave_dump_ppm_debug		@
.LVL216:
.L184:
	.loc 1 399 5 view .LVU855
	.align	2
.L183:
	.word	g_armwave_state
	.cfi_endproc
...
.LFB71:
	...
	@ args = 0, pretend = 0, frame = 8
	@ frame_needed = 0, uses_anonymous_args = 0
	.loc 1 415 5 view .LVU871
	.loc 1 416 5 view .LVU872
	.loc 1 419 5 view .LVU873
.LBB34:
.LBI34:
	.loc 1 127 6 view .LVU874
.LBB35:
	.loc 1 129 5 view .LVU875
.LBE35:
.LBE34:
@ armwave.c:414: {
	.loc 1 414 1 is_stmt 0 view .LVU876
	push	{r4, r5, r6, r7, r8, r9, r10, fp, lr}	@
	.cfi_def_cfa_offset 36
	.cfi_offset 4, -36
	.cfi_offset 5, -32
...
@ armwave.c:435:             render_nonaa_to_buffer_1ch_slice(yy * g_armwave_state.slice_height, g_armwave_state.slice_record_height);
	.loc 1 435 13 discriminator 3 view .LVU892
...
.LVL230:
	.loc 1 114 9 is_stmt 1 view .LVU911
	.loc 1 114 9 is_stmt 0 view .LVU912
	beq	.L192		@,
	ldr	r1, [sp]	@ _81, %sfp
	add	r3, r3, r1	@ tmp202, _23, _81
.LVL231:
	.loc 1 114 9 view .LVU913
	add	lr, lr, r3	@ ivtmp.128, _20, tmp202
.LVL232:
@ armwave.c:114:         for(yy = 0; yy < height; yy += 4) {
	.loc 1 114 16 view .LVU914
	mov	r1, #0	@ yy,
.LVL233:
.L193:
	.loc 1 115 13 is_stmt 1 view .LVU915
@ armwave.c:115:             word = *(uint32_t*)(wave_base + yy);
	.loc 1 115 18 is_stmt 0 view .LVU916
	ldr	r3, [lr, #4]!	@ word, MEM[base: _177, offset: 0B]
.LVL234:
	.loc 1 117 13 is_stmt 1 view .LVU917
	.loc 1 118 17 view .LVU918
	.loc 1 119 17 view .LVU919
	.loc 1 120 17 view .LVU920
@ armwave.c:118:                 scale_value = (word & 0xff) * g_armwave_state.vscale;
	.loc 1 118 45 is_stmt 0 view .LVU921
	ldr	r6, [r9, #28]	@ g_armwave_state.vscale, g_armwave_state.vscale
@ armwave.c:119:                 write_buffer = write_buffer_base + ((yy + ys) * g_armwave_state.target_height);
	.loc 1 119 63 view .LVU922
	ldr	r5, [r9, #56]	@ g_armwave_state.target_height, g_armwave_state.target_height
@ armwave.c:118:                 scale_value = (word & 0xff) * g_armwave_state.vscale;
	.loc 1 118 37 view .LVU923
	uxtb	ip, r3	@ word, word
@ armwave.c:121:                 word >>= 8;
	.loc 1 121 22 view .LVU924
	lsr	r4, r3, #8	@ word, word,
@ armwave.c:120:                 *(write_buffer + scale_value) += 1;
	.loc 1 120 47 view .LVU925
	mla	ip, r6, ip, r0	@ tmp207, g_armwave_state.vscale, word, _19
@ armwave.c:118:                 scale_value = (word & 0xff) * g_armwave_state.vscale;
	.loc 1 118 37 view .LVU926
	uxtb	r4, r4	@ word, word
@ armwave.c:120:                 *(write_buffer + scale_value) += 1;
	.loc 1 120 47 view .LVU927
...
.LVL236:
	.loc 1 121 17 is_stmt 1 view .LVU934
	.loc 1 118 17 view .LVU935
	.loc 1 119 17 view .LVU936
	.loc 1 120 17 view .LVU937
@ armwave.c:118:                 scale_value = (word & 0xff) * g_armwave_state.vscale;
	.loc 1 118 45 is_stmt 0 view .LVU938
	ldr	r5, [r9, #28]	@ g_armwave_state.vscale, g_armwave_state.vscale
@ armwave.c:119:                 write_buffer = write_buffer_base + ((yy + ys) * g_armwave_state.target_height);
	.loc 1 119 63 view .LVU939
...
@ armwave.c:119:                 write_buffer = write_buffer_base + ((yy + ys) * g_armwave_state.target_height);
	.loc 1 119 63 view .LVU943
	add	r5, r1, #3	@ tmp252, yy,
@ armwave.c:114:         for(yy = 0; yy < height; yy += 4) {
	.loc 1 114 37 view .LVU944
	add	r1, r1, #4	@ yy, yy,
.LVL237:
@ armwave.c:120:                 *(write_buffer + scale_value) += 1;
...
.LVL240:
@ armwave.c:114:         for(yy = 0; yy < height; yy += 4) {
	.loc 1 114 9 is_stmt 0 view .LVU963
	bhi	.L193		@,
...
.LBE45:
@ armwave.c:433:         for(yy = 0; yy < (2048 / g_armwave_state.slice_height); yy++) {
	.loc 1 433 32 discriminator 3 view .LVU967
	mov	r1, r5	@, _61
	mov	r0, #2048	@,
.LVL244:
	.loc 1 433 32 discriminator 3 view .LVU968
	bl	__aeabi_uidiv		@
.LVL245:
@ armwave.c:433:         for(yy = 0; yy < (2048 / g_armwave_state.slice_height); yy++) {
	.loc 1 433 67 discriminator 3 view .LVU969
	add	r8, r8, #1	@ yy, yy,
.LVL246:
@ armwave.c:433:         for(yy = 0; yy < (2048 / g_armwave_state.slice_height); yy++) {
	.loc 1 433 9 discriminator 3 view .LVU970
	cmp	r0, r8	@, yy
	bhi	.L195		@,
.LVL247:
.L198:
@ armwave.c:432:     for(n = 0; n < 5000; n++) {
	.loc 1 432 5 discriminator 2 view .LVU971
	ldr	r3, [sp, #4]	@ ivtmp_191, %sfp
	subs	r3, r3, #1	@ ivtmp_191, ivtmp_191,
	str	r3, [sp, #4]	@ ivtmp_191, %sfp
	bne	.L190		@,
	mov	r0, r3	@, ivtmp_191
	.loc 1 448 5 is_stmt 1 view .LVU972
@ armwave.c:449: }
	.loc 1 449 1 is_stmt 0 view .LVU973
	add	sp, sp, #12	@,,
	.cfi_def_cfa_offset 36
	@ sp needed	@
	pop	{r4, r5, r6, r7, r8, r9, r10, fp, pc}	@
