...
@ armwave.c:278: {
	.loc 1 278 1 is_stmt 0 view .LVU337
	push	{r4, r5, r6, r7, r8, r9, r10, lr}	@
	.cfi_def_cfa_offset 32
	.cfi_offset 4, -32
	.cfi_offset 5, -28
...
@ armwave.c:282:     uint8_t *base_ptr = g_armwave_state.ch1_buffer;
	.loc 1 282 14 view .LVU339
	ldr	lr, .L91	@ tmp173,
	ldr	r4, [lr, #4]	@ base_ptr, g_armwave_state.ch1_buffer
.LVL75:
	.loc 1 283 5 is_stmt 1 view .LVU340
	.loc 1 285 5 view .LVU341
	beq	.L80		@,
.LVL76:
@ armwave.c:288:     for(yy = 0; yy < g_armwave_state.target_height; yy++) {
	.loc 1 288 37 is_stmt 0 view .LVU342
	ldr	r2, [lr, #56]	@ prephitmp_102, g_armwave_state.target_height
@ armwave.c:288:     for(yy = 0; yy < g_armwave_state.target_height; yy++) {
	.loc 1 288 5 view .LVU343
	cmp	r2, #0	@ prephitmp_102,
	popeq	{r4, r5, r6, r7, r8, r9, r10, pc}	@
@ armwave.c:293:             rr = (g_armwave_state.ch1_color.r * value) >> 8;
	.loc 1 293 44 view .LVU344
	ldrsh	r7, [lr, #64]	@ _6, g_armwave_state.ch1_color.r
@ armwave.c:294:             gg = (g_armwave_state.ch1_color.g * value) >> 8;
	.loc 1 294 44 view .LVU345
	ldrsh	r6, [lr, #66]	@ _10, g_armwave_state.ch1_color.g
@ armwave.c:295:             bb = (g_armwave_state.ch1_color.b * value) >> 8;
	.loc 1 295 44 view .LVU346
	ldrsh	r5, [lr, #68]	@ _14, g_armwave_state.ch1_color.b
	ldr	r3, [lr, #52]	@ _28, g_armwave_state.target_width
@ armwave.c:288:     for(yy = 0; yy < g_armwave_state.target_height; yy++) {
	.loc 1 288 12 view .LVU347
	mov	ip, #0	@ yy,
.LVL77:
.L82:
@ armwave.c:289:         for(xx = 0; xx < g_armwave_state.target_width; xx++) {
	...
	cmp	r3, #0	@ _28,
@ armwave.c:289:         for(xx = 0; xx < g_armwave_state.target_width; xx++) {
	.loc 1 289 16 view .LVU349
	movne	r1, #0	@ xx,
@ armwave.c:289:         for(xx = 0; xx < g_armwave_state.target_width; xx++) {
	.loc 1 289 9 view .LVU350
	beq	.L84		@,
.LVL78:
.L83:
	.loc 1 291 13 is_stmt 1 discriminator 3 view .LVU351
@ armwave.c:291:             value = *(base_ptr + xx + (yy * g_armwave_state.target_width));
	.loc 1 291 21 is_stmt 0 discriminator 3 view .LVU352
	mla	r3, ip, r3, r4	@ tmp158, yy, _28, base_ptr
	ldrb	r8, [r3, r1]	@ zero_extendqisi2	@ _5, *_4
.LVL79:
	.loc 1 293 13 is_stmt 1 discriminator 3 view .LVU353
	.loc 1 294 13 discriminator 3 view .LVU354
	.loc 1 295 13 discriminator 3 view .LVU355
	.loc 1 297 13 discriminator 3 view .LVU356
	.loc 1 298 13 discriminator 3 view .LVU357
	.loc 1 299 13 discriminator 3 view .LVU358
	.loc 1 306 13 discriminator 3 view .LVU359
	.loc 1 308 13 discriminator 3 view .LVU360
@ armwave.c:289:         for(xx = 0; xx < g_armwave_state.target_width; xx++) {
	.loc 1 289 58 is_stmt 0 discriminator 3 view .LVU361
	add	r1, r1, #1	@ xx, xx,
.LVL80:
@ armwave.c:295:             bb = (g_armwave_state.ch1_color.b * value) >> 8;
	.loc 1 295 47 discriminator 3 view .LVU362
	smulbb	r3, r8, r5	@ tmp161, _5, _14
@ armwave.c:294:             gg = (g_armwave_state.ch1_color.g * value) >> 8;
	.loc 1 294 47 discriminator 3 view .LVU363
	smulbb	r2, r8, r6	@ tmp164, _5, _10
@ armwave.c:293:             rr = (g_armwave_state.ch1_color.r * value) >> 8;
	.loc 1 293 47 discriminator 3 view .LVU364
	smulbb	r8, r8, r7	@ tmp168, _5, _6
.LVL81:
@ armwave.c:295:             bb = (g_armwave_state.ch1_color.b * value) >> 8;
	.loc 1 295 56 discriminator 3 view .LVU365
	lsr	r9, r3, #8	@ bb, tmp161,
@ armwave.c:299:             b = MIN(bb, 255);
	.loc 1 299 17 discriminator 3 view .LVU366
	cmp	r9, #255	@ bb,
@ armwave.c:294:             gg = (g_armwave_state.ch1_color.g * value) >> 8;
	.loc 1 294 56 discriminator 3 view .LVU367
	lsr	r3, r2, #8	@ gg, tmp164,
@ armwave.c:299:             b = MIN(bb, 255);
	.loc 1 299 17 discriminator 3 view .LVU368
	movge	r9, #255	@ bb,
@ armwave.c:298:             g = MIN(gg, 255);
	.loc 1 298 17 discriminator 3 view .LVU369
	cmp	r3, #255	@ gg,
	movge	r3, #255	@ gg,
@ armwave.c:293:             rr = (g_armwave_state.ch1_color.r * value) >> 8;
	.loc 1 293 56 discriminator 3 view .LVU370
	lsr	r8, r8, #8	@ rr, tmp168,
@ armwave.c:306:             word = 0xff000000 | (b << 16) | (g << 8) | r;
	.loc 1 306 43 discriminator 3 view .LVU371
	lsl	r3, r3, #8	@ tmp165, gg,
	orr	r3, r3, r9, lsl #16	@ tmp166, tmp165, bb,
@ armwave.c:306:             word = 0xff000000 | (b << 16) | (g << 8) | r;
	.loc 1 306 54 discriminator 3 view .LVU372
	cmp	r8, #255	@ rr,
	orrle	r3, r3, r8	@,, tmp169, tmp166, rr
	orrgt	r3, r3, #255	@,, tmp169, tmp166,
@ armwave.c:306:             word = 0xff000000 | (b << 16) | (g << 8) | r;
	.loc 1 306 18 discriminator 3 view .LVU373
	orr	r3, r3, #-16777216	@ word, tmp169,
@ armwave.c:308:             *out_buffer++ = word;
	.loc 1 308 27 discriminator 3 view .LVU374
	str	r3, [r0], #4	@ word, MEM[base: out_buffer_46, offset: 4294967292B]
.LVL82:
@ armwave.c:289:         for(xx = 0; xx < g_armwave_state.target_width; xx++) {
	.loc 1 289 41 discriminator 3 view .LVU375
	ldr	r3, [lr, #52]	@ _28, g_armwave_state.target_width
@ armwave.c:289:         for(xx = 0; xx < g_armwave_state.target_width; xx++) {
	.loc 1 289 9 discriminator 3 view .LVU376
	cmp	r3, r1	@ _28, xx
	bhi	.L83		@,
	ldr	r2, [lr, #56]	@ prephitmp_102, g_armwave_state.target_height
.LVL83:
.L84:
@ armwave.c:288:     for(yy = 0; yy < g_armwave_state.target_height; yy++) {
	.loc 1 288 55 discriminator 2 view .LVU377
	add	ip, ip, #1	@ yy, yy,
.LVL84:
@ armwave.c:288:     for(yy = 0; yy < g_armwave_state.target_height; yy++) {
	.loc 1 288 5 discriminator 2 view .LVU378
	cmp	ip, r2	@ yy, prephitmp_102
	bcc	.L82		@,
	.loc 1 288 5 discriminator 2 view .LVU379
	pop	{r4, r5, r6, r7, r8, r9, r10, pc}	@
.LVL85:
.L80:
.LBB6:
.LBI6:
	.loc 1 277 6 is_stmt 1 view .LVU380
.LBB7:
	.loc 1 285 5 view .LVU381
	ldr	r3, .L91+4	@,
	ldr	r2, .L91+8	@,
	ldr	r1, .L91+12	@,
	ldr	r0, .L91+16	@,
.LVL86:
	.loc 1 285 5 is_stmt 0 view .LVU382
	bl	__assert_fail		@
.LVL87:
.L92:
	.align	2
...
.LFB64:
	...
	@ args = 0, pretend = 0, frame = 0
	@ frame_needed = 0, uses_anonymous_args = 0
	.loc 1 315 5 view .LVU384
@ armwave.c:314: {
	.loc 1 314 1 is_stmt 0 view .LVU385
	mov	r3, r1	@ fn, fn
...
@ armwave.c:315:     FILE *fp = fopen(fn, "wb");
	.loc 1 315 16 view .LVU386
	ldr	r1, .L105	@,
.LVL89:
	.loc 1 315 16 view .LVU387
	mov	r0, r3	@, fn
.LVL90:
...
@ armwave.c:322:     fprintf(fp, "%d %d\n", g_armwave_state.target_height, g_armwave_state.target_width);
	.loc 1 322 5 view .LVU389
	ldr	r6, .L105+4	@ tmp154,
@ armwave.c:321:     fputs("P3\n", fp);
	.loc 1 321 5 view .LVU390
	mov	r2, #3	@,
	mov	r1, #1	@,
@ armwave.c:315:     FILE *fp = fopen(fn, "wb");
	.loc 1 315 16 view .LVU391
	mov	r7, r0	@ fp,
.LVL92:
	.loc 1 316 5 is_stmt 1 view .LVU392
	.loc 1 317 5 view .LVU393
	.loc 1 321 5 view .LVU394
	mov	r3, r0	@, fp
	ldr	r0, .L105+8	@,
.LVL93:
	.loc 1 321 5 is_stmt 0 view .LVU395
	bl	fwrite		@
.LVL94:
	.loc 1 322 5 is_stmt 1 view .LVU396
...
@ armwave.c:330:             fprintf(fp, "%3d %3d %3d\n", data & 0xff, (data >> 8) & 0xff, (data >> 16) & 0xff);
	.loc 1 330 13 view .LVU401
	ldr	r9, .L105+20	@ tmp156,
@ armwave.c:325:     for(yy = 0; yy < g_armwave_state.target_height; yy++) {
	.loc 1 325 12 view .LVU402
	mov	r5, #0	@ yy,
.LVL97:
.L95:
@ armwave.c:326:         for(xx = 0; xx < g_armwave_state.target_width; xx++) {
	.loc 1 326 9 view .LVU403
	cmp	r3, #0	@ _12,
@ armwave.c:326:         for(xx = 0; xx < g_armwave_state.target_width; xx++) {
	.loc 1 326 16 view .LVU404
	movne	r4, #0	@ xx,
@ armwave.c:326:         for(xx = 0; xx < g_armwave_state.target_width; xx++) {
	.loc 1 326 9 view .LVU405
	beq	.L104		@,
.LVL98:
.L96:
	.loc 1 327 13 is_stmt 1 discriminator 3 view .LVU406
@ armwave.c:327:             data = *(buffer + (xx + (yy * g_armwave_state.target_width)));
	.loc 1 327 29 is_stmt 0 discriminator 3 view .LVU407
	mla	r3, r5, r3, r4	@ tmp145, yy, _12, xx
@ armwave.c:330:             fprintf(fp, "%3d %3d %3d\n", data & 0xff, (data >> 8) & 0xff, (data >> 16) & 0xff);
	.loc 1 330 13 discriminator 3 view .LVU408
	mov	r1, r9	@, tmp156
	mov	r0, r7	@, fp
@ armwave.c:327:             data = *(buffer + (xx + (yy * g_armwave_state.target_width)));
	.loc 1 327 18 discriminator 3 view .LVU409
	ldr	r2, [r8, r3, lsl #2]	@ data, *_6
.LVL99:
	.loc 1 330 13 is_stmt 1 discriminator 3 view .LVU410
@ armwave.c:326:         for(xx = 0; xx < g_armwave_state.target_width; xx++) {
	.loc 1 326 58 is_stmt 0 discriminator 3 view .LVU411
	add	r4, r4, #1	@ xx, xx,
.LVL100:
@ armwave.c:330:             fprintf(fp, "%3d %3d %3d\n", data & 0xff, (data >> 8) & 0xff, (data >> 16) & 0xff);
	.loc 1 330 81 discriminator 3 view .LVU412
	lsr	ip, r2, #16	@ tmp150, data,
@ armwave.c:330:             fprintf(fp, "%3d %3d %3d\n", data & 0xff, (data >> 8) & 0xff, (data >> 16) & 0xff);
	.loc 1 330 61 discriminator 3 view .LVU413
	lsr	r3, r2, #8	@ tmp146, data,
@ armwave.c:330:             fprintf(fp, "%3d %3d %3d\n", data & 0xff, (data >> 8) & 0xff, (data >> 16) & 0xff);
	.loc 1 330 13 discriminator 3 view .LVU414
	uxtb	ip, ip	@ tmp151, tmp150
	uxtb	r3, r3	@, tmp146
	str	ip, [sp]	@ tmp151,
	uxtb	r2, r2	@, data
.LVL101:
	.loc 1 330 13 discriminator 3 view .LVU415
	bl	fprintf		@
.LVL102:
@ armwave.c:326:         for(xx = 0; xx < g_armwave_state.target_width; xx++) {
	.loc 1 326 41 discriminator 3 view .LVU416
	ldr	r3, [r6, #52]	@ _12, g_armwave_state.target_width
@ armwave.c:326:         for(xx = 0; xx < g_armwave_state.target_width; xx++) {
	.loc 1 326 9 discriminator 3 view .LVU417
	cmp	r3, r4	@ _12, xx
	bhi	.L96		@,
	ldr	r2, [r6, #56]	@ prephitmp_57, g_armwave_state.target_height
.LVL103:
.L97:
@ armwave.c:325:     for(yy = 0; yy < g_armwave_state.target_height; yy++) {
	.loc 1 325 55 discriminator 2 view .LVU418
	add	r5, r5, #1	@ yy, yy,
.LVL104:
@ armwave.c:325:     for(yy = 0; yy < g_armwave_state.target_height; yy++) {
	.loc 1 325 5 discriminator 2 view .LVU419
	cmp	r5, r2	@ yy, prephitmp_57
	bcc	.L95		@,
.LVL105:
.L94:
	.loc 1 334 5 is_stmt 1 view .LVU420
	mov	r0, r7	@, fp
@ armwave.c:335: }
	.loc 1 335 1 is_stmt 0 view .LVU421
	add	sp, sp, #12	@,,
	.cfi_remember_state
	.cfi_def_cfa_offset 28
	@ sp needed	@
...
@ armwave.c:334:     fclose(fp);
	.loc 1 334 5 view .LVU422
	b	fclose		@
.LVL107:
.L104:
	.cfi_restore_state
@ armwave.c:325:     for(yy = 0; yy < g_armwave_state.target_height; yy++) {
	.loc 1 325 55 view .LVU423
	add	r5, r5, #1	@ yy, yy,
.LVL108:
@ armwave.c:325:     for(yy = 0; yy < g_armwave_state.target_height; yy++) {
...
.LFB65:
	...
	@ args = 0, pretend = 0, frame = 0
	@ frame_needed = 0, uses_anonymous_args = 0
	.loc 1 339 2 view .LVU426
@ armwave.c:339: 	mod_depth = mod;
	.loc 1 339 12 is_stmt 0 view .LVU427
	ldr	r3, .L111+20	@ tmp124,
@ armwave.c:338: {
	.loc 1 338 1 view .LVU428
	push	{r4, r5, r6, lr}	@
	.cfi_def_cfa_offset 16
	.cfi_offset 4, -16
	.cfi_offset 5, -12
	...
	.cfi_offset 84, -24
	.cfi_offset 85, -20
	ldr	r4, .L111+24	@ ivtmp.89,
.LBB10:
.LBB11:
@ armwave.c:84:         gamma_table[i] = pow(i / 255.0f, gamma) * 255.0f;
	.loc 1 84 32 view .LVU429
	vldr.32	s20, .L111+16	@ tmp130,
@ armwave.c:84:         gamma_table[i] = pow(i / 255.0f, gamma) * 255.0f;
	.loc 1 84 26 view .LVU430
	vldr.64	d9, .L111	@ tmp139,
@ armwave.c:84:         gamma_table[i] = pow(i / 255.0f, gamma) * 255.0f;
	.loc 1 84 49 view .LVU431
	vldr.64	d8, .L111+8	@ tmp133,
.LBE11:
.LBE10:
@ armwave.c:339: 	mod_depth = mod;
	.loc 1 339 12 view .LVU432
	vstr.32	s0, [r3]	@ mod, mod_depth
	.loc 1 341 5 is_stmt 1 view .LVU433
	bl	test_create_waveform		@
.LVL110:
	.loc 1 342 5 view .LVU434
.LBB13:
.LBI10:
	.loc 1 78 6 view .LVU435
	.loc 1 78 6 is_stmt 0 view .LVU436
	add	r3, r4, #1	@ _30, ivtmp.89,
	add	r6, r4, #256	@ _31, ivtmp.89,
	rsb	r5, r3, #1	@ tmp138, _30,
.LVL111:
.L108:
.LBB12:
	.loc 1 84 9 is_stmt 1 view .LVU437
@ armwave.c:84:         gamma_table[i] = pow(i / 255.0f, gamma) * 255.0f;
	.loc 1 84 32 is_stmt 0 view .LVU438
	add	r3, r5, r4	@ tmp127, tmp138, ivtmp.89
@ armwave.c:84:         gamma_table[i] = pow(i / 255.0f, gamma) * 255.0f;
	.loc 1 84 26 view .LVU439
	vmov.f64	d1, d9	@, tmp139
@ armwave.c:84:         gamma_table[i] = pow(i / 255.0f, gamma) * 255.0f;
	.loc 1 84 32 view .LVU440
	vmov	s15, r3	@ int	@ tmp127, tmp127
	vcvt.f32.s32	s15, s15	@ tmp128, tmp127
	vdiv.f32	s0, s15, s20	@ tmp129, tmp128, tmp130
@ armwave.c:84:         gamma_table[i] = pow(i / 255.0f, gamma) * 255.0f;
	.loc 1 84 26 view .LVU441
	vcvt.f64.f32	d0, s0	@, tmp129
	bl	pow		@
.LVL112:
@ armwave.c:84:         gamma_table[i] = pow(i / 255.0f, gamma) * 255.0f;
	.loc 1 84 49 view .LVU442
	vmul.f64	d0, d0, d8	@ tmp132,, tmp133
@ armwave.c:84:         gamma_table[i] = pow(i / 255.0f, gamma) * 255.0f;
	.loc 1 84 24 view .LVU443
	vcvt.u32.f64	s15, d0	@ tmp134, tmp132
	vmov	r3, s15	@ int	@ tmp134, tmp134
	strb	r3, [r4, #1]!	@ tmp134, MEM[base: _29, offset: 0B]
.LVL113:
@ armwave.c:83:     for(i = 0; i < 256; i++) {
	.loc 1 83 5 view .LVU444
	cmp	r4, r6	@ ivtmp.89, _31
	bne	.L108		@,
.LVL114:
	.loc 1 83 5 view .LVU445
.LBE12:
.LBE13:
	.loc 1 344 5 is_stmt 1 view .LVU446
	bl	armwave_setup_render.constprop.1		@
.LVL115:
	.loc 1 346 5 view .LVU447
@ armwave.c:347: }
	.loc 1 347 1 is_stmt 0 view .LVU448
	vldm	sp!, {d8-d10}	@,
	.cfi_restore 84
	.cfi_restore 85
	.cfi_restore 82
...
@ armwave.c:346:     printf("armwave version: %s\n", ARMWAVE_VER);
	.loc 1 346 5 view .LVU449
	ldr	r1, .L111+28	@,
	ldr	r0, .L111+32	@,
@ armwave.c:347: }
	.loc 1 347 1 view .LVU450
	pop	{r4, r5, r6, lr}	@
	.cfi_restore 14
	.cfi_restore 6
	.cfi_restore 5
...
.LFB66:
	...
	@ args = 0, pretend = 0, frame = 8
	@ frame_needed = 0, uses_anonymous_args = 0
	.loc 1 351 2 view .LVU453
	.loc 1 353 5 view .LVU454
@ armwave.c:350: {
	.loc 1 350 1 is_stmt 0 view .LVU455
	push	{r4, r5, r6, r7, r8, r9, r10, fp, lr}	@
	.cfi_def_cfa_offset 36
	.cfi_offset 4, -36
	.cfi_offset 5, -32
...
@ armwave.c:353:     memset(g_armwave_state.ch1_buffer, 0, g_armwave_state.size);
	.loc 1 353 5 view .LVU456
	mov	r1, #0	@,
	ldr	r4, .L131	@ tmp269,
@ armwave.c:350: {
	.loc 1 350 1 view .LVU457
	sub	sp, sp, #12	@,,
	.cfi_def_cfa_offset 48
@ armwave.c:353:     memset(g_armwave_state.ch1_buffer, 0, g_armwave_state.size);
	.loc 1 353 5 view .LVU458
...
@ armwave.c:355:     for(yy = 0; yy < (2048 / g_armwave_state.slice_height); yy++) {
	.loc 1 355 45 is_stmt 0 view .LVU460
	ldr	r5, [r4, #40]	@ _72, g_armwave_state.slice_height
@ armwave.c:355:     for(yy = 0; yy < (2048 / g_armwave_state.slice_height); yy++) {
	.loc 1 355 5 view .LVU461
	cmp	r5, #2048	@ _72,
	bhi	.L113		@,
	ldr	r6, [r4, #36]	@ prephitmp_171, g_armwave_state.waves
@ armwave.c:355:     for(yy = 0; yy < (2048 / g_armwave_state.slice_height); yy++) {
	.loc 1 355 12 view .LVU462
	mov	r10, #0	@ yy,
.LVL118:
.L119:
	.loc 1 356 9 is_stmt 1 discriminator 3 view .LVU463
	mul	r3, r5, r10	@ _3, _72, yy
.LBB16:
.LBB17:
@ armwave.c:103:     write_buffer_base = g_armwave_state.ch1_buffer + (slice_y * g_armwave_state.target_height);
	.loc 1 103 63 is_stmt 0 discriminator 3 view .LVU464
	ldr	r0, [r4, #56]	@ g_armwave_state.target_height, g_armwave_state.target_height
@ armwave.c:106:     for(w = 0; w < g_armwave_state.waves; w++) {
	.loc 1 106 5 discriminator 3 view .LVU465
...
@ armwave.c:356:         render_nonaa_to_buffer_1ch_slice(yy * g_armwave_state.slice_height, g_armwave_state.slice_record_height);
	.loc 1 356 9 discriminator 3 view .LVU466
	ldr	r9, [r4, #44]	@ _4, g_armwave_state.slice_record_height
.LVL119:
.LBB19:
.LBI16:
	.loc 1 95 6 is_stmt 1 discriminator 3 view .LVU467
.LBB18:
	.loc 1 97 5 discriminator 3 view .LVU468
	.loc 1 98 5 discriminator 3 view .LVU469
	.loc 1 99 5 discriminator 3 view .LVU470
	.loc 1 100 5 discriminator 3 view .LVU471
	.loc 1 101 5 discriminator 3 view .LVU472
	.loc 1 103 5 discriminator 3 view .LVU473
@ armwave.c:103:     write_buffer_base = g_armwave_state.ch1_buffer + (slice_y * g_armwave_state.target_height);
	.loc 1 103 63 is_stmt 0 discriminator 3 view .LVU474
	mul	r0, r0, r3	@ _15, g_armwave_state.target_height, _3
@ armwave.c:103:     write_buffer_base = g_armwave_state.ch1_buffer + (slice_y * g_armwave_state.target_height);
	.loc 1 103 40 discriminator 3 view .LVU475
	ldr	r2, [r4, #4]	@ _13, g_armwave_state.ch1_buffer
.LVL120:
	.loc 1 106 5 is_stmt 1 discriminator 3 view .LVU476
	.loc 1 106 5 is_stmt 0 discriminator 3 view .LVU477
	beq	.L115		@,
@ armwave.c:106:     for(w = 0; w < g_armwave_state.waves; w++) {
	.loc 1 106 11 view .LVU478
	mov	r8, #0	@ w,
	sub	r3, r3, #4	@ _77, _3,
.LVL121:
	.loc 1 106 11 view .LVU479
	str	r3, [sp, #4]	@ _77, %sfp
.LVL122:
.L118:
	.loc 1 107 9 is_stmt 1 view .LVU480
@ armwave.c:107:         wave_base = g_armwave_state.wave_buffer + slice_y + (w * g_armwave_state.wave_stride);
	.loc 1 107 64 is_stmt 0 view .LVU481
	ldr	r3, [r4, #32]	@ g_armwave_state.wave_stride, g_armwave_state.wave_stride
@ armwave.c:117:         for(yy = 0; yy < height; yy += 4) {
	.loc 1 117 9 view .LVU482
	cmp	r9, #0	@ _4,
@ armwave.c:107:         wave_base = g_armwave_state.wave_buffer + slice_y + (w * g_armwave_state.wave_stride);
	.loc 1 107 36 view .LVU483
	ldr	lr, [r4, #20]	@ _16, g_armwave_state.wave_buffer
@ armwave.c:107:         wave_base = g_armwave_state.wave_buffer + slice_y + (w * g_armwave_state.wave_stride);
	.loc 1 107 64 view .LVU484
	mul	r3, r3, r8	@ _19, g_armwave_state.wave_stride, w
.LVL123:
	.loc 1 117 9 is_stmt 1 view .LVU485
	.loc 1 117 9 is_stmt 0 view .LVU486
	beq	.L116		@,
	ldr	r1, [sp, #4]	@ _77, %sfp
	add	r3, r3, r1	@ tmp205, _19, _77
.LVL124:
	.loc 1 117 9 view .LVU487
	add	lr, lr, r3	@ ivtmp.95, _16, tmp205
.LVL125:
@ armwave.c:117:         for(yy = 0; yy < height; yy += 4) {
	.loc 1 117 16 view .LVU488
	mov	r1, #0	@ yy,
.LVL126:
.L117:
	.loc 1 132 13 is_stmt 1 view .LVU489
@ armwave.c:132:             word = *(uint32_t*)(wave_base + yy);
	.loc 1 132 18 is_stmt 0 view .LVU490
	ldr	r3, [lr, #4]!	@ word, MEM[base: _183, offset: 0B]
.LVL127:
	.loc 1 136 13 is_stmt 1 view .LVU491
	.loc 1 137 14 view .LVU492
	.loc 1 138 14 view .LVU493
	.loc 1 139 14 view .LVU494
@ armwave.c:137:             	scale_value = (word & 0xff) * g_armwave_state.vscale;
	.loc 1 137 42 is_stmt 0 view .LVU495
	ldr	r7, [r4, #28]	@ g_armwave_state.vscale, g_armwave_state.vscale
@ armwave.c:138:             	write_buffer = write_buffer_base + ((yy + ys) * g_armwave_state.target_height);
	.loc 1 138 60 view .LVU496
	ldr	r6, [r4, #56]	@ g_armwave_state.target_height, g_armwave_state.target_height
@ armwave.c:137:             	scale_value = (word & 0xff) * g_armwave_state.vscale;
	.loc 1 137 34 view .LVU497
	uxtb	ip, r3	@ word, word
@ armwave.c:140:             	word >>= 8;
	.loc 1 140 19 view .LVU498
	lsr	r5, r3, #8	@ word, word,
@ armwave.c:139:             	*(write_buffer + scale_value) += 1;
	.loc 1 139 44 view .LVU499
	mla	ip, r7, ip, r0	@ tmp210, g_armwave_state.vscale, word, _15
@ armwave.c:137:             	scale_value = (word & 0xff) * g_armwave_state.vscale;
	.loc 1 137 34 view .LVU500
	uxtb	r5, r5	@ word, word
@ armwave.c:139:             	*(write_buffer + scale_value) += 1;
	.loc 1 139 44 view .LVU501
	mla	r6, r6, r1, ip	@ tmp214, g_armwave_state.target_height, yy, tmp210
@ armwave.c:138:             	write_buffer = write_buffer_base + ((yy + ys) * g_armwave_state.target_height);
	.loc 1 138 60 view .LVU502
...
.LVL129:
	.loc 1 140 14 is_stmt 1 view .LVU508
	.loc 1 137 14 view .LVU509
	.loc 1 138 14 view .LVU510
	.loc 1 139 14 view .LVU511
@ armwave.c:137:             	scale_value = (word & 0xff) * g_armwave_state.vscale;
	.loc 1 137 42 is_stmt 0 view .LVU512
	ldr	r6, [r4, #28]	@ g_armwave_state.vscale, g_armwave_state.vscale
@ armwave.c:138:             	write_buffer = write_buffer_base + ((yy + ys) * g_armwave_state.target_height);
	.loc 1 138 60 view .LVU513
	add	r7, r1, #2	@ tmp241, yy,
@ armwave.c:139:             	*(write_buffer + scale_value) += 1;
	.loc 1 139 44 view .LVU514
	mla	r5, r6, r5, r0	@ tmp224, g_armwave_state.vscale, word, _15
@ armwave.c:138:             	write_buffer = write_buffer_base + ((yy + ys) * g_armwave_state.target_height);
	.loc 1 138 60 view .LVU515
	ldr	r6, [r4, #56]	@ g_armwave_state.target_height, g_armwave_state.target_height
@ armwave.c:139:             	*(write_buffer + scale_value) += 1;
	.loc 1 139 44 view .LVU516
	mla	r5, r6, fp, r5	@ tmp229, g_armwave_state.target_height, tmp226, tmp224
@ armwave.c:138:             	write_buffer = write_buffer_base + ((yy + ys) * g_armwave_state.target_height);
	.loc 1 138 60 view .LVU517
	add	r6, r1, #3	@ tmp255, yy,
@ armwave.c:117:         for(yy = 0; yy < height; yy += 4) {
	.loc 1 117 37 view .LVU518
	add	r1, r1, #4	@ yy, yy,
.LVL130:
@ armwave.c:139:             	*(write_buffer + scale_value) += 1;
	.loc 1 139 44 view .LVU519
	ldrb	fp, [r2, r5]	@ zero_extendqisi2	@ *_83, *_83
@ armwave.c:117:         for(yy = 0; yy < height; yy += 4) {
	.loc 1 117 9 view .LVU520
	cmp	r9, r1	@ _4, yy
@ armwave.c:139:             	*(write_buffer + scale_value) += 1;
	.loc 1 139 44 view .LVU521
	add	fp, fp, #1	@ tmp232, *_83,
	strb	fp, [r2, r5]	@ tmp232, *_83
.LVL131:
	.loc 1 140 14 is_stmt 1 view .LVU522
	.loc 1 137 14 view .LVU523
	.loc 1 138 14 view .LVU524
	.loc 1 139 14 view .LVU525
@ armwave.c:137:             	scale_value = (word & 0xff) * g_armwave_state.vscale;
	.loc 1 137 42 is_stmt 0 view .LVU526
	ldr	fp, [r4, #28]	@ g_armwave_state.vscale, g_armwave_state.vscale
@ armwave.c:138:             	write_buffer = write_buffer_base + ((yy + ys) * g_armwave_state.target_height);
	.loc 1 138 60 view .LVU527
	ldr	r5, [r4, #56]	@ g_armwave_state.target_height, g_armwave_state.target_height
@ armwave.c:139:             	*(write_buffer + scale_value) += 1;
	.loc 1 139 44 view .LVU528
	...
	.loc 1 140 14 is_stmt 1 view .LVU529
.LVL132:
	.loc 1 137 14 view .LVU530
	.loc 1 138 14 view .LVU531
	.loc 1 139 14 view .LVU532
@ armwave.c:137:             	scale_value = (word & 0xff) * g_armwave_state.vscale;
	.loc 1 137 42 is_stmt 0 view .LVU533
	ldr	r5, [r4, #28]	@ g_armwave_state.vscale, g_armwave_state.vscale
@ armwave.c:138:             	write_buffer = write_buffer_base + ((yy + ys) * g_armwave_state.target_height);
	.loc 1 138 60 view .LVU534
	ldr	ip, [r4, #56]	@ g_armwave_state.target_height, g_armwave_state.target_height
@ armwave.c:139:             	*(write_buffer + scale_value) += 1;
	.loc 1 139 44 view .LVU535
	...
	.loc 1 140 14 is_stmt 1 view .LVU536
.LVL133:
@ armwave.c:117:         for(yy = 0; yy < height; yy += 4) {
	.loc 1 117 9 is_stmt 0 view .LVU537
	bhi	.L117		@,
	ldr	r6, [r4, #36]	@ prephitmp_171, g_armwave_state.waves
.LVL134:
.L116:
@ armwave.c:106:     for(w = 0; w < g_armwave_state.waves; w++) {
	.loc 1 106 44 view .LVU538
	add	r8, r8, #1	@ w, w,
.LVL135:
@ armwave.c:106:     for(w = 0; w < g_armwave_state.waves; w++) {
	.loc 1 106 5 view .LVU539
	cmp	r8, r6	@ w, prephitmp_171
	bcc	.L118		@,
	ldr	r5, [r4, #40]	@ _72, g_armwave_state.slice_height
.LVL136:
.L115:
	.loc 1 106 5 view .LVU540
.LBE18:
.LBE19:
@ armwave.c:355:     for(yy = 0; yy < (2048 / g_armwave_state.slice_height); yy++) {
	.loc 1 355 28 discriminator 3 view .LVU541
	mov	r1, r5	@, _72
	mov	r0, #2048	@,
.LVL137:
	.loc 1 355 28 discriminator 3 view .LVU542
	bl	__aeabi_uidiv		@
.LVL138:
@ armwave.c:355:     for(yy = 0; yy < (2048 / g_armwave_state.slice_height); yy++) {
	.loc 1 355 63 discriminator 3 view .LVU543
	add	r10, r10, #1	@ yy, yy,
.LVL139:
@ armwave.c:355:     for(yy = 0; yy < (2048 / g_armwave_state.slice_height); yy++) {
	.loc 1 355 5 discriminator 3 view .LVU544
	cmp	r0, r10	@, yy
	bhi	.L119		@,
.LVL140:
.L113:
@ armwave.c:358: }
	.loc 1 358 1 view .LVU545
	add	sp, sp, #12	@,,
	.cfi_def_cfa_offset 36
	@ sp needed	@
	pop	{r4, r5, r6, r7, r8, r9, r10, fp, pc}	@
...
.LFB67:
	...
	@ args = 0, pretend = 0, frame = 0
	@ frame_needed = 0, uses_anonymous_args = 0
	.loc 1 362 5 view .LVU547
	.loc 1 363 5 view .LVU548
@ armwave.c:361: {
	.loc 1 361 1 is_stmt 0 view .LVU549
	push	{r4, r5, lr}	@
...
.LVL145:
	.loc 1 368 2 is_stmt 1 view .LVU560
@ armwave.c:368: 	mv = PyMemoryView_FromBuffer(buf);
	.loc 1 368 7 is_stmt 0 view .LVU561
	mov	r0, r5	@, tmp117
@ armwave.c:369: }
	.loc 1 369 1 view .LVU562
	add	sp, sp, #12	@,,
	.cfi_def_cfa_offset 12
	@ sp needed	@
	pop	{r4, r5, lr}	@
...
.LVL146:
@ armwave.c:368: 	mv = PyMemoryView_FromBuffer(buf);
	.loc 1 368 7 view .LVU563
	b	PyMemoryView_FromBuffer		@
.LVL147:
.L136:
	.loc 1 368 7 view .LVU564
	.align	2
.L135:
	.word	g_armwave_state
	.cfi_endproc
...
.LFB68:
	...
	@ frame_needed = 0, uses_anonymous_args = 0
	@ link register save eliminated.
	.loc 1 373 2 view .LVU566
	ldr	r3, .L138	@ tmp112,
	mov	r1, r0	@, fn
	ldr	r0, [r3, #60]	@, g_armwave_state.out_pixbuf
.LVL149:
	.loc 1 373 2 is_stmt 0 view .LVU567
	b	armwave_dump_ppm_debug		@
.LVL150:
.L139:
	.loc 1 373 2 view .LVU568
	.align	2
.L138:
	.word	g_armwave_state
	.cfi_endproc
...
.LFB70:
	...
	@ args = 0, pretend = 0, frame = 8
	@ frame_needed = 0, uses_anonymous_args = 0
	.loc 1 389 5 view .LVU584
	.loc 1 390 5 view .LVU585
	.loc 1 393 5 view .LVU586
.LBB24:
.LBI24:
	.loc 1 148 6 view .LVU587
.LBB25:
	.loc 1 150 5 view .LVU588
.LBE25:
.LBE24:
@ armwave.c:388: {
	.loc 1 388 1 is_stmt 0 view .LVU589
	push	{r4, r5, r6, r7, r8, r9, r10, fp, lr}	@
	.cfi_def_cfa_offset 36
	.cfi_offset 4, -36
	.cfi_offset 5, -32
...
@ armwave.c:409:             render_nonaa_to_buffer_1ch_slice(yy * g_armwave_state.slice_height, g_armwave_state.slice_record_height);
	.loc 1 409 13 discriminator 3 view .LVU605
	ldr	r10, [r9, #44]	@ _2, g_armwave_state.slice_record_height
.LVL160:
.LBB35:
.LBI32:
	.loc 1 95 6 is_stmt 1 discriminator 3 view .LVU606
.LBB34:
	.loc 1 97 5 discriminator 3 view .LVU607
	.loc 1 98 5 discriminator 3 view .LVU608
	.loc 1 99 5 discriminator 3 view .LVU609
	.loc 1 100 5 discriminator 3 view .LVU610
	.loc 1 101 5 discriminator 3 view .LVU611
	.loc 1 103 5 discriminator 3 view .LVU612
@ armwave.c:103:     write_buffer_base = g_armwave_state.ch1_buffer + (slice_y * g_armwave_state.target_height);
	.loc 1 103 63 is_stmt 0 discriminator 3 view .LVU613
	mul	r0, r0, r3	@ _19, g_armwave_state.target_height, _1
@ armwave.c:103:     write_buffer_base = g_armwave_state.ch1_buffer + (slice_y * g_armwave_state.target_height);
	.loc 1 103 40 discriminator 3 view .LVU614
	ldr	r2, [r9, #4]	@ _17, g_armwave_state.ch1_buffer
.LVL161:
	.loc 1 106 5 is_stmt 1 discriminator 3 view .LVU615
	.loc 1 106 5 is_stmt 0 discriminator 3 view .LVU616
	beq	.L146		@,
@ armwave.c:106:     for(w = 0; w < g_armwave_state.waves; w++) {
	.loc 1 106 11 view .LVU617
	mov	r7, #0	@ w,
	sub	r3, r3, #4	@ _81, _1,
.LVL162:
	.loc 1 106 11 view .LVU618
	str	r3, [sp]	@ _81, %sfp
.LVL163:
.L149:
	.loc 1 107 9 is_stmt 1 view .LVU619
@ armwave.c:107:         wave_base = g_armwave_state.wave_buffer + slice_y + (w * g_armwave_state.wave_stride);
	.loc 1 107 64 is_stmt 0 view .LVU620
	ldr	r3, [r9, #32]	@ g_armwave_state.wave_stride, g_armwave_state.wave_stride
@ armwave.c:117:         for(yy = 0; yy < height; yy += 4) {
	.loc 1 117 9 view .LVU621
	cmp	r10, #0	@ _2,
@ armwave.c:107:         wave_base = g_armwave_state.wave_buffer + slice_y + (w * g_armwave_state.wave_stride);
	.loc 1 107 36 view .LVU622
	ldr	lr, [r9, #20]	@ _20, g_armwave_state.wave_buffer
@ armwave.c:107:         wave_base = g_armwave_state.wave_buffer + slice_y + (w * g_armwave_state.wave_stride);
	.loc 1 107 64 view .LVU623
	mul	r3, r3, r7	@ _23, g_armwave_state.wave_stride, w
.LVL164:
	.loc 1 117 9 is_stmt 1 view .LVU624
	.loc 1 117 9 is_stmt 0 view .LVU625
	beq	.L147		@,
	ldr	r1, [sp]	@ _81, %sfp
	add	r3, r3, r1	@ tmp202, _23, _81
.LVL165:
	.loc 1 117 9 view .LVU626
	add	lr, lr, r3	@ ivtmp.108, _20, tmp202
.LVL166:
@ armwave.c:117:         for(yy = 0; yy < height; yy += 4) {
	.loc 1 117 16 view .LVU627
	mov	r1, #0	@ yy,
.LVL167:
.L148:
	.loc 1 132 13 is_stmt 1 view .LVU628
@ armwave.c:132:             word = *(uint32_t*)(wave_base + yy);
	.loc 1 132 18 is_stmt 0 view .LVU629
	ldr	r3, [lr, #4]!	@ word, MEM[base: _177, offset: 0B]
.LVL168:
	.loc 1 136 13 is_stmt 1 view .LVU630
	.loc 1 137 14 view .LVU631
	.loc 1 138 14 view .LVU632
	.loc 1 139 14 view .LVU633
@ armwave.c:137:             	scale_value = (word & 0xff) * g_armwave_state.vscale;
	.loc 1 137 42 is_stmt 0 view .LVU634
	ldr	r6, [r9, #28]	@ g_armwave_state.vscale, g_armwave_state.vscale
@ armwave.c:138:             	write_buffer = write_buffer_base + ((yy + ys) * g_armwave_state.target_height);
	.loc 1 138 60 view .LVU635
	ldr	r5, [r9, #56]	@ g_armwave_state.target_height, g_armwave_state.target_height
@ armwave.c:137:             	scale_value = (word & 0xff) * g_armwave_state.vscale;
	.loc 1 137 34 view .LVU636
	uxtb	ip, r3	@ word, word
@ armwave.c:140:             	word >>= 8;
	.loc 1 140 19 view .LVU637
	lsr	r4, r3, #8	@ word, word,
@ armwave.c:139:             	*(write_buffer + scale_value) += 1;
	.loc 1 139 44 view .LVU638
	mla	ip, r6, ip, r0	@ tmp207, g_armwave_state.vscale, word, _19
@ armwave.c:137:             	scale_value = (word & 0xff) * g_armwave_state.vscale;
	.loc 1 137 34 view .LVU639
	uxtb	r4, r4	@ word, word
@ armwave.c:139:             	*(write_buffer + scale_value) += 1;
	.loc 1 139 44 view .LVU640
	mla	r5, r5, r1, ip	@ tmp211, g_armwave_state.target_height, yy, tmp207
@ armwave.c:138:             	write_buffer = write_buffer_base + ((yy + ys) * g_armwave_state.target_height);
	.loc 1 138 60 view .LVU641
...
.LVL170:
	.loc 1 140 14 is_stmt 1 view .LVU647
	.loc 1 137 14 view .LVU648
	.loc 1 138 14 view .LVU649
	.loc 1 139 14 view .LVU650
@ armwave.c:137:             	scale_value = (word & 0xff) * g_armwave_state.vscale;
	.loc 1 137 42 is_stmt 0 view .LVU651
	ldr	r5, [r9, #28]	@ g_armwave_state.vscale, g_armwave_state.vscale
@ armwave.c:138:             	write_buffer = write_buffer_base + ((yy + ys) * g_armwave_state.target_height);
	.loc 1 138 60 view .LVU652
	add	r6, r1, #2	@ tmp238, yy,
@ armwave.c:139:             	*(write_buffer + scale_value) += 1;
	.loc 1 139 44 view .LVU653
	mla	r4, r5, r4, r0	@ tmp221, g_armwave_state.vscale, word, _19
@ armwave.c:138:             	write_buffer = write_buffer_base + ((yy + ys) * g_armwave_state.target_height);
	.loc 1 138 60 view .LVU654
	ldr	r5, [r9, #56]	@ g_armwave_state.target_height, g_armwave_state.target_height
@ armwave.c:139:             	*(write_buffer + scale_value) += 1;
	.loc 1 139 44 view .LVU655
	mla	r4, r5, fp, r4	@ tmp226, g_armwave_state.target_height, tmp223, tmp221
@ armwave.c:138:             	write_buffer = write_buffer_base + ((yy + ys) * g_armwave_state.target_height);
	.loc 1 138 60 view .LVU656
	add	r5, r1, #3	@ tmp252, yy,
@ armwave.c:117:         for(yy = 0; yy < height; yy += 4) {
	.loc 1 117 37 view .LVU657
	add	r1, r1, #4	@ yy, yy,
.LVL171:
@ armwave.c:139:             	*(write_buffer + scale_value) += 1;
	.loc 1 139 44 view .LVU658
	ldrb	fp, [r2, r4]	@ zero_extendqisi2	@ *_87, *_87
@ armwave.c:117:         for(yy = 0; yy < height; yy += 4) {
	.loc 1 117 9 view .LVU659
	cmp	r10, r1	@ _2, yy
@ armwave.c:139:             	*(write_buffer + scale_value) += 1;
	.loc 1 139 44 view .LVU660
	add	fp, fp, #1	@ tmp229, *_87,
	strb	fp, [r2, r4]	@ tmp229, *_87
.LVL172:
	.loc 1 140 14 is_stmt 1 view .LVU661
	.loc 1 137 14 view .LVU662
	.loc 1 138 14 view .LVU663
	.loc 1 139 14 view .LVU664
@ armwave.c:137:             	scale_value = (word & 0xff) * g_armwave_state.vscale;
	.loc 1 137 42 is_stmt 0 view .LVU665
	ldr	fp, [r9, #28]	@ g_armwave_state.vscale, g_armwave_state.vscale
@ armwave.c:138:             	write_buffer = write_buffer_base + ((yy + ys) * g_armwave_state.target_height);
	.loc 1 138 60 view .LVU666
	ldr	r4, [r9, #56]	@ g_armwave_state.target_height, g_armwave_state.target_height
@ armwave.c:139:             	*(write_buffer + scale_value) += 1;
	.loc 1 139 44 view .LVU667
	...
	.loc 1 140 14 is_stmt 1 view .LVU668
.LVL173:
	.loc 1 137 14 view .LVU669
	.loc 1 138 14 view .LVU670
	.loc 1 139 14 view .LVU671
@ armwave.c:137:             	scale_value = (word & 0xff) * g_armwave_state.vscale;
	.loc 1 137 42 is_stmt 0 view .LVU672
	ldr	r4, [r9, #28]	@ g_armwave_state.vscale, g_armwave_state.vscale
@ armwave.c:138:             	write_buffer = write_buffer_base + ((yy + ys) * g_armwave_state.target_height);
	.loc 1 138 60 view .LVU673
...
@ armwave.c:139:             	*(write_buffer + scale_value) += 1;
	...
	.loc 1 140 14 is_stmt 1 view .LVU675
.LVL174:
@ armwave.c:117:         for(yy = 0; yy < height; yy += 4) {
	.loc 1 117 9 is_stmt 0 view .LVU676
	bhi	.L148		@,
	ldr	r6, [r9, #36]	@ prephitmp_178, g_armwave_state.waves
.LVL175:
.L147:
@ armwave.c:106:     for(w = 0; w < g_armwave_state.waves; w++) {
	.loc 1 106 44 view .LVU677
	add	r7, r7, #1	@ w, w,
.LVL176:
@ armwave.c:106:     for(w = 0; w < g_armwave_state.waves; w++) {
	.loc 1 106 5 view .LVU678
	cmp	r7, r6	@ w, prephitmp_178
	bcc	.L149		@,
	ldr	r5, [r9, #40]	@ _61, g_armwave_state.slice_height
.LVL177:
.L146:
	.loc 1 106 5 view .LVU679
.LBE34:
.LBE35:
@ armwave.c:407:         for(yy = 0; yy < (2048 / g_armwave_state.slice_height); yy++) {
	.loc 1 407 32 discriminator 3 view .LVU680
	mov	r1, r5	@, _61
	mov	r0, #2048	@,
.LVL178:
	.loc 1 407 32 discriminator 3 view .LVU681
	bl	__aeabi_uidiv		@
.LVL179:
@ armwave.c:407:         for(yy = 0; yy < (2048 / g_armwave_state.slice_height); yy++) {
	.loc 1 407 67 discriminator 3 view .LVU682
	add	r8, r8, #1	@ yy, yy,
.LVL180:
@ armwave.c:407:         for(yy = 0; yy < (2048 / g_armwave_state.slice_height); yy++) {
	.loc 1 407 9 discriminator 3 view .LVU683
	cmp	r0, r8	@, yy
	bhi	.L150		@,
.LVL181:
.L153:
@ armwave.c:406:     for(n = 0; n < 5000; n++) {
	.loc 1 406 5 discriminator 2 view .LVU684
	ldr	r3, [sp, #4]	@ ivtmp_191, %sfp
	subs	r3, r3, #1	@ ivtmp_191, ivtmp_191,
	str	r3, [sp, #4]	@ ivtmp_191, %sfp
	bne	.L145		@,
	mov	r0, r3	@, ivtmp_191
	.loc 1 422 5 is_stmt 1 view .LVU685
@ armwave.c:423: }
	.loc 1 423 1 is_stmt 0 view .LVU686
	add	sp, sp, #12	@,,
	.cfi_def_cfa_offset 36
	@ sp needed	@
	pop	{r4, r5, r6, r7, r8, r9, r10, fp, pc}	@
