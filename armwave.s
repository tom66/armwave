...
@ armwave.c:40:         gamma_table[i] = pow(i / 255.0f, gamma) * 255.0f;
	...
	add	r5, r4, #1	@ _25, ivtmp.27,
	add	r6, r4, #256	@ _26, ivtmp.27,
...
@ armwave.c:40:         gamma_table[i] = pow(i / 255.0f, gamma) * 255.0f;
	...
	add	r3, r5, r4	@ tmp125, tmp134, ivtmp.27
@ armwave.c:40:         gamma_table[i] = pow(i / 255.0f, gamma) * 255.0f;
...
.LFB60:
	...
	.loc 1 96 5 view .LVU27
	.loc 1 97 5 view .LVU28
	.loc 1 98 5 view .LVU29
...
@ armwave.c:93: {
	...
	.cfi_offset 8, -8
	.cfi_offset 14, -4
@ armwave.c:100:     write_buffer_base = g_armwave_state.ch1_buffer + (slice_y * g_armwave_state.bitdepth_height);
	.loc 1 100 40 view .LVU32
	ldr	r5, .L16	@ tmp142,
@ armwave.c:103:     for(w = 0; w < g_armwave_state.waves; w++) {
	.loc 1 103 5 view .LVU33
	ldr	r2, [r5, #56]	@ g_armwave_state.waves, g_armwave_state.waves
@ armwave.c:100:     write_buffer_base = g_armwave_state.ch1_buffer + (slice_y * g_armwave_state.bitdepth_height);
	.loc 1 100 63 view .LVU34
	ldr	r7, [r5, #64]	@ g_armwave_state.bitdepth_height, g_armwave_state.bitdepth_height
@ armwave.c:100:     write_buffer_base = g_armwave_state.ch1_buffer + (slice_y * g_armwave_state.bitdepth_height);
	.loc 1 100 23 view .LVU35
	ldr	r3, [r5, #4]	@ g_armwave_state.ch1_buffer, g_armwave_state.ch1_buffer
@ armwave.c:103:     for(w = 0; w < g_armwave_state.waves; w++) {
	.loc 1 103 5 view .LVU36
	cmp	r2, #0	@ g_armwave_state.waves,
@ armwave.c:100:     write_buffer_base = g_armwave_state.ch1_buffer + (slice_y * g_armwave_state.bitdepth_height);
	.loc 1 100 23 view .LVU37
	mla	r7, r7, r0, r3	@ write_buffer_base, g_armwave_state.bitdepth_height, slice_y, g_armwave_state.ch1_buffer
.LVL7:
	.loc 1 103 5 is_stmt 1 view .LVU38
	.loc 1 103 5 is_stmt 0 view .LVU39
	pople	{r4, r5, r6, r7, r8, pc}	@
	mov	r8, r1	@ height, height
	mov	r6, r0	@ slice_y, slice_y
@ armwave.c:103:     for(w = 0; w < g_armwave_state.waves; w++) {
	.loc 1 103 11 view .LVU40
	mov	r4, #0	@ w,
.LVL8:
.L13:
.LBB9:
	.loc 1 104 9 is_stmt 1 discriminator 3 view .LVU41
	.loc 1 106 9 discriminator 3 view .LVU42
@ armwave.c:104:         wave_base = g_armwave_state.wave_buffer + slice_y + (w * g_armwave_state.wave_stride);
	.loc 1 104 64 is_stmt 0 discriminator 3 view .LVU43
	ldr	r3, [r5, #52]	@ g_armwave_state.wave_stride, g_armwave_state.wave_stride
@ armwave.c:104:         wave_base = g_armwave_state.wave_buffer + slice_y + (w * g_armwave_state.wave_stride);
	.loc 1 104 19 discriminator 3 view .LVU44
	ldr	r1, [r5, #20]	@ g_armwave_state.wave_buffer, g_armwave_state.wave_buffer
@ armwave.c:106:         _render_nonaa_to_buffer_1ch_slice_core(write_buffer_base, wave_base, height);
	.loc 1 106 9 discriminator 3 view .LVU45
	mov	r2, r8	@, height
@ armwave.c:104:         wave_base = g_armwave_state.wave_buffer + slice_y + (w * g_armwave_state.wave_stride);
	.loc 1 104 59 discriminator 3 view .LVU46
	mla	r3, r3, r4, r6	@ tmp137, g_armwave_state.wave_stride, w, slice_y
@ armwave.c:106:         _render_nonaa_to_buffer_1ch_slice_core(write_buffer_base, wave_base, height);
	.loc 1 106 9 discriminator 3 view .LVU47
	mov	r0, r7	@, write_buffer_base
	add	r1, r1, r3	@, g_armwave_state.wave_buffer, tmp137
	bl	_render_nonaa_to_buffer_1ch_slice_core		@
.LVL9:
	.loc 1 106 9 discriminator 3 view .LVU48
.LBE9:
@ armwave.c:103:     for(w = 0; w < g_armwave_state.waves; w++) {
	.loc 1 103 5 discriminator 3 view .LVU49
	ldr	r3, [r5, #56]	@ g_armwave_state.waves, g_armwave_state.waves
@ armwave.c:103:     for(w = 0; w < g_armwave_state.waves; w++) {
	.loc 1 103 44 discriminator 3 view .LVU50
	add	r4, r4, #1	@ w, w,
.LVL10:
@ armwave.c:103:     for(w = 0; w < g_armwave_state.waves; w++) {
	.loc 1 103 5 discriminator 3 view .LVU51
	cmp	r3, r4	@ g_armwave_state.waves, w
	bgt	.L13		@,
...
.LFB61:
	...
	.loc 1 173 5 view .LVU54
	.loc 1 174 5 view .LVU55
	.loc 1 176 5 view .LVU56
@ armwave.c:170: {
	...
	.cfi_offset 11, -8
	.cfi_offset 14, -4
@ armwave.c:180:     assert(out_buffer != NULL);
	.loc 1 180 5 view .LVU58
	cmp	r0, #0	@ out_buffer
@ armwave.c:176:     uint32_t *base_32ptr = (uint32_t*)g_armwave_state.ch1_buffer;
	.loc 1 176 15 view .LVU59
	ldr	r6, .L40	@ tmp203,
@ armwave.c:170: {
	.loc 1 170 1 view .LVU60
	sub	sp, sp, #12	@,,
	.cfi_def_cfa_offset 48
@ armwave.c:176:     uint32_t *base_32ptr = (uint32_t*)g_armwave_state.ch1_buffer;
	.loc 1 176 15 view .LVU61
	ldr	lr, [r6, #4]	@ base_32ptr, g_armwave_state.ch1_buffer
.LVL12:
	.loc 1 177 5 is_stmt 1 view .LVU62
	.loc 1 178 5 view .LVU63
	.loc 1 180 5 view .LVU64
	beq	.L37		@,
	.loc 1 182 5 view .LVU65
@ armwave.c:182:     npix = g_armwave_state.target_width * 256; 
	.loc 1 182 10 is_stmt 0 view .LVU66
	ldr	r8, [r6, #88]	@ g_armwave_state.target_width, g_armwave_state.target_width
	lsl	r8, r8, #8	@ npix, g_armwave_state.target_width,
.LVL13:
	.loc 1 185 5 is_stmt 1 view .LVU67
	.loc 1 185 5 is_stmt 0 view .LVU68
	cmp	r8, #0	@ npix,
	ble	.L18		@,
@ armwave.c:198:                     gg = (g_armwave_state.ch1_color.g * value) >> 8;
	.loc 1 198 52 view .LVU69
	ldrsh	r3, [r6, #110]	@ _10, g_armwave_state.ch1_color.g
@ armwave.c:197:                     rr = (g_armwave_state.ch1_color.r * value) >> 8;
	.loc 1 197 52 view .LVU70
	ldrsh	fp, [r6, #108]	@ _6, g_armwave_state.ch1_color.r
@ armwave.c:221:                     yy = (nsub & 0xff) * g_armwave_state.vscale_frac;
	.loc 1 221 57 view .LVU71
	vldr.32	s13, [r6, #40]	@ _27, g_armwave_state.vscale_frac
@ armwave.c:198:                     gg = (g_armwave_state.ch1_color.g * value) >> 8;
	.loc 1 198 52 view .LVU72
	str	r3, [sp]	@ _10, %sfp
@ armwave.c:199:                     bb = (g_armwave_state.ch1_color.b * value) >> 8;
	.loc 1 199 52 view .LVU73
	ldrsh	r3, [r6, #112]	@ _13, g_armwave_state.ch1_color.b
@ armwave.c:185:     for(n = 0; n < npix; n += 4) {
	.loc 1 185 11 view .LVU74
	mov	r1, #0	@ n,
@ armwave.c:199:                     bb = (g_armwave_state.ch1_color.b * value) >> 8;
	.loc 1 199 52 view .LVU75
	str	r3, [sp, #4]	@ _13, %sfp
.LVL14:
.L25:
	.loc 1 189 9 is_stmt 1 view .LVU76
@ armwave.c:189:         wave_word = *base_32ptr++;
	.loc 1 189 19 is_stmt 0 view .LVU77
	ldr	r3, [lr], #4	@ wave_word, MEM[base: base_32ptr_54, offset: 4294967292B]
.LVL15:
	.loc 1 191 9 is_stmt 1 view .LVU78
@ armwave.c:191:         if(COND_UNLIKELY(wave_word != 0)) {
	.loc 1 191 11 is_stmt 0 view .LVU79
	cmp	r3, #0	@ wave_word,
	bne	.L38		@,
.L21:
@ armwave.c:185:     for(n = 0; n < npix; n += 4) {
	.loc 1 185 28 view .LVU80
	add	r1, r1, #4	@ n, n,
.LVL16:
@ armwave.c:185:     for(n = 0; n < npix; n += 4) {
...
.L38:
	.cfi_restore_state
@ armwave.c:196:                 if(value != 0) {
	.loc 1 196 19 view .LVU83
	ands	r2, r3, #255	@ _7, wave_word,
@ armwave.c:192:             for(w = 0; w < 4; w++) {
	.loc 1 192 19 view .LVU84
	mov	r7, #0	@ w,
.LVL19:
	.loc 1 193 17 is_stmt 1 view .LVU85
	.loc 1 194 17 view .LVU86
@ armwave.c:194:                 wave_word >>= 8;
	.loc 1 194 27 is_stmt 0 view .LVU87
	lsr	r3, r3, #8	@ wave_word, wave_word,
.LVL20:
	.loc 1 196 17 is_stmt 1 view .LVU88
@ armwave.c:196:                 if(value != 0) {
	.loc 1 196 19 is_stmt 0 view .LVU89
	bne	.L39		@,
.L22:
@ armwave.c:192:             for(w = 0; w < 4; w++) {
	.loc 1 192 32 view .LVU90
	add	r7, r7, #1	@ w, w,
.LVL21:
@ armwave.c:192:             for(w = 0; w < 4; w++) {
	.loc 1 192 13 view .LVU91
	cmp	r7, #4	@ w,
	beq	.L21		@,
	.loc 1 193 17 is_stmt 1 view .LVU92
.LVL22:
	.loc 1 194 17 view .LVU93
@ armwave.c:196:                 if(value != 0) {
	.loc 1 196 19 is_stmt 0 view .LVU94
	ands	r2, r3, #255	@ _7, wave_word,
@ armwave.c:194:                 wave_word >>= 8;
	.loc 1 194 27 view .LVU95
	lsr	r3, r3, #8	@ wave_word, wave_word,
.LVL23:
	.loc 1 196 17 is_stmt 1 view .LVU96
@ armwave.c:196:                 if(value != 0) {
	.loc 1 196 19 is_stmt 0 view .LVU97
	beq	.L22		@,
.L39:
	.loc 1 197 21 is_stmt 1 view .LVU98
.LVL24:
	.loc 1 198 21 view .LVU99
	.loc 1 199 21 view .LVU100
	.loc 1 201 21 view .LVU101
	.loc 1 202 21 view .LVU102
	.loc 1 203 21 view .LVU103
	.loc 1 206 21 view .LVU104
@ armwave.c:199:                     bb = (g_armwave_state.ch1_color.b * value) >> 8;
	.loc 1 199 55 is_stmt 0 view .LVU105
	ldr	ip, [sp, #4]	@ _13, %sfp
	add	r5, r1, r7	@ _120, n, w
	mul	r10, ip, r2	@ tmp181, _13, _7
@ armwave.c:221:                     yy = (nsub & 0xff) * g_armwave_state.vscale_frac;
	.loc 1 221 32 view .LVU106
	uxtb	ip, r5	@ _25, _120
@ armwave.c:222:                     ye = ((nsub & 0xff) + 1) * g_armwave_state.vscale_frac;
	.loc 1 222 41 view .LVU107
	add	r4, ip, #1	@ tmp196, _25,
@ armwave.c:221:                     yy = (nsub & 0xff) * g_armwave_state.vscale_frac;
	.loc 1 221 40 view .LVU108
	vmov	s15, ip	@ int	@ _25, _25
@ armwave.c:222:                     ye = ((nsub & 0xff) + 1) * g_armwave_state.vscale_frac;
	.loc 1 222 41 view .LVU109
	vmov	s14, r4	@ int	@ tmp196, tmp196
@ armwave.c:198:                     gg = (g_armwave_state.ch1_color.g * value) >> 8;
	.loc 1 198 55 view .LVU110
	ldr	ip, [sp]	@ _10, %sfp
@ armwave.c:199:                     bb = (g_armwave_state.ch1_color.b * value) >> 8;
	.loc 1 199 24 view .LVU111
	asr	r10, r10, #8	@ bb, tmp181,
.LVL25:
@ armwave.c:221:                     yy = (nsub & 0xff) * g_armwave_state.vscale_frac;
	.loc 1 221 40 view .LVU112
	vcvt.f32.s32	s15, s15	@ tmp194, _25
@ armwave.c:222:                     ye = ((nsub & 0xff) + 1) * g_armwave_state.vscale_frac;
	.loc 1 222 46 view .LVU113
	vcvt.f32.s32	s14, s14	@ tmp197, tmp196
@ armwave.c:198:                     gg = (g_armwave_state.ch1_color.g * value) >> 8;
	.loc 1 198 55 view .LVU114
	mul	r4, ip, r2	@ tmp185, _10, _7
@ armwave.c:197:                     rr = (g_armwave_state.ch1_color.r * value) >> 8;
	.loc 1 197 55 view .LVU115
	mul	r2, r2, fp	@ tmp191, _7, _6
.LVL26:
@ armwave.c:203:                     b = MIN(bb, 255);
	.loc 1 203 25 view .LVU116
	cmp	r10, #255	@ bb,
@ armwave.c:198:                     gg = (g_armwave_state.ch1_color.g * value) >> 8;
	.loc 1 198 24 view .LVU117
	asr	r4, r4, #8	@ gg, tmp185,
.LVL27:
@ armwave.c:221:                     yy = (nsub & 0xff) * g_armwave_state.vscale_frac;
	.loc 1 221 40 view .LVU118
	vmul.f32	s15, s15, s13	@ tmp195, tmp194, _27
@ armwave.c:222:                     ye = ((nsub & 0xff) + 1) * g_armwave_state.vscale_frac;
	.loc 1 222 46 view .LVU119
	vmul.f32	s14, s14, s13	@ tmp198, tmp197, _27
@ armwave.c:197:                     rr = (g_armwave_state.ch1_color.r * value) >> 8;
	.loc 1 197 24 view .LVU120
	asr	ip, r2, #8	@ rr, tmp191,
.LVL28:
@ armwave.c:203:                     b = MIN(bb, 255);
	.loc 1 203 25 view .LVU121
	movge	r10, #255	@ bb,
.LVL29:
@ armwave.c:202:                     g = MIN(gg, 255);
	.loc 1 202 25 view .LVU122
	cmp	r4, #255	@ gg,
	movge	r4, #255	@ gg,
.LVL30:
@ armwave.c:201:                     r = MIN(rr, 255);
	.loc 1 201 25 view .LVU123
	cmp	ip, #255	@ rr,
@ armwave.c:206:                     word = 0xff000000 | (b << 16) | (g << 8) | r;
	.loc 1 206 56 view .LVU124
	lsl	r4, r4, #8	@ tmp186, gg,
@ armwave.c:221:                     yy = (nsub & 0xff) * g_armwave_state.vscale_frac;
	.loc 1 221 24 view .LVU125
	vcvt.u32.f32	s15, s15	@ yy, tmp195
@ armwave.c:201:                     r = MIN(rr, 255);
	.loc 1 201 25 view .LVU126
	movge	ip, #255	@ rr,
.LVL31:
@ armwave.c:206:                     word = 0xff000000 | (b << 16) | (g << 8) | r;
	.loc 1 206 44 view .LVU127
	lsl	r10, r10, #16	@ tmp182, bb,
	and	r10, r10, #16711680	@ tmp183, tmp182,
@ armwave.c:206:                     word = 0xff000000 | (b << 16) | (g << 8) | r;
	.loc 1 206 56 view .LVU128
	uxth	r4, r4	@ tmp187, tmp186
@ armwave.c:206:                     word = 0xff000000 | (b << 16) | (g << 8) | r;
	.loc 1 206 51 view .LVU129
	orr	r4, r10, r4	@ tmp189, tmp183, tmp187
@ armwave.c:206:                     word = 0xff000000 | (b << 16) | (g << 8) | r;
	.loc 1 206 62 view .LVU130
	uxtb	ip, ip	@ rr, rr
	orr	ip, r4, ip	@ tmp193, tmp189, rr
@ armwave.c:221:                     yy = (nsub & 0xff) * g_armwave_state.vscale_frac;
	.loc 1 221 24 view .LVU131
	vmov	r2, s15	@ int	@ yy, yy
@ armwave.c:222:                     ye = ((nsub & 0xff) + 1) * g_armwave_state.vscale_frac;
	.loc 1 222 24 view .LVU132
	vcvt.u32.f32	s15, s14	@ ye, tmp198
@ armwave.c:206:                     word = 0xff000000 | (b << 16) | (g << 8) | r;
	.loc 1 206 26 view .LVU133
	orr	r4, ip, #-16777216	@ word, tmp193,
.LVL32:
	.loc 1 220 21 is_stmt 1 view .LVU134
	.loc 1 221 21 view .LVU135
	.loc 1 222 21 view .LVU136
@ armwave.c:223:                     xx = (nsub >> 8);
	.loc 1 223 32 is_stmt 0 view .LVU137
	asr	r5, r5, #8	@ xx, _120,
.LVL33:
@ armwave.c:222:                     ye = ((nsub & 0xff) + 1) * g_armwave_state.vscale_frac;
	.loc 1 222 24 view .LVU138
	vmov	r9, s15	@ int	@ ye, ye
.LVL34:
	.loc 1 223 21 is_stmt 1 view .LVU139
	.loc 1 225 21 view .LVU140
	.loc 1 225 21 is_stmt 0 view .LVU141
	cmp	r2, r9	@ yy, ye
	bcs	.L22		@,
.LVL35:
.L23:
	.loc 1 226 25 is_stmt 1 discriminator 3 view .LVU142
	.loc 1 227 25 discriminator 3 view .LVU143
@ armwave.c:226:                         offset = (xx + (y * g_armwave_state.target_width)); 
	.loc 1 226 43 is_stmt 0 discriminator 3 view .LVU144
	ldr	ip, [r6, #88]	@ g_armwave_state.target_width, g_armwave_state.target_width
@ armwave.c:227:                         *(out_buffer_base + offset) = word;
	.loc 1 227 43 discriminator 3 view .LVU145
	mla	ip, ip, r2, r5	@ tmp202, g_armwave_state.target_width, yy, xx
.LVL36:
@ armwave.c:225:                     for(y = yy; y < ye; y++) {
	.loc 1 225 42 discriminator 3 view .LVU146
	add	r2, r2, #1	@ yy, yy,
.LVL37:
@ armwave.c:225:                     for(y = yy; y < ye; y++) {
	.loc 1 225 21 discriminator 3 view .LVU147
	cmp	r9, r2	@ ye, yy
@ armwave.c:227:                         *(out_buffer_base + offset) = word;
	.loc 1 227 53 discriminator 3 view .LVU148
	str	r4, [r0, ip, lsl #2]	@ word, *_37
@ armwave.c:225:                     for(y = yy; y < ye; y++) {
	.loc 1 225 21 discriminator 3 view .LVU149
	bne	.L23		@,
	.loc 1 225 21 discriminator 3 view .LVU150
	b	.L22		@
.LVL38:
.L37:
	.loc 1 180 5 is_stmt 1 discriminator 1 view .LVU151
	ldr	r3, .L40+4	@,
	mov	r2, #180	@,
	ldr	r1, .L40+8	@,
	ldr	r0, .L40+12	@,
.LVL39:
	.loc 1 180 5 is_stmt 0 discriminator 1 view .LVU152
	bl	__assert_fail		@
.LVL40:
.L41:
	.loc 1 180 5 discriminator 1 view .LVU153
	.align	2
.L40:
	.word	g_armwave_state
	.word	.LANCHOR0
...
.LFB62:
	...
	.loc 1 243 5 view .LVU157
@ armwave.c:239: {
	.loc 1 239 1 is_stmt 0 view .LVU158
...
.LVL44:
	...
	ldr	r0, .L56+8	@,
.LVL45:
	.loc 1 243 5 view .LVU164
	bl	printf		@
.LVL46:
	.loc 1 246 5 is_stmt 1 view .LVU165
	cmp	r5, r9	@ start_point, end_point
	bcs	.L53		@,
	.loc 1 268 5 view .LVU166
@ armwave.c:269:     g_armwave_state.vscale_frac = target_height / 255.0f;
	.loc 1 269 49 is_stmt 0 view .LVU167
	vmov	s15, r7	@ int	@ target_height, target_height
	vldr.32	s14, .L56	@ tmp168,
@ armwave.c:268:     g_armwave_state.xstride = target_height;
	.loc 1 268 29 view .LVU168
	ldr	r4, .L56+12	@ tmp224,
@ armwave.c:274:     g_armwave_state.size = target_height * target_width;
	.loc 1 274 42 view .LVU169
	mul	r1, r7, r6	@ tmp176, target_height, target_width
@ armwave.c:269:     g_armwave_state.vscale_frac = target_height / 255.0f;
	.loc 1 269 49 view .LVU170
	vcvt.f32.u32	s13, s15	@ tmp167, target_height
@ armwave.c:276:     g_armwave_state.ch_buff_size = g_armwave_state.bitdepth_height * target_width;
	.loc 1 276 68 view .LVU171
	lsl	r3, r6, #8	@ _10, target_width,
@ armwave.c:275:     g_armwave_state.bitdepth_height = 256;  // Always 256 possible levels in 8-bit mode
	.loc 1 275 37 view .LVU172
	mov	r0, #256	@ tmp178,
@ armwave.c:282:     g_armwave_state.cmp_x_bitdepth_scale = g_armwave_state.bitdepth_height * (1 << AM_XCOORD_MULT_SHIFT);
	.loc 1 282 42 view .LVU173
	mov	r2, #65536	@ tmp184,
@ armwave.c:274:     g_armwave_state.size = target_height * target_width;
	.loc 1 274 26 view .LVU174
	str	r1, [r4, #84]	@ tmp176, g_armwave_state.size
@ armwave.c:275:     g_armwave_state.bitdepth_height = 256;  // Always 256 possible levels in 8-bit mode
	.loc 1 275 37 view .LVU175
	str	r0, [r4, #64]	@ tmp178, g_armwave_state.bitdepth_height
@ armwave.c:284:     printf("ch_buff_size=%d\n", g_armwave_state.ch_buff_size);
	.loc 1 284 5 view .LVU176
	mov	r1, r3	@, _10
@ armwave.c:279:     g_armwave_state.wave_length = end_point - start_point;
	.loc 1 279 45 view .LVU177
	sub	r5, r9, r5	@ _12, end_point, start_point
.LVL47:
@ armwave.c:269:     g_armwave_state.vscale_frac = target_height / 255.0f;
	.loc 1 269 49 view .LVU178
	vdiv.f32	s15, s13, s14	@ _3, tmp167, tmp168
@ armwave.c:284:     printf("ch_buff_size=%d\n", g_armwave_state.ch_buff_size);
	.loc 1 284 5 view .LVU179
	ldr	r0, .L56+16	@,
@ armwave.c:276:     g_armwave_state.ch_buff_size = g_armwave_state.bitdepth_height * target_width;
	.loc 1 276 34 view .LVU180
	str	r3, [r4, #80]	@ _10, g_armwave_state.ch_buff_size
@ armwave.c:268:     g_armwave_state.xstride = target_height;
	.loc 1 268 29 view .LVU181
	str	r7, [r4, #44]	@ target_height, g_armwave_state.xstride
	.loc 1 269 5 is_stmt 1 view .LVU182
@ armwave.c:271:     g_armwave_state.wave_stride = wave_stride;
	.loc 1 271 33 is_stmt 0 view .LVU183
	str	r10, [r4, #52]	@ wave_stride, g_armwave_state.wave_stride
@ armwave.c:272:     g_armwave_state.waves_max = waves_max;
	.loc 1 272 31 view .LVU184
	str	r8, [r4, #60]	@ waves_max, g_armwave_state.waves_max
@ armwave.c:273:     g_armwave_state.waves = waves_max;  // Need a function to be able to change this on the fly
	.loc 1 273 27 view .LVU185
	str	r8, [r4, #56]	@ waves_max, g_armwave_state.waves
@ armwave.c:278:     g_armwave_state.target_height = target_height;
	.loc 1 278 35 view .LVU186
	strd	r6, [r4, #88]	@, tmp224,
@ armwave.c:279:     g_armwave_state.wave_length = end_point - start_point;
	.loc 1 279 33 view .LVU187
	str	r5, [r4, #76]	@ _12, g_armwave_state.wave_length
@ armwave.c:282:     g_armwave_state.cmp_x_bitdepth_scale = g_armwave_state.bitdepth_height * (1 << AM_XCOORD_MULT_SHIFT);
	.loc 1 282 42 view .LVU188
	str	r2, [r4, #36]	@ tmp184, g_armwave_state.cmp_x_bitdepth_scale
@ armwave.c:270:     g_armwave_state.vscale = (int)g_armwave_state.vscale_frac;
	.loc 1 270 30 view .LVU189
	vcvt.s32.f32	s14, s15	@ tmp171, _3
@ armwave.c:269:     g_armwave_state.vscale_frac = target_height / 255.0f;
	.loc 1 269 33 view .LVU190
	vstr.32	s15, [r4, #40]	@ _3, g_armwave_state.vscale_frac
	.loc 1 270 5 is_stmt 1 view .LVU191
@ armwave.c:270:     g_armwave_state.vscale = (int)g_armwave_state.vscale_frac;
	.loc 1 270 30 is_stmt 0 view .LVU192
	vstr.32	s14, [r4, #48]	@ int	@ tmp171, g_armwave_state.vscale
	.loc 1 271 5 is_stmt 1 view .LVU193
	.loc 1 272 5 view .LVU194
	.loc 1 273 5 view .LVU195
	.loc 1 274 5 view .LVU196
	.loc 1 275 5 view .LVU197
	.loc 1 276 5 view .LVU198
	.loc 1 277 5 view .LVU199
	.loc 1 278 5 view .LVU200
	.loc 1 279 5 view .LVU201
	.loc 1 282 5 view .LVU202
	.loc 1 284 5 view .LVU203
	bl	printf		@
.LVL48:
	.loc 1 289 5 view .LVU204
@ armwave.c:291:     if(g_armwave_state.ch1_buffer != NULL)
	.loc 1 291 23 is_stmt 0 view .LVU205
	ldr	r0, [r4, #4]	@ _14, g_armwave_state.ch1_buffer
@ armwave.c:289:     g_armwave_state.slice_height = 64;  
	.loc 1 289 34 view .LVU206
	mov	r3, #64	@ tmp187,
@ armwave.c:291:     if(g_armwave_state.ch1_buffer != NULL)
	.loc 1 291 7 view .LVU207
	cmp	r0, #0	@ _14,
@ armwave.c:289:     g_armwave_state.slice_height = 64;  
	.loc 1 289 34 view .LVU208
	str	r3, [r4, #68]	@ tmp187, g_armwave_state.slice_height
	.loc 1 291 5 is_stmt 1 view .LVU209
@ armwave.c:291:     if(g_armwave_state.ch1_buffer != NULL)
	.loc 1 291 7 is_stmt 0 view .LVU210
	beq	.L44		@,
	.loc 1 292 9 is_stmt 1 view .LVU211
	bl	free		@
.LVL49:
.L44:
	.loc 1 294 5 view .LVU212
@ armwave.c:294:     g_armwave_state.ch1_buffer = calloc(g_armwave_state.ch_buff_size, 1);
	.loc 1 294 34 is_stmt 0 view .LVU213
	mov	r1, #1	@,
	ldr	r0, [r4, #80]	@, g_armwave_state.ch_buff_size
	bl	calloc		@
.LVL50:
@ armwave.c:296:     assert(g_armwave_state.ch1_buffer != NULL);
	.loc 1 296 5 view .LVU214
	cmp	r0, #0	@ _17,
@ armwave.c:294:     g_armwave_state.ch1_buffer = calloc(g_armwave_state.ch_buff_size, 1);
	.loc 1 294 34 view .LVU215
	mov	r7, r0	@ _17,
@ armwave.c:294:     g_armwave_state.ch1_buffer = calloc(g_armwave_state.ch_buff_size, 1);
	.loc 1 294 32 view .LVU216
	str	r0, [r4, #4]	@ _17, g_armwave_state.ch1_buffer
	.loc 1 296 5 is_stmt 1 view .LVU217
	beq	.L54		@,
	.loc 1 299 5 view .LVU218
.LVL51:
	.loc 1 300 5 view .LVU219
@ armwave.c:300:     points_per_pixel = length / ((float)(target_width));
	.loc 1 300 34 is_stmt 0 view .LVU220
	vmov	s15, r6	@ int	@ target_width, target_width
@ armwave.c:300:     points_per_pixel = length / ((float)(target_width));
	.loc 1 300 22 view .LVU221
	vmov	s13, r5	@ int	@ _12, _12
@ armwave.c:302:     g_armwave_state.xcoord_to_xpixel = malloc(length * sizeof(uint16_t));
	.loc 1 302 40 view .LVU222
	lsl	r0, r5, #1	@, _12,
@ armwave.c:300:     points_per_pixel = length / ((float)(target_width));
	.loc 1 300 34 view .LVU223
	vcvt.f32.u32	s14, s15	@ tmp198, target_width
@ armwave.c:300:     points_per_pixel = length / ((float)(target_width));
	.loc 1 300 22 view .LVU224
	vcvt.f32.u32	s13, s13	@ tmp197, _12
@ armwave.c:301:     g_armwave_state.slice_record_height = points_per_pixel * g_armwave_state.slice_height;
	.loc 1 301 60 view .LVU225
	vldr.32	s15, [r4, #68]	@ int	@ tmp230, g_armwave_state.slice_height
	vcvt.f32.s32	s15, s15	@ tmp201, tmp230
@ armwave.c:300:     points_per_pixel = length / ((float)(target_width));
	.loc 1 300 22 view .LVU226
	vdiv.f32	s16, s13, s14	@ points_per_pixel, tmp197, tmp198
.LVL52:
	.loc 1 301 5 is_stmt 1 view .LVU227
@ armwave.c:301:     g_armwave_state.slice_record_height = points_per_pixel * g_armwave_state.slice_height;
	.loc 1 301 60 is_stmt 0 view .LVU228
	vmul.f32	s15, s15, s16	@ tmp203, tmp201, points_per_pixel
@ armwave.c:301:     g_armwave_state.slice_record_height = points_per_pixel * g_armwave_state.slice_height;
	.loc 1 301 41 view .LVU229
	vcvt.s32.f32	s15, s15	@ tmp204, tmp203
	vstr.32	s15, [r4, #72]	@ int	@ tmp204, g_armwave_state.slice_record_height
	.loc 1 302 5 is_stmt 1 view .LVU230
@ armwave.c:302:     g_armwave_state.xcoord_to_xpixel = malloc(length * sizeof(uint16_t));
	.loc 1 302 40 is_stmt 0 view .LVU231
	bl	malloc		@
.LVL53:
@ armwave.c:304:     assert(g_armwave_state.xcoord_to_xpixel != NULL);
	.loc 1 304 5 view .LVU232
	cmp	r0, #0	@ _25,
@ armwave.c:302:     g_armwave_state.xcoord_to_xpixel = malloc(length * sizeof(uint16_t));
	.loc 1 302 40 view .LVU233
	mov	r6, r0	@ _25,
@ armwave.c:302:     g_armwave_state.xcoord_to_xpixel = malloc(length * sizeof(uint16_t));
	.loc 1 302 38 view .LVU234
	str	r0, [r4, #132]	@ _25, g_armwave_state.xcoord_to_xpixel
	.loc 1 304 5 is_stmt 1 view .LVU235
	beq	.L55		@,
@ armwave.c:307:         g_armwave_state.xcoord_to_xpixel[xx] = (1.0f / points_per_pixel) * xx;
	.loc 1 307 54 is_stmt 0 view .LVU236
	vldr.32	s15, .L56+4	@ tmp212,
	sub	ip, r0, #2	@ ivtmp.51, _25,
@ armwave.c:306:     for(xx = 0; xx < length; xx++) {
	.loc 1 306 12 view .LVU237
	mov	r3, #0	@ xx,
@ armwave.c:307:         g_armwave_state.xcoord_to_xpixel[xx] = (1.0f / points_per_pixel) * xx;
	.loc 1 307 54 view .LVU238
	vdiv.f32	s14, s15, s16	@ _26, tmp212, points_per_pixel
.L47:
.LVL54:
	.loc 1 307 9 is_stmt 1 discriminator 3 view .LVU239
@ armwave.c:307:         g_armwave_state.xcoord_to_xpixel[xx] = (1.0f / points_per_pixel) * xx;
	.loc 1 307 74 is_stmt 0 discriminator 3 view .LVU240
	vmov	s15, r3	@ int	@ xx, xx
@ armwave.c:306:     for(xx = 0; xx < length; xx++) {
	.loc 1 306 32 discriminator 3 view .LVU241
	add	r3, r3, #1	@ xx, xx,
.LVL55:
@ armwave.c:306:     for(xx = 0; xx < length; xx++) {
	.loc 1 306 5 discriminator 3 view .LVU242
	cmp	r5, r3	@ _12, xx
@ armwave.c:307:         g_armwave_state.xcoord_to_xpixel[xx] = (1.0f / points_per_pixel) * xx;
	.loc 1 307 74 discriminator 3 view .LVU243
	vcvt.f32.s32	s15, s15	@ tmp213, xx
	vmul.f32	s15, s15, s14	@ tmp214, tmp213, _26
@ armwave.c:307:         g_armwave_state.xcoord_to_xpixel[xx] = (1.0f / points_per_pixel) * xx;
	.loc 1 307 46 discriminator 3 view .LVU244
	vcvt.u32.f32	s15, s15	@ tmp215, tmp214
	vmov	r2, s15	@ int	@ tmp215, tmp215
	strh	r2, [ip, #2]!	@ movhi	@ tmp215, MEM[base: _95, offset: 0B]
@ armwave.c:306:     for(xx = 0; xx < length; xx++) {
	.loc 1 306 5 discriminator 3 view .LVU245
	bne	.L47		@,
	.loc 1 312 5 is_stmt 1 view .LVU246
@ armwave.c:312:     g_armwave_state.out_pixbuf = malloc(sizeof(uint32_t) * g_armwave_state.size);
	.loc 1 312 34 is_stmt 0 view .LVU247
	ldr	r0, [r4, #84]	@ g_armwave_state.size, g_armwave_state.size
	lsl	r0, r0, #2	@, g_armwave_state.size,
	bl	malloc		@
.LVL56:
@ armwave.c:314:     printf("Ptrs: 0x%08x 0x%08x 0x%08x 0x%08x \n", \
	...
	mov	r1, r7	@, _17
@ armwave.c:312:     g_armwave_state.out_pixbuf = malloc(sizeof(uint32_t) * g_armwave_state.size);
	.loc 1 312 34 view .LVU249
	mov	ip, r0	@ tmp219,
@ armwave.c:314:     printf("Ptrs: 0x%08x 0x%08x 0x%08x 0x%08x \n", \
	.loc 1 314 5 view .LVU250
	mov	r3, r0	@, tmp219
	ldr	r0, .L56+20	@,
@ armwave.c:312:     g_armwave_state.out_pixbuf = malloc(sizeof(uint32_t) * g_armwave_state.size);
	.loc 1 312 32 view .LVU251
	str	ip, [r4, #104]	@ tmp219, g_armwave_state.out_pixbuf
	.loc 1 314 5 is_stmt 1 view .LVU252
	bl	printf		@
.LVL57:
	.loc 1 320 5 view .LVU253
@ armwave.c:321: }
	.loc 1 321 1 is_stmt 0 view .LVU254
	add	sp, sp, #16	@,,
	.cfi_remember_state
	.cfi_def_cfa_offset 40
	@ sp needed	@
...
.LVL59:
@ armwave.c:320:     malloc_stats();
	.loc 1 320 5 view .LVU256
	b	malloc_stats		@
.LVL60:
.L53:
	.cfi_restore_state
	.loc 1 246 5 is_stmt 1 discriminator 1 view .LVU257
	ldr	r3, .L56+24	@,
	mov	r2, #246	@,
	ldr	r1, .L56+28	@,
	ldr	r0, .L56+32	@,
...
.LVL61:
.L55:
	.loc 1 304 5 discriminator 1 view .LVU258
	ldr	r3, .L56+24	@,
	mov	r2, #304	@,
	ldr	r1, .L56+28	@,
	ldr	r0, .L56+36	@,
...
.LVL62:
.L54:
	.loc 1 296 5 discriminator 1 view .LVU259
	ldr	r3, .L56+24	@,
	mov	r2, #296	@,
	ldr	r1, .L56+28	@,
	ldr	r0, .L56+40	@,
...
.LFB63:
	...
	@ args = 0, pretend = 0, frame = 0
	@ frame_needed = 0, uses_anonymous_args = 0
	.loc 1 329 5 view .LVU261
	cmp	r0, #0	@ wave_buffer
	.loc 1 329 5 is_stmt 0 view .LVU262
	beq	.L63		@,
	.loc 1 330 5 is_stmt 1 view .LVU263
@ armwave.c:330:     g_armwave_state.wave_buffer = wave_buffer;
	.loc 1 330 33 is_stmt 0 view .LVU264
	ldr	r3, .L64	@ tmp116,
	str	r0, [r3, #20]	@ wave_buffer, g_armwave_state.wave_buffer
	bx	lr	@
.L63:
	.loc 1 329 5 is_stmt 1 discriminator 1 view .LVU265
@ armwave.c:328: {
	.loc 1 328 1 is_stmt 0 discriminator 1 view .LVU266
	push	{r4, lr}	@
	.cfi_def_cfa_offset 8
	.cfi_offset 4, -8
	.cfi_offset 14, -4
@ armwave.c:329:     assert(wave_buffer != NULL);
	.loc 1 329 5 discriminator 1 view .LVU267
	ldr	r3, .L64+4	@,
	ldr	r2, .L64+8	@,
	ldr	r1, .L64+12	@,
	ldr	r0, .L64+16	@,
.LVL65:
	.loc 1 329 5 discriminator 1 view .LVU268
	bl	__assert_fail		@
.LVL66:
.L65:
	.align	2
...
.LFB64:
	...
	@ frame_needed = 0, uses_anonymous_args = 0
	@ link register save eliminated.
	.loc 1 339 5 view .LVU270
@ armwave.c:339:     if(set > g_armwave_state.test_wave_buffer_nsets) {
	.loc 1 339 29 is_stmt 0 view .LVU271
	ldr	r3, .L69	@ tmp117,
@ armwave.c:339:     if(set > g_armwave_state.test_wave_buffer_nsets) {
	.loc 1 339 7 view .LVU272
	...
	bcc	.L68		@,
	.loc 1 344 5 is_stmt 1 view .LVU273
@ armwave.c:344:     g_armwave_state.wave_buffer = g_armwave_state.test_wave_buffer + (g_armwave_state.test_wave_buffer_stride * set);
	.loc 1 344 111 is_stmt 0 view .LVU274
	ldr	r1, [r3, #28]	@ g_armwave_state.test_wave_buffer_stride, g_armwave_state.test_wave_buffer_stride
@ armwave.c:344:     g_armwave_state.wave_buffer = g_armwave_state.test_wave_buffer + (g_armwave_state.test_wave_buffer_stride * set);
	.loc 1 344 68 view .LVU275
...
.LVL68:
@ armwave.c:344:     g_armwave_state.wave_buffer = g_armwave_state.test_wave_buffer + (g_armwave_state.test_wave_buffer_stride * set);
	.loc 1 344 33 view .LVU276
	str	r0, [r3, #20]	@ tmp125, g_armwave_state.wave_buffer
@ armwave.c:345: }
	.loc 1 345 1 view .LVU277
	bx	lr	@
.LVL69:
.L68:
	.loc 1 340 9 is_stmt 1 view .LVU278
	ldr	r0, .L69+4	@,
.LVL70:
	.loc 1 340 9 is_stmt 0 view .LVU279
	b	puts		@
.LVL71:
.L70:
	.align	2
...
.LFB65:
	...
	@ args = 0, pretend = 0, frame = 0
	@ frame_needed = 0, uses_anonymous_args = 0
	.loc 1 353 5 view .LVU281
	cmp	r0, #0	@ wave_buffer_ptr
	.loc 1 353 5 is_stmt 0 view .LVU282
	beq	.L76		@,
	.loc 1 354 5 is_stmt 1 view .LVU283
@ armwave.c:354:     g_armwave_state.wave_buffer = (uint8_t*)wave_buffer_ptr;
	.loc 1 354 33 is_stmt 0 view .LVU284
	ldr	r3, .L77	@ tmp117,
	str	r0, [r3, #20]	@ wave_buffer_ptr, g_armwave_state.wave_buffer
	bx	lr	@
.L76:
	.loc 1 353 5 is_stmt 1 discriminator 1 view .LVU285
@ armwave.c:352: {
	.loc 1 352 1 is_stmt 0 discriminator 1 view .LVU286
	push	{r4, lr}	@
	.cfi_def_cfa_offset 8
	.cfi_offset 4, -8
	.cfi_offset 14, -4
@ armwave.c:353:     assert(wave_buffer_ptr != 0);
	.loc 1 353 5 discriminator 1 view .LVU287
	ldr	r3, .L77+4	@,
	ldr	r2, .L77+8	@,
	ldr	r1, .L77+12	@,
	ldr	r0, .L77+16	@,
.LVL73:
	.loc 1 353 5 discriminator 1 view .LVU288
	bl	__assert_fail		@
.LVL74:
.L78:
	.align	2
...
.LFB66:
	...
	@ frame_needed = 0, uses_anonymous_args = 0
	@ link register save eliminated.
	.loc 1 363 5 view .LVU290
@ armwave.c:363:     memset(g_armwave_state.ch1_buffer, 0, g_armwave_state.ch_buff_size);
	.loc 1 363 58 is_stmt 0 view .LVU291
	ldr	r3, .L80	@ tmp114,
@ armwave.c:363:     memset(g_armwave_state.ch1_buffer, 0, g_armwave_state.ch_buff_size);
	.loc 1 363 5 view .LVU292
	mov	r1, #0	@,
	ldr	r2, [r3, #80]	@, g_armwave_state.ch_buff_size
	ldr	r0, [r3, #4]	@, g_armwave_state.ch1_buffer
.LVL76:
	.loc 1 363 5 view .LVU293
	b	memset		@
.LVL77:
.L81:
	.align	2
...
.LFB67:
	...
	@ frame_needed = 0, uses_anonymous_args = 0
	@ link register save eliminated.
	.loc 1 372 5 view .LVU295
	cmp	r0, #1	@ ch,
	.loc 1 374 13 view .LVU296
@ armwave.c:374:             g_armwave_state.ch1_color.r = r;
	.loc 1 374 41 is_stmt 0 view .LVU297
	ldreq	r0, .L84	@ tmp117,
.LVL79:
	.loc 1 374 41 view .LVU298
	strheq	r1, [r0, #108]	@ movhi	@ r, g_armwave_state.ch1_color.r
	.loc 1 375 13 is_stmt 1 view .LVU299
@ armwave.c:375:             g_armwave_state.ch1_color.g = g;
	.loc 1 375 41 is_stmt 0 view .LVU300
	strheq	r2, [r0, #110]	@ movhi	@ g, g_armwave_state.ch1_color.g
	.loc 1 376 13 is_stmt 1 view .LVU301
@ armwave.c:376:             g_armwave_state.ch1_color.b = b;
	.loc 1 376 41 is_stmt 0 view .LVU302
	strheq	r3, [r0, #112]	@ movhi	@ b, g_armwave_state.ch1_color.b
	.loc 1 377 13 is_stmt 1 view .LVU303
@ armwave.c:379: }
	.loc 1 379 1 is_stmt 0 view .LVU304
	bx	lr	@
.L85:
	.align	2
.L84:
...
.LFB68:
	...
	@ args = 0, pretend = 0, frame = 0
	@ frame_needed = 0, uses_anonymous_args = 0
	.loc 1 386 5 view .LVU306
@ armwave.c:385: {
	.loc 1 385 1 is_stmt 0 view .LVU307
	mov	r3, r1	@ fn, fn
	...
	sub	sp, sp, #12	@,,
	.cfi_def_cfa_offset 40
@ armwave.c:386:     FILE *fp = fopen(fn, "wb");
	.loc 1 386 16 view .LVU308
	ldr	r1, .L94	@,
.LVL81:
	.loc 1 386 16 view .LVU309
	mov	r0, r3	@, fn
.LVL82:
	.loc 1 386 16 view .LVU310
	bl	fopen64		@
.LVL83:
@ armwave.c:393:     fprintf(fp, "%d %d\n", g_armwave_state.target_width, g_armwave_state.target_height);
	.loc 1 393 5 view .LVU311
	ldr	r6, .L94+4	@ tmp150,
@ armwave.c:392:     fputs("P3\n", fp);
	.loc 1 392 5 view .LVU312
	mov	r2, #3	@,
	mov	r1, #1	@,
@ armwave.c:386:     FILE *fp = fopen(fn, "wb");
	.loc 1 386 16 view .LVU313
	mov	r7, r0	@ fp,
.LVL84:
	.loc 1 387 5 is_stmt 1 view .LVU314
	.loc 1 388 5 view .LVU315
	.loc 1 392 5 view .LVU316
	mov	r3, r0	@, fp
	ldr	r0, .L94+8	@,
.LVL85:
	.loc 1 392 5 is_stmt 0 view .LVU317
	bl	fwrite		@
.LVL86:
...
.LVL87:
	...
	bl	fwrite		@
.LVL88:
	.loc 1 396 5 view .LVU320
@ armwave.c:396:     for(yy = 0; yy < g_armwave_state.target_height; yy++) {
	.loc 1 396 37 is_stmt 0 view .LVU321
	ldr	r2, [r6, #92]	@ prephitmp_53, g_armwave_state.target_height
@ armwave.c:396:     for(yy = 0; yy < g_armwave_state.target_height; yy++) {
	.loc 1 396 5 view .LVU322
	cmp	r2, #0	@ prephitmp_53,
	ble	.L87		@,
	ldr	r3, [r6, #88]	@ _13, g_armwave_state.target_width
@ armwave.c:401:             fprintf(fp, "%3d %3d %3d\n", data & 0xff, (data >> 8) & 0xff, (data >> 16) & 0xff);
	.loc 1 401 13 view .LVU323
	ldr	r9, .L94+20	@ tmp152,
@ armwave.c:396:     for(yy = 0; yy < g_armwave_state.target_height; yy++) {
	.loc 1 396 12 view .LVU324
	mov	r5, #0	@ yy,
.LVL89:
.L88:
@ armwave.c:397:         for(xx = 0; xx < g_armwave_state.target_width; xx++) {
	.loc 1 397 9 view .LVU325
	cmp	r3, #0	@ _13,
@ armwave.c:397:         for(xx = 0; xx < g_armwave_state.target_width; xx++) {
	.loc 1 397 16 view .LVU326
	movgt	r4, #0	@ xx,
@ armwave.c:397:         for(xx = 0; xx < g_armwave_state.target_width; xx++) {
	.loc 1 397 9 view .LVU327
	ble	.L90		@,
.LVL90:
.L89:
	.loc 1 398 13 is_stmt 1 discriminator 3 view .LVU328
@ armwave.c:398:             data = *(buffer + (xx + (yy * g_armwave_state.target_width)));
	.loc 1 398 29 is_stmt 0 discriminator 3 view .LVU329
	mla	r3, r5, r3, r4	@ tmp141, yy, _13, xx
@ armwave.c:401:             fprintf(fp, "%3d %3d %3d\n", data & 0xff, (data >> 8) & 0xff, (data >> 16) & 0xff);
	.loc 1 401 13 discriminator 3 view .LVU330
	mov	r1, r9	@, tmp152
	mov	r0, r7	@, fp
@ armwave.c:398:             data = *(buffer + (xx + (yy * g_armwave_state.target_width)));
	.loc 1 398 18 discriminator 3 view .LVU331
	ldr	r2, [r8, r3, lsl #2]	@ data, *_7
.LVL91:
	.loc 1 401 13 is_stmt 1 discriminator 3 view .LVU332
@ armwave.c:397:         for(xx = 0; xx < g_armwave_state.target_width; xx++) {
	.loc 1 397 58 is_stmt 0 discriminator 3 view .LVU333
	add	r4, r4, #1	@ xx, xx,
.LVL92:
@ armwave.c:401:             fprintf(fp, "%3d %3d %3d\n", data & 0xff, (data >> 8) & 0xff, (data >> 16) & 0xff);
	.loc 1 401 81 discriminator 3 view .LVU334
	lsr	ip, r2, #16	@ tmp146, data,
@ armwave.c:401:             fprintf(fp, "%3d %3d %3d\n", data & 0xff, (data >> 8) & 0xff, (data >> 16) & 0xff);
	.loc 1 401 61 discriminator 3 view .LVU335
	lsr	r3, r2, #8	@ tmp142, data,
@ armwave.c:401:             fprintf(fp, "%3d %3d %3d\n", data & 0xff, (data >> 8) & 0xff, (data >> 16) & 0xff);
	.loc 1 401 13 discriminator 3 view .LVU336
	uxtb	ip, ip	@ tmp147, tmp146
	uxtb	r3, r3	@, tmp142
	str	ip, [sp]	@ tmp147,
	uxtb	r2, r2	@, data
.LVL93:
	.loc 1 401 13 discriminator 3 view .LVU337
	bl	fprintf		@
.LVL94:
@ armwave.c:397:         for(xx = 0; xx < g_armwave_state.target_width; xx++) {
	.loc 1 397 41 discriminator 3 view .LVU338
	ldr	r3, [r6, #88]	@ _13, g_armwave_state.target_width
@ armwave.c:397:         for(xx = 0; xx < g_armwave_state.target_width; xx++) {
	.loc 1 397 9 discriminator 3 view .LVU339
	cmp	r3, r4	@ _13, xx
	bgt	.L89		@,
	ldr	r2, [r6, #92]	@ prephitmp_53, g_armwave_state.target_height
.LVL95:
.L90:
@ armwave.c:396:     for(yy = 0; yy < g_armwave_state.target_height; yy++) {
	.loc 1 396 55 discriminator 2 view .LVU340
	add	r5, r5, #1	@ yy, yy,
.LVL96:
@ armwave.c:396:     for(yy = 0; yy < g_armwave_state.target_height; yy++) {
	.loc 1 396 5 discriminator 2 view .LVU341
	cmp	r5, r2	@ yy, prephitmp_53
	blt	.L88		@,
.LVL97:
.L87:
	.loc 1 405 5 is_stmt 1 view .LVU342
	mov	r0, r7	@, fp
@ armwave.c:406: }
	.loc 1 406 1 is_stmt 0 view .LVU343
	add	sp, sp, #12	@,,
	.cfi_def_cfa_offset 28
	@ sp needed	@
	...
	.cfi_def_cfa_offset 0
.LVL98:
@ armwave.c:405:     fclose(fp);
	.loc 1 405 5 view .LVU344
	b	fclose		@
.LVL99:
.L95:
	.loc 1 405 5 view .LVU345
	.align	2
.L94:
	.word	.LC13
	.word	g_armwave_state
...
.LFB69:
	...
	@ args = 0, pretend = 0, frame = 0
	@ frame_needed = 0, uses_anonymous_args = 0
	.loc 1 413 5 view .LVU347
.LBB14:
.LBI14:
	.loc 1 34 6 view .LVU348
	.loc 1 34 6 is_stmt 0 view .LVU349
.LBE14:
@ armwave.c:412: {
	.loc 1 412 1 view .LVU350
	push	{r4, r5, r6, r7, r8, r9, r10, lr}	@
	.cfi_def_cfa_offset 32
	.cfi_offset 4, -32
	.cfi_offset 5, -28
	...
	.cfi_offset 84, -40
	.cfi_offset 85, -36
	ldr	r4, .L100+20	@ ivtmp.65,
.LBB17:
.LBB15:
@ armwave.c:40:         gamma_table[i] = pow(i / 255.0f, gamma) * 255.0f;
	.loc 1 40 32 view .LVU351
	vldr.32	s20, .L100+16	@ tmp136,
@ armwave.c:40:         gamma_table[i] = pow(i / 255.0f, gamma) * 255.0f;
	.loc 1 40 26 view .LVU352
	vldr.64	d9, .L100	@ tmp151,
@ armwave.c:40:         gamma_table[i] = pow(i / 255.0f, gamma) * 255.0f;
	.loc 1 40 49 view .LVU353
	vldr.64	d8, .L100+8	@ tmp139,
	add	ip, r4, #1	@ _38, ivtmp.65,
.LBE15:
.LBE17:
@ armwave.c:412: {
	.loc 1 412 1 view .LVU354
	sub	sp, sp, #16	@,,
	.cfi_def_cfa_offset 72
@ armwave.c:412: {
	.loc 1 412 1 view .LVU355
	...
	add	r10, r4, #256	@ _39, ivtmp.65,
	rsb	r5, ip, #1	@ tmp150, _38,
.LVL101:
.L97:
.LBB18:
.LBB16:
	.loc 1 40 9 is_stmt 1 view .LVU356
@ armwave.c:40:         gamma_table[i] = pow(i / 255.0f, gamma) * 255.0f;
	.loc 1 40 32 is_stmt 0 view .LVU357
	add	r3, r5, r4	@ tmp133, tmp150, ivtmp.65
@ armwave.c:40:         gamma_table[i] = pow(i / 255.0f, gamma) * 255.0f;
	.loc 1 40 26 view .LVU358
	vmov.f64	d1, d9	@, tmp151
@ armwave.c:40:         gamma_table[i] = pow(i / 255.0f, gamma) * 255.0f;
	.loc 1 40 32 view .LVU359
	vmov	s15, r3	@ int	@ tmp133, tmp133
	vcvt.f32.s32	s15, s15	@ tmp134, tmp133
	vdiv.f32	s0, s15, s20	@ tmp135, tmp134, tmp136
@ armwave.c:40:         gamma_table[i] = pow(i / 255.0f, gamma) * 255.0f;
	.loc 1 40 26 view .LVU360
	vcvt.f64.f32	d0, s0	@, tmp135
	bl	pow		@
.LVL102:
@ armwave.c:40:         gamma_table[i] = pow(i / 255.0f, gamma) * 255.0f;
	.loc 1 40 49 view .LVU361
	vmul.f64	d0, d0, d8	@ tmp138,, tmp139
@ armwave.c:40:         gamma_table[i] = pow(i / 255.0f, gamma) * 255.0f;
	.loc 1 40 24 view .LVU362
	vcvt.u32.f64	s15, d0	@ tmp140, tmp138
	vmov	r0, s15	@ int	@ tmp140, tmp140
	strb	r0, [r4, #1]!	@ tmp140, MEM[base: _37, offset: 0B]
.LVL103:
@ armwave.c:39:     for(i = 0; i < 256; i++) {
	.loc 1 39 5 view .LVU363
	cmp	r4, r10	@ ivtmp.65, _39
	bne	.L97		@,
.LVL104:
	.loc 1 39 5 view .LVU364
.LBE16:
.LBE18:
	.loc 1 416 5 is_stmt 1 view .LVU365
.LBB19:
.LBI19:
	.loc 1 369 6 view .LVU366
.LBB20:
	.loc 1 372 5 view .LVU367
	.loc 1 374 13 view .LVU368
	.loc 1 375 13 view .LVU369
@ armwave.c:374:             g_armwave_state.ch1_color.r = r;
	.loc 1 374 41 is_stmt 0 view .LVU370
	ldr	ip, .L100+24	@ tmp142,
	ldr	r4, .L100+28	@ tmp143,
.LBE20:
.LBE19:
@ armwave.c:418:     armwave_setup_render(0, wave_size, nwaves, wave_size, render_width, render_height, 0x00000000);
	.loc 1 418 5 view .LVU371
	mov	r0, #0	@ tmp147,
.LBB24:
.LBB21:
@ armwave.c:376:             g_armwave_state.ch1_color.b = b;
	.loc 1 376 41 view .LVU372
	mov	lr, #250	@ tmp146,
.LBE21:
.LBE24:
@ armwave.c:418:     armwave_setup_render(0, wave_size, nwaves, wave_size, render_width, render_height, 0x00000000);
	.loc 1 418 5 view .LVU373
	str	r0, [sp, #8]	@ tmp147,
...
.LBB22:
@ armwave.c:374:             g_armwave_state.ch1_color.r = r;
	.loc 1 374 41 view .LVU374
	str	r4, [ip, #108]	@ tmp143, MEM[(short int *)&g_armwave_state + 108B]
	.loc 1 376 13 is_stmt 1 view .LVU375
.LBE22:
.LBE25:
@ armwave.c:418:     armwave_setup_render(0, wave_size, nwaves, wave_size, render_width, render_height, 0x00000000);
	.loc 1 418 5 is_stmt 0 view .LVU376
	mov	r3, r6	@, wave_size
.LBB26:
.LBB23:
@ armwave.c:376:             g_armwave_state.ch1_color.b = b;
	.loc 1 376 41 view .LVU377
	strh	lr, [ip, #112]	@ movhi	@ tmp146, g_armwave_state.ch1_color.b
	.loc 1 377 13 is_stmt 1 view .LVU378
.LVL105:
	.loc 1 377 13 is_stmt 0 view .LVU379
.LBE23:
.LBE26:
	.loc 1 418 5 is_stmt 1 view .LVU380
	bl	armwave_setup_render		@
.LVL106:
	.loc 1 420 5 view .LVU381
	ldr	r1, .L100+32	@,
	ldr	r0, .L100+36	@,
@ armwave.c:421: }
	.loc 1 421 1 is_stmt 0 view .LVU382
	add	sp, sp, #16	@,,
	.cfi_def_cfa_offset 56
	@ sp needed	@
	vldm	sp!, {d8-d10}	@,
	...
	.cfi_def_cfa_offset 0
.LVL107:
@ armwave.c:420:     printf("armwave version: %s\n", ARMWAVE_VER);
	.loc 1 420 5 view .LVU383
	b	printf		@
.LVL108:
.L101:
	.align	3
...
.LFB70:
	...
	@ frame_needed = 0, uses_anonymous_args = 0
	.loc 1 428 5 view .LVU385
	.loc 1 429 5 view .LVU386
@ armwave.c:427: {
	.loc 1 427 1 is_stmt 0 view .LVU387
	push	{r4, r5, r6, r7, r8, r9, r10, fp, lr}	@
	.cfi_def_cfa_offset 36
	.cfi_offset 4, -36
	.cfi_offset 5, -32
	...
	.cfi_offset 11, -8
	.cfi_offset 14, -4
@ armwave.c:431:     memset(g_armwave_state.ch1_buffer, 0, g_armwave_state.ch_buff_size);
	.loc 1 431 5 view .LVU388
	mov	r1, #0	@,
@ armwave.c:429:     uint32_t xx_rem = g_armwave_state.target_width, ypos = 0;
	.loc 1 429 38 view .LVU389
	ldr	r4, .L115	@ tmp197,
@ armwave.c:427: {
	.loc 1 427 1 view .LVU390
	sub	sp, sp, #20	@,,
	.cfi_def_cfa_offset 56
@ armwave.c:431:     memset(g_armwave_state.ch1_buffer, 0, g_armwave_state.ch_buff_size);
	.loc 1 431 5 view .LVU391
	ldr	r2, [r4, #80]	@, g_armwave_state.ch_buff_size
	ldr	r0, [r4, #4]	@, g_armwave_state.ch1_buffer
@ armwave.c:429:     uint32_t xx_rem = g_armwave_state.target_width, ypos = 0;
	.loc 1 429 14 view .LVU392
	ldr	r8, [r4, #88]	@ xx_rem, g_armwave_state.target_width
.LVL109:
	.loc 1 431 5 is_stmt 1 view .LVU393
	bl	memset		@
.LVL110:
	.loc 1 433 5 view .LVU394
@ armwave.c:433:     for(yy = 0; yy < (g_armwave_state.target_width / g_armwave_state.slice_height); yy++) {
	.loc 1 433 38 is_stmt 0 view .LVU395
	ldr	r9, [r4, #88]	@ prephitmp_116, g_armwave_state.target_width
@ armwave.c:433:     for(yy = 0; yy < (g_armwave_state.target_width / g_armwave_state.slice_height); yy++) {
	.loc 1 433 69 view .LVU396
	ldr	r5, [r4, #68]	@ _71, g_armwave_state.slice_height
@ armwave.c:433:     for(yy = 0; yy < (g_armwave_state.target_width / g_armwave_state.slice_height); yy++) {
	.loc 1 433 52 view .LVU397
	mov	r0, r9	@, prephitmp_116
	mov	r1, r5	@, _71
	bl	__aeabi_idiv		@
.LVL111:
@ armwave.c:433:     for(yy = 0; yy < (g_armwave_state.target_width / g_armwave_state.slice_height); yy++) {
	.loc 1 433 5 view .LVU398
	cmp	r0, #0	@ tmp163
	beq	.L103		@,
	ldr	r3, [r4, #4]	@ prephitmp_124, g_armwave_state.ch1_buffer
@ armwave.c:429:     uint32_t xx_rem = g_armwave_state.target_width, ypos = 0;
	.loc 1 429 53 view .LVU399
	mov	r7, #0	@ ypos,
	ldr	r2, [r4, #56]	@ prephitmp_129, g_armwave_state.waves
	str	r3, [sp, #8]	@ prephitmp_124, %sfp
@ armwave.c:433:     for(yy = 0; yy < (g_armwave_state.target_width / g_armwave_state.slice_height); yy++) {
	.loc 1 433 12 view .LVU400
	mov	r6, r7	@ yy, ypos
	ldr	r3, [r4, #64]	@ prephitmp_126, g_armwave_state.bitdepth_height
	str	r3, [sp, #12]	@ prephitmp_126, %sfp
.LVL112:
.L106:
	.loc 1 436 9 is_stmt 1 discriminator 3 view .LVU401
	ldr	r3, [r4, #72]	@ _9, g_armwave_state.slice_record_height
	mul	r10, r6, r5	@ _7, yy, _71
	str	r3, [sp, #4]	@ _9, %sfp
.LVL113:
.LBB33:
.LBI33:
	.loc 1 92 6 discriminator 3 view .LVU402
.LBB34:
	.loc 1 94 5 discriminator 3 view .LVU403
	.loc 1 95 5 discriminator 3 view .LVU404
	.loc 1 96 5 discriminator 3 view .LVU405
	.loc 1 97 5 discriminator 3 view .LVU406
	.loc 1 98 5 discriminator 3 view .LVU407
	.loc 1 100 5 discriminator 3 view .LVU408
@ armwave.c:100:     write_buffer_base = g_armwave_state.ch1_buffer + (slice_y * g_armwave_state.bitdepth_height);
	.loc 1 100 23 is_stmt 0 discriminator 3 view .LVU409
	ldr	r3, [sp, #12]	@ prephitmp_126, %sfp
.LVL114:
	.loc 1 100 23 discriminator 3 view .LVU410
	ldr	r1, [sp, #8]	@ prephitmp_124, %sfp
@ armwave.c:103:     for(w = 0; w < g_armwave_state.waves; w++) {
	.loc 1 103 5 discriminator 3 view .LVU411
	cmp	r2, #0	@ prephitmp_129,
@ armwave.c:100:     write_buffer_base = g_armwave_state.ch1_buffer + (slice_y * g_armwave_state.bitdepth_height);
	.loc 1 100 23 discriminator 3 view .LVU412
	mla	fp, r3, r10, r1	@ write_buffer_base, prephitmp_126, _7, prephitmp_124
.LVL115:
	.loc 1 103 5 is_stmt 1 discriminator 3 view .LVU413
	.loc 1 103 5 is_stmt 0 discriminator 3 view .LVU414
	ble	.L104		@,
@ armwave.c:103:     for(w = 0; w < g_armwave_state.waves; w++) {
	.loc 1 103 11 view .LVU415
	mov	r5, #0	@ w,
.LVL116:
.L105:
.LBB35:
	.loc 1 104 9 is_stmt 1 view .LVU416
	.loc 1 106 9 view .LVU417
@ armwave.c:104:         wave_base = g_armwave_state.wave_buffer + slice_y + (w * g_armwave_state.wave_stride);
	.loc 1 104 64 is_stmt 0 view .LVU418
	ldr	r1, [r4, #52]	@ g_armwave_state.wave_stride, g_armwave_state.wave_stride
@ armwave.c:104:         wave_base = g_armwave_state.wave_buffer + slice_y + (w * g_armwave_state.wave_stride);
	.loc 1 104 19 view .LVU419
	ldr	ip, [r4, #20]	@ g_armwave_state.wave_buffer, g_armwave_state.wave_buffer
@ armwave.c:106:         _render_nonaa_to_buffer_1ch_slice_core(write_buffer_base, wave_base, height);
	.loc 1 106 9 view .LVU420
	ldr	r2, [sp, #4]	@, %sfp
@ armwave.c:104:         wave_base = g_armwave_state.wave_buffer + slice_y + (w * g_armwave_state.wave_stride);
	.loc 1 104 59 view .LVU421
	mla	r1, r1, r5, r10	@ tmp173, g_armwave_state.wave_stride, w, _7
@ armwave.c:106:         _render_nonaa_to_buffer_1ch_slice_core(write_buffer_base, wave_base, height);
	.loc 1 106 9 view .LVU422
	mov	r0, fp	@, write_buffer_base
	add	r1, ip, r1	@, g_armwave_state.wave_buffer, tmp173
	bl	_render_nonaa_to_buffer_1ch_slice_core		@
.LVL117:
	.loc 1 106 9 view .LVU423
.LBE35:
@ armwave.c:103:     for(w = 0; w < g_armwave_state.waves; w++) {
	.loc 1 103 35 view .LVU424
	ldr	r2, [r4, #56]	@ prephitmp_129, g_armwave_state.waves
@ armwave.c:103:     for(w = 0; w < g_armwave_state.waves; w++) {
	.loc 1 103 44 view .LVU425
	add	r5, r5, #1	@ w, w,
.LVL118:
@ armwave.c:103:     for(w = 0; w < g_armwave_state.waves; w++) {
	.loc 1 103 5 view .LVU426
	cmp	r5, r2	@ w, prephitmp_129
	blt	.L105		@,
	ldr	r3, [r4, #4]	@ prephitmp_124, g_armwave_state.ch1_buffer
	ldr	r5, [r4, #68]	@ _71, g_armwave_state.slice_height
.LVL119:
	.loc 1 103 5 view .LVU427
	ldr	r9, [r4, #88]	@ prephitmp_116, g_armwave_state.target_width
	str	r3, [sp, #8]	@ prephitmp_124, %sfp
	ldr	r3, [r4, #64]	@ prephitmp_126, g_armwave_state.bitdepth_height
	str	r3, [sp, #12]	@ prephitmp_126, %sfp
.L104:
.LVL120:
	.loc 1 103 5 view .LVU428
.LBE34:
.LBE33:
	.loc 1 437 9 is_stmt 1 discriminator 3 view .LVU429
@ armwave.c:433:     for(yy = 0; yy < (g_armwave_state.target_width / g_armwave_state.slice_height); yy++) {
	.loc 1 433 52 is_stmt 0 discriminator 3 view .LVU430
	mov	r1, r5	@, _71
	mov	r0, r9	@, prephitmp_116
	str	r2, [sp, #4]	@ prephitmp_129, %sfp
	bl	__aeabi_idiv		@
.LVL121:
@ armwave.c:433:     for(yy = 0; yy < (g_armwave_state.target_width / g_armwave_state.slice_height); yy++) {
	.loc 1 433 87 discriminator 3 view .LVU431
	add	r6, r6, #1	@ yy, yy,
.LVL122:
@ armwave.c:437:         xx_rem -= g_armwave_state.slice_height;
	.loc 1 437 16 discriminator 3 view .LVU432
	sub	r8, r8, r5	@ xx_rem, xx_rem, _71
.LVL123:
	.loc 1 438 9 is_stmt 1 discriminator 3 view .LVU433
@ armwave.c:438:         ypos += g_armwave_state.slice_height;
	.loc 1 438 14 is_stmt 0 discriminator 3 view .LVU434
	add	r7, r7, r5	@ ypos, ypos, _71
.LVL124:
@ armwave.c:433:     for(yy = 0; yy < (g_armwave_state.target_width / g_armwave_state.slice_height); yy++) {
	.loc 1 433 5 discriminator 3 view .LVU435
	ldr	r2, [sp, #4]	@ prephitmp_129, %sfp
	cmp	r0, r6	@, yy
	bhi	.L106		@,
	ldr	r3, [sp, #12]	@ prephitmp_126, %sfp
	ldr	r1, [sp, #8]	@ prephitmp_124, %sfp
	mla	r6, r3, r7, r1	@ _140, prephitmp_126, ypos, prephitmp_124
.LVL125:
.L107:
	.loc 1 441 5 is_stmt 1 view .LVU436
.LBB36:
.LBI36:
	.loc 1 92 6 view .LVU437
.LBB37:
	.loc 1 94 5 view .LVU438
	.loc 1 95 5 view .LVU439
	.loc 1 96 5 view .LVU440
	.loc 1 97 5 view .LVU441
	.loc 1 98 5 view .LVU442
	.loc 1 100 5 view .LVU443
	.loc 1 103 5 view .LVU444
	.loc 1 103 5 is_stmt 0 view .LVU445
	cmp	r2, #0	@ prephitmp_129,
	ble	.L102		@,
@ armwave.c:103:     for(w = 0; w < g_armwave_state.waves; w++) {
	.loc 1 103 11 view .LVU446
	mov	r5, #0	@ w,
.LVL126:
.L108:
.LBB38:
	.loc 1 104 9 is_stmt 1 view .LVU447
	.loc 1 106 9 view .LVU448
@ armwave.c:104:         wave_base = g_armwave_state.wave_buffer + slice_y + (w * g_armwave_state.wave_stride);
	.loc 1 104 64 is_stmt 0 view .LVU449
	ldr	r3, [r4, #52]	@ g_armwave_state.wave_stride, g_armwave_state.wave_stride
@ armwave.c:104:         wave_base = g_armwave_state.wave_buffer + slice_y + (w * g_armwave_state.wave_stride);
	.loc 1 104 19 view .LVU450
	ldr	r1, [r4, #20]	@ g_armwave_state.wave_buffer, g_armwave_state.wave_buffer
@ armwave.c:106:         _render_nonaa_to_buffer_1ch_slice_core(write_buffer_base, wave_base, height);
	.loc 1 106 9 view .LVU451
	mov	r2, r8	@, xx_rem
@ armwave.c:104:         wave_base = g_armwave_state.wave_buffer + slice_y + (w * g_armwave_state.wave_stride);
	.loc 1 104 59 view .LVU452
	mla	r3, r3, r5, r7	@ tmp192, g_armwave_state.wave_stride, w, ypos
@ armwave.c:106:         _render_nonaa_to_buffer_1ch_slice_core(write_buffer_base, wave_base, height);
	.loc 1 106 9 view .LVU453
	mov	r0, r6	@, _140
	add	r1, r1, r3	@, g_armwave_state.wave_buffer, tmp192
	bl	_render_nonaa_to_buffer_1ch_slice_core		@
.LVL127:
	.loc 1 106 9 view .LVU454
.LBE38:
@ armwave.c:103:     for(w = 0; w < g_armwave_state.waves; w++) {
	.loc 1 103 5 view .LVU455
	ldr	r3, [r4, #56]	@ g_armwave_state.waves, g_armwave_state.waves
@ armwave.c:103:     for(w = 0; w < g_armwave_state.waves; w++) {
	.loc 1 103 44 view .LVU456
	add	r5, r5, #1	@ w, w,
.LVL128:
@ armwave.c:103:     for(w = 0; w < g_armwave_state.waves; w++) {
	.loc 1 103 5 view .LVU457
	cmp	r5, r3	@ w, g_armwave_state.waves
	blt	.L108		@,
.LVL129:
.L102:
	.loc 1 103 5 view .LVU458
.LBE37:
.LBE36:
@ armwave.c:442: }
	.loc 1 442 1 view .LVU459
	add	sp, sp, #20	@,,
	.cfi_remember_state
	.cfi_def_cfa_offset 36
	@ sp needed	@
...
.L103:
	.cfi_restore_state
	.loc 1 442 1 view .LVU460
	ldr	r6, [r4, #4]	@ _140, g_armwave_state.ch1_buffer
	ldr	r2, [r4, #56]	@ prephitmp_129, g_armwave_state.waves
@ armwave.c:429:     uint32_t xx_rem = g_armwave_state.target_width, ypos = 0;
	.loc 1 429 53 view .LVU461
	mov	r7, r0	@ ypos, tmp163
	b	.L107		@
.L116:
	.align	2
.L115:
...
.LFB71:
	...
	@ args = 0, pretend = 0, frame = 8
	@ frame_needed = 0, uses_anonymous_args = 0
	.loc 1 449 5 view .LVU463
	ldr	ip, .L138	@ tmp204,
@ armwave.c:448: {
	.loc 1 448 1 is_stmt 0 view .LVU464
	push	{r4, r5, r6, r7, r8, r9, r10, fp, lr}	@
	.cfi_def_cfa_offset 36
	.cfi_offset 4, -36
	.cfi_offset 5, -32
	...
	sub	sp, sp, #12	@,,
	.cfi_def_cfa_offset 48
@ armwave.c:449:     armwave_fill_pixbuf_scaled(g_armwave_state.out_pixbuf);
	.loc 1 449 5 view .LVU465
	ldr	r8, [ip, #104]	@ _1, g_armwave_state.out_pixbuf
.LVL131:
.LBB41:
.LBI41:
	.loc 1 169 6 is_stmt 1 view .LVU466
.LBB42:
	.loc 1 171 5 view .LVU467
	.loc 1 173 5 view .LVU468
	.loc 1 174 5 view .LVU469
	.loc 1 176 5 view .LVU470
@ armwave.c:176:     uint32_t *base_32ptr = (uint32_t*)g_armwave_state.ch1_buffer;
	.loc 1 176 15 is_stmt 0 view .LVU471
	ldr	r9, [ip, #4]	@ base_32ptr, g_armwave_state.ch1_buffer
.LVL132:
	.loc 1 177 5 is_stmt 1 view .LVU472
	.loc 1 178 5 view .LVU473
	.loc 1 180 5 view .LVU474
	cmp	r8, #0	@ _1,
	beq	.L136		@,
	.loc 1 182 5 view .LVU475
@ armwave.c:182:     npix = g_armwave_state.target_width * 256; 
	.loc 1 182 10 is_stmt 0 view .LVU476
	ldr	r7, [ip, #88]	@ g_armwave_state.target_width, g_armwave_state.target_width
	lsl	r7, r7, #8	@ npix, g_armwave_state.target_width,
.LVL133:
	.loc 1 185 5 is_stmt 1 view .LVU477
	.loc 1 185 5 is_stmt 0 view .LVU478
	cmp	r7, #0	@ npix,
	ble	.L117		@,
@ armwave.c:197:                     rr = (g_armwave_state.ch1_color.r * value) >> 8;
	.loc 1 197 52 view .LVU479
	ldrsh	fp, [ip, #108]	@ _17, g_armwave_state.ch1_color.r
@ armwave.c:198:                     gg = (g_armwave_state.ch1_color.g * value) >> 8;
	.loc 1 198 52 view .LVU480
	ldrsh	r10, [ip, #110]	@ _23, g_armwave_state.ch1_color.g
@ armwave.c:199:                     bb = (g_armwave_state.ch1_color.b * value) >> 8;
	.loc 1 199 52 view .LVU481
	ldrsh	r5, [ip, #112]	@ _27, g_armwave_state.ch1_color.b
@ armwave.c:221:                     yy = (nsub & 0xff) * g_armwave_state.vscale_frac;
	.loc 1 221 57 view .LVU482
	vldr.32	s13, [ip, #40]	@ _49, g_armwave_state.vscale_frac
@ armwave.c:185:     for(n = 0; n < npix; n += 4) {
	.loc 1 185 11 view .LVU483
	mov	lr, #0	@ n,
.LVL134:
.L124:
	.loc 1 189 9 is_stmt 1 view .LVU484
@ armwave.c:189:         wave_word = *base_32ptr++;
	.loc 1 189 19 is_stmt 0 view .LVU485
	ldr	r0, [r9], #4	@ wave_word, MEM[base: base_32ptr_8, offset: 4294967292B]
.LVL135:
	.loc 1 191 9 is_stmt 1 view .LVU486
@ armwave.c:191:         if(COND_UNLIKELY(wave_word != 0)) {
	.loc 1 191 11 is_stmt 0 view .LVU487
	cmp	r0, #0	@ wave_word,
	bne	.L133		@,
	add	lr, lr, #4	@ n, n,
.L120:
.LVL136:
@ armwave.c:185:     for(n = 0; n < npix; n += 4) {
	.loc 1 185 5 view .LVU488
	cmp	r7, lr	@ npix, n
	bgt	.L124		@,
.LVL137:
.L117:
	.loc 1 185 5 view .LVU489
.LBE42:
.LBE41:
@ armwave.c:450: }
	.loc 1 450 1 view .LVU490
	add	sp, sp, #12	@,,
	.cfi_remember_state
	.cfi_def_cfa_offset 36
	@ sp needed	@
...
@ armwave.c:191:         if(COND_UNLIKELY(wave_word != 0)) {
	.loc 1 191 11 view .LVU492
	mov	r6, lr	@ ivtmp.81, n
.LVL139:
	.loc 1 193 17 is_stmt 1 view .LVU493
	.loc 1 194 17 view .LVU494
@ armwave.c:194:                 wave_word >>= 8;
	.loc 1 194 27 is_stmt 0 view .LVU495
	lsr	r0, r0, #8	@ wave_word, wave_word,
.LVL140:
	.loc 1 196 17 is_stmt 1 view .LVU496
	add	lr, lr, #4	@ n, ivtmp.81,
@ armwave.c:196:                 if(value != 0) {
	.loc 1 196 19 is_stmt 0 view .LVU497
	bne	.L137		@,
.LVL141:
.L121:
	.loc 1 196 19 view .LVU498
	add	r6, r6, #1	@ ivtmp.81, ivtmp.81,
@ armwave.c:192:             for(w = 0; w < 4; w++) {
	.loc 1 192 13 view .LVU499
	cmp	lr, r6	@ n, ivtmp.81
	beq	.L120		@,
	.loc 1 193 17 is_stmt 1 view .LVU500
.LVL142:
	.loc 1 194 17 view .LVU501
@ armwave.c:196:                 if(value != 0) {
	.loc 1 196 19 is_stmt 0 view .LVU502
	ands	r1, r0, #255	@ _19, wave_word,
@ armwave.c:194:                 wave_word >>= 8;
	.loc 1 194 27 view .LVU503
	lsr	r0, r0, #8	@ wave_word, wave_word,
.LVL143:
	.loc 1 196 17 is_stmt 1 view .LVU504
@ armwave.c:196:                 if(value != 0) {
	.loc 1 196 19 is_stmt 0 view .LVU505
	beq	.L121		@,
.L137:
	.loc 1 197 21 is_stmt 1 view .LVU506
.LVL144:
	.loc 1 198 21 view .LVU507
	.loc 1 199 21 view .LVU508
	.loc 1 201 21 view .LVU509
	.loc 1 202 21 view .LVU510
	.loc 1 203 21 view .LVU511
	.loc 1 206 21 view .LVU512
@ armwave.c:221:                     yy = (nsub & 0xff) * g_armwave_state.vscale_frac;
	.loc 1 221 32 is_stmt 0 view .LVU513
	uxtb	r3, r6	@ _47, ivtmp.81
@ armwave.c:222:                     ye = ((nsub & 0xff) + 1) * g_armwave_state.vscale_frac;
	.loc 1 222 41 view .LVU514
	add	r2, r3, #1	@ tmp196, _47,
@ armwave.c:221:                     yy = (nsub & 0xff) * g_armwave_state.vscale_frac;
	.loc 1 221 40 view .LVU515
	vmov	s15, r3	@ int	@ _47, _47
@ armwave.c:222:                     ye = ((nsub & 0xff) + 1) * g_armwave_state.vscale_frac;
	.loc 1 222 41 view .LVU516
	vmov	s14, r2	@ int	@ tmp196, tmp196
@ armwave.c:199:                     bb = (g_armwave_state.ch1_color.b * value) >> 8;
	.loc 1 199 55 view .LVU517
	mul	r3, r5, r1	@ tmp181, _27, _19
@ armwave.c:221:                     yy = (nsub & 0xff) * g_armwave_state.vscale_frac;
	.loc 1 221 40 view .LVU518
	vcvt.f32.s32	s15, s15	@ tmp194, _47
@ armwave.c:222:                     ye = ((nsub & 0xff) + 1) * g_armwave_state.vscale_frac;
	.loc 1 222 46 view .LVU519
	vcvt.f32.s32	s14, s14	@ tmp197, tmp196
@ armwave.c:198:                     gg = (g_armwave_state.ch1_color.g * value) >> 8;
	.loc 1 198 55 view .LVU520
	mul	r2, r10, r1	@ tmp185, _23, _19
@ armwave.c:199:                     bb = (g_armwave_state.ch1_color.b * value) >> 8;
	.loc 1 199 24 view .LVU521
	asr	r3, r3, #8	@ bb, tmp181,
.LVL145:
@ armwave.c:203:                     b = MIN(bb, 255);
	.loc 1 203 25 view .LVU522
	cmp	r3, #255	@ bb,
@ armwave.c:198:                     gg = (g_armwave_state.ch1_color.g * value) >> 8;
	.loc 1 198 24 view .LVU523
	asr	r2, r2, #8	@ gg, tmp185,
.LVL146:
@ armwave.c:203:                     b = MIN(bb, 255);
	.loc 1 203 25 view .LVU524
	movge	r3, #255	@ bb,
.LVL147:
@ armwave.c:221:                     yy = (nsub & 0xff) * g_armwave_state.vscale_frac;
	.loc 1 221 40 view .LVU525
	vmul.f32	s15, s15, s13	@ tmp195, tmp194, _49
@ armwave.c:222:                     ye = ((nsub & 0xff) + 1) * g_armwave_state.vscale_frac;
	.loc 1 222 46 view .LVU526
	vmul.f32	s14, s14, s13	@ tmp198, tmp197, _49
@ armwave.c:202:                     g = MIN(gg, 255);
	.loc 1 202 25 view .LVU527
	cmp	r2, #255	@ gg,
	movge	r2, #255	@ gg,
.LVL148:
@ armwave.c:197:                     rr = (g_armwave_state.ch1_color.r * value) >> 8;
	.loc 1 197 55 view .LVU528
	mul	r1, r1, fp	@ tmp191, _19, _17
.LVL149:
@ armwave.c:206:                     word = 0xff000000 | (b << 16) | (g << 8) | r;
	.loc 1 206 56 view .LVU529
	lsl	r2, r2, #8	@ tmp186, gg,
@ armwave.c:206:                     word = 0xff000000 | (b << 16) | (g << 8) | r;
	.loc 1 206 44 view .LVU530
	lsl	r3, r3, #16	@ tmp182, bb,
@ armwave.c:221:                     yy = (nsub & 0xff) * g_armwave_state.vscale_frac;
	.loc 1 221 24 view .LVU531
	vcvt.u32.f32	s15, s15	@ yy, tmp195
@ armwave.c:197:                     rr = (g_armwave_state.ch1_color.r * value) >> 8;
	.loc 1 197 24 view .LVU532
	asr	r1, r1, #8	@ rr, tmp191,
.LVL150:
@ armwave.c:206:                     word = 0xff000000 | (b << 16) | (g << 8) | r;
	.loc 1 206 56 view .LVU533
	uxth	r2, r2	@ tmp187, tmp186
@ armwave.c:206:                     word = 0xff000000 | (b << 16) | (g << 8) | r;
	.loc 1 206 44 view .LVU534
	and	r3, r3, #16711680	@ tmp183, tmp182,
@ armwave.c:201:                     r = MIN(rr, 255);
	.loc 1 201 25 view .LVU535
	cmp	r1, #255	@ rr,
@ armwave.c:206:                     word = 0xff000000 | (b << 16) | (g << 8) | r;
	.loc 1 206 51 view .LVU536
	orr	r3, r3, r2	@ tmp189, tmp183, tmp187
@ armwave.c:201:                     r = MIN(rr, 255);
	.loc 1 201 25 view .LVU537
	movge	r1, #255	@ rr,
.LVL151:
@ armwave.c:221:                     yy = (nsub & 0xff) * g_armwave_state.vscale_frac;
	.loc 1 221 24 view .LVU538
	vmov	r4, s15	@ int	@ yy, yy
@ armwave.c:222:                     ye = ((nsub & 0xff) + 1) * g_armwave_state.vscale_frac;
	.loc 1 222 24 view .LVU539
	vcvt.u32.f32	s15, s14	@ ye, tmp198
@ armwave.c:206:                     word = 0xff000000 | (b << 16) | (g << 8) | r;
	.loc 1 206 62 view .LVU540
	uxtb	r1, r1	@ rr, rr
	orr	r3, r3, r1	@ tmp193, tmp189, rr
@ armwave.c:206:                     word = 0xff000000 | (b << 16) | (g << 8) | r;
	.loc 1 206 26 view .LVU541
	orr	r3, r3, #-16777216	@ word, tmp193,
.LVL152:
	.loc 1 220 21 is_stmt 1 view .LVU542
	.loc 1 221 21 view .LVU543
	.loc 1 222 21 view .LVU544
	.loc 1 223 21 view .LVU545
@ armwave.c:223:                     xx = (nsub >> 8);
	.loc 1 223 32 is_stmt 0 view .LVU546
	asr	r1, r6, #8	@ xx, ivtmp.81,
.LVL153:
	.loc 1 225 21 is_stmt 1 view .LVU547
	.loc 1 225 21 is_stmt 0 view .LVU548
	vmov	r2, s15	@ int	@ ye,
@ armwave.c:222:                     ye = ((nsub & 0xff) + 1) * g_armwave_state.vscale_frac;
	.loc 1 222 24 view .LVU549
	vstr.32	s15, [sp]	@ int	@ ye, %sfp
.LVL154:
@ armwave.c:225:                     for(y = yy; y < ye; y++) {
	.loc 1 225 21 view .LVU550
	cmp	r4, r2	@ yy, ye
	bcs	.L121		@,
	str	r0, [sp, #4]	@ wave_word, %sfp
.LVL155:
.L122:
	.loc 1 226 25 is_stmt 1 view .LVU551
	.loc 1 227 25 view .LVU552
@ armwave.c:226:                         offset = (xx + (y * g_armwave_state.target_width)); 
	.loc 1 226 43 is_stmt 0 view .LVU553
	ldr	r2, [ip, #88]	@ g_armwave_state.target_width, g_armwave_state.target_width
@ armwave.c:225:                     for(y = yy; y < ye; y++) {
	.loc 1 225 21 view .LVU554
	ldr	r0, [sp]	@ ye, %sfp
@ armwave.c:227:                         *(out_buffer_base + offset) = word;
	.loc 1 227 43 view .LVU555
	mla	r2, r2, r4, r1	@ tmp202, g_armwave_state.target_width, yy, xx
.LVL156:
@ armwave.c:225:                     for(y = yy; y < ye; y++) {
	.loc 1 225 42 view .LVU556
	add	r4, r4, #1	@ yy, yy,
.LVL157:
@ armwave.c:225:                     for(y = yy; y < ye; y++) {
	.loc 1 225 21 view .LVU557
	cmp	r0, r4	@ ye, yy
@ armwave.c:227:                         *(out_buffer_base + offset) = word;
	.loc 1 227 53 view .LVU558
	str	r3, [r8, r2, lsl #2]	@ word, *_64
@ armwave.c:225:                     for(y = yy; y < ye; y++) {
	.loc 1 225 21 view .LVU559
	bne	.L122		@,
	.loc 1 225 21 view .LVU560
	ldr	r0, [sp, #4]	@ wave_word, %sfp
	b	.L121		@
.LVL158:
.L136:
	.loc 1 180 5 is_stmt 1 view .LVU561
	ldr	r3, .L138+4	@,
	mov	r2, #180	@,
	ldr	r1, .L138+8	@,
	ldr	r0, .L138+12	@,
...
.LFB72:
	...
	@ frame_needed = 0, uses_anonymous_args = 0
	@ link register save eliminated.
	.loc 1 457 5 view .LVU563
	ldr	r3, .L141	@ tmp112,
	mov	r1, r0	@, fn
	ldr	r0, [r3, #104]	@, g_armwave_state.out_pixbuf
.LVL161:
	.loc 1 457 5 is_stmt 0 view .LVU564
	b	armwave_dump_ppm_debug		@
.LVL162:
.L142:
	.loc 1 457 5 view .LVU565
	.align	2
.L141:
	.word	g_armwave_state
	.cfi_endproc
...
.LBB48:
@ armwave.c:176:     uint32_t *base_32ptr = (uint32_t*)g_armwave_state.ch1_buffer;
	.loc 1 176 15 view .LVU570
	ldr	r5, .L164	@ tmp206,
.LBE48:
.LBE47:
@ armwave.c:469:     void *out_pixbuf = ((uint32_t ***)buf)[2][10];
	.loc 1 469 11 view .LVU571
	ldr	r8, [r3, #40]	@ out_pixbuf, MEM[(uint32_t * *)_1 + 40B]
.LVL164:
	.loc 1 472 5 is_stmt 1 view .LVU572
.LBB51:
.LBI47:
	.loc 1 169 6 view .LVU573
.LBB49:
	.loc 1 171 5 view .LVU574
	.loc 1 173 5 view .LVU575
	.loc 1 174 5 view .LVU576
	.loc 1 176 5 view .LVU577
@ armwave.c:180:     assert(out_buffer != NULL);
	.loc 1 180 5 is_stmt 0 view .LVU578
	cmp	r8, #0	@ out_pixbuf,
@ armwave.c:176:     uint32_t *base_32ptr = (uint32_t*)g_armwave_state.ch1_buffer;
	.loc 1 176 15 view .LVU579
	ldr	r9, [r5, #4]	@ base_32ptr, g_armwave_state.ch1_buffer
.LVL165:
	.loc 1 177 5 is_stmt 1 view .LVU580
	.loc 1 178 5 view .LVU581
	.loc 1 180 5 view .LVU582
	beq	.L162		@,
	.loc 1 182 5 view .LVU583
@ armwave.c:182:     npix = g_armwave_state.target_width * 256; 
	.loc 1 182 10 is_stmt 0 view .LVU584
	ldr	r7, [r5, #88]	@ g_armwave_state.target_width, g_armwave_state.target_width
	lsl	r7, r7, #8	@ npix, g_armwave_state.target_width,
.LVL166:
	.loc 1 185 5 is_stmt 1 view .LVU585
	.loc 1 185 5 is_stmt 0 view .LVU586
	cmp	r7, #0	@ npix,
	ble	.L143		@,
@ armwave.c:197:                     rr = (g_armwave_state.ch1_color.r * value) >> 8;
	.loc 1 197 52 view .LVU587
	ldrsh	fp, [r5, #108]	@ _19, g_armwave_state.ch1_color.r
@ armwave.c:198:                     gg = (g_armwave_state.ch1_color.g * value) >> 8;
	.loc 1 198 52 view .LVU588
	ldrsh	r10, [r5, #110]	@ _25, g_armwave_state.ch1_color.g
@ armwave.c:199:                     bb = (g_armwave_state.ch1_color.b * value) >> 8;
	.loc 1 199 52 view .LVU589
	ldrsh	r4, [r5, #112]	@ _29, g_armwave_state.ch1_color.b
@ armwave.c:221:                     yy = (nsub & 0xff) * g_armwave_state.vscale_frac;
	.loc 1 221 57 view .LVU590
	vldr.32	s13, [r5, #40]	@ _51, g_armwave_state.vscale_frac
@ armwave.c:185:     for(n = 0; n < npix; n += 4) {
	.loc 1 185 11 view .LVU591
	mov	ip, #0	@ n,
.LVL167:
.L150:
	.loc 1 189 9 is_stmt 1 view .LVU592
@ armwave.c:189:         wave_word = *base_32ptr++;
	.loc 1 189 19 is_stmt 0 view .LVU593
	ldr	r0, [r9], #4	@ wave_word, MEM[base: base_32ptr_10, offset: 4294967292B]
.LVL168:
	.loc 1 191 9 is_stmt 1 view .LVU594
@ armwave.c:191:         if(COND_UNLIKELY(wave_word != 0)) {
	.loc 1 191 11 is_stmt 0 view .LVU595
	cmp	r0, #0	@ wave_word,
	bne	.L159		@,
	add	ip, ip, #4	@ n, n,
.L146:
.LVL169:
@ armwave.c:185:     for(n = 0; n < npix; n += 4) {
	.loc 1 185 5 view .LVU596
	cmp	r7, ip	@ npix, n
	bgt	.L150		@,
.LVL170:
.L143:
	.loc 1 185 5 view .LVU597
.LBE49:
.LBE51:
@ armwave.c:473: }
	.loc 1 473 1 view .LVU598
	add	sp, sp, #12	@,,
	.cfi_remember_state
	.cfi_def_cfa_offset 36
	@ sp needed	@
...
.LBB50:
@ armwave.c:196:                 if(value != 0) {
	.loc 1 196 19 view .LVU599
	ands	r1, r0, #255	@ _21, wave_word,
@ armwave.c:191:         if(COND_UNLIKELY(wave_word != 0)) {
	.loc 1 191 11 view .LVU600
	mov	r6, ip	@ ivtmp.97, n
.LVL172:
	.loc 1 193 17 is_stmt 1 view .LVU601
	.loc 1 194 17 view .LVU602
@ armwave.c:194:                 wave_word >>= 8;
	.loc 1 194 27 is_stmt 0 view .LVU603
	lsr	r0, r0, #8	@ wave_word, wave_word,
.LVL173:
	.loc 1 196 17 is_stmt 1 view .LVU604
	add	ip, ip, #4	@ n, ivtmp.97,
@ armwave.c:196:                 if(value != 0) {
	.loc 1 196 19 is_stmt 0 view .LVU605
	bne	.L163		@,
.LVL174:
.L147:
	.loc 1 196 19 view .LVU606
	add	r6, r6, #1	@ ivtmp.97, ivtmp.97,
@ armwave.c:192:             for(w = 0; w < 4; w++) {
	.loc 1 192 13 view .LVU607
	cmp	ip, r6	@ n, ivtmp.97
	beq	.L146		@,
	.loc 1 193 17 is_stmt 1 view .LVU608
.LVL175:
	.loc 1 194 17 view .LVU609
@ armwave.c:196:                 if(value != 0) {
	.loc 1 196 19 is_stmt 0 view .LVU610
	ands	r1, r0, #255	@ _21, wave_word,
@ armwave.c:194:                 wave_word >>= 8;
	.loc 1 194 27 view .LVU611
	lsr	r0, r0, #8	@ wave_word, wave_word,
.LVL176:
	.loc 1 196 17 is_stmt 1 view .LVU612
@ armwave.c:196:                 if(value != 0) {
	.loc 1 196 19 is_stmt 0 view .LVU613
	beq	.L147		@,
.L163:
	.loc 1 197 21 is_stmt 1 view .LVU614
.LVL177:
	.loc 1 198 21 view .LVU615
	.loc 1 199 21 view .LVU616
	.loc 1 201 21 view .LVU617
	.loc 1 202 21 view .LVU618
	.loc 1 203 21 view .LVU619
	.loc 1 206 21 view .LVU620
@ armwave.c:221:                     yy = (nsub & 0xff) * g_armwave_state.vscale_frac;
	.loc 1 221 32 is_stmt 0 view .LVU621
	uxtb	r3, r6	@ _49, ivtmp.97
@ armwave.c:222:                     ye = ((nsub & 0xff) + 1) * g_armwave_state.vscale_frac;
	.loc 1 222 41 view .LVU622
	add	r2, r3, #1	@ tmp198, _49,
@ armwave.c:221:                     yy = (nsub & 0xff) * g_armwave_state.vscale_frac;
	.loc 1 221 40 view .LVU623
	vmov	s15, r3	@ int	@ _49, _49
@ armwave.c:222:                     ye = ((nsub & 0xff) + 1) * g_armwave_state.vscale_frac;
	.loc 1 222 41 view .LVU624
	vmov	s14, r2	@ int	@ tmp198, tmp198
@ armwave.c:199:                     bb = (g_armwave_state.ch1_color.b * value) >> 8;
	.loc 1 199 55 view .LVU625
	mul	r3, r4, r1	@ tmp183, _29, _21
@ armwave.c:221:                     yy = (nsub & 0xff) * g_armwave_state.vscale_frac;
	.loc 1 221 40 view .LVU626
	vcvt.f32.s32	s15, s15	@ tmp196, _49
@ armwave.c:222:                     ye = ((nsub & 0xff) + 1) * g_armwave_state.vscale_frac;
	.loc 1 222 46 view .LVU627
	vcvt.f32.s32	s14, s14	@ tmp199, tmp198
@ armwave.c:198:                     gg = (g_armwave_state.ch1_color.g * value) >> 8;
	.loc 1 198 55 view .LVU628
	mul	r2, r10, r1	@ tmp187, _25, _21
@ armwave.c:199:                     bb = (g_armwave_state.ch1_color.b * value) >> 8;
	.loc 1 199 24 view .LVU629
	asr	r3, r3, #8	@ bb, tmp183,
.LVL178:
@ armwave.c:203:                     b = MIN(bb, 255);
	.loc 1 203 25 view .LVU630
	cmp	r3, #255	@ bb,
@ armwave.c:198:                     gg = (g_armwave_state.ch1_color.g * value) >> 8;
	.loc 1 198 24 view .LVU631
	asr	r2, r2, #8	@ gg, tmp187,
.LVL179:
@ armwave.c:203:                     b = MIN(bb, 255);
	.loc 1 203 25 view .LVU632
	movge	r3, #255	@ bb,
.LVL180:
@ armwave.c:221:                     yy = (nsub & 0xff) * g_armwave_state.vscale_frac;
	.loc 1 221 40 view .LVU633
	vmul.f32	s15, s15, s13	@ tmp197, tmp196, _51
@ armwave.c:222:                     ye = ((nsub & 0xff) + 1) * g_armwave_state.vscale_frac;
	.loc 1 222 46 view .LVU634
	vmul.f32	s14, s14, s13	@ tmp200, tmp199, _51
@ armwave.c:202:                     g = MIN(gg, 255);
	.loc 1 202 25 view .LVU635
	cmp	r2, #255	@ gg,
	movge	r2, #255	@ gg,
.LVL181:
@ armwave.c:197:                     rr = (g_armwave_state.ch1_color.r * value) >> 8;
	.loc 1 197 55 view .LVU636
	mul	r1, r1, fp	@ tmp193, _21, _19
.LVL182:
@ armwave.c:206:                     word = 0xff000000 | (b << 16) | (g << 8) | r;
	.loc 1 206 56 view .LVU637
	lsl	r2, r2, #8	@ tmp188, gg,
@ armwave.c:206:                     word = 0xff000000 | (b << 16) | (g << 8) | r;
	.loc 1 206 44 view .LVU638
	lsl	r3, r3, #16	@ tmp184, bb,
@ armwave.c:221:                     yy = (nsub & 0xff) * g_armwave_state.vscale_frac;
	.loc 1 221 24 view .LVU639
	vcvt.u32.f32	s15, s15	@ yy, tmp197
@ armwave.c:197:                     rr = (g_armwave_state.ch1_color.r * value) >> 8;
	.loc 1 197 24 view .LVU640
	asr	r1, r1, #8	@ rr, tmp193,
.LVL183:
@ armwave.c:206:                     word = 0xff000000 | (b << 16) | (g << 8) | r;
	.loc 1 206 56 view .LVU641
	uxth	r2, r2	@ tmp189, tmp188
@ armwave.c:206:                     word = 0xff000000 | (b << 16) | (g << 8) | r;
	.loc 1 206 44 view .LVU642
	and	r3, r3, #16711680	@ tmp185, tmp184,
@ armwave.c:201:                     r = MIN(rr, 255);
	.loc 1 201 25 view .LVU643
	cmp	r1, #255	@ rr,
@ armwave.c:206:                     word = 0xff000000 | (b << 16) | (g << 8) | r;
	.loc 1 206 51 view .LVU644
	orr	r3, r3, r2	@ tmp191, tmp185, tmp189
@ armwave.c:201:                     r = MIN(rr, 255);
	.loc 1 201 25 view .LVU645
	movge	r1, #255	@ rr,
.LVL184:
@ armwave.c:221:                     yy = (nsub & 0xff) * g_armwave_state.vscale_frac;
	.loc 1 221 24 view .LVU646
	vmov	lr, s15	@ int	@ yy, yy
@ armwave.c:222:                     ye = ((nsub & 0xff) + 1) * g_armwave_state.vscale_frac;
	.loc 1 222 24 view .LVU647
	vcvt.u32.f32	s15, s14	@ ye, tmp200
@ armwave.c:206:                     word = 0xff000000 | (b << 16) | (g << 8) | r;
	.loc 1 206 62 view .LVU648
	uxtb	r1, r1	@ rr, rr
	orr	r3, r3, r1	@ tmp195, tmp191, rr
@ armwave.c:206:                     word = 0xff000000 | (b << 16) | (g << 8) | r;
	.loc 1 206 26 view .LVU649
	orr	r3, r3, #-16777216	@ word, tmp195,
.LVL185:
	.loc 1 220 21 is_stmt 1 view .LVU650
	.loc 1 221 21 view .LVU651
	.loc 1 222 21 view .LVU652
	.loc 1 223 21 view .LVU653
@ armwave.c:223:                     xx = (nsub >> 8);
	.loc 1 223 32 is_stmt 0 view .LVU654
	asr	r1, r6, #8	@ xx, ivtmp.97,
.LVL186:
	.loc 1 225 21 is_stmt 1 view .LVU655
	.loc 1 225 21 is_stmt 0 view .LVU656
	vmov	r2, s15	@ int	@ ye,
@ armwave.c:222:                     ye = ((nsub & 0xff) + 1) * g_armwave_state.vscale_frac;
	.loc 1 222 24 view .LVU657
	vstr.32	s15, [sp]	@ int	@ ye, %sfp
.LVL187:
@ armwave.c:225:                     for(y = yy; y < ye; y++) {
	.loc 1 225 21 view .LVU658
	cmp	lr, r2	@ yy, ye
	bcs	.L147		@,
	str	r0, [sp, #4]	@ wave_word, %sfp
.LVL188:
.L148:
	.loc 1 226 25 is_stmt 1 view .LVU659
	.loc 1 227 25 view .LVU660
@ armwave.c:226:                         offset = (xx + (y * g_armwave_state.target_width)); 
	.loc 1 226 43 is_stmt 0 view .LVU661
	ldr	r2, [r5, #88]	@ g_armwave_state.target_width, g_armwave_state.target_width
@ armwave.c:225:                     for(y = yy; y < ye; y++) {
	.loc 1 225 21 view .LVU662
	ldr	r0, [sp]	@ ye, %sfp
@ armwave.c:227:                         *(out_buffer_base + offset) = word;
	.loc 1 227 43 view .LVU663
	mla	r2, r2, lr, r1	@ tmp204, g_armwave_state.target_width, yy, xx
.LVL189:
@ armwave.c:225:                     for(y = yy; y < ye; y++) {
	.loc 1 225 42 view .LVU664
	add	lr, lr, #1	@ yy, yy,
.LVL190:
@ armwave.c:225:                     for(y = yy; y < ye; y++) {
	.loc 1 225 21 view .LVU665
	cmp	r0, lr	@ ye, yy
@ armwave.c:227:                         *(out_buffer_base + offset) = word;
	.loc 1 227 53 view .LVU666
	str	r3, [r8, r2, lsl #2]	@ word, *_66
@ armwave.c:225:                     for(y = yy; y < ye; y++) {
	.loc 1 225 21 view .LVU667
	bne	.L148		@,
	.loc 1 225 21 view .LVU668
	ldr	r0, [sp, #4]	@ wave_word, %sfp
	b	.L147		@
.LVL191:
.L162:
	.loc 1 180 5 is_stmt 1 view .LVU669
	ldr	r3, .L164+4	@,
	mov	r2, #180	@,
	ldr	r1, .L164+8	@,
	ldr	r0, .L164+12	@,
...
.LFB74:
	...
	@ args = 0, pretend = 0, frame = 0
	@ frame_needed = 0, uses_anonymous_args = 0
	.loc 1 480 5 view .LVU672
@ armwave.c:479: {
	.loc 1 479 1 is_stmt 0 view .LVU673
	push	{r4, r5, r6, lr}	@
	.cfi_def_cfa_offset 16
	.cfi_offset 4, -16
	.cfi_offset 5, -12
...
@ armwave.c:486:     g_armwave_state.test_wave_buffer = calloc(g_armwave_state.wave_length * g_armwave_state.waves_max, nsets);
	.loc 1 486 40 view .LVU680
	mov	r1, r6	@, nsets
@ armwave.c:486:     g_armwave_state.test_wave_buffer = calloc(g_armwave_state.wave_length * g_armwave_state.waves_max, nsets);
	.loc 1 486 75 view .LVU681
	mul	r5, r5, r3	@ _4, g_armwave_state.waves_max, g_armwave_state.wave_length
@ armwave.c:486:     g_armwave_state.test_wave_buffer = calloc(g_armwave_state.wave_length * g_armwave_state.waves_max, nsets);
	.loc 1 486 40 view .LVU682
	mov	r0, r5	@, _4
	bl	calloc		@
.LVL197:
@ armwave.c:488:     if(g_armwave_state.test_wave_buffer == NULL) {
	.loc 1 488 7 view .LVU683
	cmp	r0, #0	@ tmp124,
@ armwave.c:486:     g_armwave_state.test_wave_buffer = calloc(g_armwave_state.wave_length * g_armwave_state.waves_max, nsets);
	.loc 1 486 38 view .LVU684
	str	r0, [r4, #24]	@ tmp124, g_armwave_state.test_wave_buffer
	.loc 1 488 5 is_stmt 1 view .LVU685
@ armwave.c:488:     if(g_armwave_state.test_wave_buffer == NULL) {
	.loc 1 488 7 is_stmt 0 view .LVU686
	popne	{r4, r5, r6, pc}	@
	.loc 1 489 9 is_stmt 1 view .LVU687
	mul	r1, r6, r5	@, nsets, _4
	mov	r2, r6	@, nsets
	ldr	r0, .L173+4	@,
@ armwave.c:493: }
	.loc 1 493 1 is_stmt 0 view .LVU688
	pop	{r4, r5, r6, lr}	@
	.cfi_restore 14
	.cfi_restore 6
	.cfi_restore 5
...
@ armwave.c:489:         printf("armwave_test_buffer_alloc: failed to allocate test wave buffer (%d bytes, %d sets)\n", \
	.loc 1 489 9 view .LVU689
	b	printf		@
.LVL199:
.L174:
	.loc 1 489 9 view .LVU690
	.align	2
.L173:
	.word	g_armwave_state
	.word	.LC18
...
.LFB75:
	...
	@ frame_needed = 0, uses_anonymous_args = 0
	.loc 1 500 5 view .LVU692
	.loc 1 501 5 view .LVU693
	.loc 1 505 5 view .LVU694
@ armwave.c:499: {
	.loc 1 499 1 is_stmt 0 view .LVU695
	str	lr, [sp, #-4]!	@,
...
@ armwave.c:505:     ret = PyObject_GetBuffer(buf_obj, &buffer, PyBUF_SIMPLE | PyBUF_WRITABLE);
	.loc 1 505 11 view .LVU696
	add	r1, sp, #4	@ tmp131,,
	mov	r2, #1	@,
	bl	PyObject_GetBuffer		@
.LVL201:
	.loc 1 507 5 is_stmt 1 view .LVU697
@ armwave.c:507:     if(ret != 0) {
	.loc 1 507 7 is_stmt 0 view .LVU698
	cmp	r0, #0	@,
	bne	.L179		@,
	.loc 1 514 5 is_stmt 1 view .LVU699
	ldr	r0, [sp, #4]	@, buffer.buf
.LVL202:
	.loc 1 514 5 is_stmt 0 view .LVU700
	bl	armwave_fill_pixbuf_scaled		@
.LVL203:
	.loc 1 517 5 is_stmt 1 view .LVU701
	add	r0, sp, #4	@ tmp132,,
	bl	PyBuffer_Release		@
.LVL204:
	.loc 1 520 5 view .LVU702
.LBB53:
.LBI53:
	.file 2 "/usr/local/include/python3.8/object.h"
	.loc 2 456 20 view .LVU703
.LBB54:
	.loc 2 458 21 view .LVU704
	.loc 2 459 5 view .LVU705
@ /usr/local/include/python3.8/object.h:459:     op->ob_refcnt++;
	.loc 2 459 18 is_stmt 0 view .LVU706
	ldr	r3, .L180	@ tmp126,
.LBE54:
.LBE53:
@ armwave.c:520:     Py_RETURN_TRUE;
	.loc 1 520 5 view .LVU707
	mov	r0, r3	@ <retval>, tmp126
.LBB56:
.LBB55:
@ /usr/local/include/python3.8/object.h:459:     op->ob_refcnt++;
	.loc 2 459 18 view .LVU708
...
.L179:
	.cfi_restore_state
	.loc 1 508 9 is_stmt 1 view .LVU710
	ldr	r0, .L180+4	@,
.LVL206:
	.loc 1 508 9 is_stmt 0 view .LVU711
	bl	puts		@
.LVL207:
	.loc 1 509 9 is_stmt 1 view .LVU712
.LBB57:
.LBI57:
...
@ /usr/local/include/python3.8/object.h:459:     op->ob_refcnt++;
	...
	ldr	r3, .L180+8	@ tmp120,
.LBE58:
.LBE57:
@ armwave.c:509:         Py_RETURN_FALSE;
	.loc 1 509 9 view .LVU717
...
.LFB76:
	...
	@ args = 0, pretend = 0, frame = 8
	@ frame_needed = 0, uses_anonymous_args = 0
	.loc 1 532 5 view .LVU721
	.loc 1 533 5 view .LVU722
@ armwave.c:531: {
	.loc 1 531 1 is_stmt 0 view .LVU723
	push	{r4, r5, r6, r7, r8, r9, r10, lr}	@
	.cfi_def_cfa_offset 32
	.cfi_offset 4, -32
	.cfi_offset 5, -28
...
@ armwave.c:533:     float _1_waves_mod = mod * (1.0f / g_armwave_state.waves);
	.loc 1 533 38 view .LVU724
	vldr.32	s14, .L213	@ tmp180,
@ armwave.c:533:     float _1_waves_mod = mod * (1.0f / g_armwave_state.waves);
	.loc 1 533 55 view .LVU725
	ldr	r5, .L213+28	@ tmp250,
@ armwave.c:531: {
	.loc 1 531 1 view .LVU726
...
@ armwave.c:537:     g_armwave_state.test_wave_buffer_stride = (g_armwave_state.waves * g_armwave_state.wave_stride);
	.loc 1 537 70 view .LVU728
	ldr	r3, [r5, #52]	@ g_armwave_state.wave_stride, g_armwave_state.wave_stride
	ldr	r2, [r5, #56]	@ tmp265, g_armwave_state.waves
.LBB63:
.LBB64:
@ armwave.c:480:     if(g_armwave_state.test_wave_buffer != NULL) {
	.loc 1 480 23 view .LVU729
	ldr	r0, [r5, #24]	@ _82, g_armwave_state.test_wave_buffer
.LVL209:
	.loc 1 480 23 view .LVU730
.LBE64:
.LBE63:
@ armwave.c:533:     float _1_waves_mod = mod * (1.0f / g_armwave_state.waves);
	.loc 1 533 38 view .LVU731
	vcvt.f32.s32	s15, s15	@ tmp178, tmp264
@ armwave.c:537:     g_armwave_state.test_wave_buffer_stride = (g_armwave_state.waves * g_armwave_state.wave_stride);
	.loc 1 537 70 view .LVU732
	mul	r3, r2, r3	@ tmp183, tmp265, g_armwave_state.wave_stride
@ armwave.c:531: {
	.loc 1 531 1 view .LVU733
	vmov.f32	s23, s1	@ noise_fraction, noise_fraction
.LBB68:
.LBB65:
@ armwave.c:480:     if(g_armwave_state.test_wave_buffer != NULL) {
	.loc 1 480 7 view .LVU734
	cmp	r0, #0	@ _82,
.LBE65:
.LBE68:
@ armwave.c:531: {
	.loc 1 531 1 view .LVU735
	sub	sp, sp, #8	@,,
	.cfi_def_cfa_offset 88
@ armwave.c:538:     g_armwave_state.test_wave_buffer_nsets = sets;
	.loc 1 538 44 view .LVU736
	str	r9, [r5, #32]	@ sets, g_armwave_state.test_wave_buffer_nsets
@ armwave.c:537:     g_armwave_state.test_wave_buffer_stride = (g_armwave_state.waves * g_armwave_state.wave_stride);
	.loc 1 537 45 view .LVU737
	str	r3, [r5, #28]	@ tmp183, g_armwave_state.test_wave_buffer_stride
@ armwave.c:533:     float _1_waves_mod = mod * (1.0f / g_armwave_state.waves);
	.loc 1 533 38 view .LVU738
	vdiv.f32	s26, s14, s15	@ tmp179, tmp180, tmp178
@ armwave.c:533:     float _1_waves_mod = mod * (1.0f / g_armwave_state.waves);
	.loc 1 533 11 view .LVU739
	vmul.f32	s26, s26, s0	@ _1_waves_mod, tmp179, mod
.LVL210:
	.loc 1 534 5 is_stmt 1 view .LVU740
	.loc 1 535 5 view .LVU741
	.loc 1 537 5 view .LVU742
	.loc 1 538 5 view .LVU743
	.loc 1 539 5 view .LVU744
.LBB69:
.LBI63:
	.loc 1 478 6 view .LVU745
.LBB66:
	.loc 1 480 5 view .LVU746
@ armwave.c:480:     if(g_armwave_state.test_wave_buffer != NULL) {
	.loc 1 480 7 is_stmt 0 view .LVU747
	beq	.L183		@,
	.loc 1 481 9 is_stmt 1 view .LVU748
	bl	free		@
.LVL211:
.L183:
	.loc 1 486 5 view .LVU749
@ armwave.c:486:     g_armwave_state.test_wave_buffer = calloc(g_armwave_state.wave_length * g_armwave_state.waves_max, nsets);
	.loc 1 486 75 is_stmt 0 view .LVU750
...
@ armwave.c:486:     g_armwave_state.test_wave_buffer = calloc(g_armwave_state.wave_length * g_armwave_state.waves_max, nsets);
	.loc 1 486 40 view .LVU751
	mov	r1, r9	@, sets
@ armwave.c:486:     g_armwave_state.test_wave_buffer = calloc(g_armwave_state.wave_length * g_armwave_state.waves_max, nsets);
	.loc 1 486 75 view .LVU752
	mul	r4, r4, r3	@ _85, g_armwave_state.waves_max, g_armwave_state.wave_length
@ armwave.c:486:     g_armwave_state.test_wave_buffer = calloc(g_armwave_state.wave_length * g_armwave_state.waves_max, nsets);
	.loc 1 486 40 view .LVU753
	mov	r0, r4	@, _85
	bl	calloc		@
.LVL212:
@ armwave.c:488:     if(g_armwave_state.test_wave_buffer == NULL) {
	.loc 1 488 7 view .LVU754
	cmp	r0, #0	@ tmp191,
@ armwave.c:486:     g_armwave_state.test_wave_buffer = calloc(g_armwave_state.wave_length * g_armwave_state.waves_max, nsets);
	.loc 1 486 38 view .LVU755
	str	r0, [r5, #24]	@ tmp191, g_armwave_state.test_wave_buffer
	.loc 1 488 5 is_stmt 1 view .LVU756
@ armwave.c:488:     if(g_armwave_state.test_wave_buffer == NULL) {
	.loc 1 488 7 is_stmt 0 view .LVU757
	beq	.L212		@,
.L184:
.LVL213:
	.loc 1 488 7 view .LVU758
.LBE66:
.LBE69:
@ armwave.c:541:     for(s = 0; s < sets; s++) {
	.loc 1 541 5 discriminator 1 view .LVU759
	cmp	r9, #0	@ sets,
	ble	.L182		@,
@ armwave.c:560:                 v = (sin((6.28f * x * (1.0f / g_armwave_state.wave_length)) + xnoise) * mod_val) * noise;
	.loc 1 560 45 view .LVU760
	vldr.32	s16, .L213	@ tmp258,
@ armwave.c:563:                 g_armwave_state.test_wave_buffer[x + (w * g_armwave_state.wave_stride) + set_offset] = (uint8_t)MIN(MAX(128 + (v * 127), 0), 255);
	.loc 1 563 104 view .LVU761
	vldr.32	s24, .L213+4	@ tmp259,
@ armwave.c:541:     for(s = 0; s < sets; s++) {
	.loc 1 541 5 view .LVU762
	mov	r7, #0	@ set_offset,
@ armwave.c:542:         printf("Calculating test set %d\n", s);
	.loc 1 542 9 view .LVU763
	ldr	r10, .L213+32	@ tmp257,
@ armwave.c:541:     for(s = 0; s < sets; s++) {
	.loc 1 541 5 view .LVU764
	mov	r8, r7	@ s, set_offset
.LVL214:
.L185:
	.loc 1 542 9 is_stmt 1 view .LVU765
	mov	r1, r8	@, s
	mov	r0, r10	@, tmp257
	bl	printf		@
.LVL215:
	.loc 1 544 9 view .LVU766
@ armwave.c:544:         for(w = 0; w < g_armwave_state.waves; w++) {
	.loc 1 544 39 is_stmt 0 view .LVU767
	ldr	r2, [r5, #56]	@ prephitmp_120, g_armwave_state.waves
@ armwave.c:544:         for(w = 0; w < g_armwave_state.waves; w++) {
	.loc 1 544 9 view .LVU768
	cmp	r2, #0	@ prephitmp_120,
	ble	.L186		@,
@ armwave.c:546:             mod_val = 0.5f + (_1_waves_mod * w);
	.loc 1 546 21 view .LVU769
	vldr.32	s25, .L213+8	@ tmp200,
@ armwave.c:560:                 v = (sin((6.28f * x * (1.0f / g_armwave_state.wave_length)) + xnoise) * mod_val) * noise;
	.loc 1 560 33 view .LVU770
	vldr.32	s22, .L213+12	@ tmp253,
@ armwave.c:558:                 xnoise = (rand() & 0xffff) / 6553500.0f;
	.loc 1 558 24 view .LVU771
	vldr.32	s21, .L213+16	@ tmp254,
	ldr	r3, [r5, #76]	@ prephitmp_124, g_armwave_state.wave_length
@ armwave.c:544:         for(w = 0; w < g_armwave_state.waves; w++) {
	.loc 1 544 15 view .LVU772
	mov	r6, #0	@ w,
.LVL216:
.L193:
	.loc 1 546 13 is_stmt 1 view .LVU773
@ armwave.c:546:             mod_val = 0.5f + (_1_waves_mod * w);
	.loc 1 546 21 is_stmt 0 view .LVU774
	vmov	s15, r6	@ int	@ w, w
	vmov.f32	s18, s25	@ mod_val, tmp200
@ armwave.c:548:             for(x = 0; x < g_armwave_state.wave_length; x++) {
	.loc 1 548 13 view .LVU775
	cmp	r3, #0	@ prephitmp_124,
@ armwave.c:546:             mod_val = 0.5f + (_1_waves_mod * w);
	.loc 1 546 21 view .LVU776
	vcvt.f32.s32	s15, s15	@ tmp198, w
	vmla.f32	s18, s15, s26	@ mod_val, tmp198, _1_waves_mod
.LVL217:
	.loc 1 548 13 is_stmt 1 view .LVU777
	.loc 1 548 13 is_stmt 0 view .LVU778
	ble	.L187		@,
	vcvt.f64.f32	d9, s18	@ tmp249, mod_val
@ armwave.c:563:                 g_armwave_state.test_wave_buffer[x + (w * g_armwave_state.wave_stride) + set_offset] = (uint8_t)MIN(MAX(128 + (v * 127), 0), 255);
	.loc 1 563 113 view .LVU779
	vldr.32	s20, .L213+20	@ tmp229,
	vldr.32	s17, .L213+24	@ tmp230,
@ armwave.c:548:             for(x = 0; x < g_armwave_state.wave_length; x++) {
	.loc 1 548 19 view .LVU780
	mov	r4, #0	@ x,
.LVL218:
.L192:
	.loc 1 549 17 is_stmt 1 view .LVU781
@ armwave.c:549:                 noise  = ((rand() & 0xffff) * noise_fraction);
	.loc 1 549 28 is_stmt 0 view .LVU782
	bl	rand		@
.LVL219:
@ armwave.c:549:                 noise  = ((rand() & 0xffff) * noise_fraction);
	.loc 1 549 35 view .LVU783
	uxth	r0, r0	@ tmp201,
@ armwave.c:549:                 noise  = ((rand() & 0xffff) * noise_fraction);
	.loc 1 549 45 view .LVU784
	vmov	s15, r0	@ int	@ tmp201, tmp201
	vcvt.f32.s32	s15, s15	@ tmp203, tmp201
@ armwave.c:549:                 noise  = ((rand() & 0xffff) * noise_fraction);
	.loc 1 549 24 view .LVU785
	vmul.f32	s15, s15, s23	@ noise, tmp203, noise_fraction
.LVL220:
	.loc 1 550 17 is_stmt 1 view .LVU786
@ armwave.c:550:                 noise *= noise;
	.loc 1 550 23 is_stmt 0 view .LVU787
	vmul.f32	s15, s15, s15	@ noise, noise, noise
.LVL221:
	.loc 1 551 17 is_stmt 1 view .LVU788
@ armwave.c:551:                 noise *= noise;
	.loc 1 551 23 is_stmt 0 view .LVU789
	vmul.f32	s15, s15, s15	@ noise, noise, noise
.LVL222:
	.loc 1 552 17 is_stmt 1 view .LVU790
@ armwave.c:552:                 noise *= noise;
	.loc 1 552 23 is_stmt 0 view .LVU791
	vmul.f32	s27, s15, s15	@ noise, noise, noise
.LVL223:
	.loc 1 554 17 is_stmt 1 view .LVU792
@ armwave.c:554:                 if((rand() & 0xffff) > 0x7fff)
	.loc 1 554 21 is_stmt 0 view .LVU793
	bl	rand		@
.LVL224:
	.loc 1 555 21 is_stmt 1 view .LVU794
@ armwave.c:554:                 if((rand() & 0xffff) > 0x7fff)
	.loc 1 554 19 is_stmt 0 view .LVU795
	tst	r0, #32768	@,
@ armwave.c:555:                     noise = -noise;
	.loc 1 555 27 view .LVU796
	vnegne.f32	s27, s27	@ noise, noise
.LVL225:
	.loc 1 557 17 is_stmt 1 view .LVU797
	.loc 1 558 17 view .LVU798
@ armwave.c:558:                 xnoise = (rand() & 0xffff) / 6553500.0f;
	.loc 1 558 27 is_stmt 0 view .LVU799
	bl	rand		@
.LVL226:
	.loc 1 560 17 is_stmt 1 view .LVU800
@ armwave.c:560:                 v = (sin((6.28f * x * (1.0f / g_armwave_state.wave_length)) + xnoise) * mod_val) * noise;
	.loc 1 560 45 is_stmt 0 view .LVU801
	vldr.32	s14, [r5, #76]	@ int	@ tmp270, g_armwave_state.wave_length
@ armwave.c:560:                 v = (sin((6.28f * x * (1.0f / g_armwave_state.wave_length)) + xnoise) * mod_val) * noise;
	.loc 1 560 33 view .LVU802
	vmov	s15, r4	@ int	@ x, x
@ armwave.c:560:                 v = (sin((6.28f * x * (1.0f / g_armwave_state.wave_length)) + xnoise) * mod_val) * noise;
	.loc 1 560 45 view .LVU803
	vcvt.f32.s32	s14, s14	@ tmp206, tmp270
@ armwave.c:560:                 v = (sin((6.28f * x * (1.0f / g_armwave_state.wave_length)) + xnoise) * mod_val) * noise;
	.loc 1 560 33 view .LVU804
	vcvt.f32.s32	s15, s15	@ tmp210, x
@ armwave.c:560:                 v = (sin((6.28f * x * (1.0f / g_armwave_state.wave_length)) + xnoise) * mod_val) * noise;
	.loc 1 560 45 view .LVU805
	vdiv.f32	s13, s16, s14	@ tmp208, tmp258, tmp206
@ armwave.c:560:                 v = (sin((6.28f * x * (1.0f / g_armwave_state.wave_length)) + xnoise) * mod_val) * noise;
	.loc 1 560 33 view .LVU806
	vmul.f32	s15, s15, s22	@ tmp211, tmp210, tmp253
@ armwave.c:558:                 xnoise = (rand() & 0xffff) / 6553500.0f;
	.loc 1 558 34 view .LVU807
	uxth	r0, r0	@ tmp214,
.LVL227:
@ armwave.c:558:                 xnoise = (rand() & 0xffff) / 6553500.0f;
	.loc 1 558 44 view .LVU808
	vmov	s14, r0	@ int	@ tmp214, tmp214
	vcvt.f32.s32	s14, s14	@ tmp216, tmp214
@ armwave.c:558:                 xnoise = (rand() & 0xffff) / 6553500.0f;
	.loc 1 558 24 view .LVU809
	vdiv.f32	s0, s14, s21	@ xnoise, tmp216, tmp254
@ armwave.c:560:                 v = (sin((6.28f * x * (1.0f / g_armwave_state.wave_length)) + xnoise) * mod_val) * noise;
	.loc 1 560 77 view .LVU810
	vmla.f32	s0, s13, s15	@ tmp219, tmp208, tmp211
@ armwave.c:560:                 v = (sin((6.28f * x * (1.0f / g_armwave_state.wave_length)) + xnoise) * mod_val) * noise;
	.loc 1 560 22 view .LVU811
	vcvt.f64.f32	d0, s0	@, tmp219
	bl	sin		@
.LVL228:
	.loc 1 563 17 is_stmt 1 view .LVU812
@ armwave.c:557:                 noise += 1.0f;
	.loc 1 557 23 is_stmt 0 view .LVU813
	vadd.f32	s15, s27, s16	@ noise, noise, tmp258
@ armwave.c:563:                 g_armwave_state.test_wave_buffer[x + (w * g_armwave_state.wave_stride) + set_offset] = (uint8_t)MIN(MAX(128 + (v * 127), 0), 255);
	.loc 1 563 104 view .LVU814
	mov	r1, #0	@ iftmp.17_50,
@ armwave.c:560:                 v = (sin((6.28f * x * (1.0f / g_armwave_state.wave_length)) + xnoise) * mod_val) * noise;
	.loc 1 560 98 view .LVU815
	vcvt.f64.f32	d7, s15	@ tmp225, noise
@ armwave.c:560:                 v = (sin((6.28f * x * (1.0f / g_armwave_state.wave_length)) + xnoise) * mod_val) * noise;
	.loc 1 560 87 view .LVU816
	vmul.f64	d0, d9, d0	@ tmp222, tmp249,
@ armwave.c:560:                 v = (sin((6.28f * x * (1.0f / g_armwave_state.wave_length)) + xnoise) * mod_val) * noise;
	.loc 1 560 98 view .LVU817
	vmul.f64	d7, d0, d7	@ tmp226, tmp222, tmp225
@ armwave.c:560:                 v = (sin((6.28f * x * (1.0f / g_armwave_state.wave_length)) + xnoise) * mod_val) * noise;
	.loc 1 560 19 view .LVU818
	vcvt.f32.f64	s14, d7	@ v, tmp226
@ armwave.c:563:                 g_armwave_state.test_wave_buffer[x + (w * g_armwave_state.wave_stride) + set_offset] = (uint8_t)MIN(MAX(128 + (v * 127), 0), 255);
	.loc 1 563 113 view .LVU819
	...
	ble	.L189		@,
@ armwave.c:563:                 g_armwave_state.test_wave_buffer[x + (w * g_armwave_state.wave_stride) + set_offset] = (uint8_t)MIN(MAX(128 + (v * 127), 0), 255);
	.loc 1 563 104 discriminator 1 view .LVU820
	vcmpe.f32	s15, s24	@ _33, tmp259
	mov	r1, #255	@ iftmp.17_50,
	vmrs	APSR_nzcv, FPSCR
	vcvtmi.u32.f32	s15, s15	@ tmp234, _33
	vstrmi.32	s15, [sp, #4]	@ int	@ tmp234, %sfp
	ldrbmi	r1, [sp, #4]	@ zero_extendqisi2	@ iftmp.17_50, %sfp
.L189:
@ armwave.c:563:                 g_armwave_state.test_wave_buffer[x + (w * g_armwave_state.wave_stride) + set_offset] = (uint8_t)MIN(MAX(128 + (v * 127), 0), 255);
	.loc 1 563 57 discriminator 12 view .LVU821
	ldr	r2, [r5, #52]	@ g_armwave_state.wave_stride, g_armwave_state.wave_stride
@ armwave.c:563:                 g_armwave_state.test_wave_buffer[x + (w * g_armwave_state.wave_stride) + set_offset] = (uint8_t)MIN(MAX(128 + (v * 127), 0), 255);
	.loc 1 563 102 discriminator 12 view .LVU822
...
@ armwave.c:548:             for(x = 0; x < g_armwave_state.wave_length; x++) {
	.loc 1 548 58 discriminator 12 view .LVU823
	add	r4, r4, #1	@ x, x,
.LVL229:
@ armwave.c:563:                 g_armwave_state.test_wave_buffer[x + (w * g_armwave_state.wave_stride) + set_offset] = (uint8_t)MIN(MAX(128 + (v * 127), 0), 255);
	.loc 1 563 102 discriminator 12 view .LVU824
	strb	r1, [r2, r3]	@ iftmp.17_50, *_40
@ armwave.c:548:             for(x = 0; x < g_armwave_state.wave_length; x++) {
	.loc 1 548 43 discriminator 12 view .LVU825
	ldr	r3, [r5, #76]	@ prephitmp_124, g_armwave_state.wave_length
@ armwave.c:548:             for(x = 0; x < g_armwave_state.wave_length; x++) {
	.loc 1 548 13 discriminator 12 view .LVU826
...
.L187:
@ armwave.c:544:         for(w = 0; w < g_armwave_state.waves; w++) {
	.loc 1 544 48 discriminator 2 view .LVU827
	add	r6, r6, #1	@ w, w,
.LVL231:
@ armwave.c:544:         for(w = 0; w < g_armwave_state.waves; w++) {
	.loc 1 544 9 discriminator 2 view .LVU828
	cmp	r6, r2	@ w, prephitmp_120
	blt	.L193		@,
.LVL232:
.L186:
	.loc 1 567 9 is_stmt 1 discriminator 2 view .LVU829
@ armwave.c:567:         set_offset += (g_armwave_state.waves * g_armwave_state.wave_stride);
	.loc 1 567 46 is_stmt 0 discriminator 2 view .LVU830
	ldr	r3, [r5, #52]	@ g_armwave_state.wave_stride, g_armwave_state.wave_stride
@ armwave.c:541:     for(s = 0; s < sets; s++) {
	.loc 1 541 27 discriminator 2 view .LVU831
	add	r8, r8, #1	@ s, s,
.LVL233:
@ armwave.c:541:     for(s = 0; s < sets; s++) {
	.loc 1 541 5 discriminator 2 view .LVU832
	cmp	r9, r8	@ sets, s
@ armwave.c:567:         set_offset += (g_armwave_state.waves * g_armwave_state.wave_stride);
	.loc 1 567 20 discriminator 2 view .LVU833
	mla	r7, r3, r2, r7	@ set_offset, g_armwave_state.wave_stride, prephitmp_120, set_offset
.LVL234:
@ armwave.c:541:     for(s = 0; s < sets; s++) {
	.loc 1 541 5 discriminator 2 view .LVU834
	bne	.L185		@,
.LVL235:
.L182:
@ armwave.c:569: }
	.loc 1 569 1 view .LVU835
	add	sp, sp, #8	@,,
	.cfi_remember_state
	.cfi_def_cfa_offset 80
	@ sp needed	@
...
.LBB70:
.LBB67:
	.loc 1 489 9 is_stmt 1 view .LVU837
	mul	r1, r4, r9	@, _85, sets
	mov	r2, r9	@, sets
	ldr	r0, .L213+36	@,
	bl	printf		@
.LVL238:
	.loc 1 491 9 view .LVU838
	b	.L184		@
.L214:
	.align	2
.L213:
...
.LFB77:
	...
	@ args = 0, pretend = 0, frame = 0
	@ frame_needed = 0, uses_anonymous_args = 0
	.loc 1 620 5 view .LVU840
@ armwave.c:619: {
	.loc 1 619 1 is_stmt 0 view .LVU841
	push	{r4, lr}	@
	.cfi_def_cfa_offset 8
	.cfi_offset 4, -8
	.cfi_offset 14, -4
@ armwave.c:620:     free(g_armwave_state.out_pixbuf);
	.loc 1 620 25 view .LVU842
	ldr	r4, .L217	@ tmp114,
@ armwave.c:620:     free(g_armwave_state.out_pixbuf);
	.loc 1 620 5 view .LVU843
	ldr	r0, [r4, #104]	@, g_armwave_state.out_pixbuf
	bl	free		@
.LVL239:
	.loc 1 621 5 is_stmt 1 view .LVU844
	ldr	r0, [r4, #4]	@, g_armwave_state.ch1_buffer
	bl	free		@
.LVL240:
...
.LFE77:
	...
	.align	2
	.set	.LANCHOR0,. + 0
	.type	__PRETTY_FUNCTION__.17108, %object
	.size	__PRETTY_FUNCTION__.17108, 27
__PRETTY_FUNCTION__.17108:
	.ascii	"armwave_fill_pixbuf_scaled\000"
	.space	1
	.type	__PRETTY_FUNCTION__.17130, %object
	.size	__PRETTY_FUNCTION__.17130, 21
__PRETTY_FUNCTION__.17130:
	.ascii	"armwave_setup_render\000"
	.space	3
	.type	__PRETTY_FUNCTION__.17137, %object
	.size	__PRETTY_FUNCTION__.17137, 25
__PRETTY_FUNCTION__.17137:
	.ascii	"armwave_set_wave_pointer\000"
	.space	3
	.type	__PRETTY_FUNCTION__.17144, %object
	.size	__PRETTY_FUNCTION__.17144, 29
__PRETTY_FUNCTION__.17144:
...
.Ldebug_info0:
	...
	.uleb128 0x5
	.byte	0x3
	.4byte	__PRETTY_FUNCTION__.17144
	.uleb128 0x31
	.4byte	.LVL74
	.4byte	0x362e
	.uleb128 0x30
	...
	.uleb128 0x5
	.byte	0x3
	.4byte	__PRETTY_FUNCTION__.17108
	.byte	0
	.uleb128 0xc
	.4byte	0x10a
	.4byte	0x31fc
...
.LASF164:
	.ascii	"visitproc\000"
.LASF625:
	.ascii	"_render_nonaa_to_buffer_1ch_slice_core\000"
.LASF355:
