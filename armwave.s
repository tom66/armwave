...
@ armwave.c:386: {
	...
	sub	sp, sp, #12	@,,
	.cfi_def_cfa_offset 48
@ armwave.c:388:     uint32_t xx_rem = g_armwave_state.target_width, ypos = 0;
	.loc 1 388 14 view .LVU624
	ldr	r4, .L181	@ tmp400,
@ armwave.c:390:     memset(g_armwave_state.ch1_buffer, 0, g_armwave_state.ch_buff_size);
	.loc 1 390 5 view .LVU625
	mov	r1, #0	@,
@ armwave.c:388:     uint32_t xx_rem = g_armwave_state.target_width, ypos = 0;
	.loc 1 388 14 view .LVU626
	ldr	r3, [r4, #72]	@ xx_rem, g_armwave_state.target_width
@ armwave.c:390:     memset(g_armwave_state.ch1_buffer, 0, g_armwave_state.ch_buff_size);
	.loc 1 390 5 view .LVU627
	ldr	r2, [r4, #64]	@, g_armwave_state.ch_buff_size
	ldr	r0, [r4, #4]	@, g_armwave_state.ch1_buffer
@ armwave.c:388:     uint32_t xx_rem = g_armwave_state.target_width, ypos = 0;
	.loc 1 388 14 view .LVU628
	str	r3, [sp, #4]	@ xx_rem, %sfp
.LVL169:
	.loc 1 390 5 is_stmt 1 view .LVU629
	bl	memset		@
.LVL170:
	.loc 1 392 5 view .LVU630
@ armwave.c:392:     for(yy = 0; yy < (g_armwave_state.target_width / g_armwave_state.slice_height); yy++) {
	.loc 1 392 69 is_stmt 0 view .LVU631
	ldr	r6, [r4, #52]	@ _124, g_armwave_state.slice_height
@ armwave.c:392:     for(yy = 0; yy < (g_armwave_state.target_width / g_armwave_state.slice_height); yy++) {
	.loc 1 392 5 view .LVU632
	ldr	r3, [r4, #72]	@ g_armwave_state.target_width, g_armwave_state.target_width
	cmp	r3, r6	@ g_armwave_state.target_width, _124
	bcc	.L153		@,
@ armwave.c:388:     uint32_t xx_rem = g_armwave_state.target_width, ypos = 0;
	.loc 1 388 53 view .LVU633
	mov	r3, #0	@ ypos,
@ armwave.c:392:     for(yy = 0; yy < (g_armwave_state.target_width / g_armwave_state.slice_height); yy++) {
	.loc 1 392 12 view .LVU634
	mov	r5, r3	@ yy, ypos
@ armwave.c:388:     uint32_t xx_rem = g_armwave_state.target_width, ypos = 0;
	.loc 1 388 53 view .LVU635
	str	r3, [sp]	@ ypos, %sfp
.LVL171:
.L158:
	.loc 1 393 9 is_stmt 1 discriminator 3 view .LVU636
	...
	bl	printf		@
.LVL172:
	.loc 1 395 9 discriminator 3 view .LVU637
@ armwave.c:395:         render_nonaa_to_buffer_1ch_slice(yy * g_armwave_state.slice_height, g_armwave_state.slice_record_height);
	.loc 1 395 62 is_stmt 0 discriminator 3 view .LVU638
	ldr	r6, [r4, #52]	@ _124, g_armwave_state.slice_height
.LBB29:
.LBB30:
@ armwave.c:81:     write_buffer_base = g_armwave_state.ch1_buffer + (slice_y * g_armwave_state.bitdepth_height);
	.loc 1 81 63 discriminator 3 view .LVU639
	ldr	lr, [r4, #48]	@ g_armwave_state.bitdepth_height, g_armwave_state.bitdepth_height
@ armwave.c:84:     for(w = 0; w < g_armwave_state.waves; w++) {
	.loc 1 84 35 discriminator 3 view .LVU640
	ldr	r10, [r4, #40]	@ prephitmp_329, g_armwave_state.waves
.LBE30:
.LBE29:
@ armwave.c:395:         render_nonaa_to_buffer_1ch_slice(yy * g_armwave_state.slice_height, g_armwave_state.slice_record_height);
	.loc 1 395 9 discriminator 3 view .LVU641
...
.LBE33:
@ armwave.c:395:         render_nonaa_to_buffer_1ch_slice(yy * g_armwave_state.slice_height, g_armwave_state.slice_record_height);
	.loc 1 395 9 discriminator 3 view .LVU643
	ldr	r9, [r4, #56]	@ _8, g_armwave_state.slice_record_height
.LVL173:
.LBB34:
.LBI29:
	.loc 1 72 6 is_stmt 1 discriminator 3 view .LVU644
.LBB32:
	.loc 1 74 5 discriminator 3 view .LVU645
	...
	.loc 1 81 5 discriminator 3 view .LVU650
@ armwave.c:81:     write_buffer_base = g_armwave_state.ch1_buffer + (slice_y * g_armwave_state.bitdepth_height);
	.loc 1 81 63 is_stmt 0 discriminator 3 view .LVU651
	mul	lr, lr, r8	@ _29, g_armwave_state.bitdepth_height, _7
@ armwave.c:81:     write_buffer_base = g_armwave_state.ch1_buffer + (slice_y * g_armwave_state.bitdepth_height);
	.loc 1 81 40 discriminator 3 view .LVU652
	ldr	r3, [r4, #4]	@ _27, g_armwave_state.ch1_buffer
.LVL174:
	.loc 1 84 5 is_stmt 1 discriminator 3 view .LVU653
	.loc 1 84 5 is_stmt 0 discriminator 3 view .LVU654
	beq	.L154		@,
	sub	r8, r8, #4	@ _168, _7,
.LVL175:
@ armwave.c:84:     for(w = 0; w < g_armwave_state.waves; w++) {
	.loc 1 84 11 view .LVU655
	mov	r7, #0	@ w,
.LVL176:
.L157:
	.loc 1 86 9 is_stmt 1 view .LVU656
@ armwave.c:86:         wave_base = g_armwave_state.wave_buffer + slice_y + (w * g_armwave_state.wave_stride);
	.loc 1 86 64 is_stmt 0 view .LVU657
	ldr	r2, [r4, #36]	@ g_armwave_state.wave_stride, g_armwave_state.wave_stride
@ armwave.c:90:         for(yy = 0; yy < height; yy += 4) {
	.loc 1 90 9 view .LVU658
	cmp	r9, #0	@ _8,
@ armwave.c:86:         wave_base = g_armwave_state.wave_buffer + slice_y + (w * g_armwave_state.wave_stride);
	.loc 1 86 36 view .LVU659
	ldr	r0, [r4, #20]	@ _30, g_armwave_state.wave_buffer
@ armwave.c:86:         wave_base = g_armwave_state.wave_buffer + slice_y + (w * g_armwave_state.wave_stride);
	.loc 1 86 64 view .LVU660
	mul	r2, r2, r7	@ _33, g_armwave_state.wave_stride, w
.LVL177:
	.loc 1 90 9 is_stmt 1 view .LVU661
	.loc 1 90 9 is_stmt 0 view .LVU662
	beq	.L155		@,
	add	r2, r2, r8	@ tmp287, _33, _168
.LVL178:
	.loc 1 90 9 view .LVU663
	add	r0, r0, r2	@ ivtmp.117, _30, tmp287
.LVL179:
@ armwave.c:90:         for(yy = 0; yy < height; yy += 4) {
	.loc 1 90 16 view .LVU664
	mov	r2, #0	@ yy,
.LVL180:
.L156:
	.loc 1 91 13 is_stmt 1 view .LVU665
@ armwave.c:91:             word = *(uint32_t*)(wave_base + yy);
	.loc 1 91 18 is_stmt 0 view .LVU666
	ldr	r1, [r0, #4]!	@ word, MEM[base: _355, offset: 0B]
.LVL181:
	.loc 1 93 13 is_stmt 1 view .LVU667
	.loc 1 95 17 view .LVU668
	.loc 1 96 17 view .LVU669
	.loc 1 97 17 view .LVU670
@ armwave.c:96:                 write_buffer = write_buffer_base + ((yy + ys) * g_armwave_state.bitdepth_height);
	.loc 1 96 63 is_stmt 0 view .LVU671
...
.LVL182:
	.loc 1 98 17 is_stmt 1 view .LVU675
	.loc 1 95 17 view .LVU676
	.loc 1 96 17 view .LVU677
	.loc 1 97 17 view .LVU678
@ armwave.c:96:                 write_buffer = write_buffer_base + ((yy + ys) * g_armwave_state.bitdepth_height);
	.loc 1 96 63 is_stmt 0 view .LVU679
	ldr	ip, [r4, #48]	@ g_armwave_state.bitdepth_height, g_armwave_state.bitdepth_height
@ armwave.c:98:                 word >>= 8;
	.loc 1 98 22 view .LVU680
...
@ armwave.c:96:                 write_buffer = write_buffer_base + ((yy + ys) * g_armwave_state.bitdepth_height);
	.loc 1 96 63 view .LVU683
	add	r6, r2, #2	@ tmp314, yy,
@ armwave.c:97:                 *(write_buffer + scale_value) += 1;
	.loc 1 97 47 view .LVU684
	add	fp, fp, #1	@ tmp308, *_215,
	strb	fp, [r3, ip]	@ tmp308, *_215
.LVL184:
	.loc 1 98 17 is_stmt 1 view .LVU685
	.loc 1 95 17 view .LVU686
	.loc 1 96 17 view .LVU687
	.loc 1 97 17 view .LVU688
@ armwave.c:96:                 write_buffer = write_buffer_base + ((yy + ys) * g_armwave_state.bitdepth_height);
	.loc 1 96 63 is_stmt 0 view .LVU689
	ldr	fp, [r4, #48]	@ g_armwave_state.bitdepth_height, g_armwave_state.bitdepth_height
	add	ip, r2, #3	@ tmp323, yy,
@ armwave.c:90:         for(yy = 0; yy < height; yy += 4) {
	.loc 1 90 37 view .LVU690
	add	r2, r2, #4	@ yy, yy,
.LVL185:
@ armwave.c:97:                 *(write_buffer + scale_value) += 1;
	.loc 1 97 47 view .LVU691
	mla	r6, fp, r6, r10	@ tmp317, g_armwave_state.bitdepth_height, tmp314, tmp312
@ armwave.c:90:         for(yy = 0; yy < height; yy += 4) {
	.loc 1 90 9 view .LVU692
	cmp	r9, r2	@ _8, yy
@ armwave.c:97:                 *(write_buffer + scale_value) += 1;
	.loc 1 97 47 view .LVU693
	ldrb	r10, [r3, r6]	@ zero_extendqisi2	@ *_235, *_235
	add	r10, r10, #1	@ tmp320, *_235,
	strb	r10, [r3, r6]	@ tmp320, *_235
.LVL186:
	.loc 1 98 17 is_stmt 1 view .LVU694
	.loc 1 95 17 view .LVU695
	.loc 1 96 17 view .LVU696
	.loc 1 97 17 view .LVU697
@ armwave.c:96:                 write_buffer = write_buffer_base + ((yy + ys) * g_armwave_state.bitdepth_height);
	.loc 1 96 63 is_stmt 0 view .LVU698
	ldr	r6, [r4, #48]	@ g_armwave_state.bitdepth_height, g_armwave_state.bitdepth_height
@ armwave.c:97:                 *(write_buffer + scale_value) += 1;
	.loc 1 97 47 view .LVU699
	...
	.loc 1 98 17 is_stmt 1 view .LVU700
.LVL187:
@ armwave.c:90:         for(yy = 0; yy < height; yy += 4) {
	.loc 1 90 9 is_stmt 0 view .LVU701
	bhi	.L156		@,
	ldr	r10, [r4, #40]	@ prephitmp_329, g_armwave_state.waves
.LVL188:
.L155:
@ armwave.c:84:     for(w = 0; w < g_armwave_state.waves; w++) {
	.loc 1 84 44 view .LVU702
	add	r7, r7, #1	@ w, w,
.LVL189:
@ armwave.c:84:     for(w = 0; w < g_armwave_state.waves; w++) {
...
.LBE32:
.LBE34:
	.loc 1 396 9 is_stmt 1 discriminator 3 view .LVU705
@ armwave.c:392:     for(yy = 0; yy < (g_armwave_state.target_width / g_armwave_state.slice_height); yy++) {
	.loc 1 392 52 is_stmt 0 discriminator 3 view .LVU706
	mov	r1, r6	@, _124
	ldr	r0, [r4, #72]	@, g_armwave_state.target_width
	bl	__aeabi_uidiv		@
.LVL191:
@ armwave.c:396:         xx_rem -= g_armwave_state.slice_height;
	.loc 1 396 16 discriminator 3 view .LVU707
	ldr	r3, [sp, #4]	@ xx_rem, %sfp
@ armwave.c:392:     for(yy = 0; yy < (g_armwave_state.target_width / g_armwave_state.slice_height); yy++) {
	.loc 1 392 87 discriminator 3 view .LVU708
	add	r5, r5, #1	@ yy, yy,
.LVL192:
@ armwave.c:396:         xx_rem -= g_armwave_state.slice_height;
	.loc 1 396 16 discriminator 3 view .LVU709
	sub	r3, r3, r6	@ xx_rem, xx_rem, _124
	str	r3, [sp, #4]	@ xx_rem, %sfp
.LVL193:
	.loc 1 397 9 is_stmt 1 discriminator 3 view .LVU710
@ armwave.c:397:         ypos += g_armwave_state.slice_height;
	.loc 1 397 14 is_stmt 0 discriminator 3 view .LVU711
	ldr	r3, [sp]	@ ypos, %sfp
.LVL194:
	.loc 1 397 14 discriminator 3 view .LVU712
	add	r3, r3, r6	@ ypos, ypos, _124
.LVL195:
	.loc 1 397 14 discriminator 3 view .LVU713
	str	r3, [sp]	@ ypos, %sfp
.LVL196:
@ armwave.c:392:     for(yy = 0; yy < (g_armwave_state.target_width / g_armwave_state.slice_height); yy++) {
	.loc 1 392 5 discriminator 3 view .LVU714
	cmp	r0, r5	@, yy
	bhi	.L158		@,
.LVL197:
.L180:
...
.LBB36:
@ armwave.c:81:     write_buffer_base = g_armwave_state.ch1_buffer + (slice_y * g_armwave_state.bitdepth_height);
	.loc 1 81 63 view .LVU715
	ldr	r5, [r4, #48]	@ g_armwave_state.bitdepth_height, g_armwave_state.bitdepth_height
	mov	r2, r3	@ ypos, ypos
.LBE36:
.LBE35:
	.loc 1 400 5 is_stmt 1 view .LVU716
.LVL198:
.LBB38:
.LBI35:
	.loc 1 72 6 view .LVU717
.LBB37:
	.loc 1 74 5 view .LVU718
	.loc 1 75 5 view .LVU719
	.loc 1 76 5 view .LVU720
	.loc 1 77 5 view .LVU721
	.loc 1 78 5 view .LVU722
	.loc 1 81 5 view .LVU723
@ armwave.c:84:     for(w = 0; w < g_armwave_state.waves; w++) {
	.loc 1 84 5 is_stmt 0 view .LVU724
	cmp	r10, #0	@ prephitmp_329,
@ armwave.c:81:     write_buffer_base = g_armwave_state.ch1_buffer + (slice_y * g_armwave_state.bitdepth_height);
	.loc 1 81 40 view .LVU725
	ldr	r3, [r4, #4]	@ _62, g_armwave_state.ch1_buffer
@ armwave.c:81:     write_buffer_base = g_armwave_state.ch1_buffer + (slice_y * g_armwave_state.bitdepth_height);
	.loc 1 81 63 view .LVU726
	mul	r5, r5, r2	@ _64, g_armwave_state.bitdepth_height, ypos
.LVL199:
	.loc 1 84 5 is_stmt 1 view .LVU727
	.loc 1 84 5 is_stmt 0 view .LVU728
	beq	.L152		@,
...
@ armwave.c:84:     for(w = 0; w < g_armwave_state.waves; w++) {
	.loc 1 84 11 view .LVU729
	mov	r6, #0	@ w,
.LVL200:
.L163:
	.loc 1 86 9 is_stmt 1 view .LVU730
	.loc 1 90 9 view .LVU731
@ armwave.c:86:         wave_base = g_armwave_state.wave_buffer + slice_y + (w * g_armwave_state.wave_stride);
	.loc 1 86 64 is_stmt 0 view .LVU732
...
@ armwave.c:90:         for(yy = 0; yy < height; yy += 4) {
	.loc 1 90 16 view .LVU733
	mov	r2, #0	@ yy,
	mla	r1, r1, r6, r7	@ tmp349, g_armwave_state.wave_stride, w, tmp399
	add	lr, lr, r1	@ ivtmp.106, g_armwave_state.wave_buffer, tmp349
.LVL201:
.L162:
	.loc 1 91 13 is_stmt 1 view .LVU734
@ armwave.c:91:             word = *(uint32_t*)(wave_base + yy);
	.loc 1 91 18 is_stmt 0 view .LVU735
	ldr	r1, [lr, #4]!	@ word, MEM[base: _381, offset: 0B]
.LVL202:
	.loc 1 93 13 is_stmt 1 view .LVU736
	.loc 1 95 17 view .LVU737
	.loc 1 96 17 view .LVU738
	.loc 1 97 17 view .LVU739
@ armwave.c:96:                 write_buffer = write_buffer_base + ((yy + ys) * g_armwave_state.bitdepth_height);
	.loc 1 96 63 is_stmt 0 view .LVU740
	ldr	r9, [r4, #48]	@ g_armwave_state.bitdepth_height, g_armwave_state.bitdepth_height
	add	r0, r2, #1	@ tmp362, yy,
@ armwave.c:97:                 *(write_buffer + scale_value) += 1;
	.loc 1 97 47 view .LVU741
	uxtab	ip, r5, r1	@ tmp355, _64, word
	mla	r9, r9, r2, ip	@ tmp356, g_armwave_state.bitdepth_height, yy, tmp355
@ armwave.c:98:                 word >>= 8;
	.loc 1 98 22 view .LVU742
...
@ armwave.c:96:                 write_buffer = write_buffer_base + ((yy + ys) * g_armwave_state.bitdepth_height);
	.loc 1 96 63 view .LVU750
	add	r0, r2, #2	@ tmp377, yy,
	add	r9, r2, #3	@ tmp386, yy,
@ armwave.c:97:                 *(write_buffer + scale_value) += 1;
	.loc 1 97 47 view .LVU751
	ldrb	fp, [r3, ip]	@ zero_extendqisi2	@ *_135, *_135
	add	r1, r5, r1, lsr #24	@ tmp390, _64, word,
.LVL204:
@ armwave.c:90:         for(yy = 0; yy < height; yy += 4) {
	.loc 1 90 37 view .LVU752
	add	r2, r2, #4	@ yy, yy,
.LVL205:
@ armwave.c:97:                 *(write_buffer + scale_value) += 1;
	.loc 1 97 47 view .LVU753
	add	fp, fp, #1	@ tmp371, *_135,
	strb	fp, [r3, ip]	@ tmp371, *_135
.LVL206:
	.loc 1 98 17 is_stmt 1 view .LVU754
	.loc 1 95 17 view .LVU755
	.loc 1 96 17 view .LVU756
	.loc 1 97 17 view .LVU757
@ armwave.c:96:                 write_buffer = write_buffer_base + ((yy + ys) * g_armwave_state.bitdepth_height);
	.loc 1 96 63 is_stmt 0 view .LVU758
	ldr	ip, [r4, #48]	@ g_armwave_state.bitdepth_height, g_armwave_state.bitdepth_height
@ armwave.c:90:         for(yy = 0; yy < height; yy += 4) {
	.loc 1 90 9 view .LVU759
	cmp	r8, r2	@ xx_rem, yy
@ armwave.c:97:                 *(write_buffer + scale_value) += 1;
	.loc 1 97 47 view .LVU760
	...
	.loc 1 98 17 is_stmt 1 view .LVU761
.LVL207:
	.loc 1 95 17 view .LVU762
	.loc 1 96 17 view .LVU763
	.loc 1 97 17 view .LVU764
@ armwave.c:96:                 write_buffer = write_buffer_base + ((yy + ys) * g_armwave_state.bitdepth_height);
	.loc 1 96 63 is_stmt 0 view .LVU765
	ldr	r0, [r4, #48]	@ g_armwave_state.bitdepth_height, g_armwave_state.bitdepth_height
@ armwave.c:97:                 *(write_buffer + scale_value) += 1;
	.loc 1 97 47 view .LVU766
	...
	.loc 1 98 17 is_stmt 1 view .LVU767
.LVL208:
@ armwave.c:90:         for(yy = 0; yy < height; yy += 4) {
	.loc 1 90 9 is_stmt 0 view .LVU768
	bhi	.L162		@,
@ armwave.c:84:     for(w = 0; w < g_armwave_state.waves; w++) {
	.loc 1 84 5 view .LVU769
	ldr	r2, [r4, #40]	@ g_armwave_state.waves, g_armwave_state.waves
.LVL209:
@ armwave.c:84:     for(w = 0; w < g_armwave_state.waves; w++) {
	.loc 1 84 44 view .LVU770
	add	r6, r6, #1	@ w, w,
.LVL210:
@ armwave.c:84:     for(w = 0; w < g_armwave_state.waves; w++) {
	.loc 1 84 5 view .LVU771
	cmp	r6, r2	@ w, g_armwave_state.waves
	bcc	.L163		@,
.LVL211:
.L152:
	.loc 1 84 5 view .LVU772
.LBE37:
.LBE38:
@ armwave.c:401: }
	.loc 1 401 1 view .LVU773
	add	sp, sp, #12	@,,
	.cfi_remember_state
	.cfi_def_cfa_offset 36
	@ sp needed	@
...
.LFB71:
	...
	@ args = 0, pretend = 0, frame = 8
	@ frame_needed = 0, uses_anonymous_args = 0
	.loc 1 408 5 view .LVU776
	ldr	r2, .L207	@ tmp203,
@ armwave.c:407: {
	.loc 1 407 1 is_stmt 0 view .LVU777
	push	{r4, r5, r6, r7, r8, r9, r10, fp, lr}	@
	.cfi_def_cfa_offset 36
	.cfi_offset 4, -36
	.cfi_offset 5, -32
	...
	sub	sp, sp, #12	@,,
	.cfi_def_cfa_offset 48
@ armwave.c:408:     armwave_fill_pixbuf_scaled(g_armwave_state.out_pixbuf);
	.loc 1 408 5 view .LVU778
	ldr	r8, [r2, #88]	@ _1, g_armwave_state.out_pixbuf
.LVL213:
.LBB41:
.LBI41:
	.loc 1 161 6 is_stmt 1 view .LVU779
.LBB42:
	.loc 1 163 5 view .LVU780
	.loc 1 164 5 view .LVU781
	.loc 1 165 5 view .LVU782
	.loc 1 166 5 view .LVU783
@ armwave.c:166:     uint32_t *base_32ptr = (uint32_t*)g_armwave_state.ch1_buffer;
	.loc 1 166 15 is_stmt 0 view .LVU784
	ldr	r9, [r2, #4]	@ base_32ptr, g_armwave_state.ch1_buffer
.LVL214:
	.loc 1 167 5 is_stmt 1 view .LVU785
	.loc 1 168 5 view .LVU786
	.loc 1 170 5 view .LVU787
	cmp	r8, #0	@ _1,
	beq	.L205		@,
	.loc 1 172 5 view .LVU788
@ armwave.c:172:     npix = g_armwave_state.target_width * 256; 
	.loc 1 172 41 is_stmt 0 view .LVU789
	ldr	r5, [r2, #72]	@ g_armwave_state.target_width, g_armwave_state.target_width
	lsl	r5, r5, #8	@ npix, g_armwave_state.target_width,
.LVL215:
	.loc 1 173 5 is_stmt 1 view .LVU790
	.loc 1 175 5 view .LVU791
	.loc 1 175 5 is_stmt 0 view .LVU792
	cmp	r5, #0	@ npix,
	ble	.L183		@,
@ armwave.c:188:                     gg = (g_armwave_state.ch1_color.g * value) >> 8;
	.loc 1 188 52 view .LVU793
	ldrsh	r3, [r2, #94]	@ _24, g_armwave_state.ch1_color.g
@ armwave.c:187:                     rr = (g_armwave_state.ch1_color.r * value) >> 8;
	.loc 1 187 52 view .LVU794
	ldrsh	fp, [r2, #92]	@ _18, g_armwave_state.ch1_color.r
@ armwave.c:175:     for(n = 0; n < npix; n += 4) {
	.loc 1 175 11 view .LVU795
	mov	r1, #0	@ n,
@ armwave.c:188:                     gg = (g_armwave_state.ch1_color.g * value) >> 8;
	.loc 1 188 52 view .LVU796
	str	r3, [sp]	@ _24, %sfp
@ armwave.c:189:                     bb = (g_armwave_state.ch1_color.b * value) >> 8;
	.loc 1 189 52 view .LVU797
	ldrsh	r3, [r2, #96]	@ _28, g_armwave_state.ch1_color.b
	str	r3, [sp, #4]	@ _28, %sfp
.LVL216:
.L190:
	.loc 1 179 9 is_stmt 1 view .LVU798
@ armwave.c:179:         wave_word = *base_32ptr++;
	.loc 1 179 19 is_stmt 0 view .LVU799
	ldr	r0, [r9], #4	@ wave_word, MEM[base: base_32ptr_9, offset: 4294967292B]
.LVL217:
	.loc 1 181 9 is_stmt 1 view .LVU800
@ armwave.c:181:         if(COND_UNLIKELY(wave_word != 0)) {
	.loc 1 181 11 is_stmt 0 view .LVU801
	cmp	r0, #0	@ wave_word,
	bne	.L202		@,
	add	r1, r1, #4	@ n, n,
.L186:
.LVL218:
@ armwave.c:175:     for(n = 0; n < npix; n += 4) {
	.loc 1 175 5 view .LVU802
	cmp	r5, r1	@ npix, n
	bgt	.L190		@,
.LVL219:
.L183:
	.loc 1 175 5 view .LVU803
.LBE42:
.LBE41:
@ armwave.c:409: }
	.loc 1 409 1 view .LVU804
	add	sp, sp, #12	@,,
	.cfi_remember_state
	.cfi_def_cfa_offset 36
	@ sp needed	@
...
.LBB43:
@ armwave.c:186:                 if(value != 0) {
	.loc 1 186 19 view .LVU805
	ands	lr, r0, #255	@ _20, wave_word,
@ armwave.c:181:         if(COND_UNLIKELY(wave_word != 0)) {
	.loc 1 181 11 view .LVU806
	mov	r6, r1	@ ivtmp.134, n
.LVL221:
	.loc 1 183 17 is_stmt 1 view .LVU807
	.loc 1 184 17 view .LVU808
@ armwave.c:184:                 wave_word >>= 8;
	.loc 1 184 27 is_stmt 0 view .LVU809
	lsr	r0, r0, #8	@ wave_word, wave_word,
.LVL222:
	.loc 1 186 17 is_stmt 1 view .LVU810
	add	r1, r1, #4	@ n, ivtmp.134,
@ armwave.c:186:                 if(value != 0) {
	.loc 1 186 19 is_stmt 0 view .LVU811
	bne	.L206		@,
.L187:
	.loc 1 186 19 view .LVU812
	add	r6, r6, #1	@ ivtmp.134, ivtmp.134,
@ armwave.c:182:             for(w = 0; w < 4; w++) {
	.loc 1 182 13 view .LVU813
	cmp	r1, r6	@ n, ivtmp.134
	beq	.L186		@,
	.loc 1 183 17 is_stmt 1 view .LVU814
.LVL223:
	.loc 1 184 17 view .LVU815
@ armwave.c:186:                 if(value != 0) {
	.loc 1 186 19 is_stmt 0 view .LVU816
	ands	lr, r0, #255	@ _20, wave_word,
@ armwave.c:184:                 wave_word >>= 8;
	.loc 1 184 27 view .LVU817
	lsr	r0, r0, #8	@ wave_word, wave_word,
.LVL224:
	.loc 1 186 17 is_stmt 1 view .LVU818
@ armwave.c:186:                 if(value != 0) {
	.loc 1 186 19 is_stmt 0 view .LVU819
	beq	.L187		@,
.L206:
	.loc 1 187 21 is_stmt 1 view .LVU820
.LVL225:
	.loc 1 188 21 view .LVU821
	.loc 1 189 21 view .LVU822
	.loc 1 191 21 view .LVU823
	.loc 1 192 21 view .LVU824
	.loc 1 193 21 view .LVU825
	.loc 1 196 21 view .LVU826
@ armwave.c:189:                     bb = (g_armwave_state.ch1_color.b * value) >> 8;
	.loc 1 189 55 is_stmt 0 view .LVU827
	ldr	r3, [sp, #4]	@ _28, %sfp
@ armwave.c:200:                     yy = (nsub & 0xff) * g_armwave_state.vscale;
	.loc 1 200 57 view .LVU828
	ldr	r10, [r2, #32]	@ _50, g_armwave_state.vscale
@ armwave.c:200:                     yy = (nsub & 0xff) * g_armwave_state.vscale;
	.loc 1 200 32 view .LVU829
	uxtb	r7, r6	@ ivtmp.134, ivtmp.134
@ armwave.c:189:                     bb = (g_armwave_state.ch1_color.b * value) >> 8;
	.loc 1 189 55 view .LVU830
	mul	ip, r3, lr	@ tmp179, _28, _20
@ armwave.c:188:                     gg = (g_armwave_state.ch1_color.g * value) >> 8;
	.loc 1 188 55 view .LVU831
	ldr	r3, [sp]	@ _24, %sfp
@ armwave.c:200:                     yy = (nsub & 0xff) * g_armwave_state.vscale;
	.loc 1 200 24 view .LVU832
	mul	r7, r10, r7	@ yy, _50, ivtmp.134
@ armwave.c:188:                     gg = (g_armwave_state.ch1_color.g * value) >> 8;
	.loc 1 188 55 view .LVU833
	mul	r4, r3, lr	@ tmp183, _24, _20
@ armwave.c:189:                     bb = (g_armwave_state.ch1_color.b * value) >> 8;
	.loc 1 189 24 view .LVU834
	asr	ip, ip, #8	@ bb, tmp179,
.LVL226:
@ armwave.c:187:                     rr = (g_armwave_state.ch1_color.r * value) >> 8;
	.loc 1 187 55 view .LVU835
	mul	lr, lr, fp	@ tmp189, _20, _18
.LVL227:
@ armwave.c:188:                     gg = (g_armwave_state.ch1_color.g * value) >> 8;
	.loc 1 188 24 view .LVU836
	asr	r4, r4, #8	@ gg, tmp183,
.LVL228:
@ armwave.c:193:                     b = MIN(bb, 255);
	.loc 1 193 25 view .LVU837
	cmp	ip, #255	@ bb,
	movge	ip, #255	@ bb,
.LVL229:
@ armwave.c:192:                     g = MIN(gg, 255);
	.loc 1 192 25 view .LVU838
	cmp	r4, #255	@ gg,
	movge	r4, #255	@ gg,
.LVL230:
@ armwave.c:187:                     rr = (g_armwave_state.ch1_color.r * value) >> 8;
	.loc 1 187 24 view .LVU839
	asr	lr, lr, #8	@ rr, tmp189,
.LVL231:
@ armwave.c:191:                     r = MIN(rr, 255);
	.loc 1 191 25 view .LVU840
	cmp	lr, #255	@ rr,
@ armwave.c:196:                     word = 0xff000000 | (b << 16) | (g << 8) | r;
	.loc 1 196 56 view .LVU841
	lsl	r4, r4, #8	@ tmp184, gg,
@ armwave.c:191:                     r = MIN(rr, 255);
	.loc 1 191 25 view .LVU842
	movge	lr, #255	@ rr,
.LVL232:
@ armwave.c:196:                     word = 0xff000000 | (b << 16) | (g << 8) | r;
	.loc 1 196 44 view .LVU843
	lsl	r3, ip, #16	@ tmp180, bb,
	and	r3, r3, #16711680	@ tmp181, tmp180,
@ armwave.c:196:                     word = 0xff000000 | (b << 16) | (g << 8) | r;
	.loc 1 196 56 view .LVU844
	uxth	r4, r4	@ tmp185, tmp184
@ armwave.c:196:                     word = 0xff000000 | (b << 16) | (g << 8) | r;
	.loc 1 196 51 view .LVU845
	orr	r3, r3, r4	@ tmp187, tmp181, tmp185
@ armwave.c:196:                     word = 0xff000000 | (b << 16) | (g << 8) | r;
	.loc 1 196 62 view .LVU846
	uxtb	lr, lr	@ rr, rr
...
@ armwave.c:203:                     for(row = 0; row < g_armwave_state.vscale; row++) {
	...
	cmp	r10, #0	@ _50,
@ armwave.c:196:                     word = 0xff000000 | (b << 16) | (g << 8) | r;
	.loc 1 196 26 view .LVU848
	orr	r3, r3, #-16777216	@ word, tmp191,
.LVL233:
	.loc 1 199 21 is_stmt 1 view .LVU849
	.loc 1 200 21 view .LVU850
	.loc 1 201 21 view .LVU851
@ armwave.c:201:                     xx = (nsub >> 8);
	.loc 1 201 32 is_stmt 0 view .LVU852
	asr	r10, r6, #8	@ xx, ivtmp.134,
.LVL234:
	.loc 1 203 21 is_stmt 1 view .LVU853
	.loc 1 203 21 is_stmt 0 view .LVU854
	beq	.L187		@,
@ armwave.c:203:                     for(row = 0; row < g_armwave_state.vscale; row++) {
	.loc 1 203 29 view .LVU855
	mov	ip, #0	@ row,
@ armwave.c:203:                     for(row = 0; row < g_armwave_state.vscale; row++) {
	.loc 1 203 38 view .LVU856
	mov	lr, ip	@ _54, row
.LVL235:
.L188:
	.loc 1 204 25 is_stmt 1 view .LVU857
	.loc 1 205 25 view .LVU858
@ armwave.c:204:                         offset = (xx + ((yy + row) * g_armwave_state.target_width)); 
	.loc 1 204 52 is_stmt 0 view .LVU859
	ldr	r4, [r2, #72]	@ g_armwave_state.target_width, g_armwave_state.target_width
@ armwave.c:204:                         offset = (xx + ((yy + row) * g_armwave_state.target_width)); 
	.loc 1 204 45 view .LVU860
	add	lr, r7, lr	@ tmp194, yy, _54
.LVL236:
@ armwave.c:203:                     for(row = 0; row < g_armwave_state.vscale; row++) {
	.loc 1 203 67 view .LVU861
	add	ip, ip, #1	@ tmp199, row,
.LVL237:
@ armwave.c:205:                         *(out_buffer_base + offset) = word;
	.loc 1 205 43 view .LVU862
	mla	r4, r4, lr, r10	@ tmp198, g_armwave_state.target_width, tmp194, xx
.LVL238:
@ armwave.c:203:                     for(row = 0; row < g_armwave_state.vscale; row++) {
	.loc 1 203 67 view .LVU863
	uxtb	ip, ip	@ row, tmp199
.LVL239:
@ armwave.c:203:                     for(row = 0; row < g_armwave_state.vscale; row++) {
	.loc 1 203 38 view .LVU864
	mov	lr, ip	@ _54, row
@ armwave.c:205:                         *(out_buffer_base + offset) = word;
	.loc 1 205 53 view .LVU865
	str	r3, [r8, r4, lsl #2]	@ word, *_60
@ armwave.c:203:                     for(row = 0; row < g_armwave_state.vscale; row++) {
	.loc 1 203 21 view .LVU866
	ldr	r4, [r2, #32]	@ g_armwave_state.vscale, g_armwave_state.vscale
.LVL240:
	.loc 1 203 21 view .LVU867
	cmp	ip, r4	@ row, g_armwave_state.vscale
	bcc	.L188		@,
	.loc 1 203 21 view .LVU868
	b	.L187		@
.LVL241:
.L205:
	.loc 1 170 5 is_stmt 1 view .LVU869
	ldr	r3, .L207+4	@,
	mov	r2, #170	@,
	ldr	r1, .L207+8	@,
	ldr	r0, .L207+12	@,
...
.LFB72:
	...
	@ frame_needed = 0, uses_anonymous_args = 0
	@ link register save eliminated.
	.loc 1 416 5 view .LVU871
	ldr	r3, .L210	@ tmp112,
	mov	r1, r0	@, fn
	ldr	r0, [r3, #88]	@, g_armwave_state.out_pixbuf
.LVL244:
	.loc 1 416 5 is_stmt 0 view .LVU872
	b	armwave_dump_ppm_debug		@
.LVL245:
.L211:
	.loc 1 416 5 view .LVU873
	.align	2
.L210:
	.word	g_armwave_state
	.cfi_endproc
...
.LFB73:
	...
	@ args = 0, pretend = 0, frame = 8
	@ frame_needed = 0, uses_anonymous_args = 0
	.loc 1 428 5 view .LVU875
@ armwave.c:428:     void *out_pixbuf = ((uint32_t ***)buf)[2][10];
	.loc 1 428 11 is_stmt 0 view .LVU876
	ldr	r3, [r0, #8]	@ MEM[(uint32_t * * *)buf_2(D) + 8B], MEM[(uint32_t * * *)buf_2(D) + 8B]
@ armwave.c:423: {
	.loc 1 423 1 view .LVU877
	push	{r4, r5, r6, r7, r8, r9, r10, fp, lr}	@
	.cfi_def_cfa_offset 36
	.cfi_offset 4, -36
	.cfi_offset 5, -32
...
.LBB48:
@ armwave.c:166:     uint32_t *base_32ptr = (uint32_t*)g_armwave_state.ch1_buffer;
	.loc 1 166 15 view .LVU878
	ldr	r2, .L236	@ tmp206,
.LBE48:
.LBE47:
@ armwave.c:428:     void *out_pixbuf = ((uint32_t ***)buf)[2][10];
	.loc 1 428 11 view .LVU879
	ldr	r8, [r3, #40]	@ out_pixbuf, MEM[(uint32_t * *)_1 + 40B]
.LVL247:
	.loc 1 431 5 is_stmt 1 view .LVU880
.LBB51:
.LBI47:
	.loc 1 161 6 view .LVU881
.LBB49:
	.loc 1 163 5 view .LVU882
	.loc 1 164 5 view .LVU883
	.loc 1 165 5 view .LVU884
	.loc 1 166 5 view .LVU885
@ armwave.c:170:     assert(out_buffer != NULL);
	.loc 1 170 5 is_stmt 0 view .LVU886
	cmp	r8, #0	@ out_pixbuf,
@ armwave.c:166:     uint32_t *base_32ptr = (uint32_t*)g_armwave_state.ch1_buffer;
	.loc 1 166 15 view .LVU887
	ldr	r9, [r2, #4]	@ base_32ptr, g_armwave_state.ch1_buffer
.LVL248:
	.loc 1 167 5 is_stmt 1 view .LVU888
	.loc 1 168 5 view .LVU889
	.loc 1 170 5 view .LVU890
	beq	.L234		@,
	.loc 1 172 5 view .LVU891
@ armwave.c:172:     npix = g_armwave_state.target_width * 256; 
	.loc 1 172 41 is_stmt 0 view .LVU892
	ldr	r5, [r2, #72]	@ g_armwave_state.target_width, g_armwave_state.target_width
	lsl	r5, r5, #8	@ npix, g_armwave_state.target_width,
.LVL249:
	.loc 1 173 5 is_stmt 1 view .LVU893
	.loc 1 175 5 view .LVU894
	.loc 1 175 5 is_stmt 0 view .LVU895
	cmp	r5, #0	@ npix,
	ble	.L212		@,
@ armwave.c:188:                     gg = (g_armwave_state.ch1_color.g * value) >> 8;
	.loc 1 188 52 view .LVU896
	ldrsh	r3, [r2, #94]	@ _26, g_armwave_state.ch1_color.g
@ armwave.c:187:                     rr = (g_armwave_state.ch1_color.r * value) >> 8;
	.loc 1 187 52 view .LVU897
	ldrsh	fp, [r2, #92]	@ _20, g_armwave_state.ch1_color.r
@ armwave.c:175:     for(n = 0; n < npix; n += 4) {
	.loc 1 175 11 view .LVU898
	mov	r1, #0	@ n,
@ armwave.c:188:                     gg = (g_armwave_state.ch1_color.g * value) >> 8;
	.loc 1 188 52 view .LVU899
	str	r3, [sp]	@ _26, %sfp
@ armwave.c:189:                     bb = (g_armwave_state.ch1_color.b * value) >> 8;
	.loc 1 189 52 view .LVU900
	ldrsh	r3, [r2, #96]	@ _30, g_armwave_state.ch1_color.b
	str	r3, [sp, #4]	@ _30, %sfp
.LVL250:
.L219:
	.loc 1 179 9 is_stmt 1 view .LVU901
@ armwave.c:179:         wave_word = *base_32ptr++;
	.loc 1 179 19 is_stmt 0 view .LVU902
	ldr	r0, [r9], #4	@ wave_word, MEM[base: base_32ptr_11, offset: 4294967292B]
.LVL251:
	.loc 1 181 9 is_stmt 1 view .LVU903
@ armwave.c:181:         if(COND_UNLIKELY(wave_word != 0)) {
	.loc 1 181 11 is_stmt 0 view .LVU904
	cmp	r0, #0	@ wave_word,
	bne	.L231		@,
	add	r1, r1, #4	@ n, n,
.L215:
.LVL252:
@ armwave.c:175:     for(n = 0; n < npix; n += 4) {
	.loc 1 175 5 view .LVU905
	cmp	r5, r1	@ npix, n
	bgt	.L219		@,
.LVL253:
.L212:
	.loc 1 175 5 view .LVU906
.LBE49:
.LBE51:
@ armwave.c:432: }
	.loc 1 432 1 view .LVU907
	add	sp, sp, #12	@,,
	.cfi_remember_state
	.cfi_def_cfa_offset 36
	@ sp needed	@
...
.LBB50:
@ armwave.c:186:                 if(value != 0) {
	.loc 1 186 19 view .LVU908
	ands	lr, r0, #255	@ _22, wave_word,
@ armwave.c:181:         if(COND_UNLIKELY(wave_word != 0)) {
	.loc 1 181 11 view .LVU909
	mov	r6, r1	@ ivtmp.150, n
.LVL255:
	.loc 1 183 17 is_stmt 1 view .LVU910
	.loc 1 184 17 view .LVU911
@ armwave.c:184:                 wave_word >>= 8;
	.loc 1 184 27 is_stmt 0 view .LVU912
	lsr	r0, r0, #8	@ wave_word, wave_word,
.LVL256:
	.loc 1 186 17 is_stmt 1 view .LVU913
	add	r1, r1, #4	@ n, ivtmp.150,
@ armwave.c:186:                 if(value != 0) {
	.loc 1 186 19 is_stmt 0 view .LVU914
	bne	.L235		@,
.L216:
	.loc 1 186 19 view .LVU915
	add	r6, r6, #1	@ ivtmp.150, ivtmp.150,
@ armwave.c:182:             for(w = 0; w < 4; w++) {
	.loc 1 182 13 view .LVU916
	cmp	r1, r6	@ n, ivtmp.150
	beq	.L215		@,
	.loc 1 183 17 is_stmt 1 view .LVU917
.LVL257:
	.loc 1 184 17 view .LVU918
@ armwave.c:186:                 if(value != 0) {
	.loc 1 186 19 is_stmt 0 view .LVU919
	ands	lr, r0, #255	@ _22, wave_word,
@ armwave.c:184:                 wave_word >>= 8;
	.loc 1 184 27 view .LVU920
	lsr	r0, r0, #8	@ wave_word, wave_word,
.LVL258:
	.loc 1 186 17 is_stmt 1 view .LVU921
@ armwave.c:186:                 if(value != 0) {
	.loc 1 186 19 is_stmt 0 view .LVU922
	beq	.L216		@,
.L235:
	.loc 1 187 21 is_stmt 1 view .LVU923
.LVL259:
	.loc 1 188 21 view .LVU924
	.loc 1 189 21 view .LVU925
	.loc 1 191 21 view .LVU926
	.loc 1 192 21 view .LVU927
	.loc 1 193 21 view .LVU928
	.loc 1 196 21 view .LVU929
@ armwave.c:189:                     bb = (g_armwave_state.ch1_color.b * value) >> 8;
	.loc 1 189 55 is_stmt 0 view .LVU930
	ldr	r3, [sp, #4]	@ _30, %sfp
@ armwave.c:200:                     yy = (nsub & 0xff) * g_armwave_state.vscale;
	.loc 1 200 57 view .LVU931
	ldr	r10, [r2, #32]	@ _52, g_armwave_state.vscale
@ armwave.c:200:                     yy = (nsub & 0xff) * g_armwave_state.vscale;
	.loc 1 200 32 view .LVU932
	uxtb	r7, r6	@ ivtmp.150, ivtmp.150
@ armwave.c:189:                     bb = (g_armwave_state.ch1_color.b * value) >> 8;
	.loc 1 189 55 view .LVU933
	mul	ip, r3, lr	@ tmp181, _30, _22
@ armwave.c:188:                     gg = (g_armwave_state.ch1_color.g * value) >> 8;
	.loc 1 188 55 view .LVU934
	ldr	r3, [sp]	@ _26, %sfp
@ armwave.c:200:                     yy = (nsub & 0xff) * g_armwave_state.vscale;
	.loc 1 200 24 view .LVU935
	mul	r7, r10, r7	@ yy, _52, ivtmp.150
@ armwave.c:188:                     gg = (g_armwave_state.ch1_color.g * value) >> 8;
...
.LVL260:
@ armwave.c:187:                     rr = (g_armwave_state.ch1_color.r * value) >> 8;
	.loc 1 187 55 view .LVU938
	mul	lr, lr, fp	@ tmp191, _22, _20
.LVL261:
@ armwave.c:188:                     gg = (g_armwave_state.ch1_color.g * value) >> 8;
	.loc 1 188 24 view .LVU939
	asr	r4, r4, #8	@ gg, tmp185,
.LVL262:
@ armwave.c:193:                     b = MIN(bb, 255);
	.loc 1 193 25 view .LVU940
	cmp	ip, #255	@ bb,
	movge	ip, #255	@ bb,
.LVL263:
@ armwave.c:192:                     g = MIN(gg, 255);
	.loc 1 192 25 view .LVU941
	cmp	r4, #255	@ gg,
	movge	r4, #255	@ gg,
.LVL264:
@ armwave.c:187:                     rr = (g_armwave_state.ch1_color.r * value) >> 8;
	.loc 1 187 24 view .LVU942
...
@ armwave.c:191:                     r = MIN(rr, 255);
	...
	cmp	lr, #255	@ rr,
@ armwave.c:196:                     word = 0xff000000 | (b << 16) | (g << 8) | r;
	.loc 1 196 56 view .LVU944
	lsl	r4, r4, #8	@ tmp186, gg,
@ armwave.c:191:                     r = MIN(rr, 255);
	.loc 1 191 25 view .LVU945
	movge	lr, #255	@ rr,
.LVL266:
@ armwave.c:196:                     word = 0xff000000 | (b << 16) | (g << 8) | r;
	.loc 1 196 44 view .LVU946
	lsl	r3, ip, #16	@ tmp182, bb,
	and	r3, r3, #16711680	@ tmp183, tmp182,
@ armwave.c:196:                     word = 0xff000000 | (b << 16) | (g << 8) | r;
	.loc 1 196 56 view .LVU947
	uxth	r4, r4	@ tmp187, tmp186
@ armwave.c:196:                     word = 0xff000000 | (b << 16) | (g << 8) | r;
	.loc 1 196 51 view .LVU948
	orr	r3, r3, r4	@ tmp189, tmp183, tmp187
@ armwave.c:196:                     word = 0xff000000 | (b << 16) | (g << 8) | r;
	.loc 1 196 62 view .LVU949
	uxtb	lr, lr	@ rr, rr
	orr	r3, r3, lr	@ tmp193, tmp189, rr
@ armwave.c:203:                     for(row = 0; row < g_armwave_state.vscale; row++) {
	.loc 1 203 21 view .LVU950
	cmp	r10, #0	@ _52,
@ armwave.c:196:                     word = 0xff000000 | (b << 16) | (g << 8) | r;
	.loc 1 196 26 view .LVU951
	orr	r3, r3, #-16777216	@ word, tmp193,
.LVL267:
	.loc 1 199 21 is_stmt 1 view .LVU952
	.loc 1 200 21 view .LVU953
	.loc 1 201 21 view .LVU954
@ armwave.c:201:                     xx = (nsub >> 8);
	.loc 1 201 32 is_stmt 0 view .LVU955
	asr	r10, r6, #8	@ xx, ivtmp.150,
.LVL268:
	.loc 1 203 21 is_stmt 1 view .LVU956
	.loc 1 203 21 is_stmt 0 view .LVU957
	beq	.L216		@,
@ armwave.c:203:                     for(row = 0; row < g_armwave_state.vscale; row++) {
	.loc 1 203 29 view .LVU958
	mov	ip, #0	@ row,
@ armwave.c:203:                     for(row = 0; row < g_armwave_state.vscale; row++) {
	.loc 1 203 38 view .LVU959
	mov	lr, ip	@ _56, row
.LVL269:
.L217:
	.loc 1 204 25 is_stmt 1 view .LVU960
	.loc 1 205 25 view .LVU961
@ armwave.c:204:                         offset = (xx + ((yy + row) * g_armwave_state.target_width)); 
	.loc 1 204 52 is_stmt 0 view .LVU962
	ldr	r4, [r2, #72]	@ g_armwave_state.target_width, g_armwave_state.target_width
@ armwave.c:204:                         offset = (xx + ((yy + row) * g_armwave_state.target_width)); 
	.loc 1 204 45 view .LVU963
	add	lr, r7, lr	@ tmp196, yy, _56
.LVL270:
@ armwave.c:203:                     for(row = 0; row < g_armwave_state.vscale; row++) {
	.loc 1 203 67 view .LVU964
	add	ip, ip, #1	@ tmp201, row,
.LVL271:
@ armwave.c:205:                         *(out_buffer_base + offset) = word;
	.loc 1 205 43 view .LVU965
	mla	r4, r4, lr, r10	@ tmp200, g_armwave_state.target_width, tmp196, xx
.LVL272:
@ armwave.c:203:                     for(row = 0; row < g_armwave_state.vscale; row++) {
	.loc 1 203 67 view .LVU966
	uxtb	ip, ip	@ row, tmp201
.LVL273:
@ armwave.c:203:                     for(row = 0; row < g_armwave_state.vscale; row++) {
	.loc 1 203 38 view .LVU967
	mov	lr, ip	@ _56, row
@ armwave.c:205:                         *(out_buffer_base + offset) = word;
	.loc 1 205 53 view .LVU968
	str	r3, [r8, r4, lsl #2]	@ word, *_62
@ armwave.c:203:                     for(row = 0; row < g_armwave_state.vscale; row++) {
	.loc 1 203 21 view .LVU969
	ldr	r4, [r2, #32]	@ g_armwave_state.vscale, g_armwave_state.vscale
.LVL274:
	.loc 1 203 21 view .LVU970
	cmp	ip, r4	@ row, g_armwave_state.vscale
	bcc	.L217		@,
	.loc 1 203 21 view .LVU971
	b	.L216		@
.LVL275:
.L234:
	.loc 1 170 5 is_stmt 1 view .LVU972
	ldr	r3, .L236+4	@,
	mov	r2, #170	@,
	ldr	r1, .L236+8	@,
	ldr	r0, .L236+12	@,
.LVL276:
	.loc 1 170 5 is_stmt 0 view .LVU973
	bl	__assert_fail		@
.LVL277:
.L237:
	.align	2
...
.LFB74:
	...
	@ args = 0, pretend = 0, frame = 0
	@ frame_needed = 0, uses_anonymous_args = 0
	.loc 1 439 5 view .LVU975
@ armwave.c:438: {
	.loc 1 438 1 is_stmt 0 view .LVU976
	push	{r4, r5, r6, lr}	@
	.cfi_def_cfa_offset 16
	.cfi_offset 4, -16
	.cfi_offset 5, -12
	.cfi_offset 6, -8
	.cfi_offset 14, -4
@ armwave.c:439:     if(g_armwave_state.test_wave_buffer != NULL) {
	.loc 1 439 23 view .LVU977
	ldr	r4, .L245	@ tmp130,
	ldr	r0, [r4, #24]	@ _1, g_armwave_state.test_wave_buffer
@ armwave.c:439:     if(g_armwave_state.test_wave_buffer != NULL) {
	.loc 1 439 7 view .LVU978
	cmp	r0, #0	@ _1,
	beq	.L239		@,
	.loc 1 440 9 is_stmt 1 view .LVU979
	bl	free		@
.LVL278:
.L239:
	.loc 1 443 5 view .LVU980
	ldr	r2, [r4, #44]	@, g_armwave_state.waves_max
	ldr	r1, [r4, #60]	@, g_armwave_state.wave_length
	ldr	r0, .L245+4	@,
	bl	printf		@
.LVL279:
	.loc 1 445 5 view .LVU981
@ armwave.c:445:     g_armwave_state.test_wave_buffer = calloc(g_armwave_state.wave_length * g_armwave_state.waves_max, 1);
	.loc 1 445 40 is_stmt 0 view .LVU982
	...
	bl	calloc		@
.LVL280:
@ armwave.c:447:     if(g_armwave_state.test_wave_buffer == NULL) {
	.loc 1 447 7 view .LVU983
	cmp	r0, #0	@ tmp127,
@ armwave.c:445:     g_armwave_state.test_wave_buffer = calloc(g_armwave_state.wave_length * g_armwave_state.waves_max, 1);
	.loc 1 445 38 view .LVU984
	str	r0, [r4, #24]	@ tmp127, g_armwave_state.test_wave_buffer
	.loc 1 447 5 is_stmt 1 view .LVU985
@ armwave.c:447:     if(g_armwave_state.test_wave_buffer == NULL) {
	.loc 1 447 7 is_stmt 0 view .LVU986
	popne	{r4, r5, r6, pc}	@
	.loc 1 448 9 is_stmt 1 view .LVU987
	mov	r1, r5	@, _6
	ldr	r0, .L245+8	@,
@ armwave.c:451: }
	.loc 1 451 1 is_stmt 0 view .LVU988
	pop	{r4, r5, r6, lr}	@
	.cfi_restore 14
	.cfi_restore 6
	.cfi_restore 5
	.cfi_restore 4
	.cfi_def_cfa_offset 0
@ armwave.c:448:         printf("armwave_test_buffer_alloc: failed to allocate test wave buffer (%d bytes)\n", g_armwave_state.wave_length * g_armwave_state.waves_max);
	.loc 1 448 9 view .LVU989
	b	printf		@
.LVL281:
.L246:
	.align	2
...
.LFB75:
	...
	@ frame_needed = 0, uses_anonymous_args = 0
	.loc 1 458 5 view .LVU991
	.loc 1 459 5 view .LVU992
	.loc 1 461 5 view .LVU993
@ armwave.c:457: {
	.loc 1 457 1 is_stmt 0 view .LVU994
	push	{r4, lr}	@
	.cfi_def_cfa_offset 8
	.cfi_offset 4, -8
	.cfi_offset 14, -4
	...
	sub	sp, sp, #48	@,,
	.cfi_def_cfa_offset 56
@ armwave.c:461:     printf("armwave_fill_pixbuf_into_pybuffer: start\n");
	.loc 1 461 5 view .LVU995
	ldr	r0, .L252	@,
.LVL283:
	.loc 1 461 5 view .LVU996
	bl	puts		@
.LVL284:
	.loc 1 463 5 is_stmt 1 view .LVU997
@ armwave.c:463:     ret = PyObject_GetBuffer(buf_obj, &buffer, PyBUF_SIMPLE | PyBUF_WRITABLE);
	.loc 1 463 11 is_stmt 0 view .LVU998
	mov	r0, r4	@, buf_obj
	add	r1, sp, #4	@ tmp134,,
	mov	r2, #1	@,
	bl	PyObject_GetBuffer		@
.LVL285:
	.loc 1 465 5 is_stmt 1 view .LVU999
@ armwave.c:465:     if(ret != 0) {
	.loc 1 465 7 is_stmt 0 view .LVU1000
	cmp	r0, #0	@,
	bne	.L251		@,
	.loc 1 472 5 is_stmt 1 view .LVU1001
	ldr	r0, [sp, #4]	@, buffer.buf
.LVL286:
	.loc 1 472 5 is_stmt 0 view .LVU1002
	bl	armwave_fill_pixbuf_scaled		@
.LVL287:
	.loc 1 473 5 is_stmt 1 view .LVU1003
	ldr	r0, .L252+4	@,
	bl	puts		@
.LVL288:
	.loc 1 475 5 view .LVU1004
	add	r0, sp, #4	@ tmp135,,
	bl	PyBuffer_Release		@
.LVL289:
	.loc 1 476 5 view .LVU1005
	ldr	r0, .L252+8	@,
	bl	puts		@
.LVL290:
	.loc 1 478 5 view .LVU1006
.LBB53:
.LBI53:
	.file 2 "/usr/local/include/python3.8/object.h"
	.loc 2 456 20 view .LVU1007
.LBB54:
	.loc 2 458 21 view .LVU1008
	.loc 2 459 5 view .LVU1009
@ /usr/local/include/python3.8/object.h:459:     op->ob_refcnt++;
	.loc 2 459 18 is_stmt 0 view .LVU1010
	ldr	r3, .L252+12	@ tmp129,
.LBE54:
.LBE53:
@ armwave.c:478:     Py_RETURN_TRUE;
	.loc 1 478 5 view .LVU1011
	mov	r0, r3	@ <retval>, tmp129
.LBB56:
.LBB55:
@ /usr/local/include/python3.8/object.h:459:     op->ob_refcnt++;
	.loc 2 459 18 view .LVU1012
...
.L251:
	.cfi_restore_state
	.loc 1 466 9 is_stmt 1 view .LVU1014
	ldr	r0, .L252+16	@,
.LVL292:
	.loc 1 466 9 is_stmt 0 view .LVU1015
	bl	puts		@
.LVL293:
	.loc 1 467 9 is_stmt 1 view .LVU1016
.LBB57:
.LBI57:
...
@ /usr/local/include/python3.8/object.h:459:     op->ob_refcnt++;
	...
	ldr	r3, .L252+20	@ tmp121,
.LBE58:
.LBE57:
@ armwave.c:467:         Py_RETURN_FALSE;
	.loc 1 467 9 view .LVU1021
...
.LFB76:
	...
	@ args = 0, pretend = 0, frame = 8
	@ frame_needed = 0, uses_anonymous_args = 0
	.loc 1 489 5 view .LVU1026
	.loc 1 490 5 view .LVU1027
	.loc 1 492 5 view .LVU1028
.LBB63:
.LBI63:
	.loc 1 437 6 view .LVU1029
.LBB64:
	.loc 1 439 5 view .LVU1030
.LBE64:
.LBE63:
@ armwave.c:488: {
	.loc 1 488 1 is_stmt 0 view .LVU1031
	push	{r4, r5, r6, lr}	@
	.cfi_def_cfa_offset 16
	.cfi_offset 4, -16
	.cfi_offset 5, -12
...
.LBB65:
@ armwave.c:439:     if(g_armwave_state.test_wave_buffer != NULL) {
	.loc 1 439 23 view .LVU1032
	ldr	r5, .L285+32	@ tmp232,
.LBE65:
.LBE69:
@ armwave.c:488: {
	.loc 1 488 1 view .LVU1033
	vmov.f32	s25, s0	@ mod, mod
	vmov.f32	s22, s1	@ noise_fraction, noise_fraction
.LBB70:
.LBB66:
@ armwave.c:439:     if(g_armwave_state.test_wave_buffer != NULL) {
	.loc 1 439 23 view .LVU1034
	ldr	r0, [r5, #24]	@ _63, g_armwave_state.test_wave_buffer
.LBE66:
.LBE70:
@ armwave.c:488: {
	.loc 1 488 1 view .LVU1035
	sub	sp, sp, #8	@,,
	.cfi_def_cfa_offset 80
.LBB71:
.LBB67:
@ armwave.c:439:     if(g_armwave_state.test_wave_buffer != NULL) {
	.loc 1 439 7 view .LVU1036
	cmp	r0, #0	@ _63,
	beq	.L255		@,
	.loc 1 440 9 is_stmt 1 view .LVU1037
	bl	free		@
.LVL296:
.L255:
	.loc 1 443 5 view .LVU1038
	ldr	r2, [r5, #44]	@, g_armwave_state.waves_max
	ldr	r1, [r5, #60]	@, g_armwave_state.wave_length
	ldr	r0, .L285+36	@,
	bl	printf		@
.LVL297:
	.loc 1 445 5 view .LVU1039
@ armwave.c:445:     g_armwave_state.test_wave_buffer = calloc(g_armwave_state.wave_length * g_armwave_state.waves_max, 1);
	.loc 1 445 40 is_stmt 0 view .LVU1040
...
.LVL298:
@ armwave.c:447:     if(g_armwave_state.test_wave_buffer == NULL) {
	.loc 1 447 7 view .LVU1041
	cmp	r0, #0	@ tmp177,
@ armwave.c:445:     g_armwave_state.test_wave_buffer = calloc(g_armwave_state.wave_length * g_armwave_state.waves_max, 1);
	.loc 1 445 38 view .LVU1042
	str	r0, [r5, #24]	@ tmp177, g_armwave_state.test_wave_buffer
	.loc 1 447 5 is_stmt 1 view .LVU1043
@ armwave.c:447:     if(g_armwave_state.test_wave_buffer == NULL) {
	.loc 1 447 7 is_stmt 0 view .LVU1044
	beq	.L284		@,
.L256:
.LVL299:
	.loc 1 447 7 view .LVU1045
.LBE67:
.LBE71:
@ armwave.c:494:     for(w = 0; w < g_armwave_state.waves; w++) {
	.loc 1 494 35 discriminator 1 view .LVU1046
	ldr	r2, [r5, #40]	@ prephitmp_80, g_armwave_state.waves
@ armwave.c:494:     for(w = 0; w < g_armwave_state.waves; w++) {
	.loc 1 494 5 discriminator 1 view .LVU1047
	cmp	r2, #0	@ prephitmp_80,
	beq	.L254		@,
@ armwave.c:495:         mod_val = 0.5f + (((float)w / TEST_NWAVES) * mod);
	.loc 1 495 37 view .LVU1048
	vldr.32	s27, .L285	@ tmp184,
@ armwave.c:495:         mod_val = 0.5f + (((float)w / TEST_NWAVES) * mod);
	.loc 1 495 17 view .LVU1049
	vldr.32	s26, .L285+4	@ tmp186,
@ armwave.c:510:             v = (sin((6.28f * x * (1.0f / g_armwave_state.wave_length)) + xnoise) * mod_val) * noise;
	.loc 1 510 41 view .LVU1050
	vldr.32	s16, .L285+8	@ tmp234,
@ armwave.c:510:             v = (sin((6.28f * x * (1.0f / g_armwave_state.wave_length)) + xnoise) * mod_val) * noise;
	.loc 1 510 29 view .LVU1051
	vldr.32	s23, .L285+12	@ tmp235,
@ armwave.c:513:             g_armwave_state.test_wave_buffer[x + (w * g_armwave_state.wave_stride)] = (uint8_t)MIN(MAX(128 + (v * 127), 0), 255);
	.loc 1 513 87 view .LVU1052
	vldr.32	s24, .L285+16	@ tmp236,
	ldr	r3, [r5, #60]	@ prephitmp_96, g_armwave_state.wave_length
@ armwave.c:494:     for(w = 0; w < g_armwave_state.waves; w++) {
	.loc 1 494 5 view .LVU1053
	mov	r6, #0	@ w,
.LVL300:
.L264:
	.loc 1 495 9 is_stmt 1 view .LVU1054
@ armwave.c:495:         mod_val = 0.5f + (((float)w / TEST_NWAVES) * mod);
	.loc 1 495 28 is_stmt 0 view .LVU1055
	vmov	s15, r6	@ int	@ w, w
@ armwave.c:495:         mod_val = 0.5f + (((float)w / TEST_NWAVES) * mod);
	.loc 1 495 17 view .LVU1056
	vmov.f32	s18, s26	@ mod_val, tmp186
@ armwave.c:498:         for(x = 0; x < g_armwave_state.wave_length; x++) {
	.loc 1 498 9 view .LVU1057
	cmp	r3, #0	@ prephitmp_96,
@ armwave.c:495:         mod_val = 0.5f + (((float)w / TEST_NWAVES) * mod);
	.loc 1 495 28 view .LVU1058
	vcvt.f32.s32	s15, s15	@ tmp182, w
@ armwave.c:495:         mod_val = 0.5f + (((float)w / TEST_NWAVES) * mod);
	.loc 1 495 37 view .LVU1059
	vmul.f32	s15, s15, s27	@ tmp183, tmp182, tmp184
@ armwave.c:495:         mod_val = 0.5f + (((float)w / TEST_NWAVES) * mod);
	.loc 1 495 17 view .LVU1060
	vmla.f32	s18, s15, s25	@ mod_val, tmp183, mod
.LVL301:
	.loc 1 498 9 is_stmt 1 view .LVU1061
	.loc 1 498 9 is_stmt 0 view .LVU1062
	beq	.L258		@,
	vcvt.f64.f32	d9, s18	@ tmp231, mod_val
@ armwave.c:508:             xnoise = (rand() & 0xffff) / 6553500.0f;
	.loc 1 508 20 view .LVU1063
	vldr.32	s21, .L285+20	@ tmp204,
@ armwave.c:513:             g_armwave_state.test_wave_buffer[x + (w * g_armwave_state.wave_stride)] = (uint8_t)MIN(MAX(128 + (v * 127), 0), 255);
	.loc 1 513 96 view .LVU1064
	vldr.32	s20, .L285+24	@ tmp215,
	vldr.32	s17, .L285+28	@ tmp216,
@ armwave.c:498:         for(x = 0; x < g_armwave_state.wave_length; x++) {
	.loc 1 498 15 view .LVU1065
	mov	r4, #0	@ x,
.LVL302:
.L263:
	.loc 1 499 13 is_stmt 1 view .LVU1066
@ armwave.c:499:             noise  = ((rand() & 0xffff) * noise_fraction);
	.loc 1 499 24 is_stmt 0 view .LVU1067
	bl	rand		@
.LVL303:
@ armwave.c:499:             noise  = ((rand() & 0xffff) * noise_fraction);
	.loc 1 499 31 view .LVU1068
	uxth	r0, r0	@ tmp187,
@ armwave.c:499:             noise  = ((rand() & 0xffff) * noise_fraction);
	.loc 1 499 41 view .LVU1069
	vmov	s15, r0	@ int	@ tmp187, tmp187
	vcvt.f32.s32	s15, s15	@ tmp189, tmp187
@ armwave.c:499:             noise  = ((rand() & 0xffff) * noise_fraction);
	.loc 1 499 20 view .LVU1070
	vmul.f32	s15, s15, s22	@ noise, tmp189, noise_fraction
.LVL304:
	.loc 1 500 13 is_stmt 1 view .LVU1071
@ armwave.c:500:             noise *= noise;
	.loc 1 500 19 is_stmt 0 view .LVU1072
	vmul.f32	s15, s15, s15	@ noise, noise, noise
.LVL305:
	.loc 1 501 13 is_stmt 1 view .LVU1073
@ armwave.c:501:             noise *= noise;
	.loc 1 501 19 is_stmt 0 view .LVU1074
	vmul.f32	s15, s15, s15	@ noise, noise, noise
.LVL306:
	.loc 1 502 13 is_stmt 1 view .LVU1075
@ armwave.c:502:             noise *= noise;
	.loc 1 502 19 is_stmt 0 view .LVU1076
	vmul.f32	s28, s15, s15	@ noise, noise, noise
.LVL307:
	.loc 1 504 13 is_stmt 1 view .LVU1077
@ armwave.c:504:             if((rand() & 0xffff) > 0x7fff)
	.loc 1 504 17 is_stmt 0 view .LVU1078
	bl	rand		@
.LVL308:
	.loc 1 505 17 is_stmt 1 view .LVU1079
@ armwave.c:504:             if((rand() & 0xffff) > 0x7fff)
	.loc 1 504 15 is_stmt 0 view .LVU1080
	tst	r0, #32768	@,
@ armwave.c:505:                 noise = -noise;
	.loc 1 505 23 view .LVU1081
	vnegne.f32	s28, s28	@ noise, noise
.LVL309:
	.loc 1 507 13 is_stmt 1 view .LVU1082
	.loc 1 508 13 view .LVU1083
@ armwave.c:508:             xnoise = (rand() & 0xffff) / 6553500.0f;
	.loc 1 508 23 is_stmt 0 view .LVU1084
	bl	rand		@
.LVL310:
	.loc 1 510 13 is_stmt 1 view .LVU1085
@ armwave.c:510:             v = (sin((6.28f * x * (1.0f / g_armwave_state.wave_length)) + xnoise) * mod_val) * noise;
	.loc 1 510 41 is_stmt 0 view .LVU1086
	vldr.32	s14, [r5, #60]	@ int	@ tmp242, g_armwave_state.wave_length
@ armwave.c:510:             v = (sin((6.28f * x * (1.0f / g_armwave_state.wave_length)) + xnoise) * mod_val) * noise;
	.loc 1 510 29 view .LVU1087
	vmov	s15, r4	@ int	@ x, x
@ armwave.c:510:             v = (sin((6.28f * x * (1.0f / g_armwave_state.wave_length)) + xnoise) * mod_val) * noise;
	.loc 1 510 41 view .LVU1088
	vcvt.f32.u32	s14, s14	@ tmp192, tmp242
@ armwave.c:510:             v = (sin((6.28f * x * (1.0f / g_armwave_state.wave_length)) + xnoise) * mod_val) * noise;
	.loc 1 510 29 view .LVU1089
	vcvt.f32.s32	s15, s15	@ tmp196, x
@ armwave.c:510:             v = (sin((6.28f * x * (1.0f / g_armwave_state.wave_length)) + xnoise) * mod_val) * noise;
	.loc 1 510 41 view .LVU1090
	vdiv.f32	s13, s16, s14	@ tmp194, tmp234, tmp192
@ armwave.c:510:             v = (sin((6.28f * x * (1.0f / g_armwave_state.wave_length)) + xnoise) * mod_val) * noise;
	.loc 1 510 29 view .LVU1091
	vmul.f32	s15, s15, s23	@ tmp197, tmp196, tmp235
@ armwave.c:508:             xnoise = (rand() & 0xffff) / 6553500.0f;
	.loc 1 508 30 view .LVU1092
	uxth	r0, r0	@ tmp200,
.LVL311:
@ armwave.c:508:             xnoise = (rand() & 0xffff) / 6553500.0f;
	.loc 1 508 40 view .LVU1093
	vmov	s14, r0	@ int	@ tmp200, tmp200
	vcvt.f32.s32	s14, s14	@ tmp202, tmp200
@ armwave.c:508:             xnoise = (rand() & 0xffff) / 6553500.0f;
	.loc 1 508 20 view .LVU1094
	vdiv.f32	s0, s14, s21	@ xnoise, tmp202, tmp204
@ armwave.c:510:             v = (sin((6.28f * x * (1.0f / g_armwave_state.wave_length)) + xnoise) * mod_val) * noise;
	.loc 1 510 73 view .LVU1095
	vmla.f32	s0, s13, s15	@ tmp205, tmp194, tmp197
@ armwave.c:510:             v = (sin((6.28f * x * (1.0f / g_armwave_state.wave_length)) + xnoise) * mod_val) * noise;
	.loc 1 510 18 view .LVU1096
	vcvt.f64.f32	d0, s0	@, tmp205
	bl	sin		@
.LVL312:
	.loc 1 513 13 is_stmt 1 view .LVU1097
@ armwave.c:507:             noise += 1.0f;
	.loc 1 507 19 is_stmt 0 view .LVU1098
	vadd.f32	s15, s28, s16	@ noise, noise, tmp234
@ armwave.c:513:             g_armwave_state.test_wave_buffer[x + (w * g_armwave_state.wave_stride)] = (uint8_t)MIN(MAX(128 + (v * 127), 0), 255);
	.loc 1 513 87 view .LVU1099
	mov	r2, #0	@ iftmp.22_39,
@ armwave.c:510:             v = (sin((6.28f * x * (1.0f / g_armwave_state.wave_length)) + xnoise) * mod_val) * noise;
	.loc 1 510 94 view .LVU1100
	vcvt.f64.f32	d7, s15	@ tmp211, noise
@ armwave.c:510:             v = (sin((6.28f * x * (1.0f / g_armwave_state.wave_length)) + xnoise) * mod_val) * noise;
	.loc 1 510 83 view .LVU1101
	vmul.f64	d0, d9, d0	@ tmp208, tmp231,
.LVL313:
@ armwave.c:510:             v = (sin((6.28f * x * (1.0f / g_armwave_state.wave_length)) + xnoise) * mod_val) * noise;
	.loc 1 510 94 view .LVU1102
	vmul.f64	d7, d0, d7	@ tmp212, tmp208, tmp211
@ armwave.c:510:             v = (sin((6.28f * x * (1.0f / g_armwave_state.wave_length)) + xnoise) * mod_val) * noise;
	.loc 1 510 15 view .LVU1103
	vcvt.f32.f64	s14, d7	@ v, tmp212
@ armwave.c:513:             g_armwave_state.test_wave_buffer[x + (w * g_armwave_state.wave_stride)] = (uint8_t)MIN(MAX(128 + (v * 127), 0), 255);
	.loc 1 513 96 view .LVU1104
	...
	ble	.L260		@,
@ armwave.c:513:             g_armwave_state.test_wave_buffer[x + (w * g_armwave_state.wave_stride)] = (uint8_t)MIN(MAX(128 + (v * 127), 0), 255);
	.loc 1 513 87 discriminator 1 view .LVU1105
...
.L260:
@ armwave.c:513:             g_armwave_state.test_wave_buffer[x + (w * g_armwave_state.wave_stride)] = (uint8_t)MIN(MAX(128 + (v * 127), 0), 255);
	.loc 1 513 53 discriminator 12 view .LVU1106
	ldr	r3, [r5, #36]	@ g_armwave_state.wave_stride, g_armwave_state.wave_stride
@ armwave.c:513:             g_armwave_state.test_wave_buffer[x + (w * g_armwave_state.wave_stride)] = (uint8_t)MIN(MAX(128 + (v * 127), 0), 255);
	.loc 1 513 85 discriminator 12 view .LVU1107
...
@ armwave.c:498:         for(x = 0; x < g_armwave_state.wave_length; x++) {
	.loc 1 498 39 discriminator 12 view .LVU1108
	ldr	r3, [r5, #60]	@ prephitmp_96, g_armwave_state.wave_length
@ armwave.c:498:         for(x = 0; x < g_armwave_state.wave_length; x++) {
	.loc 1 498 54 discriminator 12 view .LVU1109
	add	r4, r4, #1	@ x, x,
.LVL314:
@ armwave.c:498:         for(x = 0; x < g_armwave_state.wave_length; x++) {
	.loc 1 498 9 discriminator 12 view .LVU1110
...
.L258:
@ armwave.c:494:     for(w = 0; w < g_armwave_state.waves; w++) {
	.loc 1 494 44 discriminator 2 view .LVU1111
	add	r6, r6, #1	@ w, w,
.LVL316:
@ armwave.c:494:     for(w = 0; w < g_armwave_state.waves; w++) {
	.loc 1 494 5 discriminator 2 view .LVU1112
	cmp	r6, r2	@ w, prephitmp_80
	bcc	.L264		@,
.LVL317:
.L254:
@ armwave.c:516: }
	.loc 1 516 1 view .LVU1113
	add	sp, sp, #8	@,,
	.cfi_remember_state
	.cfi_def_cfa_offset 72
	@ sp needed	@
...
.LBB72:
.LBB68:
	.loc 1 448 9 is_stmt 1 view .LVU1115
	mov	r1, r4	@, _68
	ldr	r0, .L285+40	@,
	bl	printf		@
.LVL320:
	.loc 1 449 9 view .LVU1116
	b	.L256		@
.L286:
	.align	2
.L285:
...
.LFB77:
	...
	@ args = 0, pretend = 0, frame = 8
	@ frame_needed = 0, uses_anonymous_args = 0
	.loc 1 525 5 view .LVU1118
	.loc 1 526 5 view .LVU1119
	.loc 1 527 5 view .LVU1120
	.loc 1 528 5 view .LVU1121
	.loc 1 530 5 view .LVU1122
@ armwave.c:524: {
	.loc 1 524 1 is_stmt 0 view .LVU1123
	push	{r4, r5, r6, lr}	@
	.cfi_def_cfa_offset 16
	.cfi_offset 4, -16
	.cfi_offset 5, -12
	...
	.cfi_offset 88, -24
	.cfi_offset 89, -20
@ armwave.c:530:     for(w = 0; w < g_armwave_state.waves; w++) {
	.loc 1 530 35 view .LVU1124
	ldr	r5, .L315+32	@ tmp179,
	ldr	r2, [r5, #40]	@ prephitmp_33, g_armwave_state.waves
@ armwave.c:524: {
	.loc 1 524 1 view .LVU1125
	sub	sp, sp, #8	@,,
	.cfi_def_cfa_offset 64
@ armwave.c:530:     for(w = 0; w < g_armwave_state.waves; w++) {
	.loc 1 530 5 view .LVU1126
	cmp	r2, #0	@ prephitmp_33,
	beq	.L287		@,
	vmov.f32	s19, s0	@ noise_fraction, noise_fraction
@ armwave.c:527:     float level = 0.8f, new_level = 0.8f;
	.loc 1 527 11 view .LVU1127
	vldr.32	s24, .L315	@ level,
@ armwave.c:542:             if(x > (g_armwave_state.wave_length * 0.75f)) {
	.loc 1 542 49 view .LVU1128
	vldr.32	s20, .L315+4	@ tmp186,
@ armwave.c:547:                 new_level = 0.2f;
	.loc 1 547 27 view .LVU1129
	vldr.32	s21, .L315+8	@ new_level,
@ armwave.c:544:             } else if(x > (g_armwave_state.wave_length * 0.5f)) {
	.loc 1 544 56 view .LVU1130
	vldr.32	s23, .L315+12	@ tmp188,
@ armwave.c:546:             } else if(x > (g_armwave_state.wave_length * 0.25f)) {
	.loc 1 546 56 view .LVU1131
	vldr.32	s17, .L315+16	@ tmp189,
	ldr	r3, [r5, #60]	@ prephitmp_70, g_armwave_state.wave_length
@ armwave.c:530:     for(w = 0; w < g_armwave_state.waves; w++) {
	.loc 1 530 11 view .LVU1132
	mov	r6, #0	@ w,
.LVL322:
.L289:
@ armwave.c:531:         for(x = 0; x < g_armwave_state.wave_length; x++) {
	.loc 1 531 9 view .LVU1133
	cmp	r3, #0	@ prephitmp_70,
	beq	.L296		@,
@ armwave.c:545:                 new_level = 0.8f;
	.loc 1 545 27 view .LVU1134
	vldr.32	s22, .L315	@ new_level,
@ armwave.c:552:             level = ((level * 3) + new_level) * 0.25f;
	.loc 1 552 29 view .LVU1135
	vldr.32	s18, .L315+20	@ tmp161,
@ armwave.c:531:         for(x = 0; x < g_armwave_state.wave_length; x++) {
	.loc 1 531 15 view .LVU1136
	mov	r4, #0	@ x,
.LVL323:
.L295:
	.loc 1 532 13 is_stmt 1 view .LVU1137
@ armwave.c:532:             noise  = ((rand() & 0xffff) * noise_fraction);
	.loc 1 532 24 is_stmt 0 view .LVU1138
	bl	rand		@
.LVL324:
@ armwave.c:532:             noise  = ((rand() & 0xffff) * noise_fraction);
	.loc 1 532 31 view .LVU1139
	uxth	r0, r0	@ tmp148,
@ armwave.c:532:             noise  = ((rand() & 0xffff) * noise_fraction);
	.loc 1 532 41 view .LVU1140
	vmov	s15, r0	@ int	@ tmp148, tmp148
	vcvt.f32.s32	s15, s15	@ tmp150, tmp148
@ armwave.c:532:             noise  = ((rand() & 0xffff) * noise_fraction);
	.loc 1 532 20 view .LVU1141
	vmul.f32	s15, s15, s19	@ noise, tmp150, noise_fraction
.LVL325:
	.loc 1 533 13 is_stmt 1 view .LVU1142
@ armwave.c:533:             noise *= noise;
	.loc 1 533 19 is_stmt 0 view .LVU1143
	vmul.f32	s15, s15, s15	@ noise, noise, noise
.LVL326:
	.loc 1 534 13 is_stmt 1 view .LVU1144
@ armwave.c:534:             noise *= noise;
	.loc 1 534 19 is_stmt 0 view .LVU1145
	vmul.f32	s15, s15, s15	@ noise, noise, noise
.LVL327:
	.loc 1 535 13 is_stmt 1 view .LVU1146
@ armwave.c:535:             noise *= noise;
	.loc 1 535 19 is_stmt 0 view .LVU1147
	vmul.f32	s16, s15, s15	@ noise, noise, noise
.LVL328:
	.loc 1 537 13 is_stmt 1 view .LVU1148
@ armwave.c:537:             if((rand() & 0xff) > 0x7f)
	.loc 1 537 17 is_stmt 0 view .LVU1149
	bl	rand		@
.LVL329:
@ armwave.c:542:             if(x > (g_armwave_state.wave_length * 0.75f)) {
	.loc 1 542 18 view .LVU1150
	vmov	s15, r4	@ int	@ x, x
	vcvt.f32.s32	s14, s15	@ _6, x
@ armwave.c:542:             if(x > (g_armwave_state.wave_length * 0.75f)) {
	.loc 1 542 49 view .LVU1151
...
@ armwave.c:542:             if(x > (g_armwave_state.wave_length * 0.75f)) {
	.loc 1 542 15 view .LVU1152
	vcmpe.f32	s14, s13	@ _6, tmp154
@ armwave.c:537:             if((rand() & 0xff) > 0x7f)
	.loc 1 537 15 view .LVU1153
	tst	r0, #128	@,
	.loc 1 538 17 is_stmt 1 view .LVU1154
@ armwave.c:538:                 noise = -noise;
	.loc 1 538 23 is_stmt 0 view .LVU1155
	vnegne.f32	s16, s16	@ noise, noise
.LVL330:
	.loc 1 542 13 is_stmt 1 view .LVU1156
@ armwave.c:542:             if(x > (g_armwave_state.wave_length * 0.75f)) {
	.loc 1 542 15 is_stmt 0 view .LVU1157
	vmrs	APSR_nzcv, FPSCR
@ armwave.c:547:                 new_level = 0.2f;
	.loc 1 547 27 view .LVU1158
	vmovgt.f32	s15, s21	@ new_level, new_level
@ armwave.c:542:             if(x > (g_armwave_state.wave_length * 0.75f)) {
	.loc 1 542 15 view .LVU1159
	bgt	.L291		@,
	.loc 1 544 20 is_stmt 1 view .LVU1160
@ armwave.c:544:             } else if(x > (g_armwave_state.wave_length * 0.5f)) {
	.loc 1 544 56 is_stmt 0 view .LVU1161
	vmul.f32	s13, s15, s23	@ tmp156, _8, tmp188
@ armwave.c:544:             } else if(x > (g_armwave_state.wave_length * 0.5f)) {
	.loc 1 544 22 view .LVU1162
	vcmpe.f32	s14, s13	@ _6, tmp156
	vmrs	APSR_nzcv, FPSCR
@ armwave.c:545:                 new_level = 0.8f;
	.loc 1 545 27 view .LVU1163
	vmovgt.f32	s15, s22	@ new_level, new_level
@ armwave.c:544:             } else if(x > (g_armwave_state.wave_length * 0.5f)) {
	.loc 1 544 22 view .LVU1164
	bgt	.L291		@,
	.loc 1 546 20 is_stmt 1 view .LVU1165
@ armwave.c:546:             } else if(x > (g_armwave_state.wave_length * 0.25f)) {
	.loc 1 546 56 is_stmt 0 view .LVU1166
	vmul.f32	s15, s15, s17	@ tmp158, _8, tmp189
@ armwave.c:545:                 new_level = 0.8f;
	.loc 1 545 27 view .LVU1167
...
.L291:
.LVL331:
	.loc 1 552 13 is_stmt 1 view .LVU1168
@ armwave.c:552:             level = ((level * 3) + new_level) * 0.25f;
	.loc 1 552 34 is_stmt 0 view .LVU1169
	vmla.f32	s15, s24, s18	@ _14, level, tmp161
.LVL332:
@ armwave.c:552:             level = ((level * 3) + new_level) * 0.25f;
	.loc 1 552 19 view .LVU1170
	vmul.f32	s24, s15, s17	@ level, _14, tmp189
.LVL333:
	.loc 1 554 13 is_stmt 1 view .LVU1171
@ armwave.c:554:             v = (uint8_t)(CLAMP(level + noise, 0.0f, 1.0f) * 255);
	.loc 1 554 27 is_stmt 0 view .LVU1172
	vadd.f32	s15, s16, s24	@ _15, noise, level
	vcmpe.f32	s15, #0	@ _15
	vmrs	APSR_nzcv, FPSCR
@ armwave.c:554:             v = (uint8_t)(CLAMP(level + noise, 0.0f, 1.0f) * 255);
	.loc 1 554 17 view .LVU1173
	movle	r2, #0	@ iftmp.29_32,
@ armwave.c:554:             v = (uint8_t)(CLAMP(level + noise, 0.0f, 1.0f) * 255);
	.loc 1 554 27 view .LVU1174
	ble	.L292		@,
@ armwave.c:554:             v = (uint8_t)(CLAMP(level + noise, 0.0f, 1.0f) * 255);
	.loc 1 554 17 discriminator 1 view .LVU1175
	vldr.32	s14, .L315+24	@ tmp164,
	vcmpe.f32	s15, s14	@ _15, tmp164
	vmrs	APSR_nzcv, FPSCR
@ armwave.c:554:             v = (uint8_t)(CLAMP(level + noise, 0.0f, 1.0f) * 255);
	.loc 1 554 60 discriminator 1 view .LVU1176
	vldrmi.32	s14, .L315+28	@ tmp166,
@ armwave.c:554:             v = (uint8_t)(CLAMP(level + noise, 0.0f, 1.0f) * 255);
	.loc 1 554 17 discriminator 1 view .LVU1177
	movpl	r2, #255	@ iftmp.29_32,
@ armwave.c:554:             v = (uint8_t)(CLAMP(level + noise, 0.0f, 1.0f) * 255);
	.loc 1 554 60 discriminator 1 view .LVU1178
	vmulmi.f32	s15, s15, s14	@ tmp165, _15, tmp166
@ armwave.c:554:             v = (uint8_t)(CLAMP(level + noise, 0.0f, 1.0f) * 255);
	.loc 1 554 17 discriminator 1 view .LVU1179
	vcvtmi.u32.f32	s15, s15	@ tmp168, tmp165
	vstrmi.32	s15, [sp, #4]	@ int	@ tmp168, %sfp
	ldrbmi	r2, [sp, #4]	@ zero_extendqisi2	@ iftmp.29_32, %sfp
.L292:
.LVL334:
	.loc 1 555 13 is_stmt 1 discriminator 12 view .LVU1180
@ armwave.c:555:             g_armwave_state.test_wave_buffer[x + (w * g_armwave_state.wave_stride)] = v;
	.loc 1 555 53 is_stmt 0 discriminator 12 view .LVU1181
	ldr	r3, [r5, #36]	@ g_armwave_state.wave_stride, g_armwave_state.wave_stride
@ armwave.c:555:             g_armwave_state.test_wave_buffer[x + (w * g_armwave_state.wave_stride)] = v;
	.loc 1 555 85 discriminator 12 view .LVU1182
	ldr	r1, [r5, #24]	@ g_armwave_state.test_wave_buffer, g_armwave_state.test_wave_buffer
	mla	r3, r3, r6, r1	@ tmp174, g_armwave_state.wave_stride, w, g_armwave_state.test_wave_buffer
	strb	r2, [r3, r4]	@ iftmp.29_32, *_21
@ armwave.c:531:         for(x = 0; x < g_armwave_state.wave_length; x++) {
	.loc 1 531 39 discriminator 12 view .LVU1183
	ldr	r3, [r5, #60]	@ prephitmp_70, g_armwave_state.wave_length
@ armwave.c:531:         for(x = 0; x < g_armwave_state.wave_length; x++) {
	.loc 1 531 54 discriminator 12 view .LVU1184
	add	r4, r4, #1	@ x, x,
.LVL335:
@ armwave.c:531:         for(x = 0; x < g_armwave_state.wave_length; x++) {
	.loc 1 531 9 discriminator 12 view .LVU1185
...
.L296:
@ armwave.c:530:     for(w = 0; w < g_armwave_state.waves; w++) {
	.loc 1 530 44 discriminator 2 view .LVU1186
	add	r6, r6, #1	@ w, w,
.LVL337:
@ armwave.c:530:     for(w = 0; w < g_armwave_state.waves; w++) {
	.loc 1 530 5 discriminator 2 view .LVU1187
	cmp	r6, r2	@ w, prephitmp_33
	bcc	.L289		@,
.LVL338:
.L287:
@ armwave.c:558: }
	.loc 1 558 1 view .LVU1188
	add	sp, sp, #8	@,,
	.cfi_def_cfa_offset 56
	@ sp needed	@
	vldm	sp!, {d8-d12}	@,
