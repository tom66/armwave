...
.LVL139:
.L125:
	.loc 1 300 9 is_stmt 1 discriminator 2 view .LVU627
	.loc 1 302 9 discriminator 2 view .LVU628
@ armwave.c:296:     for(n = 0; n < npix; n += 4) {
	.loc 1 296 28 is_stmt 0 discriminator 2 view .LVU629
	add	r3, r3, #4	@ n, n,
.LVL140:
@ armwave.c:296:     for(n = 0; n < npix; n += 4) {
	.loc 1 296 5 discriminator 2 view .LVU630
	cmp	r4, r3	@ npix, n
	bgt	.L125		@,
	pop	{r4, pc}	@
.LVL141:
...
.LBB6:
.LBI6:
	.loc 1 263 6 is_stmt 1 view .LVU631
.LBB7:
	.loc 1 272 5 view .LVU632
	ldr	r3, .L129+8	@,
	mov	r2, #272	@,
	ldr	r1, .L129+12	@,
	ldr	r0, .L129+16	@,
.LVL142:
	.loc 1 272 5 is_stmt 0 view .LVU633
	bl	__assert_fail		@
.LVL143:
.L130:
	.loc 1 272 5 view .LVU634
	.align	2
.L129:
	.word	g_armwave_state
	.word	.LC6
...
.LFB65:
	...
	@ args = 0, pretend = 0, frame = 0
	@ frame_needed = 0, uses_anonymous_args = 0
	.loc 1 338 5 view .LVU636
@ armwave.c:337: {
	.loc 1 337 1 is_stmt 0 view .LVU637
	mov	r3, r1	@ fn, fn
...
@ armwave.c:338:     FILE *fp = fopen(fn, "wb");
	.loc 1 338 16 view .LVU638
	ldr	r1, .L143	@,
.LVL145:
	.loc 1 338 16 view .LVU639
	mov	r0, r3	@, fn
.LVL146:
	.loc 1 338 16 view .LVU640
	bl	fopen64		@
.LVL147:
@ armwave.c:345:     fprintf(fp, "%d %d\n", g_armwave_state.target_height, g_armwave_state.target_width);
	.loc 1 345 5 view .LVU641
	ldr	r6, .L143+4	@ tmp154,
@ armwave.c:344:     fputs("P3\n", fp);
	.loc 1 344 5 view .LVU642
	mov	r2, #3	@,
	mov	r1, #1	@,
@ armwave.c:338:     FILE *fp = fopen(fn, "wb");
	.loc 1 338 16 view .LVU643
	mov	r7, r0	@ fp,
.LVL148:
	.loc 1 339 5 is_stmt 1 view .LVU644
	.loc 1 340 5 view .LVU645
	.loc 1 344 5 view .LVU646
	mov	r3, r0	@, fp
	ldr	r0, .L143+8	@,
.LVL149:
	.loc 1 344 5 is_stmt 0 view .LVU647
	bl	fwrite		@
.LVL150:
	.loc 1 345 5 is_stmt 1 view .LVU648
...
.LVL151:
	...
	bl	fwrite		@
.LVL152:
	.loc 1 348 5 view .LVU650
@ armwave.c:348:     for(yy = 0; yy < g_armwave_state.target_height; yy++) {
	.loc 1 348 37 is_stmt 0 view .LVU651
	ldr	r2, [r6, #56]	@ prephitmp_57, g_armwave_state.target_height
@ armwave.c:348:     for(yy = 0; yy < g_armwave_state.target_height; yy++) {
	.loc 1 348 5 view .LVU652
	cmp	r2, #0	@ prephitmp_57,
	beq	.L132		@,
	ldr	r3, [r6, #52]	@ _12, g_armwave_state.target_width
@ armwave.c:353:             fprintf(fp, "%3d %3d %3d\n", data & 0xff, (data >> 8) & 0xff, (data >> 16) & 0xff);
	.loc 1 353 13 view .LVU653
	ldr	r9, .L143+20	@ tmp156,
@ armwave.c:348:     for(yy = 0; yy < g_armwave_state.target_height; yy++) {
	.loc 1 348 12 view .LVU654
	mov	r5, #0	@ yy,
.LVL153:
.L133:
@ armwave.c:349:         for(xx = 0; xx < g_armwave_state.target_width; xx++) {
	.loc 1 349 9 view .LVU655
	cmp	r3, #0	@ _12,
@ armwave.c:349:         for(xx = 0; xx < g_armwave_state.target_width; xx++) {
	.loc 1 349 16 view .LVU656
	movne	r4, #0	@ xx,
@ armwave.c:349:         for(xx = 0; xx < g_armwave_state.target_width; xx++) {
	.loc 1 349 9 view .LVU657
	beq	.L142		@,
.LVL154:
.L134:
	.loc 1 350 13 is_stmt 1 discriminator 3 view .LVU658
@ armwave.c:350:             data = *(buffer + (xx + (yy * g_armwave_state.target_width)));
	.loc 1 350 29 is_stmt 0 discriminator 3 view .LVU659
	mla	r3, r5, r3, r4	@ tmp145, yy, _12, xx
@ armwave.c:353:             fprintf(fp, "%3d %3d %3d\n", data & 0xff, (data >> 8) & 0xff, (data >> 16) & 0xff);
	.loc 1 353 13 discriminator 3 view .LVU660
	mov	r1, r9	@, tmp156
	mov	r0, r7	@, fp
@ armwave.c:350:             data = *(buffer + (xx + (yy * g_armwave_state.target_width)));
	.loc 1 350 18 discriminator 3 view .LVU661
	ldr	r2, [r8, r3, lsl #2]	@ data, *_6
.LVL155:
	.loc 1 353 13 is_stmt 1 discriminator 3 view .LVU662
@ armwave.c:349:         for(xx = 0; xx < g_armwave_state.target_width; xx++) {
	.loc 1 349 58 is_stmt 0 discriminator 3 view .LVU663
	add	r4, r4, #1	@ xx, xx,
.LVL156:
@ armwave.c:353:             fprintf(fp, "%3d %3d %3d\n", data & 0xff, (data >> 8) & 0xff, (data >> 16) & 0xff);
	.loc 1 353 81 discriminator 3 view .LVU664
	lsr	ip, r2, #16	@ tmp150, data,
@ armwave.c:353:             fprintf(fp, "%3d %3d %3d\n", data & 0xff, (data >> 8) & 0xff, (data >> 16) & 0xff);
	.loc 1 353 61 discriminator 3 view .LVU665
	lsr	r3, r2, #8	@ tmp146, data,
@ armwave.c:353:             fprintf(fp, "%3d %3d %3d\n", data & 0xff, (data >> 8) & 0xff, (data >> 16) & 0xff);
	.loc 1 353 13 discriminator 3 view .LVU666
	uxtb	ip, ip	@ tmp151, tmp150
	uxtb	r3, r3	@, tmp146
	str	ip, [sp]	@ tmp151,
	uxtb	r2, r2	@, data
.LVL157:
	.loc 1 353 13 discriminator 3 view .LVU667
	bl	fprintf		@
.LVL158:
@ armwave.c:349:         for(xx = 0; xx < g_armwave_state.target_width; xx++) {
	.loc 1 349 41 discriminator 3 view .LVU668
	ldr	r3, [r6, #52]	@ _12, g_armwave_state.target_width
@ armwave.c:349:         for(xx = 0; xx < g_armwave_state.target_width; xx++) {
	.loc 1 349 9 discriminator 3 view .LVU669
	cmp	r3, r4	@ _12, xx
	bhi	.L134		@,
	ldr	r2, [r6, #56]	@ prephitmp_57, g_armwave_state.target_height
.LVL159:
.L135:
@ armwave.c:348:     for(yy = 0; yy < g_armwave_state.target_height; yy++) {
	.loc 1 348 55 discriminator 2 view .LVU670
	add	r5, r5, #1	@ yy, yy,
.LVL160:
@ armwave.c:348:     for(yy = 0; yy < g_armwave_state.target_height; yy++) {
	.loc 1 348 5 discriminator 2 view .LVU671
	cmp	r5, r2	@ yy, prephitmp_57
	bcc	.L133		@,
.LVL161:
.L132:
	.loc 1 357 5 is_stmt 1 view .LVU672
	mov	r0, r7	@, fp
@ armwave.c:358: }
	.loc 1 358 1 is_stmt 0 view .LVU673
	add	sp, sp, #12	@,,
	.cfi_remember_state
	.cfi_def_cfa_offset 28
	@ sp needed	@
...
@ armwave.c:357:     fclose(fp);
	.loc 1 357 5 view .LVU674
	b	fclose		@
.LVL163:
.L142:
	.cfi_restore_state
@ armwave.c:348:     for(yy = 0; yy < g_armwave_state.target_height; yy++) {
	.loc 1 348 55 view .LVU675
	add	r5, r5, #1	@ yy, yy,
.LVL164:
@ armwave.c:348:     for(yy = 0; yy < g_armwave_state.target_height; yy++) {
	.loc 1 348 5 view .LVU676
...
.LFB66:
	...
	@ args = 0, pretend = 0, frame = 0
	@ frame_needed = 0, uses_anonymous_args = 0
	.loc 1 362 5 view .LVU678
@ armwave.c:362:     mod_depth = mod;
	.loc 1 362 15 is_stmt 0 view .LVU679
	ldr	r3, .L149+20	@ tmp128,
@ armwave.c:361: {
	.loc 1 361 1 view .LVU680
	push	{r4, r5, r6, r7, r8, lr}	@
	.cfi_def_cfa_offset 24
	.cfi_offset 4, -24
	.cfi_offset 5, -20
	...
	.cfi_offset 84, -32
	.cfi_offset 85, -28
	ldr	r4, .L149+24	@ ivtmp.97,
.LBB10:
.LBB11:
@ armwave.c:87:         gamma_table[i] = pow(i / 255.0f, gamma) * 255.0f;
	.loc 1 87 32 view .LVU681
	vldr.32	s20, .L149+16	@ tmp134,
@ armwave.c:87:         gamma_table[i] = pow(i / 255.0f, gamma) * 255.0f;
	.loc 1 87 26 view .LVU682
	vldr.64	d9, .L149	@ tmp143,
@ armwave.c:87:         gamma_table[i] = pow(i / 255.0f, gamma) * 255.0f;
	.loc 1 87 49 view .LVU683
	vldr.64	d8, .L149+8	@ tmp137,
.LBE11:
.LBE10:
@ armwave.c:362:     mod_depth = mod;
	.loc 1 362 15 view .LVU684
	vstr.32	s0, [r3]	@ mod, mod_depth
	.loc 1 364 5 is_stmt 1 view .LVU685
@ armwave.c:361: {
	.loc 1 361 1 is_stmt 0 view .LVU686
	mov	r6, r0	@ render_width, render_width
	mov	r7, r1	@ render_height, render_height
@ armwave.c:364:     test_create_waveform();
	.loc 1 364 5 view .LVU687
	bl	test_create_waveform		@
.LVL166:
	.loc 1 365 5 is_stmt 1 view .LVU688
.LBB13:
.LBI10:
	.loc 1 81 6 view .LVU689
	.loc 1 81 6 is_stmt 0 view .LVU690
	add	r3, r4, #1	@ _34, ivtmp.97,
	add	r8, r4, #256	@ _35, ivtmp.97,
	rsb	r5, r3, #1	@ tmp142, _34,
.LVL167:
.L146:
.LBB12:
	.loc 1 87 9 is_stmt 1 view .LVU691
@ armwave.c:87:         gamma_table[i] = pow(i / 255.0f, gamma) * 255.0f;
	.loc 1 87 32 is_stmt 0 view .LVU692
	add	r3, r5, r4	@ tmp131, tmp142, ivtmp.97
@ armwave.c:87:         gamma_table[i] = pow(i / 255.0f, gamma) * 255.0f;
	.loc 1 87 26 view .LVU693
	vmov.f64	d1, d9	@, tmp143
@ armwave.c:87:         gamma_table[i] = pow(i / 255.0f, gamma) * 255.0f;
	.loc 1 87 32 view .LVU694
	vmov	s15, r3	@ int	@ tmp131, tmp131
	vcvt.f32.s32	s15, s15	@ tmp132, tmp131
	vdiv.f32	s0, s15, s20	@ tmp133, tmp132, tmp134
@ armwave.c:87:         gamma_table[i] = pow(i / 255.0f, gamma) * 255.0f;
	.loc 1 87 26 view .LVU695
	vcvt.f64.f32	d0, s0	@, tmp133
	bl	pow		@
.LVL168:
@ armwave.c:87:         gamma_table[i] = pow(i / 255.0f, gamma) * 255.0f;
	.loc 1 87 49 view .LVU696
	vmul.f64	d0, d0, d8	@ tmp136,, tmp137
@ armwave.c:87:         gamma_table[i] = pow(i / 255.0f, gamma) * 255.0f;
	.loc 1 87 24 view .LVU697
	vcvt.u32.f64	s15, d0	@ tmp138, tmp136
	vmov	r3, s15	@ int	@ tmp138, tmp138
	strb	r3, [r4, #1]!	@ tmp138, MEM[base: _33, offset: 0B]
.LVL169:
@ armwave.c:86:     for(i = 0; i < 256; i++) {
	.loc 1 86 5 view .LVU698
	cmp	r4, r8	@ ivtmp.97, _35
	bne	.L146		@,
.LVL170:
	.loc 1 86 5 view .LVU699
.LBE12:
.LBE13:
	.loc 1 367 5 is_stmt 1 view .LVU700
	mov	r1, r7	@, render_height
	mov	r0, r6	@, render_width
	bl	armwave_setup_render.constprop.1		@
.LVL171:
	.loc 1 369 5 view .LVU701
@ armwave.c:370: }
	.loc 1 370 1 is_stmt 0 view .LVU702
	vldm	sp!, {d8-d10}	@,
	.cfi_restore 84
	.cfi_restore 85
	.cfi_restore 82
...
@ armwave.c:369:     printf("armwave version: %s\n", ARMWAVE_VER);
	.loc 1 369 5 view .LVU703
	ldr	r1, .L149+28	@,
	ldr	r0, .L149+32	@,
@ armwave.c:370: }
	.loc 1 370 1 view .LVU704
...
.LFB67:
	...
	@ args = 0, pretend = 0, frame = 8
	@ frame_needed = 0, uses_anonymous_args = 0
	.loc 1 374 5 view .LVU707
	.loc 1 376 5 view .LVU708
@ armwave.c:373: {
	.loc 1 373 1 is_stmt 0 view .LVU709
	push	{r4, r5, r6, r7, r8, r9, r10, fp, lr}	@
	.cfi_def_cfa_offset 36
	.cfi_offset 4, -36
	.cfi_offset 5, -32
...
@ armwave.c:376:     memset(g_armwave_state.ch1_buffer, 0, g_armwave_state.size);
	.loc 1 376 5 view .LVU710
	mov	r1, #0	@,
	ldr	r4, .L169	@ tmp269,
@ armwave.c:373: {
	.loc 1 373 1 view .LVU711
	sub	sp, sp, #12	@,,
	.cfi_def_cfa_offset 48
@ armwave.c:376:     memset(g_armwave_state.ch1_buffer, 0, g_armwave_state.size);
	.loc 1 376 5 view .LVU712
	ldr	r2, [r4, #48]	@, g_armwave_state.size
	ldr	r0, [r4, #4]	@, g_armwave_state.ch1_buffer
	bl	memset		@
.LVL174:
	.loc 1 378 5 is_stmt 1 view .LVU713
@ armwave.c:378:     for(yy = 0; yy < (2048 / g_armwave_state.slice_height); yy++) {
	.loc 1 378 45 is_stmt 0 view .LVU714
	ldr	r5, [r4, #40]	@ _72, g_armwave_state.slice_height
@ armwave.c:378:     for(yy = 0; yy < (2048 / g_armwave_state.slice_height); yy++) {
	.loc 1 378 5 view .LVU715
	cmp	r5, #2048	@ _72,
	bhi	.L151		@,
	ldr	r6, [r4, #36]	@ prephitmp_171, g_armwave_state.waves
@ armwave.c:378:     for(yy = 0; yy < (2048 / g_armwave_state.slice_height); yy++) {
	.loc 1 378 12 view .LVU716
	mov	r10, #0	@ yy,
.LVL175:
.L157:
	.loc 1 379 9 is_stmt 1 discriminator 3 view .LVU717
	mul	r3, r5, r10	@ _3, _72, yy
.LBB16:
.LBB17:
@ armwave.c:106:     write_buffer_base = g_armwave_state.ch1_buffer + (slice_y * g_armwave_state.target_height);
	.loc 1 106 63 is_stmt 0 discriminator 3 view .LVU718
	ldr	r0, [r4, #56]	@ g_armwave_state.target_height, g_armwave_state.target_height
@ armwave.c:109:     for(w = 0; w < g_armwave_state.waves; w++) {
	.loc 1 109 5 discriminator 3 view .LVU719
...
@ armwave.c:379:         render_nonaa_to_buffer_1ch_slice(yy * g_armwave_state.slice_height, g_armwave_state.slice_record_height);
	.loc 1 379 9 discriminator 3 view .LVU720
	ldr	r9, [r4, #44]	@ _4, g_armwave_state.slice_record_height
.LVL176:
.LBB19:
.LBI16:
	.loc 1 98 6 is_stmt 1 discriminator 3 view .LVU721
.LBB18:
	.loc 1 100 5 discriminator 3 view .LVU722
	.loc 1 101 5 discriminator 3 view .LVU723
	.loc 1 102 5 discriminator 3 view .LVU724
	.loc 1 103 5 discriminator 3 view .LVU725
	.loc 1 104 5 discriminator 3 view .LVU726
	.loc 1 106 5 discriminator 3 view .LVU727
@ armwave.c:106:     write_buffer_base = g_armwave_state.ch1_buffer + (slice_y * g_armwave_state.target_height);
	.loc 1 106 63 is_stmt 0 discriminator 3 view .LVU728
	mul	r0, r0, r3	@ _15, g_armwave_state.target_height, _3
@ armwave.c:106:     write_buffer_base = g_armwave_state.ch1_buffer + (slice_y * g_armwave_state.target_height);
	.loc 1 106 40 discriminator 3 view .LVU729
	ldr	r2, [r4, #4]	@ _13, g_armwave_state.ch1_buffer
.LVL177:
	.loc 1 109 5 is_stmt 1 discriminator 3 view .LVU730
	.loc 1 109 5 is_stmt 0 discriminator 3 view .LVU731
	beq	.L153		@,
@ armwave.c:109:     for(w = 0; w < g_armwave_state.waves; w++) {
	.loc 1 109 11 view .LVU732
	mov	r8, #0	@ w,
	sub	r3, r3, #4	@ _77, _3,
.LVL178:
	.loc 1 109 11 view .LVU733
	str	r3, [sp, #4]	@ _77, %sfp
.LVL179:
.L156:
	.loc 1 110 9 is_stmt 1 view .LVU734
@ armwave.c:110:         wave_base = g_armwave_state.wave_buffer + slice_y + (w * g_armwave_state.wave_stride);
	.loc 1 110 64 is_stmt 0 view .LVU735
	ldr	r3, [r4, #32]	@ g_armwave_state.wave_stride, g_armwave_state.wave_stride
@ armwave.c:114:         for(yy = 0; yy < height; yy += 4) {
	.loc 1 114 9 view .LVU736
	cmp	r9, #0	@ _4,
@ armwave.c:110:         wave_base = g_armwave_state.wave_buffer + slice_y + (w * g_armwave_state.wave_stride);
	.loc 1 110 36 view .LVU737
	ldr	lr, [r4, #20]	@ _16, g_armwave_state.wave_buffer
@ armwave.c:110:         wave_base = g_armwave_state.wave_buffer + slice_y + (w * g_armwave_state.wave_stride);
	.loc 1 110 64 view .LVU738
	mul	r3, r3, r8	@ _19, g_armwave_state.wave_stride, w
.LVL180:
	.loc 1 114 9 is_stmt 1 view .LVU739
	.loc 1 114 9 is_stmt 0 view .LVU740
	beq	.L154		@,
	ldr	r1, [sp, #4]	@ _77, %sfp
	add	r3, r3, r1	@ tmp205, _19, _77
.LVL181:
	.loc 1 114 9 view .LVU741
	add	lr, lr, r3	@ ivtmp.103, _16, tmp205
.LVL182:
@ armwave.c:114:         for(yy = 0; yy < height; yy += 4) {
	.loc 1 114 16 view .LVU742
	mov	r1, #0	@ yy,
.LVL183:
.L155:
	.loc 1 115 13 is_stmt 1 view .LVU743
@ armwave.c:115:             word = *(uint32_t*)(wave_base + yy);
	.loc 1 115 18 is_stmt 0 view .LVU744
	ldr	r3, [lr, #4]!	@ word, MEM[base: _183, offset: 0B]
.LVL184:
	.loc 1 117 13 is_stmt 1 view .LVU745
	.loc 1 118 17 view .LVU746
	.loc 1 119 17 view .LVU747
	.loc 1 120 17 view .LVU748
@ armwave.c:118:                 scale_value = (word & 0xff) * g_armwave_state.vscale;
	.loc 1 118 45 is_stmt 0 view .LVU749
	ldr	r7, [r4, #28]	@ g_armwave_state.vscale, g_armwave_state.vscale
@ armwave.c:119:                 write_buffer = write_buffer_base + ((yy + ys) * g_armwave_state.target_height);
	.loc 1 119 63 view .LVU750
	ldr	r6, [r4, #56]	@ g_armwave_state.target_height, g_armwave_state.target_height
@ armwave.c:118:                 scale_value = (word & 0xff) * g_armwave_state.vscale;
	.loc 1 118 37 view .LVU751
	uxtb	ip, r3	@ word, word
@ armwave.c:121:                 word >>= 8;
	.loc 1 121 22 view .LVU752
	lsr	r5, r3, #8	@ word, word,
@ armwave.c:120:                 *(write_buffer + scale_value) += 1;
	.loc 1 120 47 view .LVU753
	mla	ip, r7, ip, r0	@ tmp210, g_armwave_state.vscale, word, _15
@ armwave.c:118:                 scale_value = (word & 0xff) * g_armwave_state.vscale;
	.loc 1 118 37 view .LVU754
	uxtb	r5, r5	@ word, word
@ armwave.c:120:                 *(write_buffer + scale_value) += 1;
	.loc 1 120 47 view .LVU755
	mla	r6, r6, r1, ip	@ tmp214, g_armwave_state.target_height, yy, tmp210
@ armwave.c:119:                 write_buffer = write_buffer_base + ((yy + ys) * g_armwave_state.target_height);
	.loc 1 119 63 view .LVU756
	add	fp, r1, #1	@ tmp226, yy,
@ armwave.c:121:                 word >>= 8;
	.loc 1 121 22 view .LVU757
	lsr	ip, r3, #16	@ word, word,
@ armwave.c:120:                 *(write_buffer + scale_value) += 1;
	.loc 1 120 47 view .LVU758
	ldrb	r7, [r2, r6]	@ zero_extendqisi2	@ *_63, *_63
@ armwave.c:118:                 scale_value = (word & 0xff) * g_armwave_state.vscale;
	.loc 1 118 37 view .LVU759
...
.LVL186:
	.loc 1 121 17 is_stmt 1 view .LVU762
	.loc 1 118 17 view .LVU763
	.loc 1 119 17 view .LVU764
	.loc 1 120 17 view .LVU765
@ armwave.c:118:                 scale_value = (word & 0xff) * g_armwave_state.vscale;
	.loc 1 118 45 is_stmt 0 view .LVU766
...
@ armwave.c:114:         for(yy = 0; yy < height; yy += 4) {
	...
	cmp	r9, r1	@ _4, yy
@ armwave.c:120:                 *(write_buffer + scale_value) += 1;
	.loc 1 120 47 view .LVU775
	add	fp, fp, #1	@ tmp232, *_83,
	strb	fp, [r2, r5]	@ tmp232, *_83
.LVL188:
	.loc 1 121 17 is_stmt 1 view .LVU776
	.loc 1 118 17 view .LVU777
	.loc 1 119 17 view .LVU778
	.loc 1 120 17 view .LVU779
@ armwave.c:118:                 scale_value = (word & 0xff) * g_armwave_state.vscale;
	.loc 1 118 45 is_stmt 0 view .LVU780
...
@ armwave.c:120:                 *(write_buffer + scale_value) += 1;
	...
	.loc 1 121 17 is_stmt 1 view .LVU783
.LVL189:
...
@ armwave.c:120:                 *(write_buffer + scale_value) += 1;
	...
	.loc 1 121 17 is_stmt 1 view .LVU790
.LVL190:
@ armwave.c:114:         for(yy = 0; yy < height; yy += 4) {
	.loc 1 114 9 is_stmt 0 view .LVU791
	bhi	.L155		@,
	ldr	r6, [r4, #36]	@ prephitmp_171, g_armwave_state.waves
.LVL191:
.L154:
@ armwave.c:109:     for(w = 0; w < g_armwave_state.waves; w++) {
	.loc 1 109 44 view .LVU792
	add	r8, r8, #1	@ w, w,
.LVL192:
@ armwave.c:109:     for(w = 0; w < g_armwave_state.waves; w++) {
	.loc 1 109 5 view .LVU793
	cmp	r8, r6	@ w, prephitmp_171
	bcc	.L156		@,
	ldr	r5, [r4, #40]	@ _72, g_armwave_state.slice_height
.LVL193:
.L153:
	.loc 1 109 5 view .LVU794
.LBE18:
.LBE19:
@ armwave.c:378:     for(yy = 0; yy < (2048 / g_armwave_state.slice_height); yy++) {
	.loc 1 378 28 discriminator 3 view .LVU795
	mov	r1, r5	@, _72
	mov	r0, #2048	@,
.LVL194:
	.loc 1 378 28 discriminator 3 view .LVU796
	bl	__aeabi_uidiv		@
.LVL195:
@ armwave.c:378:     for(yy = 0; yy < (2048 / g_armwave_state.slice_height); yy++) {
	.loc 1 378 63 discriminator 3 view .LVU797
	add	r10, r10, #1	@ yy, yy,
.LVL196:
@ armwave.c:378:     for(yy = 0; yy < (2048 / g_armwave_state.slice_height); yy++) {
	.loc 1 378 5 discriminator 3 view .LVU798
	cmp	r0, r10	@, yy
	bhi	.L157		@,
.LVL197:
.L151:
@ armwave.c:381: }
	.loc 1 381 1 view .LVU799
	add	sp, sp, #12	@,,
	.cfi_def_cfa_offset 36
	@ sp needed	@
	pop	{r4, r5, r6, r7, r8, r9, r10, fp, pc}	@
...
.LFB68:
	...
	@ args = 0, pretend = 0, frame = 0
	@ frame_needed = 0, uses_anonymous_args = 0
	.loc 1 385 5 view .LVU801
	.loc 1 386 5 view .LVU802
@ armwave.c:384: {
	.loc 1 384 1 is_stmt 0 view .LVU803
	push	{r4, r5, r6, lr}	@
	.cfi_def_cfa_offset 16
	.cfi_offset 4, -16
	.cfi_offset 5, -12
...
@ armwave.c:386:     Py_buffer *buf = malloc(sizeof(Py_buffer));
	.loc 1 386 22 view .LVU804
	mov	r0, #44	@,
@ armwave.c:388:  	armwave_fill_pixbuf_scaled(g_armwave_state.out_pixbuf);
	.loc 1 388 3 view .LVU805
	ldr	r5, .L178	@ tmp143,
@ armwave.c:384: {
	.loc 1 384 1 view .LVU806
	sub	sp, sp, #8	@,,
	.cfi_def_cfa_offset 24
@ armwave.c:386:     Py_buffer *buf = malloc(sizeof(Py_buffer));
	.loc 1 386 22 view .LVU807
	bl	malloc		@
.LVL198:
	.loc 1 388 3 is_stmt 1 view .LVU808
.LBB24:
.LBI24:
	.loc 1 263 6 view .LVU809
.LBB25:
	.loc 1 265 5 view .LVU810
	.loc 1 266 5 view .LVU811
	.loc 1 267 5 view .LVU812
	.loc 1 268 5 view .LVU813
	.loc 1 269 5 view .LVU814
	.loc 1 270 5 view .LVU815
	.loc 1 272 5 view .LVU816
	ldr	r3, [r5, #68]	@ g_armwave_state.out_pixbuf, g_armwave_state.out_pixbuf
	cmp	r3, #0	@ g_armwave_state.out_pixbuf,
	beq	.L177		@,
	.loc 1 276 5 view .LVU817
@ armwave.c:276:     npix = g_armwave_state.target_width * 256; //g_armwave_state.target_height;
	.loc 1 276 27 is_stmt 0 view .LVU818
	ldr	r4, [r5, #52]	@ _12, g_armwave_state.target_width
@ armwave.c:277:     vscale = g_armwave_state.target_height / 256;
	.loc 1 277 44 view .LVU819
	ldr	r3, [r5, #56]	@ g_armwave_state.target_height, g_armwave_state.target_height
@ armwave.c:279:     printf("np=%d w=%d v=%d\n", npix, g_armwave_state.target_width, vscale);
	.loc 1 279 5 view .LVU820
	mov	r2, r4	@, _12
@ armwave.c:276:     npix = g_armwave_state.target_width * 256; //g_armwave_state.target_height;
	.loc 1 276 41 view .LVU821
	lsl	r4, r4, #8	@ npix, _12,
.LVL199:
	.loc 1 277 5 is_stmt 1 view .LVU822
	.loc 1 279 5 view .LVU823
	mov	r6, r0	@ buf,
	mov	r1, r4	@, npix
	lsr	r3, r3, #8	@, g_armwave_state.target_height,
.LVL200:
	.loc 1 279 5 is_stmt 0 view .LVU824
	ldr	r0, .L178+4	@,
.LVL201:
	.loc 1 279 5 view .LVU825
	bl	printf		@
.LVL202:
	.loc 1 296 5 is_stmt 1 view .LVU826
	.loc 1 296 5 is_stmt 0 view .LVU827
	cmp	r4, #0	@ npix,
	ble	.L173		@,
@ armwave.c:296:     for(n = 0; n < npix; n += 4) {
	.loc 1 296 11 view .LVU828
	mov	r3, #0	@ n,
.LVL203:
.L174:
	.loc 1 300 9 is_stmt 1 view .LVU829
	.loc 1 302 9 view .LVU830
@ armwave.c:296:     for(n = 0; n < npix; n += 4) {
	.loc 1 296 28 is_stmt 0 view .LVU831
	add	r3, r3, #4	@ n, n,
.LVL204:
@ armwave.c:296:     for(n = 0; n < npix; n += 4) {
	.loc 1 296 5 view .LVU832
	cmp	r4, r3	@ npix, n
	bgt	.L174		@,
.LVL205:
.L173:
	.loc 1 296 5 view .LVU833
.LBE25:
.LBE24:
	.loc 1 398 5 is_stmt 1 view .LVU834
@ armwave.c:398:     PyBuffer_FillInfo(buf, NULL, g_armwave_state.out_pixbuf, sizeof(uint32_t) * g_armwave_state.size, true, PyBUF_ND);
	.loc 1 398 79 is_stmt 0 view .LVU835
	ldr	r3, [r5, #48]	@ g_armwave_state.size, g_armwave_state.size
@ armwave.c:398:     PyBuffer_FillInfo(buf, NULL, g_armwave_state.out_pixbuf, sizeof(uint32_t) * g_armwave_state.size, true, PyBUF_ND);
	.loc 1 398 5 view .LVU836
	mov	r0, #8	@ tmp141,
	mov	r1, #1	@ tmp142,
	str	r0, [sp, #4]	@ tmp141,
	str	r1, [sp]	@ tmp142,
...
.LVL206:
	.loc 1 400 5 is_stmt 1 view .LVU837
@ armwave.c:400:     mv = PyMemoryView_FromBuffer(buf);
	.loc 1 400 10 is_stmt 0 view .LVU838
	mov	r0, r6	@, buf
@ armwave.c:401: }
	.loc 1 401 1 view .LVU839
	add	sp, sp, #8	@,,
	.cfi_remember_state
	.cfi_def_cfa_offset 16
	@ sp needed	@
...
.LBB26:
.LBI26:
	.loc 1 263 6 is_stmt 1 view .LVU841
.LBB27:
	.loc 1 272 5 view .LVU842
	ldr	r3, .L178+8	@,
.LVL209:
	.loc 1 272 5 is_stmt 0 view .LVU843
	mov	r2, #272	@,
	ldr	r1, .L178+12	@,
	ldr	r0, .L178+16	@,
.LVL210:
	.loc 1 272 5 view .LVU844
	bl	__assert_fail		@
.LVL211:
.L179:
	.loc 1 272 5 view .LVU845
	.align	2
.L178:
	.word	g_armwave_state
	.word	.LC6
...
.LFB69:
	...
	@ frame_needed = 0, uses_anonymous_args = 0
	@ link register save eliminated.
	.loc 1 405 5 view .LVU847
	ldr	r3, .L181	@ tmp112,
	mov	r1, r0	@, fn
	ldr	r0, [r3, #68]	@, g_armwave_state.out_pixbuf
.LVL213:
	.loc 1 405 5 is_stmt 0 view .LVU848
	b	armwave_dump_ppm_debug		@
.LVL214:
.L182:
	.loc 1 405 5 view .LVU849
	.align	2
.L181:
	.word	g_armwave_state
	.cfi_endproc
...
.LFB71:
	...
	@ args = 0, pretend = 0, frame = 8
	@ frame_needed = 0, uses_anonymous_args = 0
	.loc 1 421 5 view .LVU865
	.loc 1 422 5 view .LVU866
	.loc 1 425 5 view .LVU867
.LBB34:
.LBI34:
	.loc 1 127 6 view .LVU868
.LBB35:
	.loc 1 129 5 view .LVU869
.LBE35:
.LBE34:
@ armwave.c:420: {
	.loc 1 420 1 is_stmt 0 view .LVU870
	push	{r4, r5, r6, r7, r8, r9, r10, fp, lr}	@
	.cfi_def_cfa_offset 36
	.cfi_offset 4, -36
	.cfi_offset 5, -32
...
.LBB38:
@ armwave.c:129:     g_armwave_state.flags = 0;
	.loc 1 129 27 view .LVU875
	str	r3, [r9]	@ tmp192, g_armwave_state.flags
.LBE38:
.LBE41:
	.loc 1 428 5 is_stmt 1 view .LVU876
	bl	test_create_waveform		@
.LVL219:
	.loc 1 431 5 view .LVU877
	bl	test_create_gamma		@
.LVL220:
	.loc 1 434 5 view .LVU878
	mov	r1, #256	@,
	mov	r0, #2048	@,
	bl	armwave_setup_render.constprop.1		@
.LVL221:
	.loc 1 438 5 view .LVU879
	.loc 1 438 5 is_stmt 0 view .LVU880
	ldr	r5, [r9, #40]	@ _61, g_armwave_state.slice_height
.LVL222:
.L188:
@ armwave.c:439:         for(yy = 0; yy < (2048 / g_armwave_state.slice_height); yy++) {
	.loc 1 439 9 view .LVU881
	cmp	r5, #2048	@ _61,
	bhi	.L196		@,
	ldr	r4, [r9, #36]	@ prephitmp_178, g_armwave_state.waves
@ armwave.c:439:         for(yy = 0; yy < (2048 / g_armwave_state.slice_height); yy++) {
	.loc 1 439 16 view .LVU882
	mov	r8, #0	@ yy,
	mov	r6, r4	@ prephitmp_178, prephitmp_178
.LVL223:
.L193:
	.loc 1 441 13 is_stmt 1 discriminator 3 view .LVU883
	mul	r3, r5, r8	@ _1, _61, yy
.LBB42:
.LBB43:
@ armwave.c:106:     write_buffer_base = g_armwave_state.ch1_buffer + (slice_y * g_armwave_state.target_height);
	.loc 1 106 63 is_stmt 0 discriminator 3 view .LVU884
	ldr	r0, [r9, #56]	@ g_armwave_state.target_height, g_armwave_state.target_height
@ armwave.c:109:     for(w = 0; w < g_armwave_state.waves; w++) {
	.loc 1 109 5 discriminator 3 view .LVU885
...
@ armwave.c:441:             render_nonaa_to_buffer_1ch_slice(yy * g_armwave_state.slice_height, g_armwave_state.slice_record_height);
	.loc 1 441 13 discriminator 3 view .LVU886
	ldr	r10, [r9, #44]	@ _2, g_armwave_state.slice_record_height
.LVL224:
.LBB45:
.LBI42:
	.loc 1 98 6 is_stmt 1 discriminator 3 view .LVU887
.LBB44:
	.loc 1 100 5 discriminator 3 view .LVU888
	.loc 1 101 5 discriminator 3 view .LVU889
	.loc 1 102 5 discriminator 3 view .LVU890
	.loc 1 103 5 discriminator 3 view .LVU891
	.loc 1 104 5 discriminator 3 view .LVU892
	.loc 1 106 5 discriminator 3 view .LVU893
@ armwave.c:106:     write_buffer_base = g_armwave_state.ch1_buffer + (slice_y * g_armwave_state.target_height);
	.loc 1 106 63 is_stmt 0 discriminator 3 view .LVU894
	mul	r0, r0, r3	@ _19, g_armwave_state.target_height, _1
@ armwave.c:106:     write_buffer_base = g_armwave_state.ch1_buffer + (slice_y * g_armwave_state.target_height);
	.loc 1 106 40 discriminator 3 view .LVU895
	ldr	r2, [r9, #4]	@ _17, g_armwave_state.ch1_buffer
.LVL225:
	.loc 1 109 5 is_stmt 1 discriminator 3 view .LVU896
	.loc 1 109 5 is_stmt 0 discriminator 3 view .LVU897
	beq	.L189		@,
@ armwave.c:109:     for(w = 0; w < g_armwave_state.waves; w++) {
	.loc 1 109 11 view .LVU898
	mov	r7, #0	@ w,
	sub	r3, r3, #4	@ _81, _1,
.LVL226:
	.loc 1 109 11 view .LVU899
	str	r3, [sp]	@ _81, %sfp
.LVL227:
.L192:
	.loc 1 110 9 is_stmt 1 view .LVU900
@ armwave.c:110:         wave_base = g_armwave_state.wave_buffer + slice_y + (w * g_armwave_state.wave_stride);
	.loc 1 110 64 is_stmt 0 view .LVU901
	ldr	r3, [r9, #32]	@ g_armwave_state.wave_stride, g_armwave_state.wave_stride
@ armwave.c:114:         for(yy = 0; yy < height; yy += 4) {
	.loc 1 114 9 view .LVU902
	cmp	r10, #0	@ _2,
@ armwave.c:110:         wave_base = g_armwave_state.wave_buffer + slice_y + (w * g_armwave_state.wave_stride);
	.loc 1 110 36 view .LVU903
	ldr	lr, [r9, #20]	@ _20, g_armwave_state.wave_buffer
@ armwave.c:110:         wave_base = g_armwave_state.wave_buffer + slice_y + (w * g_armwave_state.wave_stride);
	.loc 1 110 64 view .LVU904
	mul	r3, r3, r7	@ _23, g_armwave_state.wave_stride, w
.LVL228:
	.loc 1 114 9 is_stmt 1 view .LVU905
	.loc 1 114 9 is_stmt 0 view .LVU906
	beq	.L190		@,
	ldr	r1, [sp]	@ _81, %sfp
	add	r3, r3, r1	@ tmp202, _23, _81
.LVL229:
	.loc 1 114 9 view .LVU907
	add	lr, lr, r3	@ ivtmp.119, _20, tmp202
.LVL230:
@ armwave.c:114:         for(yy = 0; yy < height; yy += 4) {
	.loc 1 114 16 view .LVU908
	mov	r1, #0	@ yy,
.LVL231:
.L191:
	.loc 1 115 13 is_stmt 1 view .LVU909
@ armwave.c:115:             word = *(uint32_t*)(wave_base + yy);
	.loc 1 115 18 is_stmt 0 view .LVU910
	ldr	r3, [lr, #4]!	@ word, MEM[base: _177, offset: 0B]
.LVL232:
	.loc 1 117 13 is_stmt 1 view .LVU911
	.loc 1 118 17 view .LVU912
	.loc 1 119 17 view .LVU913
	.loc 1 120 17 view .LVU914
@ armwave.c:118:                 scale_value = (word & 0xff) * g_armwave_state.vscale;
	.loc 1 118 45 is_stmt 0 view .LVU915
	ldr	r6, [r9, #28]	@ g_armwave_state.vscale, g_armwave_state.vscale
@ armwave.c:119:                 write_buffer = write_buffer_base + ((yy + ys) * g_armwave_state.target_height);
	.loc 1 119 63 view .LVU916
	ldr	r5, [r9, #56]	@ g_armwave_state.target_height, g_armwave_state.target_height
@ armwave.c:118:                 scale_value = (word & 0xff) * g_armwave_state.vscale;
	.loc 1 118 37 view .LVU917
	uxtb	ip, r3	@ word, word
@ armwave.c:121:                 word >>= 8;
	.loc 1 121 22 view .LVU918
	lsr	r4, r3, #8	@ word, word,
@ armwave.c:120:                 *(write_buffer + scale_value) += 1;
	.loc 1 120 47 view .LVU919
	mla	ip, r6, ip, r0	@ tmp207, g_armwave_state.vscale, word, _19
@ armwave.c:118:                 scale_value = (word & 0xff) * g_armwave_state.vscale;
	.loc 1 118 37 view .LVU920
	uxtb	r4, r4	@ word, word
@ armwave.c:120:                 *(write_buffer + scale_value) += 1;
	.loc 1 120 47 view .LVU921
	mla	r5, r5, r1, ip	@ tmp211, g_armwave_state.target_height, yy, tmp207
@ armwave.c:119:                 write_buffer = write_buffer_base + ((yy + ys) * g_armwave_state.target_height);
	.loc 1 119 63 view .LVU922
	add	fp, r1, #1	@ tmp223, yy,
@ armwave.c:121:                 word >>= 8;
	.loc 1 121 22 view .LVU923
	lsr	ip, r3, #16	@ word, word,
@ armwave.c:120:                 *(write_buffer + scale_value) += 1;
	.loc 1 120 47 view .LVU924
	ldrb	r6, [r2, r5]	@ zero_extendqisi2	@ *_67, *_67
@ armwave.c:118:                 scale_value = (word & 0xff) * g_armwave_state.vscale;
	.loc 1 118 37 view .LVU925
	uxtb	ip, ip	@ word, word
@ armwave.c:121:                 word >>= 8;
	.loc 1 121 22 view .LVU926
	lsr	r3, r3, #24	@ word, word,
.LVL233:
@ armwave.c:120:                 *(write_buffer + scale_value) += 1;
...
.LVL234:
	.loc 1 121 17 is_stmt 1 view .LVU928
	.loc 1 118 17 view .LVU929
	.loc 1 119 17 view .LVU930
	.loc 1 120 17 view .LVU931
@ armwave.c:118:                 scale_value = (word & 0xff) * g_armwave_state.vscale;
	.loc 1 118 45 is_stmt 0 view .LVU932
...
.LVL236:
	.loc 1 121 17 is_stmt 1 view .LVU942
...
.LVL238:
@ armwave.c:114:         for(yy = 0; yy < height; yy += 4) {
	.loc 1 114 9 is_stmt 0 view .LVU957
	bhi	.L191		@,
	ldr	r6, [r9, #36]	@ prephitmp_178, g_armwave_state.waves
.LVL239:
.L190:
@ armwave.c:109:     for(w = 0; w < g_armwave_state.waves; w++) {
	.loc 1 109 44 view .LVU958
	add	r7, r7, #1	@ w, w,
.LVL240:
@ armwave.c:109:     for(w = 0; w < g_armwave_state.waves; w++) {
	.loc 1 109 5 view .LVU959
	cmp	r7, r6	@ w, prephitmp_178
	bcc	.L192		@,
	ldr	r5, [r9, #40]	@ _61, g_armwave_state.slice_height
.LVL241:
.L189:
	.loc 1 109 5 view .LVU960
.LBE44:
.LBE45:
@ armwave.c:439:         for(yy = 0; yy < (2048 / g_armwave_state.slice_height); yy++) {
	.loc 1 439 32 discriminator 3 view .LVU961
	mov	r1, r5	@, _61
	mov	r0, #2048	@,
.LVL242:
	.loc 1 439 32 discriminator 3 view .LVU962
	bl	__aeabi_uidiv		@
.LVL243:
@ armwave.c:439:         for(yy = 0; yy < (2048 / g_armwave_state.slice_height); yy++) {
	.loc 1 439 67 discriminator 3 view .LVU963
	add	r8, r8, #1	@ yy, yy,
.LVL244:
@ armwave.c:439:         for(yy = 0; yy < (2048 / g_armwave_state.slice_height); yy++) {
	.loc 1 439 9 discriminator 3 view .LVU964
	cmp	r0, r8	@, yy
	bhi	.L193		@,
.LVL245:
.L196:
@ armwave.c:438:     for(n = 0; n < 5000; n++) {
	.loc 1 438 5 discriminator 2 view .LVU965
	ldr	r3, [sp, #4]	@ ivtmp_191, %sfp
	subs	r3, r3, #1	@ ivtmp_191, ivtmp_191,
	str	r3, [sp, #4]	@ ivtmp_191, %sfp
	bne	.L188		@,
	mov	r0, r3	@, ivtmp_191
	.loc 1 454 5 is_stmt 1 view .LVU966
@ armwave.c:455: }
	.loc 1 455 1 is_stmt 0 view .LVU967
	add	sp, sp, #12	@,,
	.cfi_def_cfa_offset 36
	@ sp needed	@
	pop	{r4, r5, r6, r7, r8, r9, r10, fp, pc}	@
