...
@ armwave.c:48: {
	...
	add	r6, r6, #15	@ ivtmp.37, ivtmp.37,
	rsb	r8, r8, #0	@ ivtmp.40, _75
...
@ armwave.c:70:             test_wave_buffer[x + (w * TEST_WAVE_SIZE)] = MIN(MAX(128 + (v * 127), 0), 255);
	...
	sub	r5, r6, #2048	@ ivtmp.30, ivtmp.37,
	add	r7, r8, #1	@ tmp196, ivtmp.40,
@ armwave.c:53:         mod = 0.5f + (((float)w / TEST_NWAVES) * mod_depth);
...
@ armwave.c:57:             noise  = ((rand() & 0xffff) / 100000.0f);
	...
	bl	rand		@
.LVL15:
	add	r4, r7, r5	@ _71, tmp196, ivtmp.30
.LVL16:
...
@ armwave.c:84:         gamma_table[i] = pow(i / 255.0f, gamma) * 255.0f;
	...
	add	r5, r4, #1	@ _25, ivtmp.48,
	add	r6, r4, #256	@ _26, ivtmp.48,
...
@ armwave.c:84:         gamma_table[i] = pow(i / 255.0f, gamma) * 255.0f;
	...
	add	r3, r5, r4	@ tmp125, tmp134, ivtmp.48
@ armwave.c:84:         gamma_table[i] = pow(i / 255.0f, gamma) * 255.0f;
...
@ armwave.c:117:         for(yy = 0; yy < height; yy += 4) {
	...
	add	r7, r7, r3	@ ivtmp.54, g_armwave_state.wave_buffer, tmp195
.LVL39:
.L44:
...
@ armwave.c:282:     uint8_t *base_ptr = g_armwave_state.ch1_buffer;
	...
	ldr	r1, .L91	@ tmp177,
@ armwave.c:285:     assert(out_buffer != NULL);
	.loc 1 285 5 view .LVU338
	cmp	r0, #0	@ out_buffer
@ armwave.c:278: {
...
.LVL75:
	...
	.loc 1 285 5 view .LVU342
	beq	.L80		@,
.LVL76:
@ armwave.c:288:     for(yy = 0; yy < g_armwave_state.target_height; yy++) {
	.loc 1 288 37 is_stmt 0 view .LVU343
	ldr	r2, [r1, #56]	@ prephitmp_105, g_armwave_state.target_height
@ armwave.c:288:     for(yy = 0; yy < g_armwave_state.target_height; yy++) {
	.loc 1 288 5 view .LVU344
	cmp	r2, #0	@ prephitmp_105,
	popeq	{r4, r5, r6, pc}	@
	ldr	r3, [r1, #52]	@ _28, g_armwave_state.target_width
@ armwave.c:288:     for(yy = 0; yy < g_armwave_state.target_height; yy++) {
	.loc 1 288 12 view .LVU345
	mov	lr, #0	@ yy,
.LVL77:
.L82:
@ armwave.c:289:         for(xx = 0; xx < g_armwave_state.target_width; xx++) {
	.loc 1 289 9 view .LVU346
	cmp	r3, #0	@ _28,
@ armwave.c:289:         for(xx = 0; xx < g_armwave_state.target_width; xx++) {
	.loc 1 289 16 view .LVU347
	movne	ip, #0	@ xx,
@ armwave.c:289:         for(xx = 0; xx < g_armwave_state.target_width; xx++) {
	.loc 1 289 9 view .LVU348
	beq	.L84		@,
.LVL78:
.L83:
	.loc 1 291 13 is_stmt 1 discriminator 3 view .LVU349
@ armwave.c:291:             value = *(base_ptr + xx + (yy * g_armwave_state.target_width));
	.loc 1 291 21 is_stmt 0 discriminator 3 view .LVU350
	mla	r5, lr, r3, r4	@ tmp153, yy, _28, base_ptr
@ armwave.c:295:             bb = (g_armwave_state.ch1_color.b * value) >> 8;
	.loc 1 295 47 discriminator 3 view .LVU351
	ldrb	r2, [r1, #66]	@ zero_extendqisi2	@ g_armwave_state.ch1_color.b, g_armwave_state.ch1_color.b
@ armwave.c:294:             gg = (g_armwave_state.ch1_color.g * value) >> 8;
	.loc 1 294 47 discriminator 3 view .LVU352
	ldrb	r3, [r1, #65]	@ zero_extendqisi2	@ g_armwave_state.ch1_color.g, g_armwave_state.ch1_color.g
@ armwave.c:291:             value = *(base_ptr + xx + (yy * g_armwave_state.target_width));
	.loc 1 291 21 discriminator 3 view .LVU353
	ldrb	r6, [r5, ip]	@ zero_extendqisi2	@ _5, *_4
.LVL79:
	.loc 1 293 13 is_stmt 1 discriminator 3 view .LVU354
	.loc 1 294 13 discriminator 3 view .LVU355
	.loc 1 295 13 discriminator 3 view .LVU356
	.loc 1 297 13 discriminator 3 view .LVU357
	.loc 1 298 13 discriminator 3 view .LVU358
	.loc 1 299 13 discriminator 3 view .LVU359
	.loc 1 306 13 discriminator 3 view .LVU360
	.loc 1 308 13 discriminator 3 view .LVU361
@ armwave.c:293:             rr = (g_armwave_state.ch1_color.r * value) >> 8;
	.loc 1 293 47 is_stmt 0 discriminator 3 view .LVU362
	ldrb	r5, [r1, #64]	@ zero_extendqisi2	@ g_armwave_state.ch1_color.r, g_armwave_state.ch1_color.r
.LVL80:
@ armwave.c:289:         for(xx = 0; xx < g_armwave_state.target_width; xx++) {
	.loc 1 289 58 discriminator 3 view .LVU363
	add	ip, ip, #1	@ xx, xx,
.LVL81:
@ armwave.c:295:             bb = (g_armwave_state.ch1_color.b * value) >> 8;
	.loc 1 295 47 discriminator 3 view .LVU364
	smulbb	r2, r2, r6	@ tmp158, g_armwave_state.ch1_color.b, _5
@ armwave.c:294:             gg = (g_armwave_state.ch1_color.g * value) >> 8;
	.loc 1 294 47 discriminator 3 view .LVU365
	smulbb	r3, r3, r6	@ tmp164, g_armwave_state.ch1_color.g, _5
@ armwave.c:293:             rr = (g_armwave_state.ch1_color.r * value) >> 8;
	.loc 1 293 47 discriminator 3 view .LVU366
	smulbb	r5, r5, r6	@ tmp171, g_armwave_state.ch1_color.r, _5
.LVL82:
@ armwave.c:295:             bb = (g_armwave_state.ch1_color.b * value) >> 8;
	.loc 1 295 56 discriminator 3 view .LVU367
	lsr	r2, r2, #8	@ bb, tmp158,
@ armwave.c:306:             word = 0xff000000 | (b << 16) | (g << 8) | r;
	.loc 1 306 43 discriminator 3 view .LVU368
	and	r3, r3, #65280	@ tmp166, tmp164,
	orr	r3, r3, r2, lsl #16	@ tmp167, tmp166, bb,
@ armwave.c:306:             word = 0xff000000 | (b << 16) | (g << 8) | r;
	.loc 1 306 54 discriminator 3 view .LVU369
	orr	r3, r3, r5, lsr #8	@ tmp173, tmp167, tmp171,
@ armwave.c:306:             word = 0xff000000 | (b << 16) | (g << 8) | r;
	.loc 1 306 18 discriminator 3 view .LVU370
	orr	r3, r3, #-16777216	@ word, tmp173,
@ armwave.c:308:             *out_buffer++ = word;
	.loc 1 308 27 discriminator 3 view .LVU371
	str	r3, [r0], #4	@ word, MEM[base: out_buffer_46, offset: 4294967292B]
.LVL83:
@ armwave.c:289:         for(xx = 0; xx < g_armwave_state.target_width; xx++) {
	.loc 1 289 41 discriminator 3 view .LVU372
	ldr	r3, [r1, #52]	@ _28, g_armwave_state.target_width
@ armwave.c:289:         for(xx = 0; xx < g_armwave_state.target_width; xx++) {
	.loc 1 289 9 discriminator 3 view .LVU373
	cmp	r3, ip	@ _28, xx
	bhi	.L83		@,
	ldr	r2, [r1, #56]	@ prephitmp_105, g_armwave_state.target_height
.LVL84:
.L84:
@ armwave.c:288:     for(yy = 0; yy < g_armwave_state.target_height; yy++) {
	.loc 1 288 55 discriminator 2 view .LVU374
	add	lr, lr, #1	@ yy, yy,
.LVL85:
@ armwave.c:288:     for(yy = 0; yy < g_armwave_state.target_height; yy++) {
	.loc 1 288 5 discriminator 2 view .LVU375
	cmp	lr, r2	@ yy, prephitmp_105
	bcc	.L82		@,
	.loc 1 288 5 discriminator 2 view .LVU376
	pop	{r4, r5, r6, pc}	@
.LVL86:
.L80:
.LBB6:
.LBI6:
	.loc 1 277 6 is_stmt 1 view .LVU377
.LBB7:
	.loc 1 285 5 view .LVU378
	ldr	r3, .L91+4	@,
	ldr	r2, .L91+8	@,
	ldr	r1, .L91+12	@,
	ldr	r0, .L91+16	@,
.LVL87:
	.loc 1 285 5 is_stmt 0 view .LVU379
	bl	__assert_fail		@
.LVL88:
.L92:
	.align	2
...
@ armwave.c:314: {
	...
	sub	sp, sp, #12	@,,
	.cfi_def_cfa_offset 40
@ armwave.c:315:     FILE *fp = fopen(fn, "wb");
	.loc 1 315 16 view .LVU383
	ldr	r1, .L105	@,
.LVL90:
	.loc 1 315 16 view .LVU384
	mov	r0, r3	@, fn
.LVL91:
	.loc 1 315 16 view .LVU385
	bl	fopen64		@
.LVL92:
@ armwave.c:322:     fprintf(fp, "%d %d\n", g_armwave_state.target_height, g_armwave_state.target_width);
	.loc 1 322 5 view .LVU386
	ldr	r6, .L105+4	@ tmp154,
@ armwave.c:321:     fputs("P3\n", fp);
	.loc 1 321 5 view .LVU387
	mov	r2, #3	@,
	mov	r1, #1	@,
@ armwave.c:315:     FILE *fp = fopen(fn, "wb");
	.loc 1 315 16 view .LVU388
	mov	r7, r0	@ fp,
.LVL93:
	.loc 1 316 5 is_stmt 1 view .LVU389
	.loc 1 317 5 view .LVU390
	.loc 1 321 5 view .LVU391
	mov	r3, r0	@, fp
	ldr	r0, .L105+8	@,
.LVL94:
	.loc 1 321 5 is_stmt 0 view .LVU392
	bl	fwrite		@
.LVL95:
	.loc 1 322 5 is_stmt 1 view .LVU393
...
.LVL96:
	...
	bl	fwrite		@
.LVL97:
	.loc 1 325 5 view .LVU395
@ armwave.c:325:     for(yy = 0; yy < g_armwave_state.target_height; yy++) {
	.loc 1 325 37 is_stmt 0 view .LVU396
	ldr	r2, [r6, #56]	@ prephitmp_57, g_armwave_state.target_height
@ armwave.c:325:     for(yy = 0; yy < g_armwave_state.target_height; yy++) {
	.loc 1 325 5 view .LVU397
	cmp	r2, #0	@ prephitmp_57,
	beq	.L94		@,
	ldr	r3, [r6, #52]	@ _12, g_armwave_state.target_width
@ armwave.c:330:             fprintf(fp, "%3d %3d %3d\n", data & 0xff, (data >> 8) & 0xff, (data >> 16) & 0xff);
	.loc 1 330 13 view .LVU398
	ldr	r9, .L105+20	@ tmp156,
@ armwave.c:325:     for(yy = 0; yy < g_armwave_state.target_height; yy++) {
	.loc 1 325 12 view .LVU399
	mov	r5, #0	@ yy,
.LVL98:
.L95:
@ armwave.c:326:         for(xx = 0; xx < g_armwave_state.target_width; xx++) {
	.loc 1 326 9 view .LVU400
	cmp	r3, #0	@ _12,
@ armwave.c:326:         for(xx = 0; xx < g_armwave_state.target_width; xx++) {
	.loc 1 326 16 view .LVU401
	movne	r4, #0	@ xx,
@ armwave.c:326:         for(xx = 0; xx < g_armwave_state.target_width; xx++) {
	.loc 1 326 9 view .LVU402
	beq	.L104		@,
.LVL99:
.L96:
	.loc 1 327 13 is_stmt 1 discriminator 3 view .LVU403
@ armwave.c:327:             data = *(buffer + (xx + (yy * g_armwave_state.target_width)));
	.loc 1 327 29 is_stmt 0 discriminator 3 view .LVU404
	mla	r3, r5, r3, r4	@ tmp145, yy, _12, xx
@ armwave.c:330:             fprintf(fp, "%3d %3d %3d\n", data & 0xff, (data >> 8) & 0xff, (data >> 16) & 0xff);
	.loc 1 330 13 discriminator 3 view .LVU405
	mov	r1, r9	@, tmp156
	mov	r0, r7	@, fp
@ armwave.c:327:             data = *(buffer + (xx + (yy * g_armwave_state.target_width)));
	.loc 1 327 18 discriminator 3 view .LVU406
	ldr	r2, [r8, r3, lsl #2]	@ data, *_6
.LVL100:
	.loc 1 330 13 is_stmt 1 discriminator 3 view .LVU407
@ armwave.c:326:         for(xx = 0; xx < g_armwave_state.target_width; xx++) {
	.loc 1 326 58 is_stmt 0 discriminator 3 view .LVU408
	add	r4, r4, #1	@ xx, xx,
.LVL101:
@ armwave.c:330:             fprintf(fp, "%3d %3d %3d\n", data & 0xff, (data >> 8) & 0xff, (data >> 16) & 0xff);
	.loc 1 330 81 discriminator 3 view .LVU409
	lsr	ip, r2, #16	@ tmp150, data,
@ armwave.c:330:             fprintf(fp, "%3d %3d %3d\n", data & 0xff, (data >> 8) & 0xff, (data >> 16) & 0xff);
	.loc 1 330 61 discriminator 3 view .LVU410
	lsr	r3, r2, #8	@ tmp146, data,
@ armwave.c:330:             fprintf(fp, "%3d %3d %3d\n", data & 0xff, (data >> 8) & 0xff, (data >> 16) & 0xff);
	.loc 1 330 13 discriminator 3 view .LVU411
	uxtb	ip, ip	@ tmp151, tmp150
	uxtb	r3, r3	@, tmp146
	str	ip, [sp]	@ tmp151,
	uxtb	r2, r2	@, data
.LVL102:
	.loc 1 330 13 discriminator 3 view .LVU412
	bl	fprintf		@
.LVL103:
@ armwave.c:326:         for(xx = 0; xx < g_armwave_state.target_width; xx++) {
	.loc 1 326 41 discriminator 3 view .LVU413
	ldr	r3, [r6, #52]	@ _12, g_armwave_state.target_width
@ armwave.c:326:         for(xx = 0; xx < g_armwave_state.target_width; xx++) {
	.loc 1 326 9 discriminator 3 view .LVU414
	cmp	r3, r4	@ _12, xx
	bhi	.L96		@,
	ldr	r2, [r6, #56]	@ prephitmp_57, g_armwave_state.target_height
.LVL104:
.L97:
@ armwave.c:325:     for(yy = 0; yy < g_armwave_state.target_height; yy++) {
	.loc 1 325 55 discriminator 2 view .LVU415
	add	r5, r5, #1	@ yy, yy,
.LVL105:
@ armwave.c:325:     for(yy = 0; yy < g_armwave_state.target_height; yy++) {
	.loc 1 325 5 discriminator 2 view .LVU416
	cmp	r5, r2	@ yy, prephitmp_57
	bcc	.L95		@,
.LVL106:
.L94:
	.loc 1 334 5 is_stmt 1 view .LVU417
	mov	r0, r7	@, fp
@ armwave.c:335: }
	.loc 1 335 1 is_stmt 0 view .LVU418
	add	sp, sp, #12	@,,
	.cfi_remember_state
	.cfi_def_cfa_offset 28
	@ sp needed	@
...
.LVL107:
@ armwave.c:334:     fclose(fp);
	.loc 1 334 5 view .LVU419
	b	fclose		@
.LVL108:
.L104:
	.cfi_restore_state
@ armwave.c:325:     for(yy = 0; yy < g_armwave_state.target_height; yy++) {
	.loc 1 325 55 view .LVU420
	add	r5, r5, #1	@ yy, yy,
.LVL109:
@ armwave.c:325:     for(yy = 0; yy < g_armwave_state.target_height; yy++) {
...
.LFB65:
	...
	@ args = 0, pretend = 0, frame = 0
	@ frame_needed = 0, uses_anonymous_args = 0
	.loc 1 339 2 view .LVU423
@ armwave.c:339: 	mod_depth = mod;
	.loc 1 339 12 is_stmt 0 view .LVU424
	ldr	r3, .L111+20	@ tmp124,
@ armwave.c:338: {
	.loc 1 338 1 view .LVU425
	push	{r4, r5, r6, lr}	@
	.cfi_def_cfa_offset 16
	.cfi_offset 4, -16
	.cfi_offset 5, -12
	...
	.cfi_offset 84, -24
	.cfi_offset 85, -20
	ldr	r4, .L111+24	@ ivtmp.85,
.LBB10:
.LBB11:
@ armwave.c:84:         gamma_table[i] = pow(i / 255.0f, gamma) * 255.0f;
	.loc 1 84 32 view .LVU426
	vldr.32	s20, .L111+16	@ tmp130,
@ armwave.c:84:         gamma_table[i] = pow(i / 255.0f, gamma) * 255.0f;
	.loc 1 84 26 view .LVU427
	vldr.64	d9, .L111	@ tmp139,
@ armwave.c:84:         gamma_table[i] = pow(i / 255.0f, gamma) * 255.0f;
	.loc 1 84 49 view .LVU428
	vldr.64	d8, .L111+8	@ tmp133,
.LBE11:
.LBE10:
@ armwave.c:339: 	mod_depth = mod;
	.loc 1 339 12 view .LVU429
	vstr.32	s0, [r3]	@ mod, mod_depth
	.loc 1 341 5 is_stmt 1 view .LVU430
	bl	test_create_waveform		@
.LVL111:
	.loc 1 342 5 view .LVU431
.LBB13:
.LBI10:
	.loc 1 78 6 view .LVU432
	.loc 1 78 6 is_stmt 0 view .LVU433
	add	r3, r4, #1	@ _30, ivtmp.85,
	add	r6, r4, #256	@ _31, ivtmp.85,
	rsb	r5, r3, #1	@ tmp138, _30,
.LVL112:
.L108:
.LBB12:
	.loc 1 84 9 is_stmt 1 view .LVU434
@ armwave.c:84:         gamma_table[i] = pow(i / 255.0f, gamma) * 255.0f;
	.loc 1 84 32 is_stmt 0 view .LVU435
	add	r3, r5, r4	@ tmp127, tmp138, ivtmp.85
@ armwave.c:84:         gamma_table[i] = pow(i / 255.0f, gamma) * 255.0f;
	.loc 1 84 26 view .LVU436
...
@ armwave.c:84:         gamma_table[i] = pow(i / 255.0f, gamma) * 255.0f;
	.loc 1 84 24 view .LVU440
	vcvt.u32.f64	s15, d0	@ tmp134, tmp132
	vmov	r3, s15	@ int	@ tmp134, tmp134
	strb	r3, [r4, #1]!	@ tmp134, MEM[base: _29, offset: 0B]
.LVL114:
@ armwave.c:83:     for(i = 0; i < 256; i++) {
	.loc 1 83 5 view .LVU441
	cmp	r4, r6	@ ivtmp.85, _31
	bne	.L108		@,
.LVL115:
	.loc 1 83 5 view .LVU442
.LBE12:
.LBE13:
	.loc 1 344 5 is_stmt 1 view .LVU443
	bl	armwave_setup_render.constprop.1		@
.LVL116:
	.loc 1 346 5 view .LVU444
@ armwave.c:347: }
	.loc 1 347 1 is_stmt 0 view .LVU445
	vldm	sp!, {d8-d10}	@,
	.cfi_restore 84
	.cfi_restore 85
	.cfi_restore 82
	...
	.cfi_restore 81
	.cfi_def_cfa_offset 16
@ armwave.c:346:     printf("armwave version: %s\n", ARMWAVE_VER);
	.loc 1 346 5 view .LVU446
	ldr	r1, .L111+28	@,
	ldr	r0, .L111+32	@,
@ armwave.c:347: }
	.loc 1 347 1 view .LVU447
	pop	{r4, r5, r6, lr}	@
	.cfi_restore 14
	.cfi_restore 6
	.cfi_restore 5
...
.LFB66:
	...
	@ args = 0, pretend = 0, frame = 8
	@ frame_needed = 0, uses_anonymous_args = 0
	.loc 1 351 2 view .LVU450
	.loc 1 353 5 view .LVU451
@ armwave.c:350: {
	.loc 1 350 1 is_stmt 0 view .LVU452
	push	{r4, r5, r6, r7, r8, r9, r10, fp, lr}	@
	.cfi_def_cfa_offset 36
	.cfi_offset 4, -36
	.cfi_offset 5, -32
	...
	.cfi_offset 11, -8
	.cfi_offset 14, -4
@ armwave.c:353:     memset(g_armwave_state.ch1_buffer, 0, g_armwave_state.size);
	.loc 1 353 5 view .LVU453
	mov	r1, #0	@,
	ldr	r4, .L131	@ tmp269,
@ armwave.c:350: {
	.loc 1 350 1 view .LVU454
	sub	sp, sp, #12	@,,
	.cfi_def_cfa_offset 48
@ armwave.c:353:     memset(g_armwave_state.ch1_buffer, 0, g_armwave_state.size);
	.loc 1 353 5 view .LVU455
	ldr	r2, [r4, #48]	@, g_armwave_state.size
	ldr	r0, [r4, #4]	@, g_armwave_state.ch1_buffer
	bl	memset		@
.LVL118:
	.loc 1 355 5 is_stmt 1 view .LVU456
@ armwave.c:355:     for(yy = 0; yy < (2048 / g_armwave_state.slice_height); yy++) {
	.loc 1 355 45 is_stmt 0 view .LVU457
	ldr	r5, [r4, #40]	@ _72, g_armwave_state.slice_height
@ armwave.c:355:     for(yy = 0; yy < (2048 / g_armwave_state.slice_height); yy++) {
	.loc 1 355 5 view .LVU458
	cmp	r5, #2048	@ _72,
	bhi	.L113		@,
	ldr	r6, [r4, #36]	@ prephitmp_171, g_armwave_state.waves
@ armwave.c:355:     for(yy = 0; yy < (2048 / g_armwave_state.slice_height); yy++) {
	.loc 1 355 12 view .LVU459
	mov	r10, #0	@ yy,
.LVL119:
.L119:
	.loc 1 356 9 is_stmt 1 discriminator 3 view .LVU460
	mul	r3, r5, r10	@ _3, _72, yy
.LBB16:
.LBB17:
@ armwave.c:103:     write_buffer_base = g_armwave_state.ch1_buffer + (slice_y * g_armwave_state.target_height);
	.loc 1 103 63 is_stmt 0 discriminator 3 view .LVU461
	ldr	r0, [r4, #56]	@ g_armwave_state.target_height, g_armwave_state.target_height
@ armwave.c:106:     for(w = 0; w < g_armwave_state.waves; w++) {
	.loc 1 106 5 discriminator 3 view .LVU462
	cmp	r6, #0	@ prephitmp_171,
.LBE17:
.LBE16:
@ armwave.c:356:         render_nonaa_to_buffer_1ch_slice(yy * g_armwave_state.slice_height, g_armwave_state.slice_record_height);
	.loc 1 356 9 discriminator 3 view .LVU463
	ldr	r9, [r4, #44]	@ _4, g_armwave_state.slice_record_height
.LVL120:
.LBB19:
.LBI16:
	.loc 1 95 6 is_stmt 1 discriminator 3 view .LVU464
.LBB18:
	.loc 1 97 5 discriminator 3 view .LVU465
	.loc 1 98 5 discriminator 3 view .LVU466
	.loc 1 99 5 discriminator 3 view .LVU467
	.loc 1 100 5 discriminator 3 view .LVU468
	.loc 1 101 5 discriminator 3 view .LVU469
	.loc 1 103 5 discriminator 3 view .LVU470
@ armwave.c:103:     write_buffer_base = g_armwave_state.ch1_buffer + (slice_y * g_armwave_state.target_height);
	.loc 1 103 63 is_stmt 0 discriminator 3 view .LVU471
	mul	r0, r0, r3	@ _15, g_armwave_state.target_height, _3
@ armwave.c:103:     write_buffer_base = g_armwave_state.ch1_buffer + (slice_y * g_armwave_state.target_height);
	.loc 1 103 40 discriminator 3 view .LVU472
	ldr	r2, [r4, #4]	@ _13, g_armwave_state.ch1_buffer
.LVL121:
	.loc 1 106 5 is_stmt 1 discriminator 3 view .LVU473
	.loc 1 106 5 is_stmt 0 discriminator 3 view .LVU474
	beq	.L115		@,
@ armwave.c:106:     for(w = 0; w < g_armwave_state.waves; w++) {
	.loc 1 106 11 view .LVU475
	mov	r8, #0	@ w,
	sub	r3, r3, #4	@ _77, _3,
.LVL122:
	.loc 1 106 11 view .LVU476
	str	r3, [sp, #4]	@ _77, %sfp
.LVL123:
.L118:
	.loc 1 107 9 is_stmt 1 view .LVU477
@ armwave.c:107:         wave_base = g_armwave_state.wave_buffer + slice_y + (w * g_armwave_state.wave_stride);
	.loc 1 107 64 is_stmt 0 view .LVU478
	ldr	r3, [r4, #32]	@ g_armwave_state.wave_stride, g_armwave_state.wave_stride
@ armwave.c:117:         for(yy = 0; yy < height; yy += 4) {
	.loc 1 117 9 view .LVU479
	cmp	r9, #0	@ _4,
@ armwave.c:107:         wave_base = g_armwave_state.wave_buffer + slice_y + (w * g_armwave_state.wave_stride);
	.loc 1 107 36 view .LVU480
	ldr	lr, [r4, #20]	@ _16, g_armwave_state.wave_buffer
@ armwave.c:107:         wave_base = g_armwave_state.wave_buffer + slice_y + (w * g_armwave_state.wave_stride);
	.loc 1 107 64 view .LVU481
	mul	r3, r3, r8	@ _19, g_armwave_state.wave_stride, w
.LVL124:
	.loc 1 117 9 is_stmt 1 view .LVU482
	.loc 1 117 9 is_stmt 0 view .LVU483
	beq	.L116		@,
	ldr	r1, [sp, #4]	@ _77, %sfp
	add	r3, r3, r1	@ tmp205, _19, _77
.LVL125:
	.loc 1 117 9 view .LVU484
	add	lr, lr, r3	@ ivtmp.91, _16, tmp205
.LVL126:
@ armwave.c:117:         for(yy = 0; yy < height; yy += 4) {
	.loc 1 117 16 view .LVU485
	mov	r1, #0	@ yy,
.LVL127:
.L117:
	.loc 1 132 13 is_stmt 1 view .LVU486
@ armwave.c:132:             word = *(uint32_t*)(wave_base + yy);
	.loc 1 132 18 is_stmt 0 view .LVU487
	ldr	r3, [lr, #4]!	@ word, MEM[base: _183, offset: 0B]
.LVL128:
	.loc 1 136 13 is_stmt 1 view .LVU488
	.loc 1 137 14 view .LVU489
	.loc 1 138 14 view .LVU490
	.loc 1 139 14 view .LVU491
@ armwave.c:137:             	scale_value = (word & 0xff) * g_armwave_state.vscale;
	.loc 1 137 42 is_stmt 0 view .LVU492
	ldr	r7, [r4, #28]	@ g_armwave_state.vscale, g_armwave_state.vscale
@ armwave.c:138:             	write_buffer = write_buffer_base + ((yy + ys) * g_armwave_state.target_height);
	.loc 1 138 60 view .LVU493
	ldr	r6, [r4, #56]	@ g_armwave_state.target_height, g_armwave_state.target_height
@ armwave.c:137:             	scale_value = (word & 0xff) * g_armwave_state.vscale;
	.loc 1 137 34 view .LVU494
	uxtb	ip, r3	@ word, word
@ armwave.c:140:             	word >>= 8;
	.loc 1 140 19 view .LVU495
	lsr	r5, r3, #8	@ word, word,
@ armwave.c:139:             	*(write_buffer + scale_value) += 1;
	.loc 1 139 44 view .LVU496
	mla	ip, r7, ip, r0	@ tmp210, g_armwave_state.vscale, word, _15
@ armwave.c:137:             	scale_value = (word & 0xff) * g_armwave_state.vscale;
	.loc 1 137 34 view .LVU497
	uxtb	r5, r5	@ word, word
@ armwave.c:139:             	*(write_buffer + scale_value) += 1;
	.loc 1 139 44 view .LVU498
	mla	r6, r6, r1, ip	@ tmp214, g_armwave_state.target_height, yy, tmp210
@ armwave.c:138:             	write_buffer = write_buffer_base + ((yy + ys) * g_armwave_state.target_height);
	.loc 1 138 60 view .LVU499
	add	fp, r1, #1	@ tmp226, yy,
@ armwave.c:140:             	word >>= 8;
	.loc 1 140 19 view .LVU500
	lsr	ip, r3, #16	@ word, word,
@ armwave.c:139:             	*(write_buffer + scale_value) += 1;
	.loc 1 139 44 view .LVU501
	ldrb	r7, [r2, r6]	@ zero_extendqisi2	@ *_63, *_63
@ armwave.c:137:             	scale_value = (word & 0xff) * g_armwave_state.vscale;
	.loc 1 137 34 view .LVU502
	uxtb	ip, ip	@ word, word
@ armwave.c:140:             	word >>= 8;
	.loc 1 140 19 view .LVU503
	lsr	r3, r3, #24	@ word, word,
.LVL129:
@ armwave.c:139:             	*(write_buffer + scale_value) += 1;
	.loc 1 139 44 view .LVU504
	add	r7, r7, #1	@ tmp217, *_63,
	strb	r7, [r2, r6]	@ tmp217, *_63
.LVL130:
	.loc 1 140 14 is_stmt 1 view .LVU505
	.loc 1 137 14 view .LVU506
	.loc 1 138 14 view .LVU507
	.loc 1 139 14 view .LVU508
@ armwave.c:137:             	scale_value = (word & 0xff) * g_armwave_state.vscale;
	.loc 1 137 42 is_stmt 0 view .LVU509
	ldr	r6, [r4, #28]	@ g_armwave_state.vscale, g_armwave_state.vscale
@ armwave.c:138:             	write_buffer = write_buffer_base + ((yy + ys) * g_armwave_state.target_height);
	.loc 1 138 60 view .LVU510
	add	r7, r1, #2	@ tmp241, yy,
@ armwave.c:139:             	*(write_buffer + scale_value) += 1;
	.loc 1 139 44 view .LVU511
	mla	r5, r6, r5, r0	@ tmp224, g_armwave_state.vscale, word, _15
@ armwave.c:138:             	write_buffer = write_buffer_base + ((yy + ys) * g_armwave_state.target_height);
	.loc 1 138 60 view .LVU512
	ldr	r6, [r4, #56]	@ g_armwave_state.target_height, g_armwave_state.target_height
@ armwave.c:139:             	*(write_buffer + scale_value) += 1;
	.loc 1 139 44 view .LVU513
	mla	r5, r6, fp, r5	@ tmp229, g_armwave_state.target_height, tmp226, tmp224
@ armwave.c:138:             	write_buffer = write_buffer_base + ((yy + ys) * g_armwave_state.target_height);
	.loc 1 138 60 view .LVU514
	add	r6, r1, #3	@ tmp255, yy,
@ armwave.c:117:         for(yy = 0; yy < height; yy += 4) {
	.loc 1 117 37 view .LVU515
	add	r1, r1, #4	@ yy, yy,
.LVL131:
@ armwave.c:139:             	*(write_buffer + scale_value) += 1;
	.loc 1 139 44 view .LVU516
	ldrb	fp, [r2, r5]	@ zero_extendqisi2	@ *_83, *_83
@ armwave.c:117:         for(yy = 0; yy < height; yy += 4) {
	.loc 1 117 9 view .LVU517
	cmp	r9, r1	@ _4, yy
@ armwave.c:139:             	*(write_buffer + scale_value) += 1;
	.loc 1 139 44 view .LVU518
	add	fp, fp, #1	@ tmp232, *_83,
	strb	fp, [r2, r5]	@ tmp232, *_83
.LVL132:
	.loc 1 140 14 is_stmt 1 view .LVU519
	.loc 1 137 14 view .LVU520
	.loc 1 138 14 view .LVU521
	.loc 1 139 14 view .LVU522
@ armwave.c:137:             	scale_value = (word & 0xff) * g_armwave_state.vscale;
	.loc 1 137 42 is_stmt 0 view .LVU523
	ldr	fp, [r4, #28]	@ g_armwave_state.vscale, g_armwave_state.vscale
@ armwave.c:138:             	write_buffer = write_buffer_base + ((yy + ys) * g_armwave_state.target_height);
	.loc 1 138 60 view .LVU524
	ldr	r5, [r4, #56]	@ g_armwave_state.target_height, g_armwave_state.target_height
@ armwave.c:139:             	*(write_buffer + scale_value) += 1;
	.loc 1 139 44 view .LVU525
	...
	.loc 1 140 14 is_stmt 1 view .LVU526
.LVL133:
	.loc 1 137 14 view .LVU527
	.loc 1 138 14 view .LVU528
	.loc 1 139 14 view .LVU529
@ armwave.c:137:             	scale_value = (word & 0xff) * g_armwave_state.vscale;
	.loc 1 137 42 is_stmt 0 view .LVU530
	ldr	r5, [r4, #28]	@ g_armwave_state.vscale, g_armwave_state.vscale
@ armwave.c:138:             	write_buffer = write_buffer_base + ((yy + ys) * g_armwave_state.target_height);
	.loc 1 138 60 view .LVU531
	ldr	ip, [r4, #56]	@ g_armwave_state.target_height, g_armwave_state.target_height
@ armwave.c:139:             	*(write_buffer + scale_value) += 1;
	.loc 1 139 44 view .LVU532
	...
	.loc 1 140 14 is_stmt 1 view .LVU533
.LVL134:
@ armwave.c:117:         for(yy = 0; yy < height; yy += 4) {
	.loc 1 117 9 is_stmt 0 view .LVU534
	bhi	.L117		@,
	ldr	r6, [r4, #36]	@ prephitmp_171, g_armwave_state.waves
.LVL135:
.L116:
@ armwave.c:106:     for(w = 0; w < g_armwave_state.waves; w++) {
	.loc 1 106 44 view .LVU535
	add	r8, r8, #1	@ w, w,
.LVL136:
@ armwave.c:106:     for(w = 0; w < g_armwave_state.waves; w++) {
	.loc 1 106 5 view .LVU536
	cmp	r8, r6	@ w, prephitmp_171
	bcc	.L118		@,
	ldr	r5, [r4, #40]	@ _72, g_armwave_state.slice_height
.LVL137:
.L115:
	.loc 1 106 5 view .LVU537
.LBE18:
.LBE19:
@ armwave.c:355:     for(yy = 0; yy < (2048 / g_armwave_state.slice_height); yy++) {
	.loc 1 355 28 discriminator 3 view .LVU538
	mov	r1, r5	@, _72
	mov	r0, #2048	@,
.LVL138:
	.loc 1 355 28 discriminator 3 view .LVU539
	bl	__aeabi_uidiv		@
.LVL139:
@ armwave.c:355:     for(yy = 0; yy < (2048 / g_armwave_state.slice_height); yy++) {
	.loc 1 355 63 discriminator 3 view .LVU540
	add	r10, r10, #1	@ yy, yy,
.LVL140:
@ armwave.c:355:     for(yy = 0; yy < (2048 / g_armwave_state.slice_height); yy++) {
	.loc 1 355 5 discriminator 3 view .LVU541
	cmp	r0, r10	@, yy
	bhi	.L119		@,
.LVL141:
.L113:
@ armwave.c:358: }
	.loc 1 358 1 view .LVU542
	add	sp, sp, #12	@,,
	.cfi_def_cfa_offset 36
	@ sp needed	@
	pop	{r4, r5, r6, r7, r8, r9, r10, fp, pc}	@
...
.LFB67:
	...
	@ args = 0, pretend = 0, frame = 0
	@ frame_needed = 0, uses_anonymous_args = 0
	.loc 1 362 5 view .LVU544
	.loc 1 363 5 view .LVU545
@ armwave.c:361: {
	.loc 1 361 1 is_stmt 0 view .LVU546
	push	{r4, r5, lr}	@
	.cfi_def_cfa_offset 12
	.cfi_offset 4, -12
	.cfi_offset 5, -8
	.cfi_offset 14, -4
@ armwave.c:363:     Py_buffer *buf = malloc(sizeof(Py_buffer));
	.loc 1 363 22 view .LVU547
	mov	r0, #44	@,
@ armwave.c:361: {
	.loc 1 361 1 view .LVU548
	sub	sp, sp, #12	@,,
	.cfi_def_cfa_offset 24
@ armwave.c:363:     Py_buffer *buf = malloc(sizeof(Py_buffer));
	.loc 1 363 22 view .LVU549
	bl	malloc		@
.LVL142:
@ armwave.c:365:     armwave_fill_pixbuf2(g_armwave_state.out_pixbuf);
	.loc 1 365 5 view .LVU550
	ldr	r4, .L135	@ tmp118,
@ armwave.c:363:     Py_buffer *buf = malloc(sizeof(Py_buffer));
	.loc 1 363 22 view .LVU551
	mov	r5, r0	@ tmp117,
.LVL143:
	.loc 1 365 5 is_stmt 1 view .LVU552
	ldr	r0, [r4, #60]	@, g_armwave_state.out_pixbuf
.LVL144:
	.loc 1 365 5 is_stmt 0 view .LVU553
	bl	armwave_fill_pixbuf2		@
.LVL145:
	.loc 1 366 5 is_stmt 1 view .LVU554
@ armwave.c:366:     PyBuffer_FillInfo(buf, NULL, g_armwave_state.out_pixbuf, sizeof(uint32_t) * g_armwave_state.size, true, PyBUF_ND);
	.loc 1 366 79 is_stmt 0 view .LVU555
	ldr	r3, [r4, #48]	@ g_armwave_state.size, g_armwave_state.size
@ armwave.c:366:     PyBuffer_FillInfo(buf, NULL, g_armwave_state.out_pixbuf, sizeof(uint32_t) * g_armwave_state.size, true, PyBUF_ND);
	.loc 1 366 5 view .LVU556
	mov	ip, #8	@ tmp125,
	mov	r1, #1	@ tmp126,
...
.LVL146:
	.loc 1 368 2 is_stmt 1 view .LVU557
@ armwave.c:368: 	mv = PyMemoryView_FromBuffer(buf);
	.loc 1 368 7 is_stmt 0 view .LVU558
	mov	r0, r5	@, tmp117
@ armwave.c:369: }
	.loc 1 369 1 view .LVU559
	add	sp, sp, #12	@,,
	.cfi_def_cfa_offset 12
	@ sp needed	@
	pop	{r4, r5, lr}	@
...
.LVL147:
@ armwave.c:368: 	mv = PyMemoryView_FromBuffer(buf);
	.loc 1 368 7 view .LVU560
	b	PyMemoryView_FromBuffer		@
.LVL148:
.L136:
	.loc 1 368 7 view .LVU561
	.align	2
.L135:
	.word	g_armwave_state
	.cfi_endproc
...
.LFB68:
	...
	@ frame_needed = 0, uses_anonymous_args = 0
	@ link register save eliminated.
	.loc 1 373 2 view .LVU563
	ldr	r3, .L138	@ tmp112,
	mov	r1, r0	@, fn
	ldr	r0, [r3, #60]	@, g_armwave_state.out_pixbuf
.LVL150:
	.loc 1 373 2 is_stmt 0 view .LVU564
	b	armwave_dump_ppm_debug		@
.LVL151:
.L139:
	.loc 1 373 2 view .LVU565
	.align	2
.L138:
	.word	g_armwave_state
	.cfi_endproc
...
.LFB69:
	...
	@ args = 0, pretend = 0, frame = 0
	@ frame_needed = 0, uses_anonymous_args = 0
	.loc 1 378 2 view .LVU567
@ armwave.c:377: {
	.loc 1 377 1 is_stmt 0 view .LVU568
	push	{r4, lr}	@
	.cfi_def_cfa_offset 8
	.cfi_offset 4, -8
	.cfi_offset 14, -4
@ armwave.c:378: 	free(g_armwave_state.out_pixbuf);
	.loc 1 378 22 view .LVU569
	ldr	r4, .L142	@ tmp113,
@ armwave.c:378: 	free(g_armwave_state.out_pixbuf);
	.loc 1 378 2 view .LVU570
	ldr	r0, [r4, #60]	@, g_armwave_state.out_pixbuf
	bl	free		@
.LVL152:
	.loc 1 379 2 is_stmt 1 view .LVU571
	ldr	r0, [r4, #4]	@, g_armwave_state.ch1_buffer
	bl	free		@
.LVL153:
	.loc 1 380 2 view .LVU572
	ldr	r0, [r4, #76]	@, g_armwave_state.xcoord_to_xpixel
	bl	free		@
.LVL154:
	.loc 1 382 2 view .LVU573
@ armwave.c:382: 	g_armwave_state.out_pixbuf = NULL;
	.loc 1 382 29 is_stmt 0 view .LVU574
	mov	r3, #0	@ tmp120,
	str	r3, [r4, #60]	@ tmp120, g_armwave_state.out_pixbuf
	.loc 1 383 2 is_stmt 1 view .LVU575
@ armwave.c:383: 	g_armwave_state.ch1_buffer = NULL;
	.loc 1 383 29 is_stmt 0 view .LVU576
	str	r3, [r4, #4]	@ tmp120, g_armwave_state.ch1_buffer
	.loc 1 384 2 is_stmt 1 view .LVU577
@ armwave.c:384: 	g_armwave_state.xcoord_to_xpixel = NULL;
	.loc 1 384 35 is_stmt 0 view .LVU578
	str	r3, [r4, #76]	@ tmp120, g_armwave_state.xcoord_to_xpixel
@ armwave.c:385: }
	.loc 1 385 1 view .LVU579
	pop	{r4, pc}	@
.L143:
	.align	2
.L142:
...
.LFB70:
	...
	@ args = 0, pretend = 0, frame = 8
	@ frame_needed = 0, uses_anonymous_args = 0
	.loc 1 389 5 view .LVU581
	.loc 1 390 5 view .LVU582
	.loc 1 393 5 view .LVU583
.LBB24:
.LBI24:
	.loc 1 148 6 view .LVU584
.LBB25:
	.loc 1 150 5 view .LVU585
.LBE25:
.LBE24:
@ armwave.c:388: {
	.loc 1 388 1 is_stmt 0 view .LVU586
	push	{r4, r5, r6, r7, r8, r9, r10, fp, lr}	@
	.cfi_def_cfa_offset 36
	.cfi_offset 4, -36
	.cfi_offset 5, -32
...
.LBB26:
@ armwave.c:150:     g_armwave_state.flags = 0;
	.loc 1 150 27 view .LVU587
	ldr	r9, .L164	@ tmp267,
.LBE26:
.LBE29:
@ armwave.c:402:     armwave_setup_render(&test_wave_buffer, 0, TEST_WAVE_SIZE, TEST_NWAVES, TEST_WAVE_SIZE, 2048, 256, 0x00000000);
	.loc 1 402 5 view .LVU588
	ldr	r2, .L164+4	@ ivtmp_191,
.LBB30:
.LBB27:
@ armwave.c:150:     g_armwave_state.flags = 0;
	.loc 1 150 27 view .LVU589
	mov	r3, #0	@ tmp192,
.LBE27:
.LBE30:
@ armwave.c:402:     armwave_setup_render(&test_wave_buffer, 0, TEST_WAVE_SIZE, TEST_NWAVES, TEST_WAVE_SIZE, 2048, 256, 0x00000000);
	.loc 1 402 5 view .LVU590
	str	r2, [sp, #4]	@ ivtmp_191, %sfp
.LBB31:
.LBB28:
@ armwave.c:150:     g_armwave_state.flags = 0;
	.loc 1 150 27 view .LVU591
...
.LVL157:
	.loc 1 402 5 view .LVU594
	bl	armwave_setup_render.constprop.1		@
.LVL158:
	.loc 1 406 5 view .LVU595
	.loc 1 406 5 is_stmt 0 view .LVU596
	ldr	r5, [r9, #40]	@ _61, g_armwave_state.slice_height
.LVL159:
.L145:
@ armwave.c:407:         for(yy = 0; yy < (2048 / g_armwave_state.slice_height); yy++) {
	.loc 1 407 9 view .LVU597
	cmp	r5, #2048	@ _61,
	bhi	.L153		@,
	ldr	r4, [r9, #36]	@ prephitmp_178, g_armwave_state.waves
@ armwave.c:407:         for(yy = 0; yy < (2048 / g_armwave_state.slice_height); yy++) {
	.loc 1 407 16 view .LVU598
	mov	r8, #0	@ yy,
	mov	r6, r4	@ prephitmp_178, prephitmp_178
.LVL160:
.L150:
	.loc 1 409 13 is_stmt 1 discriminator 3 view .LVU599
	mul	r3, r5, r8	@ _1, _61, yy
.LBB32:
.LBB33:
@ armwave.c:103:     write_buffer_base = g_armwave_state.ch1_buffer + (slice_y * g_armwave_state.target_height);
	.loc 1 103 63 is_stmt 0 discriminator 3 view .LVU600
	ldr	r0, [r9, #56]	@ g_armwave_state.target_height, g_armwave_state.target_height
@ armwave.c:106:     for(w = 0; w < g_armwave_state.waves; w++) {
	.loc 1 106 5 discriminator 3 view .LVU601
	cmp	r6, #0	@ prephitmp_178,
.LBE33:
.LBE32:
@ armwave.c:409:             render_nonaa_to_buffer_1ch_slice(yy * g_armwave_state.slice_height, g_armwave_state.slice_record_height);
	.loc 1 409 13 discriminator 3 view .LVU602
	ldr	r10, [r9, #44]	@ _2, g_armwave_state.slice_record_height
.LVL161:
.LBB35:
.LBI32:
	.loc 1 95 6 is_stmt 1 discriminator 3 view .LVU603
.LBB34:
	.loc 1 97 5 discriminator 3 view .LVU604
	.loc 1 98 5 discriminator 3 view .LVU605
	.loc 1 99 5 discriminator 3 view .LVU606
	.loc 1 100 5 discriminator 3 view .LVU607
	.loc 1 101 5 discriminator 3 view .LVU608
	.loc 1 103 5 discriminator 3 view .LVU609
@ armwave.c:103:     write_buffer_base = g_armwave_state.ch1_buffer + (slice_y * g_armwave_state.target_height);
	.loc 1 103 63 is_stmt 0 discriminator 3 view .LVU610
	mul	r0, r0, r3	@ _19, g_armwave_state.target_height, _1
@ armwave.c:103:     write_buffer_base = g_armwave_state.ch1_buffer + (slice_y * g_armwave_state.target_height);
	.loc 1 103 40 discriminator 3 view .LVU611
	ldr	r2, [r9, #4]	@ _17, g_armwave_state.ch1_buffer
.LVL162:
	.loc 1 106 5 is_stmt 1 discriminator 3 view .LVU612
	.loc 1 106 5 is_stmt 0 discriminator 3 view .LVU613
	beq	.L146		@,
@ armwave.c:106:     for(w = 0; w < g_armwave_state.waves; w++) {
	.loc 1 106 11 view .LVU614
	mov	r7, #0	@ w,
	sub	r3, r3, #4	@ _81, _1,
.LVL163:
	.loc 1 106 11 view .LVU615
	str	r3, [sp]	@ _81, %sfp
.LVL164:
.L149:
	.loc 1 107 9 is_stmt 1 view .LVU616
@ armwave.c:107:         wave_base = g_armwave_state.wave_buffer + slice_y + (w * g_armwave_state.wave_stride);
	.loc 1 107 64 is_stmt 0 view .LVU617
	ldr	r3, [r9, #32]	@ g_armwave_state.wave_stride, g_armwave_state.wave_stride
@ armwave.c:117:         for(yy = 0; yy < height; yy += 4) {
	.loc 1 117 9 view .LVU618
	cmp	r10, #0	@ _2,
@ armwave.c:107:         wave_base = g_armwave_state.wave_buffer + slice_y + (w * g_armwave_state.wave_stride);
	.loc 1 107 36 view .LVU619
	ldr	lr, [r9, #20]	@ _20, g_armwave_state.wave_buffer
@ armwave.c:107:         wave_base = g_armwave_state.wave_buffer + slice_y + (w * g_armwave_state.wave_stride);
	.loc 1 107 64 view .LVU620
	mul	r3, r3, r7	@ _23, g_armwave_state.wave_stride, w
.LVL165:
	.loc 1 117 9 is_stmt 1 view .LVU621
	.loc 1 117 9 is_stmt 0 view .LVU622
	beq	.L147		@,
	ldr	r1, [sp]	@ _81, %sfp
	add	r3, r3, r1	@ tmp202, _23, _81
.LVL166:
	.loc 1 117 9 view .LVU623
	add	lr, lr, r3	@ ivtmp.104, _20, tmp202
.LVL167:
@ armwave.c:117:         for(yy = 0; yy < height; yy += 4) {
	.loc 1 117 16 view .LVU624
	mov	r1, #0	@ yy,
.LVL168:
.L148:
	.loc 1 132 13 is_stmt 1 view .LVU625
@ armwave.c:132:             word = *(uint32_t*)(wave_base + yy);
	.loc 1 132 18 is_stmt 0 view .LVU626
	ldr	r3, [lr, #4]!	@ word, MEM[base: _177, offset: 0B]
.LVL169:
	.loc 1 136 13 is_stmt 1 view .LVU627
	.loc 1 137 14 view .LVU628
	.loc 1 138 14 view .LVU629
	.loc 1 139 14 view .LVU630
@ armwave.c:137:             	scale_value = (word & 0xff) * g_armwave_state.vscale;
	.loc 1 137 42 is_stmt 0 view .LVU631
	ldr	r6, [r9, #28]	@ g_armwave_state.vscale, g_armwave_state.vscale
@ armwave.c:138:             	write_buffer = write_buffer_base + ((yy + ys) * g_armwave_state.target_height);
	.loc 1 138 60 view .LVU632
	ldr	r5, [r9, #56]	@ g_armwave_state.target_height, g_armwave_state.target_height
@ armwave.c:137:             	scale_value = (word & 0xff) * g_armwave_state.vscale;
	.loc 1 137 34 view .LVU633
	uxtb	ip, r3	@ word, word
@ armwave.c:140:             	word >>= 8;
	.loc 1 140 19 view .LVU634
	lsr	r4, r3, #8	@ word, word,
@ armwave.c:139:             	*(write_buffer + scale_value) += 1;
	.loc 1 139 44 view .LVU635
	mla	ip, r6, ip, r0	@ tmp207, g_armwave_state.vscale, word, _19
@ armwave.c:137:             	scale_value = (word & 0xff) * g_armwave_state.vscale;
	.loc 1 137 34 view .LVU636
	uxtb	r4, r4	@ word, word
@ armwave.c:139:             	*(write_buffer + scale_value) += 1;
	.loc 1 139 44 view .LVU637
	mla	r5, r5, r1, ip	@ tmp211, g_armwave_state.target_height, yy, tmp207
@ armwave.c:138:             	write_buffer = write_buffer_base + ((yy + ys) * g_armwave_state.target_height);
	.loc 1 138 60 view .LVU638
	add	fp, r1, #1	@ tmp223, yy,
@ armwave.c:140:             	word >>= 8;
	.loc 1 140 19 view .LVU639
	lsr	ip, r3, #16	@ word, word,
@ armwave.c:139:             	*(write_buffer + scale_value) += 1;
	.loc 1 139 44 view .LVU640
	ldrb	r6, [r2, r5]	@ zero_extendqisi2	@ *_67, *_67
@ armwave.c:137:             	scale_value = (word & 0xff) * g_armwave_state.vscale;
	.loc 1 137 34 view .LVU641
	uxtb	ip, ip	@ word, word
@ armwave.c:140:             	word >>= 8;
	.loc 1 140 19 view .LVU642
	lsr	r3, r3, #24	@ word, word,
.LVL170:
@ armwave.c:139:             	*(write_buffer + scale_value) += 1;
	.loc 1 139 44 view .LVU643
	add	r6, r6, #1	@ tmp214, *_67,
	strb	r6, [r2, r5]	@ tmp214, *_67
.LVL171:
	.loc 1 140 14 is_stmt 1 view .LVU644
	.loc 1 137 14 view .LVU645
	.loc 1 138 14 view .LVU646
	.loc 1 139 14 view .LVU647
@ armwave.c:137:             	scale_value = (word & 0xff) * g_armwave_state.vscale;
	.loc 1 137 42 is_stmt 0 view .LVU648
	ldr	r5, [r9, #28]	@ g_armwave_state.vscale, g_armwave_state.vscale
@ armwave.c:138:             	write_buffer = write_buffer_base + ((yy + ys) * g_armwave_state.target_height);
	.loc 1 138 60 view .LVU649
	add	r6, r1, #2	@ tmp238, yy,
@ armwave.c:139:             	*(write_buffer + scale_value) += 1;
	.loc 1 139 44 view .LVU650
	mla	r4, r5, r4, r0	@ tmp221, g_armwave_state.vscale, word, _19
@ armwave.c:138:             	write_buffer = write_buffer_base + ((yy + ys) * g_armwave_state.target_height);
	.loc 1 138 60 view .LVU651
	ldr	r5, [r9, #56]	@ g_armwave_state.target_height, g_armwave_state.target_height
@ armwave.c:139:             	*(write_buffer + scale_value) += 1;
	.loc 1 139 44 view .LVU652
	mla	r4, r5, fp, r4	@ tmp226, g_armwave_state.target_height, tmp223, tmp221
@ armwave.c:138:             	write_buffer = write_buffer_base + ((yy + ys) * g_armwave_state.target_height);
	.loc 1 138 60 view .LVU653
	add	r5, r1, #3	@ tmp252, yy,
@ armwave.c:117:         for(yy = 0; yy < height; yy += 4) {
	.loc 1 117 37 view .LVU654
	add	r1, r1, #4	@ yy, yy,
.LVL172:
@ armwave.c:139:             	*(write_buffer + scale_value) += 1;
	.loc 1 139 44 view .LVU655
	ldrb	fp, [r2, r4]	@ zero_extendqisi2	@ *_87, *_87
@ armwave.c:117:         for(yy = 0; yy < height; yy += 4) {
	.loc 1 117 9 view .LVU656
	cmp	r10, r1	@ _2, yy
@ armwave.c:139:             	*(write_buffer + scale_value) += 1;
	.loc 1 139 44 view .LVU657
	add	fp, fp, #1	@ tmp229, *_87,
	strb	fp, [r2, r4]	@ tmp229, *_87
.LVL173:
	.loc 1 140 14 is_stmt 1 view .LVU658
	.loc 1 137 14 view .LVU659
	.loc 1 138 14 view .LVU660
	.loc 1 139 14 view .LVU661
@ armwave.c:137:             	scale_value = (word & 0xff) * g_armwave_state.vscale;
	.loc 1 137 42 is_stmt 0 view .LVU662
	ldr	fp, [r9, #28]	@ g_armwave_state.vscale, g_armwave_state.vscale
@ armwave.c:138:             	write_buffer = write_buffer_base + ((yy + ys) * g_armwave_state.target_height);
	.loc 1 138 60 view .LVU663
	ldr	r4, [r9, #56]	@ g_armwave_state.target_height, g_armwave_state.target_height
@ armwave.c:139:             	*(write_buffer + scale_value) += 1;
	.loc 1 139 44 view .LVU664
	...
	.loc 1 140 14 is_stmt 1 view .LVU665
.LVL174:
	.loc 1 137 14 view .LVU666
	.loc 1 138 14 view .LVU667
	.loc 1 139 14 view .LVU668
@ armwave.c:137:             	scale_value = (word & 0xff) * g_armwave_state.vscale;
	.loc 1 137 42 is_stmt 0 view .LVU669
	ldr	r4, [r9, #28]	@ g_armwave_state.vscale, g_armwave_state.vscale
@ armwave.c:138:             	write_buffer = write_buffer_base + ((yy + ys) * g_armwave_state.target_height);
	.loc 1 138 60 view .LVU670
	ldr	ip, [r9, #56]	@ g_armwave_state.target_height, g_armwave_state.target_height
@ armwave.c:139:             	*(write_buffer + scale_value) += 1;
	.loc 1 139 44 view .LVU671
	...
	.loc 1 140 14 is_stmt 1 view .LVU672
.LVL175:
@ armwave.c:117:         for(yy = 0; yy < height; yy += 4) {
	.loc 1 117 9 is_stmt 0 view .LVU673
	bhi	.L148		@,
	ldr	r6, [r9, #36]	@ prephitmp_178, g_armwave_state.waves
.LVL176:
.L147:
@ armwave.c:106:     for(w = 0; w < g_armwave_state.waves; w++) {
	.loc 1 106 44 view .LVU674
	add	r7, r7, #1	@ w, w,
.LVL177:
@ armwave.c:106:     for(w = 0; w < g_armwave_state.waves; w++) {
	.loc 1 106 5 view .LVU675
	cmp	r7, r6	@ w, prephitmp_178
	bcc	.L149		@,
	ldr	r5, [r9, #40]	@ _61, g_armwave_state.slice_height
.LVL178:
.L146:
	.loc 1 106 5 view .LVU676
.LBE34:
.LBE35:
@ armwave.c:407:         for(yy = 0; yy < (2048 / g_armwave_state.slice_height); yy++) {
	.loc 1 407 32 discriminator 3 view .LVU677
	mov	r1, r5	@, _61
	mov	r0, #2048	@,
.LVL179:
	.loc 1 407 32 discriminator 3 view .LVU678
	bl	__aeabi_uidiv		@
.LVL180:
@ armwave.c:407:         for(yy = 0; yy < (2048 / g_armwave_state.slice_height); yy++) {
	.loc 1 407 67 discriminator 3 view .LVU679
	add	r8, r8, #1	@ yy, yy,
.LVL181:
@ armwave.c:407:         for(yy = 0; yy < (2048 / g_armwave_state.slice_height); yy++) {
	.loc 1 407 9 discriminator 3 view .LVU680
	cmp	r0, r8	@, yy
	bhi	.L150		@,
.LVL182:
.L153:
@ armwave.c:406:     for(n = 0; n < 5000; n++) {
	.loc 1 406 5 discriminator 2 view .LVU681
	ldr	r3, [sp, #4]	@ ivtmp_191, %sfp
	subs	r3, r3, #1	@ ivtmp_191, ivtmp_191,
	str	r3, [sp, #4]	@ ivtmp_191, %sfp
	bne	.L145		@,
	mov	r0, r3	@, ivtmp_191
	.loc 1 422 5 is_stmt 1 view .LVU682
@ armwave.c:423: }
	.loc 1 423 1 is_stmt 0 view .LVU683
	add	sp, sp, #12	@,,
	.cfi_def_cfa_offset 36
	@ sp needed	@
	pop	{r4, r5, r6, r7, r8, r9, r10, fp, pc}	@
...
__PRETTY_FUNCTION__.16995:
	...
	.size	__PRETTY_FUNCTION__.17018, 21
