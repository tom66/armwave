...
@ armwave.c:423: {
	.loc 1 423 1 is_stmt 0 view .LVU468
	push	{r4, r5, r6, r7, r8, r9, r10, fp, lr}	@
	.cfi_def_cfa_offset 36
	.cfi_offset 4, -36
	.cfi_offset 5, -32
	...
	sub	sp, sp, #36	@,,
	.cfi_def_cfa_offset 72
@ armwave.c:425:     uint32_t xx_rem = g_armwave_state.target_width, ypos = 0;
	.loc 1 425 38 view .LVU469
	ldr	fp, .L133	@ tmp321,
@ armwave.c:427:     memset(g_armwave_state.ch1_buffer, 0, g_armwave_state.ch_buff_size);
	.loc 1 427 5 view .LVU470
	mov	r1, #0	@,
@ armwave.c:425:     uint32_t xx_rem = g_armwave_state.target_width, ypos = 0;
	.loc 1 425 14 view .LVU471
	ldr	r3, [fp, #88]	@ xx_rem, g_armwave_state.target_width
@ armwave.c:427:     memset(g_armwave_state.ch1_buffer, 0, g_armwave_state.ch_buff_size);
	.loc 1 427 5 view .LVU472
	ldr	r2, [fp, #80]	@, g_armwave_state.ch_buff_size
	ldr	r0, [fp, #4]	@, g_armwave_state.ch1_buffer
@ armwave.c:425:     uint32_t xx_rem = g_armwave_state.target_width, ypos = 0;
	.loc 1 425 14 view .LVU473
	str	r3, [sp, #12]	@ xx_rem, %sfp
.LVL122:
	.loc 1 427 5 is_stmt 1 view .LVU474
	bl	memset		@
.LVL123:
	.loc 1 429 5 view .LVU475
@ armwave.c:429:     for(yy = 0; yy < (g_armwave_state.target_width / g_armwave_state.slice_height); yy++) {
	.loc 1 429 69 is_stmt 0 view .LVU476
	ldr	r5, [fp, #68]	@ _14, g_armwave_state.slice_height
@ armwave.c:429:     for(yy = 0; yy < (g_armwave_state.target_width / g_armwave_state.slice_height); yy++) {
	.loc 1 429 52 view .LVU477
	ldr	r0, [fp, #88]	@, g_armwave_state.target_width
	mov	r1, r5	@, _14
	bl	__aeabi_idiv		@
.LVL124:
@ armwave.c:429:     for(yy = 0; yy < (g_armwave_state.target_width / g_armwave_state.slice_height); yy++) {
	.loc 1 429 5 view .LVU478
	cmp	r0, #0	@ tmp226
	beq	.L125		@,
	ldr	r7, [fp, #72]	@ _10, g_armwave_state.slice_record_height
@ armwave.c:425:     uint32_t xx_rem = g_armwave_state.target_width, ypos = 0;
	.loc 1 425 53 view .LVU479
	mov	r10, #0	@ ypos,
	str	r10, [sp, #16]	@ ypos, %sfp
.LVL125:
.L116:
	.loc 1 432 9 is_stmt 1 discriminator 3 view .LVU480
	mul	r5, r10, r5	@ _7, yy, _14
.LVL126:
.LBB27:
.LBI27:
	.loc 1 62 6 discriminator 3 view .LVU481
.LBB28:
	.loc 1 64 5 discriminator 3 view .LVU482
	.loc 1 65 5 discriminator 3 view .LVU483
	.loc 1 66 5 discriminator 3 view .LVU484
	.loc 1 67 5 discriminator 3 view .LVU485
	.loc 1 68 5 discriminator 3 view .LVU486
	.loc 1 71 5 discriminator 3 view .LVU487
@ armwave.c:71:     write_buffer_base = g_armwave_state.ch1_buffer + ((slice_y * g_armwave_state.cmp_x_bitdepth_scale) >> AM_XCOORD_MULT_SHIFT);
	.loc 1 71 64 is_stmt 0 discriminator 3 view .LVU488
	ldr	r3, [fp, #36]	@ g_armwave_state.cmp_x_bitdepth_scale, g_armwave_state.cmp_x_bitdepth_scale
@ armwave.c:71:     write_buffer_base = g_armwave_state.ch1_buffer + ((slice_y * g_armwave_state.cmp_x_bitdepth_scale) >> AM_XCOORD_MULT_SHIFT);
	.loc 1 71 40 discriminator 3 view .LVU489
	ldr	r4, [fp, #4]	@ _29, g_armwave_state.ch1_buffer
@ armwave.c:73:     printf("b=0x%08x ch1=0x%08x off=%d slice_y=%d height=%d\n", \
	.loc 1 73 5 discriminator 3 view .LVU490
	str	r5, [sp]	@ _7,
@ armwave.c:71:     write_buffer_base = g_armwave_state.ch1_buffer + ((slice_y * g_armwave_state.cmp_x_bitdepth_scale) >> AM_XCOORD_MULT_SHIFT);
	.loc 1 71 64 discriminator 3 view .LVU491
	mul	r3, r3, r5	@ tmp230, g_armwave_state.cmp_x_bitdepth_scale, _7
@ armwave.c:73:     printf("b=0x%08x ch1=0x%08x off=%d slice_y=%d height=%d\n", \
	.loc 1 73 5 discriminator 3 view .LVU492
	mov	r2, r4	@, _29
	str	r7, [sp, #4]	@ _10,
@ armwave.c:71:     write_buffer_base = g_armwave_state.ch1_buffer + ((slice_y * g_armwave_state.cmp_x_bitdepth_scale) >> AM_XCOORD_MULT_SHIFT);
	.loc 1 71 104 discriminator 3 view .LVU493
...
.LVL127:
	...
	bl	printf		@
.LVL128:
	.loc 1 78 5 discriminator 3 view .LVU496
...
@ armwave.c:78:     for(w = 0; w < g_armwave_state.waves; w++) {
	...
	mov	r6, #0	@ w,
	sub	r3, r5, #4	@ tmp320, _7,
	str	r3, [sp, #20]	@ tmp320, %sfp
	str	r7, [sp, #24]	@ _10, %sfp
	str	r10, [sp, #28]	@ yy, %sfp
.LVL129:
.L122:
...
@ armwave.c:79:         wave_base = g_armwave_state.wave_buffer + slice_y + (w * g_armwave_state.wave_stride);
	...
	ldr	r2, [sp, #20]	@ tmp320, %sfp
	ldr	r5, [fp, #20]	@ g_armwave_state.wave_buffer, g_armwave_state.wave_buffer
	mla	r3, r3, r6, r2	@ tmp247, g_armwave_state.wave_stride, w, tmp320
@ armwave.c:83:         for(yy = 0; yy < height; yy += 4) {
	.loc 1 83 16 view .LVU502
	mov	r1, #0	@ yy,
	add	r5, r5, r3	@ ivtmp.85, g_armwave_state.wave_buffer, tmp247
.LVL130:
.L121:
...
@ armwave.c:84:             word = *(uint32_t*)(wave_base + yy);
	...
	ldr	r3, [r5, #4]!	@ word, MEM[base: _268, offset: 0B]
.LVL131:
...
@ armwave.c:90:                 if(COND_UNLIKELY(scale_value == 0x00 || scale_value == 0xff))
	...
	cmp	ip, #255	@ scale_value,
	orreq	r8, r8, #1	@,, tmp255, tmp250
	cmp	r8, #0	@ tmp255,
@ armwave.c:95:                 write_buffer = write_buffer_base + (((yy + ys) * g_armwave_state.cmp_x_bitdepth_scale) >> AM_XCOORD_MULT_SHIFT);
	.loc 1 95 64 view .LVU519
	add	r7, r1, #2	@ tmp292, yy,
	add	lr, r1, #3	@ tmp309, yy,
@ armwave.c:97:                 word >>= 8;
...
@ armwave.c:95:                 write_buffer = write_buffer_base + (((yy + ys) * g_armwave_state.cmp_x_bitdepth_scale) >> AM_XCOORD_MULT_SHIFT);
	...
	ldr	r8, [fp, #36]	@ g_armwave_state.cmp_x_bitdepth_scale, g_armwave_state.cmp_x_bitdepth_scale
@ armwave.c:90:                 if(COND_UNLIKELY(scale_value == 0x00 || scale_value == 0xff))
...
@ armwave.c:95:                 write_buffer = write_buffer_base + (((yy + ys) * g_armwave_state.cmp_x_bitdepth_scale) >> AM_XCOORD_MULT_SHIFT);
	...
	mul	r8, r8, r1	@ tmp257, g_armwave_state.cmp_x_bitdepth_scale, yy
@ armwave.c:90:                 if(COND_UNLIKELY(scale_value == 0x00 || scale_value == 0xff))
...
@ armwave.c:90:                 if(COND_UNLIKELY(scale_value == 0x00 || scale_value == 0xff))
	...
	orreq	r10, r10, #1	@,, tmp272, tmp267
@ armwave.c:96:                 *(write_buffer + scale_value) += 1;
	.loc 1 96 47 view .LVU527
	add	ip, ip, r8, lsr #8	@ tmp260, scale_value, tmp257,
@ armwave.c:90:                 if(COND_UNLIKELY(scale_value == 0x00 || scale_value == 0xff))
	.loc 1 90 19 view .LVU528
	cmp	r10, #0	@ tmp272,
@ armwave.c:96:                 *(write_buffer + scale_value) += 1;
	.loc 1 96 47 view .LVU529
	ldrb	r8, [r4, ip]	@ zero_extendqisi2	@ *_95, *_95
	add	r8, r8, #1	@ tmp263, *_95,
	strb	r8, [r4, ip]	@ tmp263, *_95
.LVL132:
...
@ armwave.c:95:                 write_buffer = write_buffer_base + (((yy + ys) * g_armwave_state.cmp_x_bitdepth_scale) >> AM_XCOORD_MULT_SHIFT);
	...
	ldr	ip, [fp, #36]	@ g_armwave_state.cmp_x_bitdepth_scale, g_armwave_state.cmp_x_bitdepth_scale
@ armwave.c:90:                 if(COND_UNLIKELY(scale_value == 0x00 || scale_value == 0xff))
...
@ armwave.c:95:                 write_buffer = write_buffer_base + (((yy + ys) * g_armwave_state.cmp_x_bitdepth_scale) >> AM_XCOORD_MULT_SHIFT);
	...
	mul	ip, ip, r9	@ tmp275, g_armwave_state.cmp_x_bitdepth_scale, tmp274
@ armwave.c:90:                 if(COND_UNLIKELY(scale_value == 0x00 || scale_value == 0xff))
...
@ armwave.c:90:                 if(COND_UNLIKELY(scale_value == 0x00 || scale_value == 0xff))
	...
	cmp	r2, #255	@ scale_value,
	orreq	r8, r8, #1	@,, tmp290, tmp285
@ armwave.c:96:                 *(write_buffer + scale_value) += 1;
	.loc 1 96 47 view .LVU539
	add	r0, r0, ip, lsr #8	@ tmp278, scale_value, tmp275,
@ armwave.c:90:                 if(COND_UNLIKELY(scale_value == 0x00 || scale_value == 0xff))
...
@ armwave.c:96:                 *(write_buffer + scale_value) += 1;
	...
	add	ip, ip, #1	@ tmp281, *_122,
	strb	ip, [r4, r0]	@ tmp281, *_122
...
@ armwave.c:95:                 write_buffer = write_buffer_base + (((yy + ys) * g_armwave_state.cmp_x_bitdepth_scale) >> AM_XCOORD_MULT_SHIFT);
	...
	ldr	r0, [fp, #36]	@ g_armwave_state.cmp_x_bitdepth_scale, g_armwave_state.cmp_x_bitdepth_scale
@ armwave.c:90:                 if(COND_UNLIKELY(scale_value == 0x00 || scale_value == 0xff))
...
@ armwave.c:95:                 write_buffer = write_buffer_base + (((yy + ys) * g_armwave_state.cmp_x_bitdepth_scale) >> AM_XCOORD_MULT_SHIFT);
	...
	mul	r0, r0, r7	@ tmp293, g_armwave_state.cmp_x_bitdepth_scale, tmp292
@ armwave.c:90:                 if(COND_UNLIKELY(scale_value == 0x00 || scale_value == 0xff))
...
@ armwave.c:90:                 if(COND_UNLIKELY(scale_value == 0x00 || scale_value == 0xff))
	...
	cmp	r3, #255	@ word,
	orreq	ip, ip, #1	@,, tmp307, tmp302
@ armwave.c:96:                 *(write_buffer + scale_value) += 1;
	.loc 1 96 47 view .LVU552
	add	r2, r2, r0, lsr #8	@ tmp296, scale_value, tmp293,
@ armwave.c:90:                 if(COND_UNLIKELY(scale_value == 0x00 || scale_value == 0xff))
...
@ armwave.c:96:                 *(write_buffer + scale_value) += 1;
	...
	add	r0, r0, #1	@ tmp299, *_149,
	strb	r0, [r4, r2]	@ tmp299, *_149
...
@ armwave.c:95:                 write_buffer = write_buffer_base + (((yy + ys) * g_armwave_state.cmp_x_bitdepth_scale) >> AM_XCOORD_MULT_SHIFT);
	...
	mul	r2, r2, lr	@ tmp310, g_armwave_state.cmp_x_bitdepth_scale, tmp309
@ armwave.c:96:                 *(write_buffer + scale_value) += 1;
	.loc 1 96 47 view .LVU560
	add	r3, r3, r2, lsr #8	@ tmp313, word, tmp310,
	ldrb	r2, [r4, r3]	@ zero_extendqisi2	@ *_176, *_176
	add	r2, r2, #1	@ tmp316, *_176,
	strb	r2, [r4, r3]	@ tmp316, *_176
	.loc 1 97 17 is_stmt 1 view .LVU561
.LVL136:
.L124:
@ armwave.c:83:         for(yy = 0; yy < height; yy += 4) {
	.loc 1 83 9 is_stmt 0 view .LVU562
	ldr	r3, [sp, #24]	@ _10, %sfp
@ armwave.c:83:         for(yy = 0; yy < height; yy += 4) {
...
@ armwave.c:78:     for(w = 0; w < g_armwave_state.waves; w++) {
	...
	blt	.L122		@,
	ldr	r10, [sp, #28]	@ yy, %sfp
.LVL139:
.L123:
	.loc 1 78 5 view .LVU568
.LBE28:
.LBE27:
	.loc 1 433 9 is_stmt 1 view .LVU569
@ armwave.c:429:     for(yy = 0; yy < (g_armwave_state.target_width / g_armwave_state.slice_height); yy++) {
	.loc 1 429 69 is_stmt 0 view .LVU570
	ldr	r5, [fp, #68]	@ _14, g_armwave_state.slice_height
@ armwave.c:429:     for(yy = 0; yy < (g_armwave_state.target_width / g_armwave_state.slice_height); yy++) {
	.loc 1 429 52 view .LVU571
	ldr	r0, [fp, #88]	@, g_armwave_state.target_width
	mov	r1, r5	@, _14
	bl	__aeabi_idiv		@
.LVL140:
@ armwave.c:433:         xx_rem -= g_armwave_state.slice_record_height;
	.loc 1 433 34 view .LVU572
	ldr	r7, [fp, #72]	@ _10, g_armwave_state.slice_record_height
@ armwave.c:433:         xx_rem -= g_armwave_state.slice_record_height;
	.loc 1 433 16 view .LVU573
	ldr	r3, [sp, #12]	@ xx_rem, %sfp
@ armwave.c:429:     for(yy = 0; yy < (g_armwave_state.target_width / g_armwave_state.slice_height); yy++) {
	.loc 1 429 87 view .LVU574
	add	r10, r10, #1	@ yy, yy,
@ armwave.c:433:         xx_rem -= g_armwave_state.slice_record_height;
	.loc 1 433 16 view .LVU575
	sub	r3, r3, r7	@ xx_rem, xx_rem, _10
	str	r3, [sp, #12]	@ xx_rem, %sfp
.LVL141:
	.loc 1 434 9 is_stmt 1 view .LVU576
@ armwave.c:434:         ypos += g_armwave_state.slice_record_height;
	.loc 1 434 14 is_stmt 0 view .LVU577
	ldr	r3, [sp, #16]	@ ypos, %sfp
.LVL142:
	.loc 1 434 14 view .LVU578
	add	r3, r3, r7	@ ypos, ypos, _10
	str	r3, [sp, #16]	@ ypos, %sfp
.LVL143:
@ armwave.c:429:     for(yy = 0; yy < (g_armwave_state.target_width / g_armwave_state.slice_height); yy++) {
	.loc 1 429 5 view .LVU579
	cmp	r0, r10	@, yy
	bhi	.L116		@,
	mov	r0, r3	@, ypos
	.loc 1 437 5 is_stmt 1 view .LVU580
	ldr	r1, [sp, #12]	@, %sfp
@ armwave.c:438: }
	.loc 1 438 1 is_stmt 0 view .LVU581
	add	sp, sp, #36	@,,
	.cfi_remember_state
	.cfi_def_cfa_offset 36
	@ sp needed	@
	...
	.cfi_def_cfa_offset 0
.LVL144:
@ armwave.c:437:     render_nonaa_to_buffer_1ch_slice(ypos, xx_rem);
...
.L125:
	.cfi_restore_state
@ armwave.c:425:     uint32_t xx_rem = g_armwave_state.target_width, ypos = 0;
	.loc 1 425 53 view .LVU583
	str	r0, [sp, #16]	@ tmp226, %sfp
	.loc 1 437 5 is_stmt 1 view .LVU584
	ldr	r1, [sp, #12]	@, %sfp
@ armwave.c:438: }
	.loc 1 438 1 is_stmt 0 view .LVU585
	add	sp, sp, #36	@,,
	.cfi_def_cfa_offset 36
	@ sp needed	@
	pop	{r4, r5, r6, r7, r8, r9, r10, fp, lr}	@
...
.LFB70:
	...
	@ args = 0, pretend = 0, frame = 8
	@ frame_needed = 0, uses_anonymous_args = 0
	.loc 1 445 5 view .LVU588
	ldr	ip, .L156	@ tmp204,
@ armwave.c:444: {
	.loc 1 444 1 is_stmt 0 view .LVU589
	push	{r4, r5, r6, r7, r8, r9, r10, fp, lr}	@
	.cfi_def_cfa_offset 36
	.cfi_offset 4, -36
	.cfi_offset 5, -32
...
@ armwave.c:445:     armwave_fill_pixbuf_scaled(g_armwave_state.out_pixbuf);
	.loc 1 445 5 view .LVU590
	ldr	r8, [ip, #104]	@ _1, g_armwave_state.out_pixbuf
.LVL147:
.LBB31:
.LBI31:
	.loc 1 162 6 is_stmt 1 view .LVU591
.LBB32:
	.loc 1 164 5 view .LVU592
	.loc 1 166 5 view .LVU593
	.loc 1 167 5 view .LVU594
	.loc 1 169 5 view .LVU595
@ armwave.c:169:     uint32_t *base_32ptr = (uint32_t*)g_armwave_state.ch1_buffer;
	.loc 1 169 15 is_stmt 0 view .LVU596
	ldr	r9, [ip, #4]	@ base_32ptr, g_armwave_state.ch1_buffer
.LVL148:
	.loc 1 170 5 is_stmt 1 view .LVU597
	.loc 1 171 5 view .LVU598
	.loc 1 173 5 view .LVU599
	cmp	r8, #0	@ _1,
	beq	.L154		@,
	.loc 1 175 5 view .LVU600
@ armwave.c:175:     npix = g_armwave_state.target_width * 256; 
	.loc 1 175 10 is_stmt 0 view .LVU601
	ldr	r7, [ip, #88]	@ g_armwave_state.target_width, g_armwave_state.target_width
	lsl	r7, r7, #8	@ npix, g_armwave_state.target_width,
.LVL149:
	.loc 1 178 5 is_stmt 1 view .LVU602
	.loc 1 178 5 is_stmt 0 view .LVU603
	cmp	r7, #0	@ npix,
	ble	.L135		@,
@ armwave.c:190:                     rr = (g_armwave_state.ch1_color.r * value) >> 8;
	.loc 1 190 52 view .LVU604
	ldrsh	fp, [ip, #108]	@ _17, g_armwave_state.ch1_color.r
@ armwave.c:191:                     gg = (g_armwave_state.ch1_color.g * value) >> 8;
	.loc 1 191 52 view .LVU605
	ldrsh	r10, [ip, #110]	@ _23, g_armwave_state.ch1_color.g
@ armwave.c:192:                     bb = (g_armwave_state.ch1_color.b * value) >> 8;
	.loc 1 192 52 view .LVU606
	ldrsh	r5, [ip, #112]	@ _27, g_armwave_state.ch1_color.b
@ armwave.c:214:                     yy = (nsub & 0xff) * g_armwave_state.vscale_frac;
	.loc 1 214 57 view .LVU607
	vldr.32	s13, [ip, #40]	@ _49, g_armwave_state.vscale_frac
@ armwave.c:178:     for(n = 0; n < npix; n += 4) {
	.loc 1 178 11 view .LVU608
	mov	lr, #0	@ n,
.LVL150:
.L142:
	.loc 1 182 9 is_stmt 1 view .LVU609
@ armwave.c:182:         wave_word = *base_32ptr++;
	.loc 1 182 19 is_stmt 0 view .LVU610
	ldr	r0, [r9], #4	@ wave_word, MEM[base: base_32ptr_8, offset: 4294967292B]
.LVL151:
	.loc 1 184 9 is_stmt 1 view .LVU611
@ armwave.c:184:         if(COND_UNLIKELY(wave_word != 0)) {
	.loc 1 184 11 is_stmt 0 view .LVU612
	cmp	r0, #0	@ wave_word,
	bne	.L151		@,
	add	lr, lr, #4	@ n, n,
.L138:
.LVL152:
@ armwave.c:178:     for(n = 0; n < npix; n += 4) {
	.loc 1 178 5 view .LVU613
	cmp	r7, lr	@ npix, n
	bgt	.L142		@,
.LVL153:
.L135:
	.loc 1 178 5 view .LVU614
.LBE32:
.LBE31:
@ armwave.c:446: }
	.loc 1 446 1 view .LVU615
	add	sp, sp, #12	@,,
	.cfi_remember_state
	.cfi_def_cfa_offset 36
	@ sp needed	@
...
.LBB33:
@ armwave.c:189:                 if(value != 0) {
	.loc 1 189 19 view .LVU616
	ands	r1, r0, #255	@ _19, wave_word,
@ armwave.c:184:         if(COND_UNLIKELY(wave_word != 0)) {
	.loc 1 184 11 view .LVU617
	mov	r6, lr	@ ivtmp.102, n
.LVL155:
	.loc 1 186 17 is_stmt 1 view .LVU618
	.loc 1 187 17 view .LVU619
@ armwave.c:187:                 wave_word >>= 8;
	.loc 1 187 27 is_stmt 0 view .LVU620
	lsr	r0, r0, #8	@ wave_word, wave_word,
.LVL156:
	.loc 1 189 17 is_stmt 1 view .LVU621
	add	lr, lr, #4	@ n, ivtmp.102,
@ armwave.c:189:                 if(value != 0) {
	.loc 1 189 19 is_stmt 0 view .LVU622
	bne	.L155		@,
.LVL157:
.L139:
	.loc 1 189 19 view .LVU623
	add	r6, r6, #1	@ ivtmp.102, ivtmp.102,
@ armwave.c:185:             for(w = 0; w < 4; w++) {
	.loc 1 185 13 view .LVU624
	cmp	lr, r6	@ n, ivtmp.102
	beq	.L138		@,
	.loc 1 186 17 is_stmt 1 view .LVU625
.LVL158:
	.loc 1 187 17 view .LVU626
@ armwave.c:189:                 if(value != 0) {
	.loc 1 189 19 is_stmt 0 view .LVU627
	ands	r1, r0, #255	@ _19, wave_word,
@ armwave.c:187:                 wave_word >>= 8;
	.loc 1 187 27 view .LVU628
	lsr	r0, r0, #8	@ wave_word, wave_word,
.LVL159:
	.loc 1 189 17 is_stmt 1 view .LVU629
@ armwave.c:189:                 if(value != 0) {
	.loc 1 189 19 is_stmt 0 view .LVU630
	beq	.L139		@,
.L155:
	.loc 1 190 21 is_stmt 1 view .LVU631
.LVL160:
	.loc 1 191 21 view .LVU632
	.loc 1 192 21 view .LVU633
	.loc 1 194 21 view .LVU634
	.loc 1 195 21 view .LVU635
	.loc 1 196 21 view .LVU636
	.loc 1 199 21 view .LVU637
@ armwave.c:214:                     yy = (nsub & 0xff) * g_armwave_state.vscale_frac;
	.loc 1 214 32 is_stmt 0 view .LVU638
	uxtb	r3, r6	@ _47, ivtmp.102
@ armwave.c:215:                     ye = ((nsub & 0xff) + 1) * g_armwave_state.vscale_frac;
	.loc 1 215 41 view .LVU639
	add	r2, r3, #1	@ tmp196, _47,
@ armwave.c:214:                     yy = (nsub & 0xff) * g_armwave_state.vscale_frac;
	.loc 1 214 40 view .LVU640
	vmov	s15, r3	@ int	@ _47, _47
@ armwave.c:215:                     ye = ((nsub & 0xff) + 1) * g_armwave_state.vscale_frac;
	.loc 1 215 41 view .LVU641
	vmov	s14, r2	@ int	@ tmp196, tmp196
@ armwave.c:192:                     bb = (g_armwave_state.ch1_color.b * value) >> 8;
	.loc 1 192 55 view .LVU642
	mul	r3, r5, r1	@ tmp181, _27, _19
@ armwave.c:214:                     yy = (nsub & 0xff) * g_armwave_state.vscale_frac;
	.loc 1 214 40 view .LVU643
	vcvt.f32.s32	s15, s15	@ tmp194, _47
@ armwave.c:215:                     ye = ((nsub & 0xff) + 1) * g_armwave_state.vscale_frac;
	.loc 1 215 46 view .LVU644
	vcvt.f32.s32	s14, s14	@ tmp197, tmp196
@ armwave.c:191:                     gg = (g_armwave_state.ch1_color.g * value) >> 8;
	.loc 1 191 55 view .LVU645
	mul	r2, r10, r1	@ tmp185, _23, _19
@ armwave.c:192:                     bb = (g_armwave_state.ch1_color.b * value) >> 8;
	.loc 1 192 24 view .LVU646
	asr	r3, r3, #8	@ bb, tmp181,
.LVL161:
@ armwave.c:196:                     b = MIN(bb, 255);
	.loc 1 196 25 view .LVU647
	cmp	r3, #255	@ bb,
@ armwave.c:191:                     gg = (g_armwave_state.ch1_color.g * value) >> 8;
	.loc 1 191 24 view .LVU648
	asr	r2, r2, #8	@ gg, tmp185,
.LVL162:
@ armwave.c:196:                     b = MIN(bb, 255);
	.loc 1 196 25 view .LVU649
	movge	r3, #255	@ bb,
.LVL163:
@ armwave.c:214:                     yy = (nsub & 0xff) * g_armwave_state.vscale_frac;
	.loc 1 214 40 view .LVU650
	vmul.f32	s15, s15, s13	@ tmp195, tmp194, _49
@ armwave.c:215:                     ye = ((nsub & 0xff) + 1) * g_armwave_state.vscale_frac;
	.loc 1 215 46 view .LVU651
	vmul.f32	s14, s14, s13	@ tmp198, tmp197, _49
@ armwave.c:195:                     g = MIN(gg, 255);
	.loc 1 195 25 view .LVU652
	cmp	r2, #255	@ gg,
	movge	r2, #255	@ gg,
.LVL164:
@ armwave.c:190:                     rr = (g_armwave_state.ch1_color.r * value) >> 8;
	.loc 1 190 55 view .LVU653
	mul	r1, r1, fp	@ tmp191, _19, _17
.LVL165:
@ armwave.c:199:                     word = 0xff000000 | (b << 16) | (g << 8) | r;
	.loc 1 199 56 view .LVU654
	lsl	r2, r2, #8	@ tmp186, gg,
@ armwave.c:199:                     word = 0xff000000 | (b << 16) | (g << 8) | r;
	.loc 1 199 44 view .LVU655
	lsl	r3, r3, #16	@ tmp182, bb,
@ armwave.c:214:                     yy = (nsub & 0xff) * g_armwave_state.vscale_frac;
	.loc 1 214 24 view .LVU656
	vcvt.u32.f32	s15, s15	@ yy, tmp195
@ armwave.c:190:                     rr = (g_armwave_state.ch1_color.r * value) >> 8;
	.loc 1 190 24 view .LVU657
	asr	r1, r1, #8	@ rr, tmp191,
.LVL166:
@ armwave.c:199:                     word = 0xff000000 | (b << 16) | (g << 8) | r;
	.loc 1 199 56 view .LVU658
	uxth	r2, r2	@ tmp187, tmp186
@ armwave.c:199:                     word = 0xff000000 | (b << 16) | (g << 8) | r;
	.loc 1 199 44 view .LVU659
	and	r3, r3, #16711680	@ tmp183, tmp182,
@ armwave.c:194:                     r = MIN(rr, 255);
	.loc 1 194 25 view .LVU660
	cmp	r1, #255	@ rr,
@ armwave.c:199:                     word = 0xff000000 | (b << 16) | (g << 8) | r;
	.loc 1 199 51 view .LVU661
	orr	r3, r3, r2	@ tmp189, tmp183, tmp187
@ armwave.c:194:                     r = MIN(rr, 255);
	.loc 1 194 25 view .LVU662
	movge	r1, #255	@ rr,
.LVL167:
@ armwave.c:214:                     yy = (nsub & 0xff) * g_armwave_state.vscale_frac;
	.loc 1 214 24 view .LVU663
	vmov	r4, s15	@ int	@ yy, yy
@ armwave.c:215:                     ye = ((nsub & 0xff) + 1) * g_armwave_state.vscale_frac;
	.loc 1 215 24 view .LVU664
	vcvt.u32.f32	s15, s14	@ ye, tmp198
@ armwave.c:199:                     word = 0xff000000 | (b << 16) | (g << 8) | r;
	.loc 1 199 62 view .LVU665
	uxtb	r1, r1	@ rr, rr
	orr	r3, r3, r1	@ tmp193, tmp189, rr
@ armwave.c:199:                     word = 0xff000000 | (b << 16) | (g << 8) | r;
	.loc 1 199 26 view .LVU666
	orr	r3, r3, #-16777216	@ word, tmp193,
.LVL168:
	.loc 1 213 21 is_stmt 1 view .LVU667
	.loc 1 214 21 view .LVU668
	.loc 1 215 21 view .LVU669
	.loc 1 216 21 view .LVU670
@ armwave.c:216:                     xx = (nsub >> 8);
	.loc 1 216 32 is_stmt 0 view .LVU671
	asr	r1, r6, #8	@ xx, ivtmp.102,
.LVL169:
	.loc 1 218 21 is_stmt 1 view .LVU672
	.loc 1 218 21 is_stmt 0 view .LVU673
	vmov	r2, s15	@ int	@ ye,
@ armwave.c:215:                     ye = ((nsub & 0xff) + 1) * g_armwave_state.vscale_frac;
	.loc 1 215 24 view .LVU674
...
.LVL171:
.L140:
	.loc 1 219 25 is_stmt 1 view .LVU676
	.loc 1 220 25 view .LVU677
@ armwave.c:219:                         offset = (xx + (y * g_armwave_state.target_width)); 
	.loc 1 219 43 is_stmt 0 view .LVU678
	ldr	r2, [ip, #88]	@ g_armwave_state.target_width, g_armwave_state.target_width
@ armwave.c:218:                     for(y = yy; y < ye; y++) {
	.loc 1 218 21 view .LVU679
	ldr	r0, [sp]	@ ye, %sfp
@ armwave.c:220:                         *(out_buffer_base + offset) = word;
	.loc 1 220 43 view .LVU680
	mla	r2, r2, r4, r1	@ tmp202, g_armwave_state.target_width, yy, xx
.LVL172:
@ armwave.c:218:                     for(y = yy; y < ye; y++) {
	.loc 1 218 42 view .LVU681
	add	r4, r4, #1	@ yy, yy,
.LVL173:
@ armwave.c:218:                     for(y = yy; y < ye; y++) {
	.loc 1 218 21 view .LVU682
	cmp	r0, r4	@ ye, yy
@ armwave.c:220:                         *(out_buffer_base + offset) = word;
	.loc 1 220 53 view .LVU683
	str	r3, [r8, r2, lsl #2]	@ word, *_64
@ armwave.c:218:                     for(y = yy; y < ye; y++) {
	.loc 1 218 21 view .LVU684
	bne	.L140		@,
	.loc 1 218 21 view .LVU685
	ldr	r0, [sp, #4]	@ wave_word, %sfp
	b	.L139		@
.LVL174:
.L154:
	.loc 1 173 5 is_stmt 1 view .LVU686
	ldr	r3, .L156+4	@,
	mov	r2, #173	@,
	ldr	r1, .L156+8	@,
	ldr	r0, .L156+12	@,
...
.LFB71:
	...
	@ frame_needed = 0, uses_anonymous_args = 0
	@ link register save eliminated.
	.loc 1 453 5 view .LVU688
	ldr	r3, .L159	@ tmp112,
	mov	r1, r0	@, fn
	ldr	r0, [r3, #104]	@, g_armwave_state.out_pixbuf
.LVL177:
	.loc 1 453 5 is_stmt 0 view .LVU689
	b	armwave_dump_ppm_debug		@
.LVL178:
.L160:
	.loc 1 453 5 view .LVU690
	.align	2
.L159:
	.word	g_armwave_state
	.cfi_endproc
...
.LBB38:
@ armwave.c:169:     uint32_t *base_32ptr = (uint32_t*)g_armwave_state.ch1_buffer;
	.loc 1 169 15 view .LVU695
	ldr	r5, .L182	@ tmp206,
.LBE38:
.LBE37:
@ armwave.c:465:     void *out_pixbuf = ((uint32_t ***)buf)[2][10];
	.loc 1 465 11 view .LVU696
	ldr	r8, [r3, #40]	@ out_pixbuf, MEM[(uint32_t * *)_1 + 40B]
.LVL180:
	.loc 1 468 5 is_stmt 1 view .LVU697
.LBB41:
.LBI37:
	.loc 1 162 6 view .LVU698
.LBB39:
	.loc 1 164 5 view .LVU699
	.loc 1 166 5 view .LVU700
	.loc 1 167 5 view .LVU701
	.loc 1 169 5 view .LVU702
@ armwave.c:173:     assert(out_buffer != NULL);
	.loc 1 173 5 is_stmt 0 view .LVU703
	cmp	r8, #0	@ out_pixbuf,
@ armwave.c:169:     uint32_t *base_32ptr = (uint32_t*)g_armwave_state.ch1_buffer;
	.loc 1 169 15 view .LVU704
	ldr	r9, [r5, #4]	@ base_32ptr, g_armwave_state.ch1_buffer
.LVL181:
	.loc 1 170 5 is_stmt 1 view .LVU705
	.loc 1 171 5 view .LVU706
	.loc 1 173 5 view .LVU707
	beq	.L180		@,
	.loc 1 175 5 view .LVU708
@ armwave.c:175:     npix = g_armwave_state.target_width * 256; 
	.loc 1 175 10 is_stmt 0 view .LVU709
	ldr	r7, [r5, #88]	@ g_armwave_state.target_width, g_armwave_state.target_width
	lsl	r7, r7, #8	@ npix, g_armwave_state.target_width,
.LVL182:
	.loc 1 178 5 is_stmt 1 view .LVU710
	.loc 1 178 5 is_stmt 0 view .LVU711
	cmp	r7, #0	@ npix,
	ble	.L161		@,
@ armwave.c:190:                     rr = (g_armwave_state.ch1_color.r * value) >> 8;
	.loc 1 190 52 view .LVU712
	ldrsh	fp, [r5, #108]	@ _19, g_armwave_state.ch1_color.r
@ armwave.c:191:                     gg = (g_armwave_state.ch1_color.g * value) >> 8;
	.loc 1 191 52 view .LVU713
	ldrsh	r10, [r5, #110]	@ _25, g_armwave_state.ch1_color.g
@ armwave.c:192:                     bb = (g_armwave_state.ch1_color.b * value) >> 8;
	.loc 1 192 52 view .LVU714
	ldrsh	r4, [r5, #112]	@ _29, g_armwave_state.ch1_color.b
@ armwave.c:214:                     yy = (nsub & 0xff) * g_armwave_state.vscale_frac;
	.loc 1 214 57 view .LVU715
	vldr.32	s13, [r5, #40]	@ _51, g_armwave_state.vscale_frac
@ armwave.c:178:     for(n = 0; n < npix; n += 4) {
	.loc 1 178 11 view .LVU716
	mov	ip, #0	@ n,
.LVL183:
.L168:
	.loc 1 182 9 is_stmt 1 view .LVU717
@ armwave.c:182:         wave_word = *base_32ptr++;
	.loc 1 182 19 is_stmt 0 view .LVU718
	ldr	r0, [r9], #4	@ wave_word, MEM[base: base_32ptr_10, offset: 4294967292B]
.LVL184:
	.loc 1 184 9 is_stmt 1 view .LVU719
@ armwave.c:184:         if(COND_UNLIKELY(wave_word != 0)) {
...
.LVL185:
@ armwave.c:178:     for(n = 0; n < npix; n += 4) {
	.loc 1 178 5 view .LVU721
	cmp	r7, ip	@ npix, n
	bgt	.L168		@,
.LVL186:
.L161:
	.loc 1 178 5 view .LVU722
.LBE39:
.LBE41:
@ armwave.c:469: }
	.loc 1 469 1 view .LVU723
	add	sp, sp, #12	@,,
	.cfi_remember_state
	.cfi_def_cfa_offset 36
	@ sp needed	@
...
.LBB40:
@ armwave.c:189:                 if(value != 0) {
	.loc 1 189 19 view .LVU724
	ands	r1, r0, #255	@ _21, wave_word,
@ armwave.c:184:         if(COND_UNLIKELY(wave_word != 0)) {
	.loc 1 184 11 view .LVU725
	mov	r6, ip	@ ivtmp.118, n
.LVL188:
	.loc 1 186 17 is_stmt 1 view .LVU726
	.loc 1 187 17 view .LVU727
@ armwave.c:187:                 wave_word >>= 8;
	.loc 1 187 27 is_stmt 0 view .LVU728
	lsr	r0, r0, #8	@ wave_word, wave_word,
.LVL189:
	.loc 1 189 17 is_stmt 1 view .LVU729
	add	ip, ip, #4	@ n, ivtmp.118,
@ armwave.c:189:                 if(value != 0) {
	.loc 1 189 19 is_stmt 0 view .LVU730
	bne	.L181		@,
.LVL190:
.L165:
	.loc 1 189 19 view .LVU731
	add	r6, r6, #1	@ ivtmp.118, ivtmp.118,
@ armwave.c:185:             for(w = 0; w < 4; w++) {
	.loc 1 185 13 view .LVU732
	cmp	ip, r6	@ n, ivtmp.118
	beq	.L164		@,
	.loc 1 186 17 is_stmt 1 view .LVU733
.LVL191:
	.loc 1 187 17 view .LVU734
@ armwave.c:189:                 if(value != 0) {
	.loc 1 189 19 is_stmt 0 view .LVU735
	ands	r1, r0, #255	@ _21, wave_word,
@ armwave.c:187:                 wave_word >>= 8;
	.loc 1 187 27 view .LVU736
	lsr	r0, r0, #8	@ wave_word, wave_word,
.LVL192:
	.loc 1 189 17 is_stmt 1 view .LVU737
@ armwave.c:189:                 if(value != 0) {
	.loc 1 189 19 is_stmt 0 view .LVU738
	beq	.L165		@,
.L181:
	.loc 1 190 21 is_stmt 1 view .LVU739
.LVL193:
	.loc 1 191 21 view .LVU740
	.loc 1 192 21 view .LVU741
	.loc 1 194 21 view .LVU742
	.loc 1 195 21 view .LVU743
	.loc 1 196 21 view .LVU744
	.loc 1 199 21 view .LVU745
@ armwave.c:214:                     yy = (nsub & 0xff) * g_armwave_state.vscale_frac;
	.loc 1 214 32 is_stmt 0 view .LVU746
	uxtb	r3, r6	@ _49, ivtmp.118
@ armwave.c:215:                     ye = ((nsub & 0xff) + 1) * g_armwave_state.vscale_frac;
	.loc 1 215 41 view .LVU747
	add	r2, r3, #1	@ tmp198, _49,
@ armwave.c:214:                     yy = (nsub & 0xff) * g_armwave_state.vscale_frac;
	.loc 1 214 40 view .LVU748
	vmov	s15, r3	@ int	@ _49, _49
@ armwave.c:215:                     ye = ((nsub & 0xff) + 1) * g_armwave_state.vscale_frac;
	.loc 1 215 41 view .LVU749
	vmov	s14, r2	@ int	@ tmp198, tmp198
@ armwave.c:192:                     bb = (g_armwave_state.ch1_color.b * value) >> 8;
	.loc 1 192 55 view .LVU750
	mul	r3, r4, r1	@ tmp183, _29, _21
@ armwave.c:214:                     yy = (nsub & 0xff) * g_armwave_state.vscale_frac;
	.loc 1 214 40 view .LVU751
	vcvt.f32.s32	s15, s15	@ tmp196, _49
@ armwave.c:215:                     ye = ((nsub & 0xff) + 1) * g_armwave_state.vscale_frac;
	.loc 1 215 46 view .LVU752
	vcvt.f32.s32	s14, s14	@ tmp199, tmp198
@ armwave.c:191:                     gg = (g_armwave_state.ch1_color.g * value) >> 8;
	.loc 1 191 55 view .LVU753
	mul	r2, r10, r1	@ tmp187, _25, _21
@ armwave.c:192:                     bb = (g_armwave_state.ch1_color.b * value) >> 8;
	.loc 1 192 24 view .LVU754
	asr	r3, r3, #8	@ bb, tmp183,
.LVL194:
@ armwave.c:196:                     b = MIN(bb, 255);
	.loc 1 196 25 view .LVU755
	cmp	r3, #255	@ bb,
@ armwave.c:191:                     gg = (g_armwave_state.ch1_color.g * value) >> 8;
	.loc 1 191 24 view .LVU756
	asr	r2, r2, #8	@ gg, tmp187,
.LVL195:
@ armwave.c:196:                     b = MIN(bb, 255);
	.loc 1 196 25 view .LVU757
	movge	r3, #255	@ bb,
.LVL196:
@ armwave.c:214:                     yy = (nsub & 0xff) * g_armwave_state.vscale_frac;
	.loc 1 214 40 view .LVU758
	vmul.f32	s15, s15, s13	@ tmp197, tmp196, _51
@ armwave.c:215:                     ye = ((nsub & 0xff) + 1) * g_armwave_state.vscale_frac;
	.loc 1 215 46 view .LVU759
	vmul.f32	s14, s14, s13	@ tmp200, tmp199, _51
@ armwave.c:195:                     g = MIN(gg, 255);
	.loc 1 195 25 view .LVU760
	cmp	r2, #255	@ gg,
	movge	r2, #255	@ gg,
.LVL197:
@ armwave.c:190:                     rr = (g_armwave_state.ch1_color.r * value) >> 8;
	.loc 1 190 55 view .LVU761
	mul	r1, r1, fp	@ tmp193, _21, _19
.LVL198:
@ armwave.c:199:                     word = 0xff000000 | (b << 16) | (g << 8) | r;
	.loc 1 199 56 view .LVU762
	lsl	r2, r2, #8	@ tmp188, gg,
@ armwave.c:199:                     word = 0xff000000 | (b << 16) | (g << 8) | r;
	.loc 1 199 44 view .LVU763
	lsl	r3, r3, #16	@ tmp184, bb,
@ armwave.c:214:                     yy = (nsub & 0xff) * g_armwave_state.vscale_frac;
	.loc 1 214 24 view .LVU764
	vcvt.u32.f32	s15, s15	@ yy, tmp197
@ armwave.c:190:                     rr = (g_armwave_state.ch1_color.r * value) >> 8;
	.loc 1 190 24 view .LVU765
	asr	r1, r1, #8	@ rr, tmp193,
.LVL199:
@ armwave.c:199:                     word = 0xff000000 | (b << 16) | (g << 8) | r;
	.loc 1 199 56 view .LVU766
	uxth	r2, r2	@ tmp189, tmp188
@ armwave.c:199:                     word = 0xff000000 | (b << 16) | (g << 8) | r;
	.loc 1 199 44 view .LVU767
	and	r3, r3, #16711680	@ tmp185, tmp184,
@ armwave.c:194:                     r = MIN(rr, 255);
	.loc 1 194 25 view .LVU768
	cmp	r1, #255	@ rr,
@ armwave.c:199:                     word = 0xff000000 | (b << 16) | (g << 8) | r;
	.loc 1 199 51 view .LVU769
	orr	r3, r3, r2	@ tmp191, tmp185, tmp189
@ armwave.c:194:                     r = MIN(rr, 255);
	.loc 1 194 25 view .LVU770
	movge	r1, #255	@ rr,
.LVL200:
@ armwave.c:214:                     yy = (nsub & 0xff) * g_armwave_state.vscale_frac;
	.loc 1 214 24 view .LVU771
	vmov	lr, s15	@ int	@ yy, yy
@ armwave.c:215:                     ye = ((nsub & 0xff) + 1) * g_armwave_state.vscale_frac;
	.loc 1 215 24 view .LVU772
	vcvt.u32.f32	s15, s14	@ ye, tmp200
@ armwave.c:199:                     word = 0xff000000 | (b << 16) | (g << 8) | r;
	.loc 1 199 62 view .LVU773
	uxtb	r1, r1	@ rr, rr
	orr	r3, r3, r1	@ tmp195, tmp191, rr
@ armwave.c:199:                     word = 0xff000000 | (b << 16) | (g << 8) | r;
	.loc 1 199 26 view .LVU774
	orr	r3, r3, #-16777216	@ word, tmp195,
.LVL201:
	.loc 1 213 21 is_stmt 1 view .LVU775
	.loc 1 214 21 view .LVU776
	.loc 1 215 21 view .LVU777
	.loc 1 216 21 view .LVU778
@ armwave.c:216:                     xx = (nsub >> 8);
	.loc 1 216 32 is_stmt 0 view .LVU779
	asr	r1, r6, #8	@ xx, ivtmp.118,
.LVL202:
	.loc 1 218 21 is_stmt 1 view .LVU780
	.loc 1 218 21 is_stmt 0 view .LVU781
	vmov	r2, s15	@ int	@ ye,
@ armwave.c:215:                     ye = ((nsub & 0xff) + 1) * g_armwave_state.vscale_frac;
	.loc 1 215 24 view .LVU782
	vstr.32	s15, [sp]	@ int	@ ye, %sfp
.LVL203:
@ armwave.c:218:                     for(y = yy; y < ye; y++) {
...
.LVL204:
.L166:
	.loc 1 219 25 is_stmt 1 view .LVU784
	.loc 1 220 25 view .LVU785
@ armwave.c:219:                         offset = (xx + (y * g_armwave_state.target_width)); 
	.loc 1 219 43 is_stmt 0 view .LVU786
	ldr	r2, [r5, #88]	@ g_armwave_state.target_width, g_armwave_state.target_width
@ armwave.c:218:                     for(y = yy; y < ye; y++) {
	.loc 1 218 21 view .LVU787
	ldr	r0, [sp]	@ ye, %sfp
@ armwave.c:220:                         *(out_buffer_base + offset) = word;
	.loc 1 220 43 view .LVU788
	mla	r2, r2, lr, r1	@ tmp204, g_armwave_state.target_width, yy, xx
.LVL205:
@ armwave.c:218:                     for(y = yy; y < ye; y++) {
	.loc 1 218 42 view .LVU789
	add	lr, lr, #1	@ yy, yy,
.LVL206:
@ armwave.c:218:                     for(y = yy; y < ye; y++) {
	.loc 1 218 21 view .LVU790
	cmp	r0, lr	@ ye, yy
@ armwave.c:220:                         *(out_buffer_base + offset) = word;
	.loc 1 220 53 view .LVU791
	str	r3, [r8, r2, lsl #2]	@ word, *_66
@ armwave.c:218:                     for(y = yy; y < ye; y++) {
	.loc 1 218 21 view .LVU792
	bne	.L166		@,
	.loc 1 218 21 view .LVU793
	ldr	r0, [sp, #4]	@ wave_word, %sfp
	b	.L165		@
.LVL207:
.L180:
	.loc 1 173 5 is_stmt 1 view .LVU794
	ldr	r3, .L182+4	@,
	mov	r2, #173	@,
	ldr	r1, .L182+8	@,
	ldr	r0, .L182+12	@,
.LVL208:
	.loc 1 173 5 is_stmt 0 view .LVU795
	bl	__assert_fail		@
.LVL209:
.L183:
	.align	2
...
.LFB73:
	...
	@ args = 0, pretend = 0, frame = 0
	@ frame_needed = 0, uses_anonymous_args = 0
	.loc 1 476 5 view .LVU797
@ armwave.c:475: {
	.loc 1 475 1 is_stmt 0 view .LVU798
	push	{r4, r5, r6, lr}	@
	.cfi_def_cfa_offset 16
	.cfi_offset 4, -16
	.cfi_offset 5, -12
...
@ armwave.c:482:     g_armwave_state.test_wave_buffer = calloc(g_armwave_state.wave_length * g_armwave_state.waves_max, nsets);
	.loc 1 482 40 view .LVU805
	mov	r1, r6	@, nsets
@ armwave.c:482:     g_armwave_state.test_wave_buffer = calloc(g_armwave_state.wave_length * g_armwave_state.waves_max, nsets);
	.loc 1 482 75 view .LVU806
	mul	r5, r5, r3	@ _4, g_armwave_state.waves_max, g_armwave_state.wave_length
@ armwave.c:482:     g_armwave_state.test_wave_buffer = calloc(g_armwave_state.wave_length * g_armwave_state.waves_max, nsets);
	.loc 1 482 40 view .LVU807
	mov	r0, r5	@, _4
	bl	calloc		@
.LVL213:
@ armwave.c:484:     if(g_armwave_state.test_wave_buffer == NULL) {
	.loc 1 484 7 view .LVU808
	cmp	r0, #0	@ tmp124,
@ armwave.c:482:     g_armwave_state.test_wave_buffer = calloc(g_armwave_state.wave_length * g_armwave_state.waves_max, nsets);
	.loc 1 482 38 view .LVU809
	str	r0, [r4, #24]	@ tmp124, g_armwave_state.test_wave_buffer
	.loc 1 484 5 is_stmt 1 view .LVU810
@ armwave.c:484:     if(g_armwave_state.test_wave_buffer == NULL) {
	.loc 1 484 7 is_stmt 0 view .LVU811
	popne	{r4, r5, r6, pc}	@
	.loc 1 485 9 is_stmt 1 view .LVU812
	mul	r1, r6, r5	@, nsets, _4
	mov	r2, r6	@, nsets
	ldr	r0, .L191+4	@,
@ armwave.c:489: }
	.loc 1 489 1 is_stmt 0 view .LVU813
	pop	{r4, r5, r6, lr}	@
	.cfi_restore 14
	.cfi_restore 6
	.cfi_restore 5
...
@ armwave.c:485:         printf("armwave_test_buffer_alloc: failed to allocate test wave buffer (%d bytes, %d sets)\n", \
	.loc 1 485 9 view .LVU814
	b	printf		@
.LVL215:
.L192:
	.loc 1 485 9 view .LVU815
	.align	2
.L191:
	.word	g_armwave_state
	.word	.LC19
...
.LFB74:
	...
	@ frame_needed = 0, uses_anonymous_args = 0
	.loc 1 496 5 view .LVU817
	.loc 1 497 5 view .LVU818
	.loc 1 501 5 view .LVU819
@ armwave.c:495: {
	.loc 1 495 1 is_stmt 0 view .LVU820
	str	lr, [sp, #-4]!	@,
...
@ armwave.c:501:     ret = PyObject_GetBuffer(buf_obj, &buffer, PyBUF_SIMPLE | PyBUF_WRITABLE);
	.loc 1 501 11 view .LVU821
	add	r1, sp, #4	@ tmp131,,
	mov	r2, #1	@,
	bl	PyObject_GetBuffer		@
.LVL217:
	.loc 1 503 5 is_stmt 1 view .LVU822
@ armwave.c:503:     if(ret != 0) {
	.loc 1 503 7 is_stmt 0 view .LVU823
	cmp	r0, #0	@,
	bne	.L197		@,
	.loc 1 510 5 is_stmt 1 view .LVU824
	ldr	r0, [sp, #4]	@, buffer.buf
.LVL218:
	.loc 1 510 5 is_stmt 0 view .LVU825
	bl	armwave_fill_pixbuf_scaled		@
.LVL219:
	.loc 1 513 5 is_stmt 1 view .LVU826
	add	r0, sp, #4	@ tmp132,,
	bl	PyBuffer_Release		@
.LVL220:
	.loc 1 516 5 view .LVU827
.LBB43:
.LBI43:
...
.L197:
	.cfi_restore_state
	.loc 1 504 9 is_stmt 1 view .LVU835
	ldr	r0, .L198+4	@,
.LVL222:
	.loc 1 504 9 is_stmt 0 view .LVU836
	bl	puts		@
.LVL223:
	.loc 1 505 9 is_stmt 1 view .LVU837
.LBB47:
.LBI47:
	.loc 2 456 20 view .LVU838
.LBB48:
	.loc 2 458 21 view .LVU839
	.loc 2 459 5 view .LVU840
@ /usr/local/include/python3.8/object.h:459:     op->ob_refcnt++;
	.loc 2 459 18 is_stmt 0 view .LVU841
	ldr	r3, .L198+8	@ tmp120,
.LBE48:
.LBE47:
@ armwave.c:505:         Py_RETURN_FALSE;
	.loc 1 505 9 view .LVU842
	mov	r0, r3	@ <retval>, tmp120
.LBB50:
.LBB49:
@ /usr/local/include/python3.8/object.h:459:     op->ob_refcnt++;
	.loc 2 459 18 view .LVU843
...
.LFB75:
	...
	@ args = 0, pretend = 0, frame = 8
	@ frame_needed = 0, uses_anonymous_args = 0
	.loc 1 528 5 view .LVU846
	.loc 1 529 5 view .LVU847
@ armwave.c:527: {
	.loc 1 527 1 is_stmt 0 view .LVU848
	push	{r4, r5, r6, r7, r8, r9, r10, lr}	@
	.cfi_def_cfa_offset 32
	.cfi_offset 4, -32
	.cfi_offset 5, -28
...
@ armwave.c:529:     float _1_waves_mod = mod * (1.0f / g_armwave_state.waves);
	.loc 1 529 38 view .LVU849
	vldr.32	s14, .L231	@ tmp180,
@ armwave.c:529:     float _1_waves_mod = mod * (1.0f / g_armwave_state.waves);
	.loc 1 529 55 view .LVU850
	ldr	r5, .L231+28	@ tmp250,
@ armwave.c:527: {
	.loc 1 527 1 view .LVU851
...
@ armwave.c:533:     g_armwave_state.test_wave_buffer_stride = (g_armwave_state.waves * g_armwave_state.wave_stride);
	.loc 1 533 70 view .LVU853
	ldr	r3, [r5, #52]	@ g_armwave_state.wave_stride, g_armwave_state.wave_stride
	ldr	r2, [r5, #56]	@ tmp265, g_armwave_state.waves
.LBB53:
.LBB54:
@ armwave.c:476:     if(g_armwave_state.test_wave_buffer != NULL) {
	.loc 1 476 23 view .LVU854
	ldr	r0, [r5, #24]	@ _82, g_armwave_state.test_wave_buffer
.LVL225:
	.loc 1 476 23 view .LVU855
.LBE54:
.LBE53:
@ armwave.c:529:     float _1_waves_mod = mod * (1.0f / g_armwave_state.waves);
	.loc 1 529 38 view .LVU856
	vcvt.f32.s32	s15, s15	@ tmp178, tmp264
@ armwave.c:533:     g_armwave_state.test_wave_buffer_stride = (g_armwave_state.waves * g_armwave_state.wave_stride);
	.loc 1 533 70 view .LVU857
	mul	r3, r2, r3	@ tmp183, tmp265, g_armwave_state.wave_stride
@ armwave.c:527: {
	.loc 1 527 1 view .LVU858
	vmov.f32	s23, s1	@ noise_fraction, noise_fraction
.LBB58:
.LBB55:
@ armwave.c:476:     if(g_armwave_state.test_wave_buffer != NULL) {
	.loc 1 476 7 view .LVU859
	cmp	r0, #0	@ _82,
.LBE55:
.LBE58:
@ armwave.c:527: {
	.loc 1 527 1 view .LVU860
	sub	sp, sp, #8	@,,
	.cfi_def_cfa_offset 88
@ armwave.c:534:     g_armwave_state.test_wave_buffer_nsets = sets;
	.loc 1 534 44 view .LVU861
	str	r9, [r5, #32]	@ sets, g_armwave_state.test_wave_buffer_nsets
@ armwave.c:533:     g_armwave_state.test_wave_buffer_stride = (g_armwave_state.waves * g_armwave_state.wave_stride);
	.loc 1 533 45 view .LVU862
	str	r3, [r5, #28]	@ tmp183, g_armwave_state.test_wave_buffer_stride
@ armwave.c:529:     float _1_waves_mod = mod * (1.0f / g_armwave_state.waves);
	.loc 1 529 38 view .LVU863
	vdiv.f32	s26, s14, s15	@ tmp179, tmp180, tmp178
@ armwave.c:529:     float _1_waves_mod = mod * (1.0f / g_armwave_state.waves);
	.loc 1 529 11 view .LVU864
	vmul.f32	s26, s26, s0	@ _1_waves_mod, tmp179, mod
.LVL226:
	.loc 1 530 5 is_stmt 1 view .LVU865
	.loc 1 531 5 view .LVU866
	.loc 1 533 5 view .LVU867
	.loc 1 534 5 view .LVU868
	.loc 1 535 5 view .LVU869
.LBB59:
.LBI53:
	.loc 1 474 6 view .LVU870
.LBB56:
	.loc 1 476 5 view .LVU871
@ armwave.c:476:     if(g_armwave_state.test_wave_buffer != NULL) {
	.loc 1 476 7 is_stmt 0 view .LVU872
	beq	.L201		@,
	.loc 1 477 9 is_stmt 1 view .LVU873
	bl	free		@
.LVL227:
.L201:
	.loc 1 482 5 view .LVU874
@ armwave.c:482:     g_armwave_state.test_wave_buffer = calloc(g_armwave_state.wave_length * g_armwave_state.waves_max, nsets);
	.loc 1 482 75 is_stmt 0 view .LVU875
...
@ armwave.c:482:     g_armwave_state.test_wave_buffer = calloc(g_armwave_state.wave_length * g_armwave_state.waves_max, nsets);
	.loc 1 482 40 view .LVU876
	mov	r1, r9	@, sets
@ armwave.c:482:     g_armwave_state.test_wave_buffer = calloc(g_armwave_state.wave_length * g_armwave_state.waves_max, nsets);
	.loc 1 482 75 view .LVU877
	mul	r4, r4, r3	@ _85, g_armwave_state.waves_max, g_armwave_state.wave_length
@ armwave.c:482:     g_armwave_state.test_wave_buffer = calloc(g_armwave_state.wave_length * g_armwave_state.waves_max, nsets);
	.loc 1 482 40 view .LVU878
	mov	r0, r4	@, _85
	bl	calloc		@
.LVL228:
@ armwave.c:484:     if(g_armwave_state.test_wave_buffer == NULL) {
	.loc 1 484 7 view .LVU879
	cmp	r0, #0	@ tmp191,
@ armwave.c:482:     g_armwave_state.test_wave_buffer = calloc(g_armwave_state.wave_length * g_armwave_state.waves_max, nsets);
	.loc 1 482 38 view .LVU880
	str	r0, [r5, #24]	@ tmp191, g_armwave_state.test_wave_buffer
	.loc 1 484 5 is_stmt 1 view .LVU881
@ armwave.c:484:     if(g_armwave_state.test_wave_buffer == NULL) {
	.loc 1 484 7 is_stmt 0 view .LVU882
	beq	.L230		@,
.L202:
.LVL229:
	.loc 1 484 7 view .LVU883
.LBE56:
.LBE59:
@ armwave.c:537:     for(s = 0; s < sets; s++) {
	.loc 1 537 5 discriminator 1 view .LVU884
	cmp	r9, #0	@ sets,
	ble	.L200		@,
@ armwave.c:556:                 v = (sin((6.28f * x * (1.0f / g_armwave_state.wave_length)) + xnoise) * mod_val) * noise;
	.loc 1 556 45 view .LVU885
...
@ armwave.c:559:                 g_armwave_state.test_wave_buffer[x + (w * g_armwave_state.wave_stride) + set_offset] = (uint8_t)MIN(MAX(128 + (v * 127), 0), 255);
	...
	ble	.L207		@,
@ armwave.c:559:                 g_armwave_state.test_wave_buffer[x + (w * g_armwave_state.wave_stride) + set_offset] = (uint8_t)MIN(MAX(128 + (v * 127), 0), 255);
	.loc 1 559 104 discriminator 1 view .LVU945
...
.L207:
@ armwave.c:559:                 g_armwave_state.test_wave_buffer[x + (w * g_armwave_state.wave_stride) + set_offset] = (uint8_t)MIN(MAX(128 + (v * 127), 0), 255);
	.loc 1 559 57 discriminator 12 view .LVU946
	ldr	r2, [r5, #52]	@ g_armwave_state.wave_stride, g_armwave_state.wave_stride
@ armwave.c:559:                 g_armwave_state.test_wave_buffer[x + (w * g_armwave_state.wave_stride) + set_offset] = (uint8_t)MIN(MAX(128 + (v * 127), 0), 255);
	.loc 1 559 102 discriminator 12 view .LVU947
...
@ armwave.c:544:             for(x = 0; x < g_armwave_state.wave_length; x++) {
	.loc 1 544 58 discriminator 12 view .LVU948
	add	r4, r4, #1	@ x, x,
.LVL245:
@ armwave.c:559:                 g_armwave_state.test_wave_buffer[x + (w * g_armwave_state.wave_stride) + set_offset] = (uint8_t)MIN(MAX(128 + (v * 127), 0), 255);
	.loc 1 559 102 discriminator 12 view .LVU949
	strb	r1, [r2, r3]	@ iftmp.22_50, *_40
@ armwave.c:544:             for(x = 0; x < g_armwave_state.wave_length; x++) {
	.loc 1 544 43 discriminator 12 view .LVU950
	ldr	r3, [r5, #76]	@ prephitmp_124, g_armwave_state.wave_length
@ armwave.c:544:             for(x = 0; x < g_armwave_state.wave_length; x++) {
	.loc 1 544 13 discriminator 12 view .LVU951
...
.L205:
@ armwave.c:540:         for(w = 0; w < g_armwave_state.waves; w++) {
	.loc 1 540 48 discriminator 2 view .LVU952
	add	r6, r6, #1	@ w, w,
.LVL247:
@ armwave.c:540:         for(w = 0; w < g_armwave_state.waves; w++) {
	.loc 1 540 9 discriminator 2 view .LVU953
	cmp	r6, r2	@ w, prephitmp_120
	blt	.L211		@,
.LVL248:
.L204:
	.loc 1 563 9 is_stmt 1 discriminator 2 view .LVU954
@ armwave.c:563:         set_offset += (g_armwave_state.waves * g_armwave_state.wave_stride);
	.loc 1 563 46 is_stmt 0 discriminator 2 view .LVU955
	ldr	r3, [r5, #52]	@ g_armwave_state.wave_stride, g_armwave_state.wave_stride
@ armwave.c:537:     for(s = 0; s < sets; s++) {
	.loc 1 537 27 discriminator 2 view .LVU956
	add	r8, r8, #1	@ s, s,
.LVL249:
@ armwave.c:537:     for(s = 0; s < sets; s++) {
	.loc 1 537 5 discriminator 2 view .LVU957
	cmp	r9, r8	@ sets, s
@ armwave.c:563:         set_offset += (g_armwave_state.waves * g_armwave_state.wave_stride);
	.loc 1 563 20 discriminator 2 view .LVU958
	mla	r7, r3, r2, r7	@ set_offset, g_armwave_state.wave_stride, prephitmp_120, set_offset
.LVL250:
@ armwave.c:537:     for(s = 0; s < sets; s++) {
	.loc 1 537 5 discriminator 2 view .LVU959
	bne	.L203		@,
.LVL251:
.L200:
@ armwave.c:565: }
	.loc 1 565 1 view .LVU960
	add	sp, sp, #8	@,,
	.cfi_remember_state
	.cfi_def_cfa_offset 80
	@ sp needed	@
...
.LBB60:
.LBB57:
	.loc 1 485 9 is_stmt 1 view .LVU962
	mul	r1, r4, r9	@, _85, sets
	mov	r2, r9	@, sets
	ldr	r0, .L231+36	@,
	bl	printf		@
.LVL254:
	.loc 1 487 9 view .LVU963
	b	.L202		@
.L232:
	.align	2
.L231:
...
.LFB76:
	...
	@ args = 0, pretend = 0, frame = 0
	@ frame_needed = 0, uses_anonymous_args = 0
	.loc 1 616 5 view .LVU965
@ armwave.c:615: {
	.loc 1 615 1 is_stmt 0 view .LVU966
	push	{r4, lr}	@
	.cfi_def_cfa_offset 8
	.cfi_offset 4, -8
	.cfi_offset 14, -4
@ armwave.c:616:     free(g_armwave_state.out_pixbuf);
	.loc 1 616 25 view .LVU967
	ldr	r4, .L235	@ tmp114,
@ armwave.c:616:     free(g_armwave_state.out_pixbuf);
	.loc 1 616 5 view .LVU968
	ldr	r0, [r4, #104]	@, g_armwave_state.out_pixbuf
	bl	free		@
.LVL255:
	.loc 1 617 5 is_stmt 1 view .LVU969
	ldr	r0, [r4, #4]	@, g_armwave_state.ch1_buffer
	bl	free		@
.LVL256:
	.loc 1 618 5 view .LVU970
