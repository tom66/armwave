...
@ armwave.c:307:             b = MIN(bb, 255);
	...
	cmp	lr, #255	@ bb,
@ armwave.c:314:             *(out_buffer_base + (xx + (yy * g_armwave_state.target_width))) = word;
	.loc 1 314 43 view .LVU378
...
@ armwave.c:314:             *(out_buffer_base + (xx + (yy * g_armwave_state.target_width))) = word;
	...
	mla	r1, ip, r0, r1	@ tmp172, g_armwave_state.target_width,,
.LVL87:
@ armwave.c:314:             *(out_buffer_base + (xx + (yy * g_armwave_state.target_width))) = word;
	.loc 1 314 77 view .LVU387
