...
.LVL32:
	.loc 1 139 5 is_stmt 1 view .LVU141
	lsl	r1, r1, #2	@, tmp190,
	mov	r2, r10	@, npix
	str	r0, [sp, #4]	@ tmp194,
...
.LVL34:
	...
	bl	puts		@
.LVL35:
	.loc 1 148 5 view .LVU148
	.loc 1 148 5 is_stmt 0 view .LVU149
	cmp	r10, #0	@ npix,
	ble	.L34		@,
@ armwave.c:148:     for(n = 0; n < npix; n += 2) {
	.loc 1 148 11 view .LVU150
	mov	r4, #0	@ n,
@ armwave.c:152:         if(n % 200 == 0) {
	.loc 1 152 14 view .LVU151
	ldr	fp, .L47+16	@ tmp208,
@ armwave.c:122:     uint32_t xx, yy, ye, y, word, wave_word, painted = 0;
	.loc 1 122 46 view .LVU152
	str	r4, [sp, #8]	@ n, %sfp
	b	.L33		@
.LVL36:
.L28:
	.loc 1 156 9 is_stmt 1 view .LVU153
@ armwave.c:156:         if(COND_UNLIKELY(wave_word != 0)) {
	.loc 1 156 11 is_stmt 0 view .LVU154
	cmp	r5, #0	@ wave_word,
	bne	.L45		@,
.LVL37:
.L29:
@ armwave.c:148:     for(n = 0; n < npix; n += 2) {
	.loc 1 148 28 discriminator 2 view .LVU155
	add	r4, r4, #2	@ n, n,
.LVL38:
@ armwave.c:148:     for(n = 0; n < npix; n += 2) {
	.loc 1 148 5 discriminator 2 view .LVU156
	cmp	r10, r4	@ npix, n
	ble	.L27		@,
.LVL39:
.L33:
	.loc 1 150 9 is_stmt 1 view .LVU157
@ armwave.c:152:         if(n % 200 == 0) {
	.loc 1 152 14 is_stmt 0 view .LVU158
	smull	r2, r3, fp, r4	@ tmp283, tmp207, tmp208, n
@ armwave.c:150:         wave_word = *base_32ptr++;
	.loc 1 150 19 view .LVU159
	ldr	r5, [r9], #4	@ wave_word, MEM[base: base_32ptr_79, offset: 4294967292B]
.LVL40:
	.loc 1 152 9 is_stmt 1 view .LVU160
@ armwave.c:152:         if(n % 200 == 0) {
	.loc 1 152 14 is_stmt 0 view .LVU161
...
@ armwave.c:152:         if(n % 200 == 0) {
	.loc 1 152 11 view .LVU162
	cmp	r4, r3, lsl #3	@ n, tmp215,
	bne	.L28		@,
.LVL41:
	.loc 1 153 12 is_stmt 1 view .LVU163
	mov	r1, r4	@, n
	ldr	r0, .L47+20	@,
	bl	printf		@
.LVL42:
	.loc 1 156 9 view .LVU164
@ armwave.c:156:         if(COND_UNLIKELY(wave_word != 0)) {
	.loc 1 156 11 is_stmt 0 view .LVU165
	cmp	r5, #0	@ wave_word,
	beq	.L29		@,
.LVL43:
.L45:
	.loc 1 157 13 is_stmt 1 view .LVU166
@ armwave.c:162:                     rr = (g_armwave_state.ch1_color.r * value) >> 8;
	.loc 1 162 52 is_stmt 0 view .LVU167
	ldrsh	r3, [r6, #108]	@ _19, g_armwave_state.ch1_color.r
@ armwave.c:175:                     yy = (nsub & 0xff) * g_armwave_state.vscale_frac;
	.loc 1 175 57 view .LVU168
	vldr.32	s13, [r6, #40]	@ _39, g_armwave_state.vscale_frac
@ armwave.c:157:             for(w = 0; w < 2; w++) {
	.loc 1 157 26 view .LVU169
	mov	lr, #0	@ w.9_110,
@ armwave.c:162:                     rr = (g_armwave_state.ch1_color.r * value) >> 8;
	.loc 1 162 52 view .LVU170
	str	r3, [sp, #12]	@ _19, %sfp
@ armwave.c:163:                     gg = (g_armwave_state.ch1_color.g * value) >> 8;
	.loc 1 163 52 view .LVU171
	ldrsh	r3, [r6, #110]	@ _22, g_armwave_state.ch1_color.g
	str	r3, [sp, #16]	@ _22, %sfp
@ armwave.c:164:                     bb = (g_armwave_state.ch1_color.b * value) >> 8;
	.loc 1 164 52 view .LVU172
...
.L30:
@ armwave.c:157:             for(w = 0; w < 2; w++) {
	.loc 1 157 13 discriminator 2 view .LVU173
	cmp	lr, #1	@ w.9_110,
	beq	.L46		@,
.L35:
	.loc 1 157 13 discriminator 2 view .LVU174
	mov	lr, #1	@ w.9_110,
.L32:
	.loc 1 158 17 is_stmt 1 view .LVU175
@ armwave.c:158:                 value = wave_word & 0xffff;
	.loc 1 158 23 is_stmt 0 view .LVU176
	uxth	r3, r5	@ value, wave_word
.LVL45:
	.loc 1 159 17 is_stmt 1 view .LVU177
@ armwave.c:161:                 if(value != 0) {
	.loc 1 161 19 is_stmt 0 view .LVU178
	cmp	r3, #0	@ value,
@ armwave.c:159:                 wave_word >>= 16;
	.loc 1 159 27 view .LVU179
	lsr	r5, r5, #16	@ wave_word, wave_word,
.LVL46:
	.loc 1 161 17 is_stmt 1 view .LVU180
@ armwave.c:161:                 if(value != 0) {
	.loc 1 161 19 is_stmt 0 view .LVU181
	beq	.L30		@,
	.loc 1 162 21 is_stmt 1 view .LVU182
.LVL47:
	.loc 1 163 21 view .LVU183
	.loc 1 164 21 view .LVU184
	.loc 1 166 21 view .LVU185
	.loc 1 167 21 view .LVU186
	.loc 1 168 21 view .LVU187
	.loc 1 171 21 view .LVU188
	add	r0, r4, lr	@ _165, n, w.9_110
@ armwave.c:164:                     bb = (g_armwave_state.ch1_color.b * value) >> 8;
	.loc 1 164 55 is_stmt 0 view .LVU189
	ldr	r2, [sp, #20]	@ _25, %sfp
@ armwave.c:175:                     yy = (nsub & 0xff) * g_armwave_state.vscale_frac;
	.loc 1 175 32 view .LVU190
	uxtb	r1, r0	@ _37, _165
@ armwave.c:176:                     ye = ((nsub & 0xff) + 1) * g_armwave_state.vscale_frac;
	.loc 1 176 41 view .LVU191
	add	ip, r1, #1	@ tmp241, _37,
@ armwave.c:175:                     yy = (nsub & 0xff) * g_armwave_state.vscale_frac;
	.loc 1 175 40 view .LVU192
	vmov	s15, r1	@ int	@ _37, _37
@ armwave.c:176:                     ye = ((nsub & 0xff) + 1) * g_armwave_state.vscale_frac;
	.loc 1 176 41 view .LVU193
	vmov	s14, ip	@ int	@ tmp241, tmp241
@ armwave.c:163:                     gg = (g_armwave_state.ch1_color.g * value) >> 8;
	.loc 1 163 55 view .LVU194
	ldr	r1, [sp, #16]	@ _22, %sfp
@ armwave.c:164:                     bb = (g_armwave_state.ch1_color.b * value) >> 8;
	.loc 1 164 55 view .LVU195
	mul	r2, r3, r2	@ tmp226, value, _25
@ armwave.c:175:                     yy = (nsub & 0xff) * g_armwave_state.vscale_frac;
	.loc 1 175 40 view .LVU196
	vcvt.f32.s32	s15, s15	@ tmp239, _37
@ armwave.c:176:                     ye = ((nsub & 0xff) + 1) * g_armwave_state.vscale_frac;
	.loc 1 176 46 view .LVU197
	vcvt.f32.s32	s14, s14	@ tmp242, tmp241
@ armwave.c:163:                     gg = (g_armwave_state.ch1_color.g * value) >> 8;
	.loc 1 163 55 view .LVU198
	mul	r1, r3, r1	@ tmp230, value, _22
@ armwave.c:162:                     rr = (g_armwave_state.ch1_color.r * value) >> 8;
	.loc 1 162 55 view .LVU199
	ldr	ip, [sp, #12]	@ _19, %sfp
@ armwave.c:164:                     bb = (g_armwave_state.ch1_color.b * value) >> 8;
	.loc 1 164 24 view .LVU200
	asr	r2, r2, #8	@ bb, tmp226,
.LVL48:
@ armwave.c:168:                     b = MIN(bb, 255);
	.loc 1 168 25 view .LVU201
	cmp	r2, #255	@ bb,
@ armwave.c:162:                     rr = (g_armwave_state.ch1_color.r * value) >> 8;
	.loc 1 162 55 view .LVU202
	mul	r3, r3, ip	@ tmp236, value, _19
.LVL49:
@ armwave.c:175:                     yy = (nsub & 0xff) * g_armwave_state.vscale_frac;
	.loc 1 175 40 view .LVU203
	vmul.f32	s15, s15, s13	@ tmp240, tmp239, _39
@ armwave.c:176:                     ye = ((nsub & 0xff) + 1) * g_armwave_state.vscale_frac;
	.loc 1 176 46 view .LVU204
	vmul.f32	s14, s14, s13	@ tmp243, tmp242, _39
@ armwave.c:163:                     gg = (g_armwave_state.ch1_color.g * value) >> 8;
	.loc 1 163 24 view .LVU205
	asr	r1, r1, #8	@ gg, tmp230,
.LVL50:
@ armwave.c:168:                     b = MIN(bb, 255);
	.loc 1 168 25 view .LVU206
	movge	r2, #255	@ bb,
.LVL51:
@ armwave.c:167:                     g = MIN(gg, 255);
	.loc 1 167 25 view .LVU207
	cmp	r1, #255	@ gg,
	movge	r1, #255	@ gg,
.LVL52:
@ armwave.c:162:                     rr = (g_armwave_state.ch1_color.r * value) >> 8;
	.loc 1 162 24 view .LVU208
	asr	r3, r3, #8	@ rr, tmp236,
.LVL53:
@ armwave.c:166:                     r = MIN(rr, 255);
	.loc 1 166 25 view .LVU209
	cmp	r3, #255	@ rr,
@ armwave.c:175:                     yy = (nsub & 0xff) * g_armwave_state.vscale_frac;
	.loc 1 175 24 view .LVU210
	vcvt.u32.f32	s15, s15	@ yy, tmp240
@ armwave.c:171:                     word = 0xff000000 | (b << 16) | (g << 8) | r;
	.loc 1 171 56 view .LVU211
	lsl	r1, r1, #8	@ tmp231, gg,
@ armwave.c:166:                     r = MIN(rr, 255);
	.loc 1 166 25 view .LVU212
	movge	r3, #255	@ rr,
.LVL54:
@ armwave.c:171:                     word = 0xff000000 | (b << 16) | (g << 8) | r;
	.loc 1 171 44 view .LVU213
	lsl	r2, r2, #16	@ tmp227, bb,
@ armwave.c:177:                     xx = (nsub >> 8) / 2;
	.loc 1 177 32 view .LVU214
	asr	r0, r0, #8	@ tmp244, _165,
@ armwave.c:171:                     word = 0xff000000 | (b << 16) | (g << 8) | r;
	.loc 1 171 44 view .LVU215
	and	r2, r2, #16711680	@ tmp228, tmp227,
@ armwave.c:171:                     word = 0xff000000 | (b << 16) | (g << 8) | r;
	.loc 1 171 56 view .LVU216
	uxth	r1, r1	@ tmp232, tmp231
@ armwave.c:171:                     word = 0xff000000 | (b << 16) | (g << 8) | r;
	.loc 1 171 51 view .LVU217
	orr	r1, r2, r1	@ tmp234, tmp228, tmp232
@ armwave.c:175:                     yy = (nsub & 0xff) * g_armwave_state.vscale_frac;
	.loc 1 175 24 view .LVU218
	vmov	r8, s15	@ int	@ yy, yy
@ armwave.c:176:                     ye = ((nsub & 0xff) + 1) * g_armwave_state.vscale_frac;
	.loc 1 176 24 view .LVU219
	vcvt.u32.f32	s15, s14	@ ye, tmp243
@ armwave.c:171:                     word = 0xff000000 | (b << 16) | (g << 8) | r;
	.loc 1 171 62 view .LVU220
	uxtb	r3, r3	@ rr, rr
@ armwave.c:177:                     xx = (nsub >> 8) / 2;
	.loc 1 177 38 view .LVU221
	add	r0, r0, r0, lsr #31	@ tmp246, tmp244, tmp244,
@ armwave.c:171:                     word = 0xff000000 | (b << 16) | (g << 8) | r;
	.loc 1 171 62 view .LVU222
	orr	r1, r1, r3	@ tmp238, tmp234, rr
@ armwave.c:171:                     word = 0xff000000 | (b << 16) | (g << 8) | r;
	.loc 1 171 26 view .LVU223
	orr	r1, r1, #-16777216	@ word, tmp238,
.LVL55:
	.loc 1 174 21 is_stmt 1 view .LVU224
	.loc 1 175 21 view .LVU225
	.loc 1 176 21 view .LVU226
@ armwave.c:177:                     xx = (nsub >> 8) / 2;
	.loc 1 177 38 is_stmt 0 view .LVU227
	asr	r0, r0, #1	@ xx, tmp246,
@ armwave.c:176:                     ye = ((nsub & 0xff) + 1) * g_armwave_state.vscale_frac;
	.loc 1 176 24 view .LVU228
	vmov	ip, s15	@ int	@ ye, ye
.LVL56:
	.loc 1 177 21 is_stmt 1 view .LVU229
	.loc 1 179 21 view .LVU230
	.loc 1 179 21 is_stmt 0 view .LVU231
	cmp	r8, ip	@ yy, ye
	bcs	.L30		@,
	mov	r3, r8	@ y, yy
.LVL57:
.L31:
	.loc 1 180 25 is_stmt 1 discriminator 3 view .LVU232
	.loc 1 181 25 discriminator 3 view .LVU233
@ armwave.c:180:                         offset = (xx + (y * g_armwave_state.target_width)); 
	.loc 1 180 43 is_stmt 0 discriminator 3 view .LVU234
	ldr	r2, [r6, #88]	@ g_armwave_state.target_width, g_armwave_state.target_width
@ armwave.c:181:                         *(out_buffer_base + offset) = word;
	.loc 1 181 43 discriminator 3 view .LVU235
	mla	r2, r2, r3, r0	@ tmp251, g_armwave_state.target_width, y, xx
.LVL58:
@ armwave.c:179:                     for(y = yy; y < ye; y++) {
	.loc 1 179 42 discriminator 3 view .LVU236
	add	r3, r3, #1	@ y, y,
.LVL59:
@ armwave.c:179:                     for(y = yy; y < ye; y++) {
	.loc 1 179 21 discriminator 3 view .LVU237
	cmp	ip, r3	@ ye, y
@ armwave.c:181:                         *(out_buffer_base + offset) = word;
	.loc 1 181 53 discriminator 3 view .LVU238
	str	r1, [r7, r2, lsl #2]	@ word, *_50
	.loc 1 182 25 is_stmt 1 discriminator 3 view .LVU239
.LVL60:
@ armwave.c:179:                     for(y = yy; y < ye; y++) {
	.loc 1 179 21 is_stmt 0 discriminator 3 view .LVU240
	bne	.L31		@,
	.loc 1 179 21 discriminator 3 view .LVU241
	ldr	r3, [sp, #8]	@ painted, %sfp
.LVL61:
	.loc 1 179 21 discriminator 3 view .LVU242
	sub	ip, ip, r8	@ tmp252, ye, yy
.LVL62:
	.loc 1 179 21 discriminator 3 view .LVU243
	add	r3, r3, ip	@ painted, painted, tmp252
@ armwave.c:157:             for(w = 0; w < 2; w++) {
	.loc 1 157 13 view .LVU244
	cmp	lr, #1	@ w.9_110,
	str	r3, [sp, #8]	@ painted, %sfp
.LVL63:
	.loc 1 157 13 view .LVU245
	bne	.L35		@,
.LVL64:
.L46:
@ armwave.c:148:     for(n = 0; n < npix; n += 2) {
	.loc 1 148 28 view .LVU246
	add	r4, r4, #2	@ n, n,
.LVL65:
	.loc 1 148 28 view .LVU247
	mov	r3, #2	@ tmp253,
@ armwave.c:148:     for(n = 0; n < npix; n += 2) {
	.loc 1 148 5 view .LVU248
	cmp	r10, r4	@ npix, n
	str	r3, [sp, #28]	@ tmp253, w
.LVL66:
	.loc 1 148 5 view .LVU249
	bgt	.L33		@,
.LVL67:
.L27:
	.loc 1 189 5 is_stmt 1 view .LVU250
	ldr	r1, [sp, #8]	@, %sfp
	ldr	r0, .L47+24	@,
	bl	printf		@
.LVL68:
.L24:
@ armwave.c:190: }
	.loc 1 190 1 is_stmt 0 view .LVU251
	add	sp, sp, #36	@,,
	.cfi_remember_state
	.cfi_def_cfa_offset 36
	@ sp needed	@
...
.LFB61:
	...
	@ args = 0, pretend = 0, frame = 0
	@ frame_needed = 0, uses_anonymous_args = 0
	.loc 1 197 5 view .LVU254
	.loc 1 198 5 view .LVU255
.LVL70:
	.loc 1 200 5 view .LVU256
@ armwave.c:196: {
	...
	.cfi_offset 7, -8
	.cfi_offset 14, -4
@ armwave.c:200:     memset(g_armwave_state.ch1_buffer, 0, g_armwave_state.ch_buff_size);
	.loc 1 200 5 view .LVU258
	mov	r1, #0	@,
@ armwave.c:200:     memset(g_armwave_state.ch1_buffer, 0, g_armwave_state.ch_buff_size);
	.loc 1 200 58 view .LVU259
	ldr	r5, .L57	@ tmp154,
@ armwave.c:196: {
	.loc 1 196 1 view .LVU260
	sub	sp, sp, #12	@,,
...
@ armwave.c:202:     for(yy = 0; yy < (g_armwave_state.wave_length / g_armwave_state.slice_height); yy++) {
	.loc 1 202 68 is_stmt 0 view .LVU263
	ldr	r6, [r5, #68]	@ _13, g_armwave_state.slice_height
@ armwave.c:202:     for(yy = 0; yy < (g_armwave_state.wave_length / g_armwave_state.slice_height); yy++) {
	.loc 1 202 51 view .LVU264
...
@ armwave.c:202:     for(yy = 0; yy < (g_armwave_state.wave_length / g_armwave_state.slice_height); yy++) {
	...
	cmp	r0, #0	@,
	beq	.L49		@,
@ armwave.c:204:         printf("armwave_generate: slice %d (y=%d, h=%d, xpos=%d)\n", \
	.loc 1 204 9 view .LVU266
	ldr	r7, .L57+4	@ tmp155,
@ armwave.c:202:     for(yy = 0; yy < (g_armwave_state.wave_length / g_armwave_state.slice_height); yy++) {
	.loc 1 202 12 view .LVU267
	mov	r4, #0	@ yy,
.LVL73:
.L51:
	.loc 1 204 9 is_stmt 1 discriminator 3 view .LVU268
	mul	r1, r4, r6	@ _5, yy, _13
@ armwave.c:206:             (yy * g_armwave_state.slice_height * g_armwave_state.cmp_x_bitdepth_scale) >> AM_XCOORD_MULT_SHIFT);
	.loc 1 206 48 is_stmt 0 discriminator 3 view .LVU269
	ldr	ip, [r5, #36]	@ g_armwave_state.cmp_x_bitdepth_scale, g_armwave_state.cmp_x_bitdepth_scale
@ armwave.c:204:         printf("armwave_generate: slice %d (y=%d, h=%d, xpos=%d)\n", \
	.loc 1 204 9 discriminator 3 view .LVU270
	mov	r3, r6	@, _13
	mov	r2, r1	@, _5
@ armwave.c:206:             (yy * g_armwave_state.slice_height * g_armwave_state.cmp_x_bitdepth_scale) >> AM_XCOORD_MULT_SHIFT);
	.loc 1 206 48 discriminator 3 view .LVU271
	mul	ip, ip, r1	@ tmp143, g_armwave_state.cmp_x_bitdepth_scale, _5
@ armwave.c:204:         printf("armwave_generate: slice %d (y=%d, h=%d, xpos=%d)\n", \
	.loc 1 204 9 discriminator 3 view .LVU272
	mov	r0, r7	@, tmp155
	mov	r1, r4	@, yy
	...
	bl	printf		@
.LVL74:
	.loc 1 208 9 is_stmt 1 discriminator 3 view .LVU273
@ armwave.c:208:         render_nonaa_to_buffer_1ch_slice(yy * g_armwave_state.slice_height, g_armwave_state.slice_height);
	.loc 1 208 62 is_stmt 0 discriminator 3 view .LVU274
	ldr	r1, [r5, #68]	@ _10, g_armwave_state.slice_height
@ armwave.c:208:         render_nonaa_to_buffer_1ch_slice(yy * g_armwave_state.slice_height, g_armwave_state.slice_height);
	.loc 1 208 9 discriminator 3 view .LVU275
	mul	r0, r4, r1	@, yy,
	bl	render_nonaa_to_buffer_1ch_slice		@
.LVL75:
	.loc 1 209 9 is_stmt 1 discriminator 3 view .LVU276
	.loc 1 210 9 discriminator 3 view .LVU277
@ armwave.c:202:     for(yy = 0; yy < (g_armwave_state.wave_length / g_armwave_state.slice_height); yy++) {
	.loc 1 202 68 is_stmt 0 discriminator 3 view .LVU278
	ldr	r6, [r5, #68]	@ _13, g_armwave_state.slice_height
@ armwave.c:202:     for(yy = 0; yy < (g_armwave_state.wave_length / g_armwave_state.slice_height); yy++) {
	.loc 1 202 51 discriminator 3 view .LVU279
	ldr	r0, [r5, #76]	@, g_armwave_state.wave_length
	mov	r1, r6	@, _13
	bl	__aeabi_idiv		@
.LVL76:
@ armwave.c:202:     for(yy = 0; yy < (g_armwave_state.wave_length / g_armwave_state.slice_height); yy++) {
	.loc 1 202 86 discriminator 3 view .LVU280
	add	r4, r4, #1	@ yy, yy,
.LVL77:
@ armwave.c:202:     for(yy = 0; yy < (g_armwave_state.wave_length / g_armwave_state.slice_height); yy++) {
	.loc 1 202 5 discriminator 3 view .LVU281
	cmp	r0, r4	@, yy
	bhi	.L51		@,
.LVL78:
.L49:
@ armwave.c:219: }
	.loc 1 219 1 view .LVU282
	add	sp, sp, #12	@,,
	.cfi_def_cfa_offset 20
	@ sp needed	@
	pop	{r4, r5, r6, r7, pc}	@
...
.LFB62:
	...
	@ frame_needed = 0, uses_anonymous_args = 0
	.loc 1 226 5 view .LVU284
	.loc 1 227 5 view .LVU285
	.loc 1 229 5 view .LVU286
@ armwave.c:225: {
	.loc 1 225 1 is_stmt 0 view .LVU287
...
@ armwave.c:229:     printf("s=%d e=%d w=%d ws=%d tw=%d th=%d rf=0x%08x\n", start_point, end_point, waves_max, wave_stride, target_width, target_height, render_flags);
	.loc 1 229 5 view .LVU291
	strd	r6, [sp, #4]	@,,
	mov	r3, r2	@, waves_max
.LVL80:
	.loc 1 229 5 view .LVU292
	str	ip, [sp, #12]	@ render_flags,
	mov	r2, r1	@, end_point
.LVL81:
	.loc 1 229 5 view .LVU293
	mov	r1, r0	@, start_point
.LVL82:
	.loc 1 229 5 view .LVU294
	ldr	r0, .L69+12	@,
.LVL83:
	.loc 1 229 5 view .LVU295
	bl	printf		@
.LVL84:
	.loc 1 232 5 is_stmt 1 view .LVU296
	cmp	r4, r5	@ start_point, end_point
	bcs	.L67		@,
	.loc 1 253 5 view .LVU297
@ armwave.c:264:     g_armwave_state.wave_length = end_point - start_point;
	.loc 1 264 45 is_stmt 0 view .LVU298
	sub	r5, r5, r4	@ _13, end_point, start_point
.LVL85:
@ armwave.c:268:         ((g_armwave_state.target_width * (1.0f / g_armwave_state.wave_length))) * (1 << AM_XCOORD_MULT_SHIFT);
	.loc 1 268 48 view .LVU299
	vldr.32	s10, .L69	@ tmp187,
	vmov	s15, r5	@ int	@ _13, _13
@ armwave.c:254:     g_armwave_state.vscale_frac = target_height / 255.0f;
	.loc 1 254 49 view .LVU300
	vldr.32	s14, .L69+4	@ tmp165,
@ armwave.c:268:         ((g_armwave_state.target_width * (1.0f / g_armwave_state.wave_length))) * (1 << AM_XCOORD_MULT_SHIFT);
	.loc 1 268 81 view .LVU301
	vldr.32	s12, .L69+8	@ tmp191,
@ armwave.c:261:     g_armwave_state.ch_buff_size = (g_armwave_state.bitdepth_height + 4) * (target_width + 4) * sizeof(bufftyp_t);  // Add word padding too
	.loc 1 261 90 view .LVU302
	add	r3, r6, #4	@ tmp176, target_width,
@ armwave.c:268:         ((g_armwave_state.target_width * (1.0f / g_armwave_state.wave_length))) * (1 << AM_XCOORD_MULT_SHIFT);
	.loc 1 268 48 view .LVU303
	vcvt.f32.s32	s13, s15	@ tmp185, _13
@ armwave.c:254:     g_armwave_state.vscale_frac = target_height / 255.0f;
	.loc 1 254 49 view .LVU304
	vmov	s15, r7	@ int	@ target_height, target_height
@ armwave.c:253:     g_armwave_state.xstride = target_height;
	.loc 1 253 29 view .LVU305
	ldr	r4, .L69+16	@ tmp222,
.LVL86:
@ armwave.c:259:     g_armwave_state.size = target_height * target_width;
	.loc 1 259 42 view .LVU306
	mul	r1, r7, r6	@ tmp173, target_height, target_width
@ armwave.c:254:     g_armwave_state.vscale_frac = target_height / 255.0f;
	.loc 1 254 49 view .LVU307
	vcvt.f32.u32	s11, s15	@ tmp164, target_height
@ armwave.c:261:     g_armwave_state.ch_buff_size = (g_armwave_state.bitdepth_height + 4) * (target_width + 4) * sizeof(bufftyp_t);  // Add word padding too
	.loc 1 261 95 view .LVU308
	add	r3, r3, r3, lsl #7	@ tmp179, tmp176, tmp176,
@ armwave.c:270:     printf("ch_buff_size=%d, cmp_x_bitdepth_scale=%d (0x%08x), targ_width=%d, wave_length=%d, scaler=%d\n", \
	.loc 1 270 5 view .LVU309
	mov	r2, #65536	@ tmp194,
@ armwave.c:268:         ((g_armwave_state.target_width * (1.0f / g_armwave_state.wave_length))) * (1 << AM_XCOORD_MULT_SHIFT);
	.loc 1 268 48 view .LVU310
	vdiv.f32	s15, s10, s13	@ tmp186, tmp187, tmp185
@ armwave.c:270:     printf("ch_buff_size=%d, cmp_x_bitdepth_scale=%d (0x%08x), targ_width=%d, wave_length=%d, scaler=%d\n", \
	.loc 1 270 5 view .LVU311
	str	r5, [sp, #4]	@ _13,
	str	r6, [sp]	@ target_width,
@ armwave.c:261:     g_armwave_state.ch_buff_size = (g_armwave_state.bitdepth_height + 4) * (target_width + 4) * sizeof(bufftyp_t);  // Add word padding too
	.loc 1 261 95 view .LVU312
	lsl	r3, r3, #3	@ tmp180, tmp179,
@ armwave.c:253:     g_armwave_state.xstride = target_height;
	.loc 1 253 29 view .LVU313
	str	r7, [r4, #44]	@ target_height, g_armwave_state.xstride
	.loc 1 254 5 is_stmt 1 view .LVU314
@ armwave.c:256:     g_armwave_state.wave_stride = wave_stride;
	.loc 1 256 33 is_stmt 0 view .LVU315
	str	r9, [r4, #52]	@ wave_stride, g_armwave_state.wave_stride
@ armwave.c:257:     g_armwave_state.waves_max = waves_max;
	.loc 1 257 31 view .LVU316
	str	r8, [r4, #60]	@ waves_max, g_armwave_state.waves_max
@ armwave.c:258:     g_armwave_state.waves = waves_max;  // Need a function to be able to change this on the fly
	.loc 1 258 27 view .LVU317
	str	r8, [r4, #56]	@ waves_max, g_armwave_state.waves
@ armwave.c:263:     g_armwave_state.target_height = target_height;
	.loc 1 263 35 view .LVU318
	strd	r6, [r4, #88]	@, tmp222,
@ armwave.c:270:     printf("ch_buff_size=%d, cmp_x_bitdepth_scale=%d (0x%08x), targ_width=%d, wave_length=%d, scaler=%d\n", \
	.loc 1 270 5 view .LVU319
	str	r2, [sp, #8]	@ tmp194,
@ armwave.c:260:     g_armwave_state.bitdepth_height = 256 * sizeof(bufftyp_t);  // Always 256 possible levels in 8-bit mode
	.loc 1 260 37 view .LVU320
	mov	r2, #512	@ tmp175,
@ armwave.c:259:     g_armwave_state.size = target_height * target_width;
	.loc 1 259 26 view .LVU321
	str	r1, [r4, #84]	@ tmp173, g_armwave_state.size
@ armwave.c:260:     g_armwave_state.bitdepth_height = 256 * sizeof(bufftyp_t);  // Always 256 possible levels in 8-bit mode
	.loc 1 260 37 view .LVU322
	str	r2, [r4, #64]	@ tmp175, g_armwave_state.bitdepth_height
@ armwave.c:270:     printf("ch_buff_size=%d, cmp_x_bitdepth_scale=%d (0x%08x), targ_width=%d, wave_length=%d, scaler=%d\n", \
	.loc 1 270 5 view .LVU323
	mov	r1, r3	@, tmp180
@ armwave.c:261:     g_armwave_state.ch_buff_size = (g_armwave_state.bitdepth_height + 4) * (target_width + 4) * sizeof(bufftyp_t);  // Add word padding too
	.loc 1 261 34 view .LVU324
	str	r3, [r4, #80]	@ tmp180, g_armwave_state.ch_buff_size
@ armwave.c:254:     g_armwave_state.vscale_frac = target_height / 255.0f;
	.loc 1 254 49 view .LVU325
	vdiv.f32	s13, s11, s14	@ _3, tmp164, tmp165
@ armwave.c:268:         ((g_armwave_state.target_width * (1.0f / g_armwave_state.wave_length))) * (1 << AM_XCOORD_MULT_SHIFT);
	.loc 1 268 40 view .LVU326
	vmov	s14, r6	@ int	@ target_width, target_width
@ armwave.c:264:     g_armwave_state.wave_length = end_point - start_point;
	.loc 1 264 33 view .LVU327
	str	r5, [r4, #76]	@ _13, g_armwave_state.wave_length
@ armwave.c:270:     printf("ch_buff_size=%d, cmp_x_bitdepth_scale=%d (0x%08x), targ_width=%d, wave_length=%d, scaler=%d\n", \
	.loc 1 270 5 view .LVU328
	ldr	r0, .L69+20	@,
@ armwave.c:268:         ((g_armwave_state.target_width * (1.0f / g_armwave_state.wave_length))) * (1 << AM_XCOORD_MULT_SHIFT);
	.loc 1 268 40 view .LVU329
	vcvt.f32.s32	s14, s14	@ tmp188, target_width
	vmul.f32	s15, s15, s14	@ tmp189, tmp186, tmp188
@ armwave.c:255:     g_armwave_state.vscale = (int)g_armwave_state.vscale_frac;
	.loc 1 255 30 view .LVU330
	vcvt.s32.f32	s14, s13	@ tmp168, _3
@ armwave.c:254:     g_armwave_state.vscale_frac = target_height / 255.0f;
	.loc 1 254 33 view .LVU331
	vstr.32	s13, [r4, #40]	@ _3, g_armwave_state.vscale_frac
	.loc 1 255 5 is_stmt 1 view .LVU332
@ armwave.c:268:         ((g_armwave_state.target_width * (1.0f / g_armwave_state.wave_length))) * (1 << AM_XCOORD_MULT_SHIFT);
	.loc 1 268 81 is_stmt 0 view .LVU333
	vmul.f32	s15, s15, s12	@ tmp190, tmp189, tmp191
@ armwave.c:255:     g_armwave_state.vscale = (int)g_armwave_state.vscale_frac;
	.loc 1 255 30 view .LVU334
	vstr.32	s14, [r4, #48]	@ int	@ tmp168, g_armwave_state.vscale
	.loc 1 256 5 is_stmt 1 view .LVU335
	.loc 1 257 5 view .LVU336
	.loc 1 258 5 view .LVU337
	.loc 1 259 5 view .LVU338
	.loc 1 260 5 view .LVU339
	.loc 1 261 5 view .LVU340
	.loc 1 262 5 view .LVU341
	.loc 1 263 5 view .LVU342
	.loc 1 264 5 view .LVU343
	.loc 1 267 5 view .LVU344
@ armwave.c:267:     g_armwave_state.cmp_x_bitdepth_scale = \
	.loc 1 267 42 is_stmt 0 view .LVU345
	vcvt.u32.f32	s15, s15	@ _20, tmp190
	vmov	ip, s15	@ int	@ _20, _20
@ armwave.c:270:     printf("ch_buff_size=%d, cmp_x_bitdepth_scale=%d (0x%08x), targ_width=%d, wave_length=%d, scaler=%d\n", \
	.loc 1 270 5 view .LVU346
	vmov	r3, s15	@ int	@, _20
@ armwave.c:267:     g_armwave_state.cmp_x_bitdepth_scale = \
	.loc 1 267 42 view .LVU347
	vstr.32	s15, [r4, #36]	@ int	@ _20, g_armwave_state.cmp_x_bitdepth_scale
	.loc 1 270 5 is_stmt 1 view .LVU348
	mov	r2, ip	@, tmp3
	bl	printf		@
.LVL87:
	.loc 1 278 5 view .LVU349
@ armwave.c:280:     if(g_armwave_state.ch1_buffer != NULL)
	.loc 1 280 23 is_stmt 0 view .LVU350
	ldr	r0, [r4, #4]	@ _21, g_armwave_state.ch1_buffer
@ armwave.c:278:     g_armwave_state.slice_height = 64; // 64;  
	.loc 1 278 34 view .LVU351
	mov	r3, #64	@ tmp196,
@ armwave.c:280:     if(g_armwave_state.ch1_buffer != NULL)
	.loc 1 280 7 view .LVU352
	cmp	r0, #0	@ _21,
@ armwave.c:278:     g_armwave_state.slice_height = 64; // 64;  
	.loc 1 278 34 view .LVU353
	str	r3, [r4, #68]	@ tmp196, g_armwave_state.slice_height
	.loc 1 280 5 is_stmt 1 view .LVU354
@ armwave.c:280:     if(g_armwave_state.ch1_buffer != NULL)
	.loc 1 280 7 is_stmt 0 view .LVU355
	beq	.L61		@,
	.loc 1 281 9 is_stmt 1 view .LVU356
	bl	free		@
.LVL88:
.L61:
	.loc 1 283 5 view .LVU357
@ armwave.c:283:     g_armwave_state.ch1_buffer = calloc(g_armwave_state.ch_buff_size, 1);
	.loc 1 283 56 is_stmt 0 view .LVU358
	ldr	r8, [r4, #80]	@ _22, g_armwave_state.ch_buff_size
.LVL89:
@ armwave.c:283:     g_armwave_state.ch1_buffer = calloc(g_armwave_state.ch_buff_size, 1);
	.loc 1 283 34 view .LVU359
	mov	r1, #1	@,
	mov	r0, r8	@, _22
	bl	calloc		@
.LVL90:
@ armwave.c:285:     if(g_armwave_state.ch1_buffer == NULL) {
	.loc 1 285 7 view .LVU360
	cmp	r0, #0	@ tmp199,
@ armwave.c:283:     g_armwave_state.ch1_buffer = calloc(g_armwave_state.ch_buff_size, 1);
	.loc 1 283 34 view .LVU361
	mov	r7, r0	@ tmp199,
@ armwave.c:283:     g_armwave_state.ch1_buffer = calloc(g_armwave_state.ch_buff_size, 1);
	.loc 1 283 32 view .LVU362
	str	r0, [r4, #4]	@ tmp199, g_armwave_state.ch1_buffer
	.loc 1 285 5 is_stmt 1 view .LVU363
@ armwave.c:285:     if(g_armwave_state.ch1_buffer == NULL) {
	.loc 1 285 7 is_stmt 0 view .LVU364
	beq	.L68		@,
	.loc 1 291 5 is_stmt 1 view .LVU365
.LVL91:
	.loc 1 292 5 view .LVU366
	.loc 1 293 5 view .LVU367
@ armwave.c:292:     points_per_pixel = length / ((float)(target_width));
	.loc 1 292 31 is_stmt 0 view .LVU368
	vmov	s15, r5	@ int	@ _13, _13
@ armwave.c:292:     points_per_pixel = length / ((float)(target_width));
	.loc 1 292 34 view .LVU369
	vmov	s14, r6	@ int	@ target_width, target_width
@ armwave.c:293:     g_armwave_state.slice_record_height = points_per_pixel * g_armwave_state.slice_height;
	.loc 1 293 60 view .LVU370
...
@ armwave.c:307:     g_armwave_state.out_pixbuf = malloc(sizeof(uint32_t) * g_armwave_state.size);
	.loc 1 307 34 is_stmt 0 view .LVU380
	bl	malloc		@
.LVL93:
...
@ armwave.c:307:     g_armwave_state.out_pixbuf = malloc(sizeof(uint32_t) * g_armwave_state.size);
	.loc 1 307 34 view .LVU382
	mov	ip, r0	@ tmp215,
@ armwave.c:309:     printf("Ptrs: 0x%08x 0x%08x 0x%08x 0x%08x \n", \
	.loc 1 309 5 view .LVU383
	mov	r3, r0	@, tmp215
@ armwave.c:307:     g_armwave_state.out_pixbuf = malloc(sizeof(uint32_t) * g_armwave_state.size);
	.loc 1 307 32 view .LVU384
	str	ip, [r4, #104]	@ tmp215, g_armwave_state.out_pixbuf
	.loc 1 309 5 is_stmt 1 view .LVU385
	ldr	r0, .L69+24	@,
@ armwave.c:316: }
	.loc 1 316 1 is_stmt 0 view .LVU386
	add	sp, sp, #20	@,,
	.cfi_remember_state
	.cfi_def_cfa_offset 28
	@ sp needed	@
...
.L67:
	.cfi_restore_state
	.loc 1 232 5 is_stmt 1 discriminator 1 view .LVU388
	ldr	r3, .L69+28	@,
	mov	r2, #232	@,
	ldr	r1, .L69+32	@,
	ldr	r0, .L69+36	@,
...
.L68:
	...
	ldr	r3, .L69+40	@ tmp202,
	mov	r2, r8	@, _22
	ldr	r1, .L69+44	@,
	ldr	r0, [r3]	@, stderr
	bl	fprintf		@
.LVL97:
	.loc 1 287 9 view .LVU390
	mvn	r0, #0	@,
	bl	exit		@
.LVL98:
.L70:
...
.LFB63:
	...
	@ args = 0, pretend = 0, frame = 0
	@ frame_needed = 0, uses_anonymous_args = 0
	.loc 1 324 5 view .LVU392
	cmp	r0, #0	@ wave_buffer
	.loc 1 324 5 is_stmt 0 view .LVU393
	beq	.L76		@,
	.loc 1 325 5 is_stmt 1 view .LVU394
@ armwave.c:325:     g_armwave_state.wave_buffer = wave_buffer;
	.loc 1 325 33 is_stmt 0 view .LVU395
	ldr	r3, .L77	@ tmp115,
	str	r0, [r3, #20]	@ wave_buffer, g_armwave_state.wave_buffer
	bx	lr	@
.L76:
	.loc 1 324 5 is_stmt 1 discriminator 1 view .LVU396
@ armwave.c:323: {
	.loc 1 323 1 is_stmt 0 discriminator 1 view .LVU397
	push	{r4, lr}	@
	.cfi_def_cfa_offset 8
	.cfi_offset 4, -8
	.cfi_offset 14, -4
@ armwave.c:324:     assert(wave_buffer != NULL);
	.loc 1 324 5 discriminator 1 view .LVU398
	mov	r2, #324	@,
	ldr	r3, .L77+4	@,
	ldr	r1, .L77+8	@,
	ldr	r0, .L77+12	@,
.LVL100:
	.loc 1 324 5 discriminator 1 view .LVU399
	bl	__assert_fail		@
.LVL101:
.L78:
	.align	2
...
@ armwave.c:334:     if(set > g_armwave_state.test_wave_buffer_nsets) {
	.loc 1 334 29 is_stmt 0 view .LVU402
	ldr	r3, .L82	@ tmp117,
@ armwave.c:334:     if(set > g_armwave_state.test_wave_buffer_nsets) {
	.loc 1 334 7 view .LVU403
...
.LVL103:
@ armwave.c:339:     g_armwave_state.wave_buffer = g_armwave_state.test_wave_buffer + (g_armwave_state.test_wave_buffer_stride * set);
	.loc 1 339 33 view .LVU407
	str	r0, [r3, #20]	@ tmp125, g_armwave_state.wave_buffer
@ armwave.c:340: }
	.loc 1 340 1 view .LVU408
	bx	lr	@
.LVL104:
.L81:
	.loc 1 335 9 is_stmt 1 view .LVU409
	ldr	r0, .L82+4	@,
.LVL105:
	.loc 1 335 9 is_stmt 0 view .LVU410
	b	puts		@
.LVL106:
.L83:
	.align	2
...
.LFB65:
	...
	@ args = 0, pretend = 0, frame = 0
	@ frame_needed = 0, uses_anonymous_args = 0
	.loc 1 348 5 view .LVU412
	cmp	r0, #0	@ wave_buffer_ptr
	.loc 1 348 5 is_stmt 0 view .LVU413
	beq	.L89		@,
	.loc 1 349 5 is_stmt 1 view .LVU414
@ armwave.c:349:     g_armwave_state.wave_buffer = (uint8_t*)wave_buffer_ptr;
	.loc 1 349 33 is_stmt 0 view .LVU415
	ldr	r3, .L90	@ tmp116,
	str	r0, [r3, #20]	@ wave_buffer_ptr, g_armwave_state.wave_buffer
	bx	lr	@
.L89:
	.loc 1 348 5 is_stmt 1 discriminator 1 view .LVU416
@ armwave.c:347: {
	.loc 1 347 1 is_stmt 0 discriminator 1 view .LVU417
	push	{r4, lr}	@
	.cfi_def_cfa_offset 8
	.cfi_offset 4, -8
	.cfi_offset 14, -4
@ armwave.c:348:     assert(wave_buffer_ptr != 0);
	.loc 1 348 5 discriminator 1 view .LVU418
	mov	r2, #348	@,
	ldr	r3, .L90+4	@,
	ldr	r1, .L90+8	@,
	ldr	r0, .L90+12	@,
.LVL108:
	.loc 1 348 5 discriminator 1 view .LVU419
	bl	__assert_fail		@
.LVL109:
.L91:
	.align	2
...
.LFB67:
	...
	@ frame_needed = 0, uses_anonymous_args = 0
	@ link register save eliminated.
	.loc 1 367 5 view .LVU426
	cmp	r0, #1	@ ch,
	.loc 1 369 13 view .LVU427
@ armwave.c:369:             g_armwave_state.ch1_color.r = r;
	.loc 1 369 41 is_stmt 0 view .LVU428
	ldreq	r0, .L97	@ tmp117,
.LVL114:
	.loc 1 369 41 view .LVU429
...
@ armwave.c:370:             g_armwave_state.ch1_color.g = g;
	.loc 1 370 41 is_stmt 0 view .LVU431
	strheq	r2, [r0, #110]	@ movhi	@ g, g_armwave_state.ch1_color.g
	.loc 1 371 13 is_stmt 1 view .LVU432
@ armwave.c:371:             g_armwave_state.ch1_color.b = b;
	.loc 1 371 41 is_stmt 0 view .LVU433
	strheq	r3, [r0, #112]	@ movhi	@ b, g_armwave_state.ch1_color.b
	.loc 1 372 13 is_stmt 1 view .LVU434
@ armwave.c:374: }
	.loc 1 374 1 is_stmt 0 view .LVU435
	bx	lr	@
.L98:
	.align	2
.L97:
...
.LFB68:
	...
	@ args = 0, pretend = 0, frame = 0
	@ frame_needed = 0, uses_anonymous_args = 0
	.loc 1 381 5 view .LVU437
@ armwave.c:380: {
	.loc 1 380 1 is_stmt 0 view .LVU438
	mov	r3, r1	@ fn, fn
	push	{r4, r5, r6, r7, r8, r9, lr}	@
	.cfi_def_cfa_offset 28
	.cfi_offset 4, -28
...
@ armwave.c:381:     FILE *fp = fopen(fn, "wb");
	.loc 1 381 16 view .LVU439
	ldr	r1, .L107	@,
.LVL116:
	.loc 1 381 16 view .LVU440
	mov	r0, r3	@, fn
.LVL117:
	.loc 1 381 16 view .LVU441
	bl	fopen64		@
.LVL118:
@ armwave.c:388:     fprintf(fp, "%d %d\n", g_armwave_state.target_width, g_armwave_state.target_height);
	.loc 1 388 5 view .LVU442
	ldr	r6, .L107+4	@ tmp150,
@ armwave.c:387:     fputs("P3\n", fp);
	.loc 1 387 5 view .LVU443
	mov	r2, #3	@,
	mov	r1, #1	@,
@ armwave.c:381:     FILE *fp = fopen(fn, "wb");
	.loc 1 381 16 view .LVU444
	mov	r7, r0	@ fp,
.LVL119:
	.loc 1 382 5 is_stmt 1 view .LVU445
	.loc 1 383 5 view .LVU446
	.loc 1 387 5 view .LVU447
	mov	r3, r0	@, fp
	ldr	r0, .L107+8	@,
.LVL120:
	.loc 1 387 5 is_stmt 0 view .LVU448
	bl	fwrite		@
.LVL121:
	.loc 1 388 5 is_stmt 1 view .LVU449
	ldrd	r2, [r6, #88]	@, tmp150,
	ldr	r1, .L107+12	@,
	mov	r0, r7	@, fp
	bl	fprintf		@
.LVL122:
	.loc 1 389 5 view .LVU450
	mov	r2, #4	@,
	mov	r3, r7	@, fp
	mov	r1, #1	@,
	ldr	r0, .L107+16	@,
	bl	fwrite		@
.LVL123:
	.loc 1 391 5 view .LVU451
@ armwave.c:391:     for(yy = 0; yy < g_armwave_state.target_height; yy++) {
	.loc 1 391 37 is_stmt 0 view .LVU452
	ldr	r2, [r6, #92]	@ prephitmp_53, g_armwave_state.target_height
@ armwave.c:391:     for(yy = 0; yy < g_armwave_state.target_height; yy++) {
	.loc 1 391 5 view .LVU453
	cmp	r2, #0	@ prephitmp_53,
	ble	.L100		@,
	ldr	r3, [r6, #88]	@ _13, g_armwave_state.target_width
@ armwave.c:396:             fprintf(fp, "%3d %3d %3d\n", data & 0xff, (data >> 8) & 0xff, (data >> 16) & 0xff);
	.loc 1 396 13 view .LVU454
	ldr	r9, .L107+20	@ tmp152,
@ armwave.c:391:     for(yy = 0; yy < g_armwave_state.target_height; yy++) {
	.loc 1 391 12 view .LVU455
	mov	r5, #0	@ yy,
.LVL124:
.L101:
@ armwave.c:392:         for(xx = 0; xx < g_armwave_state.target_width; xx++) {
	.loc 1 392 9 view .LVU456
	cmp	r3, #0	@ _13,
@ armwave.c:392:         for(xx = 0; xx < g_armwave_state.target_width; xx++) {
	.loc 1 392 16 view .LVU457
	movgt	r4, #0	@ xx,
@ armwave.c:392:         for(xx = 0; xx < g_armwave_state.target_width; xx++) {
	.loc 1 392 9 view .LVU458
	ble	.L103		@,
.LVL125:
.L102:
	.loc 1 393 13 is_stmt 1 discriminator 3 view .LVU459
@ armwave.c:393:             data = *(buffer + (xx + (yy * g_armwave_state.target_width)));
	.loc 1 393 29 is_stmt 0 discriminator 3 view .LVU460
	mla	r3, r5, r3, r4	@ tmp141, yy, _13, xx
@ armwave.c:396:             fprintf(fp, "%3d %3d %3d\n", data & 0xff, (data >> 8) & 0xff, (data >> 16) & 0xff);
	.loc 1 396 13 discriminator 3 view .LVU461
	mov	r1, r9	@, tmp152
	mov	r0, r7	@, fp
@ armwave.c:393:             data = *(buffer + (xx + (yy * g_armwave_state.target_width)));
	.loc 1 393 18 discriminator 3 view .LVU462
	ldr	r2, [r8, r3, lsl #2]	@ data, *_7
.LVL126:
	.loc 1 396 13 is_stmt 1 discriminator 3 view .LVU463
@ armwave.c:392:         for(xx = 0; xx < g_armwave_state.target_width; xx++) {
	.loc 1 392 58 is_stmt 0 discriminator 3 view .LVU464
	add	r4, r4, #1	@ xx, xx,
.LVL127:
@ armwave.c:396:             fprintf(fp, "%3d %3d %3d\n", data & 0xff, (data >> 8) & 0xff, (data >> 16) & 0xff);
	.loc 1 396 81 discriminator 3 view .LVU465
	lsr	ip, r2, #16	@ tmp146, data,
@ armwave.c:396:             fprintf(fp, "%3d %3d %3d\n", data & 0xff, (data >> 8) & 0xff, (data >> 16) & 0xff);
	.loc 1 396 61 discriminator 3 view .LVU466
	lsr	r3, r2, #8	@ tmp142, data,
@ armwave.c:396:             fprintf(fp, "%3d %3d %3d\n", data & 0xff, (data >> 8) & 0xff, (data >> 16) & 0xff);
	.loc 1 396 13 discriminator 3 view .LVU467
	uxtb	ip, ip	@ tmp147, tmp146
	uxtb	r3, r3	@, tmp142
	str	ip, [sp]	@ tmp147,
	uxtb	r2, r2	@, data
.LVL128:
	.loc 1 396 13 discriminator 3 view .LVU468
	bl	fprintf		@
.LVL129:
@ armwave.c:392:         for(xx = 0; xx < g_armwave_state.target_width; xx++) {
	.loc 1 392 41 discriminator 3 view .LVU469
	ldr	r3, [r6, #88]	@ _13, g_armwave_state.target_width
@ armwave.c:392:         for(xx = 0; xx < g_armwave_state.target_width; xx++) {
	.loc 1 392 9 discriminator 3 view .LVU470
	cmp	r3, r4	@ _13, xx
	bgt	.L102		@,
	ldr	r2, [r6, #92]	@ prephitmp_53, g_armwave_state.target_height
.LVL130:
.L103:
@ armwave.c:391:     for(yy = 0; yy < g_armwave_state.target_height; yy++) {
	.loc 1 391 55 discriminator 2 view .LVU471
	add	r5, r5, #1	@ yy, yy,
.LVL131:
@ armwave.c:391:     for(yy = 0; yy < g_armwave_state.target_height; yy++) {
	.loc 1 391 5 discriminator 2 view .LVU472
	cmp	r5, r2	@ yy, prephitmp_53
	blt	.L101		@,
.LVL132:
.L100:
	.loc 1 400 5 is_stmt 1 view .LVU473
	mov	r0, r7	@, fp
@ armwave.c:401: }
	.loc 1 401 1 is_stmt 0 view .LVU474
	add	sp, sp, #12	@,,
	.cfi_def_cfa_offset 28
	@ sp needed	@
	pop	{r4, r5, r6, r7, r8, r9, lr}	@
...
@ armwave.c:400:     fclose(fp);
	.loc 1 400 5 view .LVU475
	b	fclose		@
.LVL134:
.L108:
	.loc 1 400 5 view .LVU476
	.align	2
.L107:
	.word	.LC19
	.word	g_armwave_state
...
.LFB69:
	...
	@ args = 0, pretend = 0, frame = 0
	@ frame_needed = 0, uses_anonymous_args = 0
	.loc 1 408 5 view .LVU478
.LBB12:
.LBI12:
	.loc 1 34 6 view .LVU479
	.loc 1 34 6 is_stmt 0 view .LVU480
.LBE12:
@ armwave.c:407: {
	.loc 1 407 1 view .LVU481
...
.LBE15:
@ armwave.c:407: {
	.loc 1 407 1 view .LVU485
	sub	sp, sp, #16	@,,
	.cfi_def_cfa_offset 72
@ armwave.c:407: {
	.loc 1 407 1 view .LVU486
...
.LBB16:
.LBB14:
	.loc 1 40 9 is_stmt 1 view .LVU487
@ armwave.c:40:         gamma_table[i] = pow(i / 255.0f, gamma) * 255.0f;
	.loc 1 40 32 is_stmt 0 view .LVU488
	add	r3, r5, r4	@ tmp133, tmp150, ivtmp.87
@ armwave.c:40:         gamma_table[i] = pow(i / 255.0f, gamma) * 255.0f;
	.loc 1 40 26 view .LVU489
	vmov.f64	d1, d9	@, tmp151
@ armwave.c:40:         gamma_table[i] = pow(i / 255.0f, gamma) * 255.0f;
	.loc 1 40 32 view .LVU490
...
.LVL137:
@ armwave.c:40:         gamma_table[i] = pow(i / 255.0f, gamma) * 255.0f;
	.loc 1 40 49 view .LVU492
	vmul.f64	d0, d0, d8	@ tmp138,, tmp139
@ armwave.c:40:         gamma_table[i] = pow(i / 255.0f, gamma) * 255.0f;
	.loc 1 40 24 view .LVU493
	vcvt.u32.f64	s15, d0	@ tmp140, tmp138
	vmov	r0, s15	@ int	@ tmp140, tmp140
	strb	r0, [r4, #1]!	@ tmp140, MEM[base: _37, offset: 0B]
.LVL138:
@ armwave.c:39:     for(i = 0; i < 256; i++) {
	.loc 1 39 5 view .LVU494
	cmp	r4, r10	@ ivtmp.87, _39
	bne	.L110		@,
.LVL139:
	.loc 1 39 5 view .LVU495
.LBE14:
.LBE16:
	.loc 1 411 5 is_stmt 1 view .LVU496
.LBB17:
.LBI17:
	.loc 1 364 6 view .LVU497
.LBB18:
	.loc 1 367 5 view .LVU498
	.loc 1 369 13 view .LVU499
	.loc 1 370 13 view .LVU500
@ armwave.c:369:             g_armwave_state.ch1_color.r = r;
	.loc 1 369 41 is_stmt 0 view .LVU501
...
@ armwave.c:413:     armwave_setup_render(0, wave_size, nwaves, wave_size, render_width, render_height, 0x00000000);
	.loc 1 413 5 view .LVU502
	mov	r0, #0	@ tmp147,
.LBB22:
.LBB19:
@ armwave.c:371:             g_armwave_state.ch1_color.b = b;
	.loc 1 371 41 view .LVU503
	mov	lr, #250	@ tmp146,
.LBE19:
.LBE22:
@ armwave.c:413:     armwave_setup_render(0, wave_size, nwaves, wave_size, render_width, render_height, 0x00000000);
	.loc 1 413 5 view .LVU504
	str	r0, [sp, #8]	@ tmp147,
...
.LBB20:
@ armwave.c:369:             g_armwave_state.ch1_color.r = r;
	.loc 1 369 41 view .LVU505
	str	r4, [ip, #108]	@ tmp143, MEM[(short int *)&g_armwave_state + 108B]
	.loc 1 371 13 is_stmt 1 view .LVU506
.LBE20:
.LBE23:
@ armwave.c:413:     armwave_setup_render(0, wave_size, nwaves, wave_size, render_width, render_height, 0x00000000);
	.loc 1 413 5 is_stmt 0 view .LVU507
	mov	r3, r6	@, wave_size
.LBB24:
.LBB21:
@ armwave.c:371:             g_armwave_state.ch1_color.b = b;
	.loc 1 371 41 view .LVU508
	strh	lr, [ip, #112]	@ movhi	@ tmp146, g_armwave_state.ch1_color.b
	.loc 1 372 13 is_stmt 1 view .LVU509
.LVL140:
	.loc 1 372 13 is_stmt 0 view .LVU510
.LBE21:
.LBE24:
	.loc 1 413 5 is_stmt 1 view .LVU511
	bl	armwave_setup_render		@
.LVL141:
	.loc 1 415 5 view .LVU512
	ldr	r1, .L113+32	@,
	ldr	r0, .L113+36	@,
@ armwave.c:416: }
	.loc 1 416 1 is_stmt 0 view .LVU513
	add	sp, sp, #16	@,,
	.cfi_def_cfa_offset 56
	@ sp needed	@
	vldm	sp!, {d8-d10}	@,
...
.LFB71:
	...
	@ frame_needed = 0, uses_anonymous_args = 0
	@ link register save eliminated.
	.loc 1 431 5 view .LVU518
	ldr	r3, .L119	@ tmp112,
	mov	r1, r0	@, fn
	ldr	r0, [r3, #104]	@, g_armwave_state.out_pixbuf
.LVL146:
	.loc 1 431 5 is_stmt 0 view .LVU519
	b	armwave_dump_ppm_debug		@
.LVL147:
.L120:
	.loc 1 431 5 view .LVU520
	.align	2
.L119:
	.word	g_armwave_state
	.cfi_endproc
...
.LFB72:
	...
	@ frame_needed = 0, uses_anonymous_args = 0
	@ link register save eliminated.
	.loc 1 443 5 view .LVU522
	.loc 1 446 5 view .LVU523
@ armwave.c:443:     void *out_pixbuf = ((uint32_t ***)buf)[2][10];
	.loc 1 443 11 is_stmt 0 view .LVU524
	ldr	r3, [r0, #8]	@ MEM[(uint32_t * * *)buf_2(D) + 8B], MEM[(uint32_t * * *)buf_2(D) + 8B]
@ armwave.c:446:     armwave_fill_pixbuf_scaled(out_pixbuf);
	.loc 1 446 5 view .LVU525
	ldr	r0, [r3, #40]	@, MEM[(uint32_t * *)_1 + 40B]
.LVL149:
	.loc 1 446 5 view .LVU526
	b	armwave_fill_pixbuf_scaled		@
.LVL150:
	.loc 1 446 5 view .LVU527
	.cfi_endproc
.LFE72:
...
@ armwave.c:453: {
	.loc 1 453 1 is_stmt 0 view .LVU530
	push	{r4, r5, r6, lr}	@
	.cfi_def_cfa_offset 16
	.cfi_offset 4, -16
	.cfi_offset 5, -12
	...
	.cfi_offset 14, -4
@ armwave.c:453: {
	.loc 1 453 1 view .LVU531
	mov	r6, r0	@ nsets, nsets
@ armwave.c:454:     if(g_armwave_state.test_wave_buffer != NULL) {
	.loc 1 454 23 view .LVU532
	ldr	r4, .L129	@ tmp128,
	ldr	r0, [r4, #24]	@ _1, g_armwave_state.test_wave_buffer
.LVL152:
@ armwave.c:454:     if(g_armwave_state.test_wave_buffer != NULL) {
	.loc 1 454 7 view .LVU533
	cmp	r0, #0	@ _1,
	beq	.L123		@,
	.loc 1 455 9 is_stmt 1 view .LVU534
	bl	free		@
.LVL153:
.L123:
	.loc 1 460 5 view .LVU535
@ armwave.c:460:     g_armwave_state.test_wave_buffer = calloc(g_armwave_state.wave_length * g_armwave_state.waves_max, nsets);
	.loc 1 460 75 is_stmt 0 view .LVU536
...
@ armwave.c:460:     g_armwave_state.test_wave_buffer = calloc(g_armwave_state.wave_length * g_armwave_state.waves_max, nsets);
	.loc 1 460 40 view .LVU537
	mov	r1, r6	@, nsets
@ armwave.c:460:     g_armwave_state.test_wave_buffer = calloc(g_armwave_state.wave_length * g_armwave_state.waves_max, nsets);
	.loc 1 460 75 view .LVU538
	mul	r5, r5, r3	@ _4, g_armwave_state.waves_max, g_armwave_state.wave_length
@ armwave.c:460:     g_armwave_state.test_wave_buffer = calloc(g_armwave_state.wave_length * g_armwave_state.waves_max, nsets);
	.loc 1 460 40 view .LVU539
	mov	r0, r5	@, _4
	bl	calloc		@
.LVL154:
@ armwave.c:462:     if(g_armwave_state.test_wave_buffer == NULL) {
	.loc 1 462 7 view .LVU540
	cmp	r0, #0	@ tmp124,
@ armwave.c:460:     g_armwave_state.test_wave_buffer = calloc(g_armwave_state.wave_length * g_armwave_state.waves_max, nsets);
	.loc 1 460 38 view .LVU541
	str	r0, [r4, #24]	@ tmp124, g_armwave_state.test_wave_buffer
	.loc 1 462 5 is_stmt 1 view .LVU542
@ armwave.c:462:     if(g_armwave_state.test_wave_buffer == NULL) {
	.loc 1 462 7 is_stmt 0 view .LVU543
	popne	{r4, r5, r6, pc}	@
	.loc 1 463 9 is_stmt 1 view .LVU544
	mul	r1, r6, r5	@, nsets, _4
	mov	r2, r6	@, nsets
	ldr	r0, .L129+4	@,
@ armwave.c:467: }
	.loc 1 467 1 is_stmt 0 view .LVU545
	pop	{r4, r5, r6, lr}	@
	.cfi_restore 14
	.cfi_restore 6
	.cfi_restore 5
	...
	.cfi_def_cfa_offset 0
.LVL155:
@ armwave.c:463:         printf("armwave_test_buffer_alloc: failed to allocate test wave buffer (%d bytes, %d sets)\n", \
	.loc 1 463 9 view .LVU546
	b	printf		@
.LVL156:
.L130:
	.loc 1 463 9 view .LVU547
	.align	2
.L129:
	.word	g_armwave_state
	.word	.LC24
...
.LFB74:
	...
	@ frame_needed = 0, uses_anonymous_args = 0
	.loc 1 474 5 view .LVU549
	.loc 1 475 5 view .LVU550
	.loc 1 479 5 view .LVU551
@ armwave.c:473: {
	.loc 1 473 1 is_stmt 0 view .LVU552
	str	lr, [sp, #-4]!	@,
	.cfi_def_cfa_offset 4
	.cfi_offset 14, -4
	sub	sp, sp, #52	@,,
	.cfi_def_cfa_offset 56
@ armwave.c:479:     ret = PyObject_GetBuffer(buf_obj, &buffer, PyBUF_SIMPLE | PyBUF_WRITABLE);
	.loc 1 479 11 view .LVU553
	add	r1, sp, #4	@ tmp131,,
	mov	r2, #1	@,
	bl	PyObject_GetBuffer		@
.LVL158:
	.loc 1 481 5 is_stmt 1 view .LVU554
@ armwave.c:481:     if(ret != 0) {
	.loc 1 481 7 is_stmt 0 view .LVU555
	cmp	r0, #0	@,
	bne	.L135		@,
	.loc 1 488 5 is_stmt 1 view .LVU556
	ldr	r0, [sp, #4]	@, buffer.buf
.LVL159:
	.loc 1 488 5 is_stmt 0 view .LVU557
	bl	armwave_fill_pixbuf_scaled		@
.LVL160:
	.loc 1 491 5 is_stmt 1 view .LVU558
	add	r0, sp, #4	@ tmp132,,
	bl	PyBuffer_Release		@
.LVL161:
	.loc 1 494 5 view .LVU559
.LBB25:
.LBI25:
	.file 2 "/usr/local/include/python3.8/object.h"
	.loc 2 456 20 view .LVU560
.LBB26:
	.loc 2 458 21 view .LVU561
	.loc 2 459 5 view .LVU562
@ /usr/local/include/python3.8/object.h:459:     op->ob_refcnt++;
	.loc 2 459 18 is_stmt 0 view .LVU563
	ldr	r3, .L136	@ tmp126,
.LBE26:
.LBE25:
@ armwave.c:494:     Py_RETURN_TRUE;
	.loc 1 494 5 view .LVU564
	mov	r0, r3	@ <retval>, tmp126
.LBB28:
.LBB27:
@ /usr/local/include/python3.8/object.h:459:     op->ob_refcnt++;
	.loc 2 459 18 view .LVU565
...
.L135:
	.cfi_restore_state
	.loc 1 482 9 is_stmt 1 view .LVU567
	ldr	r0, .L136+4	@,
.LVL163:
	.loc 1 482 9 is_stmt 0 view .LVU568
	bl	puts		@
.LVL164:
	.loc 1 483 9 is_stmt 1 view .LVU569
.LBB29:
.LBI29:
	.loc 2 456 20 view .LVU570
.LBB30:
	.loc 2 458 21 view .LVU571
	.loc 2 459 5 view .LVU572
@ /usr/local/include/python3.8/object.h:459:     op->ob_refcnt++;
	.loc 2 459 18 is_stmt 0 view .LVU573
	ldr	r3, .L136+8	@ tmp120,
.LBE30:
.LBE29:
@ armwave.c:483:         Py_RETURN_FALSE;
	.loc 1 483 9 view .LVU574
	mov	r0, r3	@ <retval>, tmp120
.LBB32:
.LBB31:
@ /usr/local/include/python3.8/object.h:459:     op->ob_refcnt++;
	.loc 2 459 18 view .LVU575
...
.LFB75:
	...
	@ frame_needed = 0, uses_anonymous_args = 0
	.loc 1 506 5 view .LVU578
	.loc 1 507 5 view .LVU579
@ armwave.c:505: {
	.loc 1 505 1 is_stmt 0 view .LVU580
	push	{r4, r5, r6, r7, r8, r9, r10, lr}	@
	.cfi_def_cfa_offset 32
	.cfi_offset 4, -32
	.cfi_offset 5, -28
	...
	.cfi_offset 10, -8
	.cfi_offset 14, -4
@ armwave.c:507:     float _1_waves_mod = mod * (1.0f / g_armwave_state.waves);
	.loc 1 507 38 view .LVU581
	vldr.32	s14, .L169	@ tmp180,
@ armwave.c:507:     float _1_waves_mod = mod * (1.0f / g_armwave_state.waves);
	.loc 1 507 55 view .LVU582
	ldr	r5, .L169+28	@ tmp250,
@ armwave.c:505: {
	.loc 1 505 1 view .LVU583
	...
	mov	r9, r0	@ sets, sets
@ armwave.c:507:     float _1_waves_mod = mod * (1.0f / g_armwave_state.waves);
	.loc 1 507 38 view .LVU584
	vldr.32	s15, [r5, #56]	@ int	@ tmp264, g_armwave_state.waves
@ armwave.c:511:     g_armwave_state.test_wave_buffer_stride = (g_armwave_state.waves * g_armwave_state.wave_stride);
	.loc 1 511 70 view .LVU585
	ldr	r3, [r5, #52]	@ g_armwave_state.wave_stride, g_armwave_state.wave_stride
	ldr	r2, [r5, #56]	@ tmp265, g_armwave_state.waves
.LBB35:
.LBB36:
@ armwave.c:454:     if(g_armwave_state.test_wave_buffer != NULL) {
	.loc 1 454 23 view .LVU586
	ldr	r0, [r5, #24]	@ _82, g_armwave_state.test_wave_buffer
.LVL166:
	.loc 1 454 23 view .LVU587
.LBE36:
.LBE35:
@ armwave.c:507:     float _1_waves_mod = mod * (1.0f / g_armwave_state.waves);
	.loc 1 507 38 view .LVU588
	vcvt.f32.s32	s15, s15	@ tmp178, tmp264
@ armwave.c:511:     g_armwave_state.test_wave_buffer_stride = (g_armwave_state.waves * g_armwave_state.wave_stride);
	.loc 1 511 70 view .LVU589
	mul	r3, r2, r3	@ tmp183, tmp265, g_armwave_state.wave_stride
@ armwave.c:505: {
	.loc 1 505 1 view .LVU590
	vmov.f32	s23, s1	@ noise_fraction, noise_fraction
.LBB40:
.LBB37:
@ armwave.c:454:     if(g_armwave_state.test_wave_buffer != NULL) {
	.loc 1 454 7 view .LVU591
	cmp	r0, #0	@ _82,
.LBE37:
.LBE40:
@ armwave.c:505: {
	.loc 1 505 1 view .LVU592
	sub	sp, sp, #8	@,,
	.cfi_def_cfa_offset 88
@ armwave.c:512:     g_armwave_state.test_wave_buffer_nsets = sets;
	.loc 1 512 44 view .LVU593
	str	r9, [r5, #32]	@ sets, g_armwave_state.test_wave_buffer_nsets
@ armwave.c:511:     g_armwave_state.test_wave_buffer_stride = (g_armwave_state.waves * g_armwave_state.wave_stride);
	.loc 1 511 45 view .LVU594
	str	r3, [r5, #28]	@ tmp183, g_armwave_state.test_wave_buffer_stride
@ armwave.c:507:     float _1_waves_mod = mod * (1.0f / g_armwave_state.waves);
	.loc 1 507 38 view .LVU595
	vdiv.f32	s26, s14, s15	@ tmp179, tmp180, tmp178
@ armwave.c:507:     float _1_waves_mod = mod * (1.0f / g_armwave_state.waves);
	.loc 1 507 11 view .LVU596
	vmul.f32	s26, s26, s0	@ _1_waves_mod, tmp179, mod
.LVL167:
	.loc 1 508 5 is_stmt 1 view .LVU597
	.loc 1 509 5 view .LVU598
	.loc 1 511 5 view .LVU599
	.loc 1 512 5 view .LVU600
	.loc 1 513 5 view .LVU601
.LBB41:
.LBI35:
	.loc 1 452 6 view .LVU602
.LBB38:
	.loc 1 454 5 view .LVU603
@ armwave.c:454:     if(g_armwave_state.test_wave_buffer != NULL) {
	.loc 1 454 7 is_stmt 0 view .LVU604
	beq	.L139		@,
	.loc 1 455 9 is_stmt 1 view .LVU605
	bl	free		@
.LVL168:
.L139:
	.loc 1 460 5 view .LVU606
@ armwave.c:460:     g_armwave_state.test_wave_buffer = calloc(g_armwave_state.wave_length * g_armwave_state.waves_max, nsets);
	.loc 1 460 75 is_stmt 0 view .LVU607
...
@ armwave.c:460:     g_armwave_state.test_wave_buffer = calloc(g_armwave_state.wave_length * g_armwave_state.waves_max, nsets);
	.loc 1 460 40 view .LVU608
	mov	r1, r9	@, sets
@ armwave.c:460:     g_armwave_state.test_wave_buffer = calloc(g_armwave_state.wave_length * g_armwave_state.waves_max, nsets);
	.loc 1 460 75 view .LVU609
	mul	r4, r4, r3	@ _85, g_armwave_state.waves_max, g_armwave_state.wave_length
@ armwave.c:460:     g_armwave_state.test_wave_buffer = calloc(g_armwave_state.wave_length * g_armwave_state.waves_max, nsets);
	.loc 1 460 40 view .LVU610
	mov	r0, r4	@, _85
	bl	calloc		@
.LVL169:
@ armwave.c:462:     if(g_armwave_state.test_wave_buffer == NULL) {
	.loc 1 462 7 view .LVU611
	cmp	r0, #0	@ tmp191,
@ armwave.c:460:     g_armwave_state.test_wave_buffer = calloc(g_armwave_state.wave_length * g_armwave_state.waves_max, nsets);
	.loc 1 460 38 view .LVU612
	str	r0, [r5, #24]	@ tmp191, g_armwave_state.test_wave_buffer
	.loc 1 462 5 is_stmt 1 view .LVU613
@ armwave.c:462:     if(g_armwave_state.test_wave_buffer == NULL) {
	.loc 1 462 7 is_stmt 0 view .LVU614
	beq	.L168		@,
.L140:
.LVL170:
	.loc 1 462 7 view .LVU615
.LBE38:
.LBE41:
@ armwave.c:515:     for(s = 0; s < sets; s++) {
	.loc 1 515 5 discriminator 1 view .LVU616
	cmp	r9, #0	@ sets,
	ble	.L138		@,
@ armwave.c:534:                 v = (sin((6.28f * x * (1.0f / g_armwave_state.wave_length)) + xnoise) * mod_val) * noise;
	.loc 1 534 45 view .LVU617
	vldr.32	s16, .L169	@ tmp258,
@ armwave.c:537:                 g_armwave_state.test_wave_buffer[x + (w * g_armwave_state.wave_stride) + set_offset] = (uint8_t)MIN(MAX(128 + (v * 127), 0), 255);
	.loc 1 537 104 view .LVU618
	vldr.32	s24, .L169+4	@ tmp259,
@ armwave.c:515:     for(s = 0; s < sets; s++) {
	.loc 1 515 5 view .LVU619
	mov	r7, #0	@ set_offset,
@ armwave.c:516:         printf("Calculating test set %d\n", s);
	.loc 1 516 9 view .LVU620
	ldr	r10, .L169+32	@ tmp257,
@ armwave.c:515:     for(s = 0; s < sets; s++) {
	.loc 1 515 5 view .LVU621
	mov	r8, r7	@ s, set_offset
.LVL171:
.L141:
	.loc 1 516 9 is_stmt 1 view .LVU622
	mov	r1, r8	@, s
	mov	r0, r10	@, tmp257
	bl	printf		@
.LVL172:
	.loc 1 518 9 view .LVU623
@ armwave.c:518:         for(w = 0; w < g_armwave_state.waves; w++) {
	.loc 1 518 39 is_stmt 0 view .LVU624
	ldr	r2, [r5, #56]	@ prephitmp_120, g_armwave_state.waves
@ armwave.c:518:         for(w = 0; w < g_armwave_state.waves; w++) {
	.loc 1 518 9 view .LVU625
	cmp	r2, #0	@ prephitmp_120,
	ble	.L142		@,
@ armwave.c:520:             mod_val = 0.5f + (_1_waves_mod * w);
	.loc 1 520 21 view .LVU626
	vldr.32	s25, .L169+8	@ tmp200,
@ armwave.c:534:                 v = (sin((6.28f * x * (1.0f / g_armwave_state.wave_length)) + xnoise) * mod_val) * noise;
	.loc 1 534 33 view .LVU627
	vldr.32	s22, .L169+12	@ tmp253,
@ armwave.c:532:                 xnoise = (rand() & 0xffff) / 6553500.0f;
	.loc 1 532 24 view .LVU628
	vldr.32	s21, .L169+16	@ tmp254,
	ldr	r3, [r5, #76]	@ prephitmp_124, g_armwave_state.wave_length
@ armwave.c:518:         for(w = 0; w < g_armwave_state.waves; w++) {
	.loc 1 518 15 view .LVU629
	mov	r6, #0	@ w,
.LVL173:
.L149:
	.loc 1 520 13 is_stmt 1 view .LVU630
@ armwave.c:520:             mod_val = 0.5f + (_1_waves_mod * w);
	.loc 1 520 21 is_stmt 0 view .LVU631
	vmov	s15, r6	@ int	@ w, w
	vmov.f32	s18, s25	@ mod_val, tmp200
@ armwave.c:522:             for(x = 0; x < g_armwave_state.wave_length; x++) {
	.loc 1 522 13 view .LVU632
	cmp	r3, #0	@ prephitmp_124,
@ armwave.c:520:             mod_val = 0.5f + (_1_waves_mod * w);
	.loc 1 520 21 view .LVU633
	vcvt.f32.s32	s15, s15	@ tmp198, w
	vmla.f32	s18, s15, s26	@ mod_val, tmp198, _1_waves_mod
.LVL174:
	.loc 1 522 13 is_stmt 1 view .LVU634
	.loc 1 522 13 is_stmt 0 view .LVU635
	ble	.L143		@,
	vcvt.f64.f32	d9, s18	@ tmp249, mod_val
@ armwave.c:537:                 g_armwave_state.test_wave_buffer[x + (w * g_armwave_state.wave_stride) + set_offset] = (uint8_t)MIN(MAX(128 + (v * 127), 0), 255);
	.loc 1 537 113 view .LVU636
	vldr.32	s20, .L169+20	@ tmp229,
	vldr.32	s17, .L169+24	@ tmp230,
@ armwave.c:522:             for(x = 0; x < g_armwave_state.wave_length; x++) {
	.loc 1 522 19 view .LVU637
	mov	r4, #0	@ x,
.LVL175:
.L148:
	.loc 1 523 17 is_stmt 1 view .LVU638
@ armwave.c:523:                 noise  = ((rand() & 0xffff) * noise_fraction);
	.loc 1 523 28 is_stmt 0 view .LVU639
	bl	rand		@
.LVL176:
@ armwave.c:523:                 noise  = ((rand() & 0xffff) * noise_fraction);
	.loc 1 523 35 view .LVU640
	uxth	r0, r0	@ tmp201,
@ armwave.c:523:                 noise  = ((rand() & 0xffff) * noise_fraction);
	.loc 1 523 45 view .LVU641
	vmov	s15, r0	@ int	@ tmp201, tmp201
	vcvt.f32.s32	s15, s15	@ tmp203, tmp201
@ armwave.c:523:                 noise  = ((rand() & 0xffff) * noise_fraction);
	.loc 1 523 24 view .LVU642
...
.LVL178:
	.loc 1 525 17 is_stmt 1 view .LVU645
@ armwave.c:525:                 noise *= noise;
	.loc 1 525 23 is_stmt 0 view .LVU646
	vmul.f32	s15, s15, s15	@ noise, noise, noise
.LVL179:
	.loc 1 526 17 is_stmt 1 view .LVU647
@ armwave.c:526:                 noise *= noise;
	.loc 1 526 23 is_stmt 0 view .LVU648
	vmul.f32	s27, s15, s15	@ noise, noise, noise
.LVL180:
	.loc 1 528 17 is_stmt 1 view .LVU649
@ armwave.c:528:                 if((rand() & 0xffff) > 0x7fff)
	.loc 1 528 21 is_stmt 0 view .LVU650
	bl	rand		@
.LVL181:
	.loc 1 529 21 is_stmt 1 view .LVU651
@ armwave.c:528:                 if((rand() & 0xffff) > 0x7fff)
	.loc 1 528 19 is_stmt 0 view .LVU652
	tst	r0, #32768	@,
@ armwave.c:529:                     noise = -noise;
	.loc 1 529 27 view .LVU653
	vnegne.f32	s27, s27	@ noise, noise
.LVL182:
	.loc 1 531 17 is_stmt 1 view .LVU654
	.loc 1 532 17 view .LVU655
@ armwave.c:532:                 xnoise = (rand() & 0xffff) / 6553500.0f;
	.loc 1 532 27 is_stmt 0 view .LVU656
	bl	rand		@
.LVL183:
	.loc 1 534 17 is_stmt 1 view .LVU657
@ armwave.c:534:                 v = (sin((6.28f * x * (1.0f / g_armwave_state.wave_length)) + xnoise) * mod_val) * noise;
	.loc 1 534 45 is_stmt 0 view .LVU658
	vldr.32	s14, [r5, #76]	@ int	@ tmp270, g_armwave_state.wave_length
@ armwave.c:534:                 v = (sin((6.28f * x * (1.0f / g_armwave_state.wave_length)) + xnoise) * mod_val) * noise;
	.loc 1 534 33 view .LVU659
	vmov	s15, r4	@ int	@ x, x
@ armwave.c:534:                 v = (sin((6.28f * x * (1.0f / g_armwave_state.wave_length)) + xnoise) * mod_val) * noise;
	.loc 1 534 45 view .LVU660
	vcvt.f32.s32	s14, s14	@ tmp206, tmp270
@ armwave.c:534:                 v = (sin((6.28f * x * (1.0f / g_armwave_state.wave_length)) + xnoise) * mod_val) * noise;
	.loc 1 534 33 view .LVU661
	vcvt.f32.s32	s15, s15	@ tmp210, x
@ armwave.c:534:                 v = (sin((6.28f * x * (1.0f / g_armwave_state.wave_length)) + xnoise) * mod_val) * noise;
	.loc 1 534 45 view .LVU662
	vdiv.f32	s13, s16, s14	@ tmp208, tmp258, tmp206
@ armwave.c:534:                 v = (sin((6.28f * x * (1.0f / g_armwave_state.wave_length)) + xnoise) * mod_val) * noise;
	.loc 1 534 33 view .LVU663
	vmul.f32	s15, s15, s22	@ tmp211, tmp210, tmp253
@ armwave.c:532:                 xnoise = (rand() & 0xffff) / 6553500.0f;
	.loc 1 532 34 view .LVU664
	uxth	r0, r0	@ tmp214,
.LVL184:
@ armwave.c:532:                 xnoise = (rand() & 0xffff) / 6553500.0f;
	.loc 1 532 44 view .LVU665
	vmov	s14, r0	@ int	@ tmp214, tmp214
	vcvt.f32.s32	s14, s14	@ tmp216, tmp214
@ armwave.c:532:                 xnoise = (rand() & 0xffff) / 6553500.0f;
	.loc 1 532 24 view .LVU666
	vdiv.f32	s0, s14, s21	@ xnoise, tmp216, tmp254
@ armwave.c:534:                 v = (sin((6.28f * x * (1.0f / g_armwave_state.wave_length)) + xnoise) * mod_val) * noise;
	.loc 1 534 77 view .LVU667
	vmla.f32	s0, s13, s15	@ tmp219, tmp208, tmp211
@ armwave.c:534:                 v = (sin((6.28f * x * (1.0f / g_armwave_state.wave_length)) + xnoise) * mod_val) * noise;
	.loc 1 534 22 view .LVU668
	vcvt.f64.f32	d0, s0	@, tmp219
	bl	sin		@
.LVL185:
	.loc 1 537 17 is_stmt 1 view .LVU669
@ armwave.c:531:                 noise += 1.0f;
	.loc 1 531 23 is_stmt 0 view .LVU670
	vadd.f32	s15, s27, s16	@ noise, noise, tmp258
@ armwave.c:537:                 g_armwave_state.test_wave_buffer[x + (w * g_armwave_state.wave_stride) + set_offset] = (uint8_t)MIN(MAX(128 + (v * 127), 0), 255);
	.loc 1 537 104 view .LVU671
	mov	r1, #0	@ iftmp.27_50,
@ armwave.c:534:                 v = (sin((6.28f * x * (1.0f / g_armwave_state.wave_length)) + xnoise) * mod_val) * noise;
	.loc 1 534 98 view .LVU672
	vcvt.f64.f32	d7, s15	@ tmp225, noise
@ armwave.c:534:                 v = (sin((6.28f * x * (1.0f / g_armwave_state.wave_length)) + xnoise) * mod_val) * noise;
	.loc 1 534 87 view .LVU673
	vmul.f64	d0, d9, d0	@ tmp222, tmp249,
@ armwave.c:534:                 v = (sin((6.28f * x * (1.0f / g_armwave_state.wave_length)) + xnoise) * mod_val) * noise;
	.loc 1 534 98 view .LVU674
	vmul.f64	d7, d0, d7	@ tmp226, tmp222, tmp225
@ armwave.c:534:                 v = (sin((6.28f * x * (1.0f / g_armwave_state.wave_length)) + xnoise) * mod_val) * noise;
	.loc 1 534 19 view .LVU675
	vcvt.f32.f64	s14, d7	@ v, tmp226
@ armwave.c:537:                 g_armwave_state.test_wave_buffer[x + (w * g_armwave_state.wave_stride) + set_offset] = (uint8_t)MIN(MAX(128 + (v * 127), 0), 255);
	.loc 1 537 113 view .LVU676
	...
	ble	.L145		@,
@ armwave.c:537:                 g_armwave_state.test_wave_buffer[x + (w * g_armwave_state.wave_stride) + set_offset] = (uint8_t)MIN(MAX(128 + (v * 127), 0), 255);
	.loc 1 537 104 discriminator 1 view .LVU677
...
.L145:
@ armwave.c:537:                 g_armwave_state.test_wave_buffer[x + (w * g_armwave_state.wave_stride) + set_offset] = (uint8_t)MIN(MAX(128 + (v * 127), 0), 255);
	.loc 1 537 57 discriminator 12 view .LVU678
	ldr	r2, [r5, #52]	@ g_armwave_state.wave_stride, g_armwave_state.wave_stride
@ armwave.c:537:                 g_armwave_state.test_wave_buffer[x + (w * g_armwave_state.wave_stride) + set_offset] = (uint8_t)MIN(MAX(128 + (v * 127), 0), 255);
	.loc 1 537 102 discriminator 12 view .LVU679
...
@ armwave.c:522:             for(x = 0; x < g_armwave_state.wave_length; x++) {
	.loc 1 522 58 discriminator 12 view .LVU680
	add	r4, r4, #1	@ x, x,
.LVL186:
@ armwave.c:537:                 g_armwave_state.test_wave_buffer[x + (w * g_armwave_state.wave_stride) + set_offset] = (uint8_t)MIN(MAX(128 + (v * 127), 0), 255);
	.loc 1 537 102 discriminator 12 view .LVU681
	strb	r1, [r2, r3]	@ iftmp.27_50, *_40
@ armwave.c:522:             for(x = 0; x < g_armwave_state.wave_length; x++) {
	.loc 1 522 43 discriminator 12 view .LVU682
	ldr	r3, [r5, #76]	@ prephitmp_124, g_armwave_state.wave_length
@ armwave.c:522:             for(x = 0; x < g_armwave_state.wave_length; x++) {
	.loc 1 522 13 discriminator 12 view .LVU683
...
.L143:
@ armwave.c:518:         for(w = 0; w < g_armwave_state.waves; w++) {
	.loc 1 518 48 discriminator 2 view .LVU684
	add	r6, r6, #1	@ w, w,
.LVL188:
@ armwave.c:518:         for(w = 0; w < g_armwave_state.waves; w++) {
	.loc 1 518 9 discriminator 2 view .LVU685
	cmp	r6, r2	@ w, prephitmp_120
	blt	.L149		@,
.LVL189:
.L142:
	.loc 1 541 9 is_stmt 1 discriminator 2 view .LVU686
@ armwave.c:541:         set_offset += (g_armwave_state.waves * g_armwave_state.wave_stride);
	.loc 1 541 46 is_stmt 0 discriminator 2 view .LVU687
	ldr	r3, [r5, #52]	@ g_armwave_state.wave_stride, g_armwave_state.wave_stride
@ armwave.c:515:     for(s = 0; s < sets; s++) {
	.loc 1 515 27 discriminator 2 view .LVU688
	add	r8, r8, #1	@ s, s,
.LVL190:
@ armwave.c:515:     for(s = 0; s < sets; s++) {
	.loc 1 515 5 discriminator 2 view .LVU689
	cmp	r9, r8	@ sets, s
@ armwave.c:541:         set_offset += (g_armwave_state.waves * g_armwave_state.wave_stride);
	.loc 1 541 20 discriminator 2 view .LVU690
	mla	r7, r3, r2, r7	@ set_offset, g_armwave_state.wave_stride, prephitmp_120, set_offset
.LVL191:
@ armwave.c:515:     for(s = 0; s < sets; s++) {
	.loc 1 515 5 discriminator 2 view .LVU691
	bne	.L141		@,
.LVL192:
.L138:
@ armwave.c:543: }
	.loc 1 543 1 view .LVU692
	add	sp, sp, #8	@,,
	.cfi_remember_state
	.cfi_def_cfa_offset 80
	@ sp needed	@
...
.LBB42:
.LBB39:
	.loc 1 463 9 is_stmt 1 view .LVU694
	mul	r1, r4, r9	@, _85, sets
	mov	r2, r9	@, sets
	ldr	r0, .L169+36	@,
	bl	printf		@
.LVL195:
	.loc 1 465 9 view .LVU695
	b	.L140		@
.L170:
	.align	2
.L169:
...
.LFB76:
	...
	@ args = 0, pretend = 0, frame = 0
	@ frame_needed = 0, uses_anonymous_args = 0
	.loc 1 594 5 view .LVU697
@ armwave.c:593: {
	.loc 1 593 1 is_stmt 0 view .LVU698
	push	{r4, lr}	@
	.cfi_def_cfa_offset 8
	.cfi_offset 4, -8
	.cfi_offset 14, -4
@ armwave.c:594:     free(g_armwave_state.out_pixbuf);
	.loc 1 594 25 view .LVU699
	ldr	r4, .L173	@ tmp114,
@ armwave.c:594:     free(g_armwave_state.out_pixbuf);
	.loc 1 594 5 view .LVU700
	ldr	r0, [r4, #104]	@, g_armwave_state.out_pixbuf
	bl	free		@
.LVL196:
	.loc 1 595 5 is_stmt 1 view .LVU701
	ldr	r0, [r4, #4]	@, g_armwave_state.ch1_buffer
	bl	free		@
.LVL197:
	.loc 1 596 5 view .LVU702
	ldr	r0, [r4, #132]	@, g_armwave_state.xcoord_to_xpixel
	bl	free		@
.LVL198:
	.loc 1 597 5 view .LVU703
	ldr	r0, [r4, #24]	@, g_armwave_state.test_wave_buffer
	bl	free		@
.LVL199:
	.loc 1 599 5 view .LVU704
@ armwave.c:599:     g_armwave_state.out_pixbuf = NULL;
	.loc 1 599 32 is_stmt 0 view .LVU705
	mov	r3, #0	@ tmp123,
	str	r3, [r4, #104]	@ tmp123, g_armwave_state.out_pixbuf
	.loc 1 600 5 is_stmt 1 view .LVU706
@ armwave.c:600:     g_armwave_state.ch1_buffer = NULL;
	.loc 1 600 32 is_stmt 0 view .LVU707
	str	r3, [r4, #4]	@ tmp123, g_armwave_state.ch1_buffer
	.loc 1 601 5 is_stmt 1 view .LVU708
@ armwave.c:601:     g_armwave_state.xcoord_to_xpixel = NULL;
	.loc 1 601 38 is_stmt 0 view .LVU709
	str	r3, [r4, #132]	@ tmp123, g_armwave_state.xcoord_to_xpixel
	.loc 1 602 5 is_stmt 1 view .LVU710
@ armwave.c:602:     g_armwave_state.test_wave_buffer = NULL;
	.loc 1 602 38 is_stmt 0 view .LVU711
	str	r3, [r4, #24]	@ tmp123, g_armwave_state.test_wave_buffer
@ armwave.c:603: }
	.loc 1 603 1 view .LVU712
	pop	{r4, pc}	@
.L174:
	.align	2
.L173:
