...
@ armwave.c:300:     npix = g_armwave_state.target_width * 256; //g_armwave_state.target_height;
	...
	ldr	r6, [r3, #52]	@ _1, g_armwave_state.target_width
...
@ armwave.c:339:         printf("0x%08x, %d\n", out_buffer_base, n);
	.loc 1 339 9 view .LVU626
	ldr	r7, .L129+8	@ tmp131,
@ armwave.c:305:     for(n = 0; n < npix; n += 4) {
	.loc 1 305 11 view .LVU627
	mov	r4, #0	@ n,
.LVL139:
.L125:
	.loc 1 309 9 is_stmt 1 discriminator 2 view .LVU628
	.loc 1 311 9 discriminator 2 view .LVU629
	.loc 1 339 9 discriminator 2 view .LVU630
	mov	r2, r4	@, n
	mov	r1, r5	@, ivtmp.93
	mov	r0, r7	@, tmp131
	bl	printf		@
.LVL140:
	.loc 1 341 9 discriminator 2 view .LVU631
@ armwave.c:341:         *out_buffer_base++ = n;
	.loc 1 341 28 is_stmt 0 discriminator 2 view .LVU632
	str	r4, [r5], #4	@ n, MEM[base: out_buffer_base_23, offset: 0B]
@ armwave.c:305:     for(n = 0; n < npix; n += 4) {
	.loc 1 305 28 discriminator 2 view .LVU633
	add	r4, r4, #4	@ n, n,
.LVL141:
@ armwave.c:305:     for(n = 0; n < npix; n += 4) {
	.loc 1 305 5 discriminator 2 view .LVU634
	cmp	r6, r4	@ npix, n
	bgt	.L125		@,
	pop	{r4, r5, r6, r7, r8, pc}	@
.LVL142:
...
.LBB6:
.LBI6:
	.loc 1 287 6 is_stmt 1 view .LVU635
.LBB7:
	.loc 1 296 5 view .LVU636
	ldr	r3, .L129+12	@,
	mov	r2, #296	@,
	ldr	r1, .L129+16	@,
	ldr	r0, .L129+20	@,
.LVL143:
	.loc 1 296 5 is_stmt 0 view .LVU637
	bl	__assert_fail		@
.LVL144:
.L130:
	.loc 1 296 5 view .LVU638
	.align	2
.L129:
	.word	g_armwave_state
	.word	.LC6
...
.LFB65:
	...
	@ args = 0, pretend = 0, frame = 0
	@ frame_needed = 0, uses_anonymous_args = 0
	.loc 1 347 5 view .LVU640
@ armwave.c:346: {
	.loc 1 346 1 is_stmt 0 view .LVU641
	mov	r3, r1	@ fn, fn
...
@ armwave.c:347:     FILE *fp = fopen(fn, "wb");
	.loc 1 347 16 view .LVU642
	ldr	r1, .L143	@,
.LVL146:
	.loc 1 347 16 view .LVU643
	mov	r0, r3	@, fn
.LVL147:
	.loc 1 347 16 view .LVU644
	bl	fopen64		@
.LVL148:
@ armwave.c:354:     fprintf(fp, "%d %d\n", g_armwave_state.target_height, g_armwave_state.target_width);
	.loc 1 354 5 view .LVU645
	ldr	r6, .L143+4	@ tmp154,
@ armwave.c:353:     fputs("P3\n", fp);
	.loc 1 353 5 view .LVU646
	mov	r2, #3	@,
	mov	r1, #1	@,
@ armwave.c:347:     FILE *fp = fopen(fn, "wb");
	.loc 1 347 16 view .LVU647
	mov	r7, r0	@ fp,
.LVL149:
	.loc 1 348 5 is_stmt 1 view .LVU648
	.loc 1 349 5 view .LVU649
	.loc 1 353 5 view .LVU650
	mov	r3, r0	@, fp
	ldr	r0, .L143+8	@,
.LVL150:
	.loc 1 353 5 is_stmt 0 view .LVU651
	bl	fwrite		@
.LVL151:
	.loc 1 354 5 is_stmt 1 view .LVU652
...
.LVL152:
	...
	bl	fwrite		@
.LVL153:
	.loc 1 357 5 view .LVU654
@ armwave.c:357:     for(yy = 0; yy < g_armwave_state.target_height; yy++) {
	.loc 1 357 37 is_stmt 0 view .LVU655
	ldr	r2, [r6, #56]	@ prephitmp_57, g_armwave_state.target_height
@ armwave.c:357:     for(yy = 0; yy < g_armwave_state.target_height; yy++) {
	.loc 1 357 5 view .LVU656
	cmp	r2, #0	@ prephitmp_57,
	beq	.L132		@,
	ldr	r3, [r6, #52]	@ _12, g_armwave_state.target_width
@ armwave.c:362:             fprintf(fp, "%3d %3d %3d\n", data & 0xff, (data >> 8) & 0xff, (data >> 16) & 0xff);
	.loc 1 362 13 view .LVU657
	ldr	r9, .L143+20	@ tmp156,
@ armwave.c:357:     for(yy = 0; yy < g_armwave_state.target_height; yy++) {
	.loc 1 357 12 view .LVU658
	mov	r5, #0	@ yy,
.LVL154:
.L133:
@ armwave.c:358:         for(xx = 0; xx < g_armwave_state.target_width; xx++) {
	.loc 1 358 9 view .LVU659
	cmp	r3, #0	@ _12,
@ armwave.c:358:         for(xx = 0; xx < g_armwave_state.target_width; xx++) {
	.loc 1 358 16 view .LVU660
	movne	r4, #0	@ xx,
@ armwave.c:358:         for(xx = 0; xx < g_armwave_state.target_width; xx++) {
	.loc 1 358 9 view .LVU661
	beq	.L142		@,
.LVL155:
.L134:
	.loc 1 359 13 is_stmt 1 discriminator 3 view .LVU662
@ armwave.c:359:             data = *(buffer + (xx + (yy * g_armwave_state.target_width)));
	.loc 1 359 29 is_stmt 0 discriminator 3 view .LVU663
	mla	r3, r5, r3, r4	@ tmp145, yy, _12, xx
@ armwave.c:362:             fprintf(fp, "%3d %3d %3d\n", data & 0xff, (data >> 8) & 0xff, (data >> 16) & 0xff);
	.loc 1 362 13 discriminator 3 view .LVU664
	mov	r1, r9	@, tmp156
	mov	r0, r7	@, fp
@ armwave.c:359:             data = *(buffer + (xx + (yy * g_armwave_state.target_width)));
	.loc 1 359 18 discriminator 3 view .LVU665
	ldr	r2, [r8, r3, lsl #2]	@ data, *_6
.LVL156:
	.loc 1 362 13 is_stmt 1 discriminator 3 view .LVU666
@ armwave.c:358:         for(xx = 0; xx < g_armwave_state.target_width; xx++) {
	.loc 1 358 58 is_stmt 0 discriminator 3 view .LVU667
	add	r4, r4, #1	@ xx, xx,
.LVL157:
@ armwave.c:362:             fprintf(fp, "%3d %3d %3d\n", data & 0xff, (data >> 8) & 0xff, (data >> 16) & 0xff);
	.loc 1 362 81 discriminator 3 view .LVU668
	lsr	ip, r2, #16	@ tmp150, data,
@ armwave.c:362:             fprintf(fp, "%3d %3d %3d\n", data & 0xff, (data >> 8) & 0xff, (data >> 16) & 0xff);
	.loc 1 362 61 discriminator 3 view .LVU669
	lsr	r3, r2, #8	@ tmp146, data,
@ armwave.c:362:             fprintf(fp, "%3d %3d %3d\n", data & 0xff, (data >> 8) & 0xff, (data >> 16) & 0xff);
	.loc 1 362 13 discriminator 3 view .LVU670
	uxtb	ip, ip	@ tmp151, tmp150
	uxtb	r3, r3	@, tmp146
	str	ip, [sp]	@ tmp151,
	uxtb	r2, r2	@, data
.LVL158:
	.loc 1 362 13 discriminator 3 view .LVU671
	bl	fprintf		@
.LVL159:
@ armwave.c:358:         for(xx = 0; xx < g_armwave_state.target_width; xx++) {
	.loc 1 358 41 discriminator 3 view .LVU672
	ldr	r3, [r6, #52]	@ _12, g_armwave_state.target_width
@ armwave.c:358:         for(xx = 0; xx < g_armwave_state.target_width; xx++) {
	.loc 1 358 9 discriminator 3 view .LVU673
	cmp	r3, r4	@ _12, xx
	bhi	.L134		@,
	ldr	r2, [r6, #56]	@ prephitmp_57, g_armwave_state.target_height
.LVL160:
.L135:
@ armwave.c:357:     for(yy = 0; yy < g_armwave_state.target_height; yy++) {
	.loc 1 357 55 discriminator 2 view .LVU674
	add	r5, r5, #1	@ yy, yy,
.LVL161:
@ armwave.c:357:     for(yy = 0; yy < g_armwave_state.target_height; yy++) {
	.loc 1 357 5 discriminator 2 view .LVU675
	cmp	r5, r2	@ yy, prephitmp_57
	bcc	.L133		@,
.LVL162:
.L132:
	.loc 1 366 5 is_stmt 1 view .LVU676
	mov	r0, r7	@, fp
@ armwave.c:367: }
	.loc 1 367 1 is_stmt 0 view .LVU677
	add	sp, sp, #12	@,,
	.cfi_remember_state
	.cfi_def_cfa_offset 28
	@ sp needed	@
...
@ armwave.c:366:     fclose(fp);
	.loc 1 366 5 view .LVU678
	b	fclose		@
.LVL164:
.L142:
	.cfi_restore_state
@ armwave.c:357:     for(yy = 0; yy < g_armwave_state.target_height; yy++) {
	.loc 1 357 55 view .LVU679
	add	r5, r5, #1	@ yy, yy,
.LVL165:
@ armwave.c:357:     for(yy = 0; yy < g_armwave_state.target_height; yy++) {
	.loc 1 357 5 view .LVU680
...
.LFB66:
	...
	@ args = 0, pretend = 0, frame = 0
	@ frame_needed = 0, uses_anonymous_args = 0
	.loc 1 371 5 view .LVU682
@ armwave.c:371:     mod_depth = mod;
	.loc 1 371 15 is_stmt 0 view .LVU683
	ldr	r3, .L149+20	@ tmp128,
@ armwave.c:370: {
	.loc 1 370 1 view .LVU684
	push	{r4, r5, r6, r7, r8, lr}	@
	.cfi_def_cfa_offset 24
	.cfi_offset 4, -24
	.cfi_offset 5, -20
	...
	.cfi_offset 84, -32
	.cfi_offset 85, -28
	ldr	r4, .L149+24	@ ivtmp.104,
.LBB10:
.LBB11:
@ armwave.c:87:         gamma_table[i] = pow(i / 255.0f, gamma) * 255.0f;
	.loc 1 87 32 view .LVU685
	vldr.32	s20, .L149+16	@ tmp134,
@ armwave.c:87:         gamma_table[i] = pow(i / 255.0f, gamma) * 255.0f;
	.loc 1 87 26 view .LVU686
	vldr.64	d9, .L149	@ tmp143,
@ armwave.c:87:         gamma_table[i] = pow(i / 255.0f, gamma) * 255.0f;
	.loc 1 87 49 view .LVU687
	vldr.64	d8, .L149+8	@ tmp137,
.LBE11:
.LBE10:
@ armwave.c:371:     mod_depth = mod;
	.loc 1 371 15 view .LVU688
	vstr.32	s0, [r3]	@ mod, mod_depth
	.loc 1 373 5 is_stmt 1 view .LVU689
@ armwave.c:370: {
	.loc 1 370 1 is_stmt 0 view .LVU690
...
.LVL167:
	.loc 1 374 5 is_stmt 1 view .LVU692
.LBB13:
.LBI10:
	.loc 1 81 6 view .LVU693
	.loc 1 81 6 is_stmt 0 view .LVU694
...
@ armwave.c:378:     printf("armwave version: %s\n", ARMWAVE_VER);
	.loc 1 378 5 view .LVU707
	ldr	r1, .L149+28	@,
	ldr	r0, .L149+32	@,
@ armwave.c:379: }
	.loc 1 379 1 view .LVU708
...
.LFB67:
	...
	@ args = 0, pretend = 0, frame = 8
	@ frame_needed = 0, uses_anonymous_args = 0
	.loc 1 383 5 view .LVU711
	.loc 1 385 5 view .LVU712
@ armwave.c:382: {
	.loc 1 382 1 is_stmt 0 view .LVU713
	push	{r4, r5, r6, r7, r8, r9, r10, fp, lr}	@
	.cfi_def_cfa_offset 36
	.cfi_offset 4, -36
	.cfi_offset 5, -32
...
@ armwave.c:385:     memset(g_armwave_state.ch1_buffer, 0, g_armwave_state.size);
	.loc 1 385 5 view .LVU714
	mov	r1, #0	@,
	ldr	r4, .L169	@ tmp269,
@ armwave.c:382: {
	.loc 1 382 1 view .LVU715
	sub	sp, sp, #12	@,,
	.cfi_def_cfa_offset 48
@ armwave.c:385:     memset(g_armwave_state.ch1_buffer, 0, g_armwave_state.size);
	.loc 1 385 5 view .LVU716
	ldr	r2, [r4, #48]	@, g_armwave_state.size
	ldr	r0, [r4, #4]	@, g_armwave_state.ch1_buffer
	bl	memset		@
.LVL175:
	.loc 1 387 5 is_stmt 1 view .LVU717
@ armwave.c:387:     for(yy = 0; yy < (2048 / g_armwave_state.slice_height); yy++) {
	.loc 1 387 45 is_stmt 0 view .LVU718
	ldr	r5, [r4, #40]	@ _72, g_armwave_state.slice_height
@ armwave.c:387:     for(yy = 0; yy < (2048 / g_armwave_state.slice_height); yy++) {
	.loc 1 387 5 view .LVU719
	cmp	r5, #2048	@ _72,
	bhi	.L151		@,
	ldr	r6, [r4, #36]	@ prephitmp_171, g_armwave_state.waves
@ armwave.c:387:     for(yy = 0; yy < (2048 / g_armwave_state.slice_height); yy++) {
	.loc 1 387 12 view .LVU720
	mov	r10, #0	@ yy,
.LVL176:
.L157:
	.loc 1 388 9 is_stmt 1 discriminator 3 view .LVU721
	mul	r3, r5, r10	@ _3, _72, yy
.LBB16:
.LBB17:
@ armwave.c:106:     write_buffer_base = g_armwave_state.ch1_buffer + (slice_y * g_armwave_state.target_height);
	.loc 1 106 63 is_stmt 0 discriminator 3 view .LVU722
	ldr	r0, [r4, #56]	@ g_armwave_state.target_height, g_armwave_state.target_height
@ armwave.c:109:     for(w = 0; w < g_armwave_state.waves; w++) {
	.loc 1 109 5 discriminator 3 view .LVU723
...
@ armwave.c:388:         render_nonaa_to_buffer_1ch_slice(yy * g_armwave_state.slice_height, g_armwave_state.slice_record_height);
	.loc 1 388 9 discriminator 3 view .LVU724
	ldr	r9, [r4, #44]	@ _4, g_armwave_state.slice_record_height
.LVL177:
.LBB19:
.LBI16:
	.loc 1 98 6 is_stmt 1 discriminator 3 view .LVU725
.LBB18:
	.loc 1 100 5 discriminator 3 view .LVU726
	.loc 1 101 5 discriminator 3 view .LVU727
	.loc 1 102 5 discriminator 3 view .LVU728
	.loc 1 103 5 discriminator 3 view .LVU729
	.loc 1 104 5 discriminator 3 view .LVU730
	.loc 1 106 5 discriminator 3 view .LVU731
@ armwave.c:106:     write_buffer_base = g_armwave_state.ch1_buffer + (slice_y * g_armwave_state.target_height);
	.loc 1 106 63 is_stmt 0 discriminator 3 view .LVU732
	mul	r0, r0, r3	@ _15, g_armwave_state.target_height, _3
@ armwave.c:106:     write_buffer_base = g_armwave_state.ch1_buffer + (slice_y * g_armwave_state.target_height);
	.loc 1 106 40 discriminator 3 view .LVU733
	ldr	r2, [r4, #4]	@ _13, g_armwave_state.ch1_buffer
.LVL178:
	.loc 1 109 5 is_stmt 1 discriminator 3 view .LVU734
	.loc 1 109 5 is_stmt 0 discriminator 3 view .LVU735
	beq	.L153		@,
@ armwave.c:109:     for(w = 0; w < g_armwave_state.waves; w++) {
	.loc 1 109 11 view .LVU736
	mov	r8, #0	@ w,
	sub	r3, r3, #4	@ _77, _3,
.LVL179:
	.loc 1 109 11 view .LVU737
	str	r3, [sp, #4]	@ _77, %sfp
.LVL180:
.L156:
	.loc 1 110 9 is_stmt 1 view .LVU738
@ armwave.c:110:         wave_base = g_armwave_state.wave_buffer + slice_y + (w * g_armwave_state.wave_stride);
	.loc 1 110 64 is_stmt 0 view .LVU739
	ldr	r3, [r4, #32]	@ g_armwave_state.wave_stride, g_armwave_state.wave_stride
@ armwave.c:120:         for(yy = 0; yy < height; yy += 4) {
	.loc 1 120 9 view .LVU740
	cmp	r9, #0	@ _4,
@ armwave.c:110:         wave_base = g_armwave_state.wave_buffer + slice_y + (w * g_armwave_state.wave_stride);
	.loc 1 110 36 view .LVU741
	ldr	lr, [r4, #20]	@ _16, g_armwave_state.wave_buffer
@ armwave.c:110:         wave_base = g_armwave_state.wave_buffer + slice_y + (w * g_armwave_state.wave_stride);
	.loc 1 110 64 view .LVU742
	mul	r3, r3, r8	@ _19, g_armwave_state.wave_stride, w
.LVL181:
	.loc 1 120 9 is_stmt 1 view .LVU743
	.loc 1 120 9 is_stmt 0 view .LVU744
	beq	.L154		@,
	ldr	r1, [sp, #4]	@ _77, %sfp
	add	r3, r3, r1	@ tmp205, _19, _77
.LVL182:
	.loc 1 120 9 view .LVU745
	add	lr, lr, r3	@ ivtmp.110, _16, tmp205
.LVL183:
@ armwave.c:120:         for(yy = 0; yy < height; yy += 4) {
	.loc 1 120 16 view .LVU746
	mov	r1, #0	@ yy,
.LVL184:
.L155:
	.loc 1 135 13 is_stmt 1 view .LVU747
@ armwave.c:135:             word = *(uint32_t*)(wave_base + yy);
	.loc 1 135 18 is_stmt 0 view .LVU748
	ldr	r3, [lr, #4]!	@ word, MEM[base: _183, offset: 0B]
.LVL185:
	.loc 1 139 13 is_stmt 1 view .LVU749
	.loc 1 140 17 view .LVU750
	.loc 1 141 17 view .LVU751
	.loc 1 142 17 view .LVU752
@ armwave.c:140:                 scale_value = (word & 0xff) * g_armwave_state.vscale;
	.loc 1 140 45 is_stmt 0 view .LVU753
	ldr	r7, [r4, #28]	@ g_armwave_state.vscale, g_armwave_state.vscale
@ armwave.c:141:                 write_buffer = write_buffer_base + ((yy + ys) * g_armwave_state.target_height);
	.loc 1 141 63 view .LVU754
	ldr	r6, [r4, #56]	@ g_armwave_state.target_height, g_armwave_state.target_height
@ armwave.c:140:                 scale_value = (word & 0xff) * g_armwave_state.vscale;
	.loc 1 140 37 view .LVU755
	uxtb	ip, r3	@ word, word
@ armwave.c:143:                 word >>= 8;
	.loc 1 143 22 view .LVU756
	lsr	r5, r3, #8	@ word, word,
@ armwave.c:142:                 *(write_buffer + scale_value) += 1;
	.loc 1 142 47 view .LVU757
	mla	ip, r7, ip, r0	@ tmp210, g_armwave_state.vscale, word, _15
@ armwave.c:140:                 scale_value = (word & 0xff) * g_armwave_state.vscale;
	.loc 1 140 37 view .LVU758
	uxtb	r5, r5	@ word, word
@ armwave.c:142:                 *(write_buffer + scale_value) += 1;
	.loc 1 142 47 view .LVU759
	mla	r6, r6, r1, ip	@ tmp214, g_armwave_state.target_height, yy, tmp210
@ armwave.c:141:                 write_buffer = write_buffer_base + ((yy + ys) * g_armwave_state.target_height);
	.loc 1 141 63 view .LVU760
	add	fp, r1, #1	@ tmp226, yy,
@ armwave.c:143:                 word >>= 8;
	.loc 1 143 22 view .LVU761
	lsr	ip, r3, #16	@ word, word,
@ armwave.c:142:                 *(write_buffer + scale_value) += 1;
	.loc 1 142 47 view .LVU762
	ldrb	r7, [r2, r6]	@ zero_extendqisi2	@ *_63, *_63
@ armwave.c:140:                 scale_value = (word & 0xff) * g_armwave_state.vscale;
	.loc 1 140 37 view .LVU763
	uxtb	ip, ip	@ word, word
@ armwave.c:143:                 word >>= 8;
	.loc 1 143 22 view .LVU764
	lsr	r3, r3, #24	@ word, word,
.LVL186:
@ armwave.c:142:                 *(write_buffer + scale_value) += 1;
	.loc 1 142 47 view .LVU765
	add	r7, r7, #1	@ tmp217, *_63,
	strb	r7, [r2, r6]	@ tmp217, *_63
.LVL187:
	.loc 1 143 17 is_stmt 1 view .LVU766
	.loc 1 140 17 view .LVU767
	.loc 1 141 17 view .LVU768
	.loc 1 142 17 view .LVU769
@ armwave.c:140:                 scale_value = (word & 0xff) * g_armwave_state.vscale;
	.loc 1 140 45 is_stmt 0 view .LVU770
	ldr	r6, [r4, #28]	@ g_armwave_state.vscale, g_armwave_state.vscale
@ armwave.c:141:                 write_buffer = write_buffer_base + ((yy + ys) * g_armwave_state.target_height);
	.loc 1 141 63 view .LVU771
	add	r7, r1, #2	@ tmp241, yy,
@ armwave.c:142:                 *(write_buffer + scale_value) += 1;
	.loc 1 142 47 view .LVU772
	mla	r5, r6, r5, r0	@ tmp224, g_armwave_state.vscale, word, _15
@ armwave.c:141:                 write_buffer = write_buffer_base + ((yy + ys) * g_armwave_state.target_height);
	.loc 1 141 63 view .LVU773
	ldr	r6, [r4, #56]	@ g_armwave_state.target_height, g_armwave_state.target_height
@ armwave.c:142:                 *(write_buffer + scale_value) += 1;
	.loc 1 142 47 view .LVU774
	mla	r5, r6, fp, r5	@ tmp229, g_armwave_state.target_height, tmp226, tmp224
@ armwave.c:141:                 write_buffer = write_buffer_base + ((yy + ys) * g_armwave_state.target_height);
	.loc 1 141 63 view .LVU775
	add	r6, r1, #3	@ tmp255, yy,
@ armwave.c:120:         for(yy = 0; yy < height; yy += 4) {
	.loc 1 120 37 view .LVU776
	add	r1, r1, #4	@ yy, yy,
.LVL188:
@ armwave.c:142:                 *(write_buffer + scale_value) += 1;
	.loc 1 142 47 view .LVU777
	ldrb	fp, [r2, r5]	@ zero_extendqisi2	@ *_83, *_83
@ armwave.c:120:         for(yy = 0; yy < height; yy += 4) {
	.loc 1 120 9 view .LVU778
	cmp	r9, r1	@ _4, yy
@ armwave.c:142:                 *(write_buffer + scale_value) += 1;
	.loc 1 142 47 view .LVU779
	add	fp, fp, #1	@ tmp232, *_83,
	strb	fp, [r2, r5]	@ tmp232, *_83
.LVL189:
	.loc 1 143 17 is_stmt 1 view .LVU780
	.loc 1 140 17 view .LVU781
	.loc 1 141 17 view .LVU782
	.loc 1 142 17 view .LVU783
@ armwave.c:140:                 scale_value = (word & 0xff) * g_armwave_state.vscale;
	.loc 1 140 45 is_stmt 0 view .LVU784
	ldr	fp, [r4, #28]	@ g_armwave_state.vscale, g_armwave_state.vscale
@ armwave.c:141:                 write_buffer = write_buffer_base + ((yy + ys) * g_armwave_state.target_height);
	.loc 1 141 63 view .LVU785
	ldr	r5, [r4, #56]	@ g_armwave_state.target_height, g_armwave_state.target_height
@ armwave.c:142:                 *(write_buffer + scale_value) += 1;
	.loc 1 142 47 view .LVU786
	...
	.loc 1 143 17 is_stmt 1 view .LVU787
.LVL190:
	.loc 1 140 17 view .LVU788
	.loc 1 141 17 view .LVU789
	.loc 1 142 17 view .LVU790
@ armwave.c:140:                 scale_value = (word & 0xff) * g_armwave_state.vscale;
	.loc 1 140 45 is_stmt 0 view .LVU791
	ldr	r5, [r4, #28]	@ g_armwave_state.vscale, g_armwave_state.vscale
@ armwave.c:141:                 write_buffer = write_buffer_base + ((yy + ys) * g_armwave_state.target_height);
	.loc 1 141 63 view .LVU792
	ldr	ip, [r4, #56]	@ g_armwave_state.target_height, g_armwave_state.target_height
@ armwave.c:142:                 *(write_buffer + scale_value) += 1;
	.loc 1 142 47 view .LVU793
	...
	.loc 1 143 17 is_stmt 1 view .LVU794
.LVL191:
@ armwave.c:120:         for(yy = 0; yy < height; yy += 4) {
	.loc 1 120 9 is_stmt 0 view .LVU795
	bhi	.L155		@,
	ldr	r6, [r4, #36]	@ prephitmp_171, g_armwave_state.waves
.LVL192:
.L154:
@ armwave.c:109:     for(w = 0; w < g_armwave_state.waves; w++) {
	.loc 1 109 44 view .LVU796
	add	r8, r8, #1	@ w, w,
.LVL193:
@ armwave.c:109:     for(w = 0; w < g_armwave_state.waves; w++) {
	.loc 1 109 5 view .LVU797
	cmp	r8, r6	@ w, prephitmp_171
	bcc	.L156		@,
	ldr	r5, [r4, #40]	@ _72, g_armwave_state.slice_height
.LVL194:
.L153:
	.loc 1 109 5 view .LVU798
.LBE18:
.LBE19:
@ armwave.c:387:     for(yy = 0; yy < (2048 / g_armwave_state.slice_height); yy++) {
	.loc 1 387 28 discriminator 3 view .LVU799
	mov	r1, r5	@, _72
	mov	r0, #2048	@,
.LVL195:
	.loc 1 387 28 discriminator 3 view .LVU800
	bl	__aeabi_uidiv		@
.LVL196:
@ armwave.c:387:     for(yy = 0; yy < (2048 / g_armwave_state.slice_height); yy++) {
	.loc 1 387 63 discriminator 3 view .LVU801
	add	r10, r10, #1	@ yy, yy,
.LVL197:
@ armwave.c:387:     for(yy = 0; yy < (2048 / g_armwave_state.slice_height); yy++) {
	.loc 1 387 5 discriminator 3 view .LVU802
	cmp	r0, r10	@, yy
	bhi	.L157		@,
.LVL198:
.L151:
@ armwave.c:390: }
	.loc 1 390 1 view .LVU803
	add	sp, sp, #12	@,,
	.cfi_def_cfa_offset 36
	@ sp needed	@
	pop	{r4, r5, r6, r7, r8, r9, r10, fp, pc}	@
...
.LFB68:
	...
	.loc 1 395 5 view .LVU806
@ armwave.c:393: {
	.loc 1 393 1 is_stmt 0 view .LVU807
	push	{r4, r5, r6, r7, r8, r9, lr}	@
	.cfi_def_cfa_offset 28
	.cfi_offset 4, -28
	.cfi_offset 5, -24
...
@ armwave.c:395:     Py_buffer *buf = malloc(sizeof(Py_buffer));
	.loc 1 395 22 view .LVU808
	mov	r0, #44	@,
@ armwave.c:397:  	armwave_fill_pixbuf_scaled(g_armwave_state.out_pixbuf);
	.loc 1 397 3 view .LVU809
	ldr	r6, .L178	@ tmp146,
@ armwave.c:393: {
	.loc 1 393 1 view .LVU810
	sub	sp, sp, #12	@,,
	.cfi_def_cfa_offset 40
@ armwave.c:395:     Py_buffer *buf = malloc(sizeof(Py_buffer));
	.loc 1 395 22 view .LVU811
	bl	malloc		@
.LVL199:
	.loc 1 397 3 is_stmt 1 view .LVU812
	ldr	r5, [r6, #68]	@ _1, g_armwave_state.out_pixbuf
.LVL200:
.LBB24:
.LBI24:
	.loc 1 287 6 view .LVU813
.LBB25:
	.loc 1 289 5 view .LVU814
	.loc 1 290 5 view .LVU815
	.loc 1 291 5 view .LVU816
	.loc 1 292 5 view .LVU817
	.loc 1 293 5 view .LVU818
	.loc 1 294 5 view .LVU819
	.loc 1 296 5 view .LVU820
	cmp	r5, #0	@ _1,
	beq	.L177		@,
	.loc 1 300 5 view .LVU821
@ armwave.c:300:     npix = g_armwave_state.target_width * 256; //g_armwave_state.target_height;
	.loc 1 300 27 is_stmt 0 view .LVU822
	ldr	r4, [r6, #52]	@ _12, g_armwave_state.target_width
@ armwave.c:301:     vscale = g_armwave_state.target_height / 256;
	.loc 1 301 44 view .LVU823
	ldr	r3, [r6, #56]	@ g_armwave_state.target_height, g_armwave_state.target_height
@ armwave.c:303:     printf("np=%d w=%d v=%d\n", npix, g_armwave_state.target_width, vscale);
	.loc 1 303 5 view .LVU824
	mov	r2, r4	@, _12
@ armwave.c:300:     npix = g_armwave_state.target_width * 256; //g_armwave_state.target_height;
	.loc 1 300 41 view .LVU825
	lsl	r4, r4, #8	@ npix, _12,
.LVL201:
	.loc 1 301 5 is_stmt 1 view .LVU826
	.loc 1 303 5 view .LVU827
	mov	r8, r0	@ buf,
	mov	r1, r4	@, npix
	lsr	r3, r3, #8	@, g_armwave_state.target_height,
.LVL202:
	.loc 1 303 5 is_stmt 0 view .LVU828
	ldr	r0, .L178+4	@,
.LVL203:
	.loc 1 303 5 view .LVU829
	bl	printf		@
.LVL204:
	.loc 1 305 5 is_stmt 1 view .LVU830
	.loc 1 305 5 is_stmt 0 view .LVU831
	cmp	r4, #0	@ npix,
	ble	.L173		@,
@ armwave.c:339:         printf("0x%08x, %d\n", out_buffer_base, n);
	.loc 1 339 9 view .LVU832
	ldr	r9, .L178+8	@ tmp147,
@ armwave.c:305:     for(n = 0; n < npix; n += 4) {
	.loc 1 305 11 view .LVU833
	mov	r7, #0	@ n,
.LVL205:
.L174:
	.loc 1 309 9 is_stmt 1 view .LVU834
	.loc 1 311 9 view .LVU835
	.loc 1 339 9 view .LVU836
	mov	r2, r7	@, n
	mov	r1, r5	@, ivtmp.125
	mov	r0, r9	@, tmp147
	bl	printf		@
.LVL206:
	.loc 1 341 9 view .LVU837
@ armwave.c:341:         *out_buffer_base++ = n;
	.loc 1 341 28 is_stmt 0 view .LVU838
	str	r7, [r5], #4	@ n, MEM[base: out_buffer_base_30, offset: 0B]
@ armwave.c:305:     for(n = 0; n < npix; n += 4) {
	.loc 1 305 28 view .LVU839
	add	r7, r7, #4	@ n, n,
.LVL207:
@ armwave.c:305:     for(n = 0; n < npix; n += 4) {
	.loc 1 305 5 view .LVU840
	cmp	r4, r7	@ npix, n
	bgt	.L174		@,
.LVL208:
.L173:
	.loc 1 305 5 view .LVU841
.LBE25:
.LBE24:
	.loc 1 407 5 is_stmt 1 view .LVU842
@ armwave.c:407:     PyBuffer_FillInfo(buf, NULL, g_armwave_state.out_pixbuf, sizeof(uint32_t) * g_armwave_state.size, true, PyBUF_ND);
	.loc 1 407 79 is_stmt 0 view .LVU843
	ldr	r3, [r6, #48]	@ g_armwave_state.size, g_armwave_state.size
@ armwave.c:407:     PyBuffer_FillInfo(buf, NULL, g_armwave_state.out_pixbuf, sizeof(uint32_t) * g_armwave_state.size, true, PyBUF_ND);
	.loc 1 407 5 view .LVU844
	mov	r0, #8	@ tmp144,
	mov	r1, #1	@ tmp145,
	str	r0, [sp, #4]	@ tmp144,
	str	r1, [sp]	@ tmp145,
...
.LVL209:
	.loc 1 409 5 is_stmt 1 view .LVU845
@ armwave.c:409:     mv = PyMemoryView_FromBuffer(buf);
	.loc 1 409 10 is_stmt 0 view .LVU846
	mov	r0, r8	@, buf
@ armwave.c:410: }
	.loc 1 410 1 view .LVU847
	add	sp, sp, #12	@,,
	.cfi_remember_state
	.cfi_def_cfa_offset 28
	@ sp needed	@
...
.LBB26:
.LBI26:
	.loc 1 287 6 is_stmt 1 view .LVU849
.LBB27:
	.loc 1 296 5 view .LVU850
	ldr	r3, .L178+12	@,
	mov	r2, #296	@,
	ldr	r1, .L178+16	@,
	ldr	r0, .L178+20	@,
.LVL212:
	.loc 1 296 5 is_stmt 0 view .LVU851
	bl	__assert_fail		@
.LVL213:
.L179:
	.loc 1 296 5 view .LVU852
	.align	2
.L178:
	.word	g_armwave_state
	.word	.LC6
...
.LFB69:
	...
	@ frame_needed = 0, uses_anonymous_args = 0
	@ link register save eliminated.
	.loc 1 414 5 view .LVU854
	ldr	r3, .L181	@ tmp112,
	mov	r1, r0	@, fn
	ldr	r0, [r3, #68]	@, g_armwave_state.out_pixbuf
.LVL215:
	.loc 1 414 5 is_stmt 0 view .LVU855
	b	armwave_dump_ppm_debug		@
.LVL216:
.L182:
	.loc 1 414 5 view .LVU856
	.align	2
.L181:
	.word	g_armwave_state
	.cfi_endproc
...
.LFB71:
	...
	@ args = 0, pretend = 0, frame = 8
	@ frame_needed = 0, uses_anonymous_args = 0
	.loc 1 430 5 view .LVU872
	.loc 1 431 5 view .LVU873
	.loc 1 434 5 view .LVU874
.LBB34:
.LBI34:
	.loc 1 151 6 view .LVU875
.LBB35:
	.loc 1 153 5 view .LVU876
.LBE35:
.LBE34:
@ armwave.c:429: {
	.loc 1 429 1 is_stmt 0 view .LVU877
	push	{r4, r5, r6, r7, r8, r9, r10, fp, lr}	@
	.cfi_def_cfa_offset 36
	.cfi_offset 4, -36
	.cfi_offset 5, -32
...
@ armwave.c:450:             render_nonaa_to_buffer_1ch_slice(yy * g_armwave_state.slice_height, g_armwave_state.slice_record_height);
	.loc 1 450 13 discriminator 3 view .LVU893
	ldr	r10, [r9, #44]	@ _2, g_armwave_state.slice_record_height
.LVL226:
.LBB45:
.LBI42:
	.loc 1 98 6 is_stmt 1 discriminator 3 view .LVU894
.LBB44:
	.loc 1 100 5 discriminator 3 view .LVU895
	.loc 1 101 5 discriminator 3 view .LVU896
	.loc 1 102 5 discriminator 3 view .LVU897
	.loc 1 103 5 discriminator 3 view .LVU898
	.loc 1 104 5 discriminator 3 view .LVU899
	.loc 1 106 5 discriminator 3 view .LVU900
@ armwave.c:106:     write_buffer_base = g_armwave_state.ch1_buffer + (slice_y * g_armwave_state.target_height);
	.loc 1 106 63 is_stmt 0 discriminator 3 view .LVU901
	mul	r0, r0, r3	@ _19, g_armwave_state.target_height, _1
@ armwave.c:106:     write_buffer_base = g_armwave_state.ch1_buffer + (slice_y * g_armwave_state.target_height);
	.loc 1 106 40 discriminator 3 view .LVU902
	ldr	r2, [r9, #4]	@ _17, g_armwave_state.ch1_buffer
.LVL227:
	.loc 1 109 5 is_stmt 1 discriminator 3 view .LVU903
	.loc 1 109 5 is_stmt 0 discriminator 3 view .LVU904
	beq	.L189		@,
@ armwave.c:109:     for(w = 0; w < g_armwave_state.waves; w++) {
	.loc 1 109 11 view .LVU905
	mov	r7, #0	@ w,
	sub	r3, r3, #4	@ _81, _1,
.LVL228:
	.loc 1 109 11 view .LVU906
	str	r3, [sp]	@ _81, %sfp
.LVL229:
.L192:
	.loc 1 110 9 is_stmt 1 view .LVU907
@ armwave.c:110:         wave_base = g_armwave_state.wave_buffer + slice_y + (w * g_armwave_state.wave_stride);
	.loc 1 110 64 is_stmt 0 view .LVU908
	ldr	r3, [r9, #32]	@ g_armwave_state.wave_stride, g_armwave_state.wave_stride
@ armwave.c:120:         for(yy = 0; yy < height; yy += 4) {
	.loc 1 120 9 view .LVU909
	cmp	r10, #0	@ _2,
@ armwave.c:110:         wave_base = g_armwave_state.wave_buffer + slice_y + (w * g_armwave_state.wave_stride);
	.loc 1 110 36 view .LVU910
	ldr	lr, [r9, #20]	@ _20, g_armwave_state.wave_buffer
@ armwave.c:110:         wave_base = g_armwave_state.wave_buffer + slice_y + (w * g_armwave_state.wave_stride);
	.loc 1 110 64 view .LVU911
	mul	r3, r3, r7	@ _23, g_armwave_state.wave_stride, w
.LVL230:
	.loc 1 120 9 is_stmt 1 view .LVU912
	.loc 1 120 9 is_stmt 0 view .LVU913
	beq	.L190		@,
	ldr	r1, [sp]	@ _81, %sfp
	add	r3, r3, r1	@ tmp202, _23, _81
.LVL231:
	.loc 1 120 9 view .LVU914
	add	lr, lr, r3	@ ivtmp.130, _20, tmp202
.LVL232:
@ armwave.c:120:         for(yy = 0; yy < height; yy += 4) {
	.loc 1 120 16 view .LVU915
	mov	r1, #0	@ yy,
.LVL233:
.L191:
	.loc 1 135 13 is_stmt 1 view .LVU916
@ armwave.c:135:             word = *(uint32_t*)(wave_base + yy);
	.loc 1 135 18 is_stmt 0 view .LVU917
	ldr	r3, [lr, #4]!	@ word, MEM[base: _177, offset: 0B]
.LVL234:
	.loc 1 139 13 is_stmt 1 view .LVU918
	.loc 1 140 17 view .LVU919
	.loc 1 141 17 view .LVU920
	.loc 1 142 17 view .LVU921
@ armwave.c:140:                 scale_value = (word & 0xff) * g_armwave_state.vscale;
	.loc 1 140 45 is_stmt 0 view .LVU922
	ldr	r6, [r9, #28]	@ g_armwave_state.vscale, g_armwave_state.vscale
@ armwave.c:141:                 write_buffer = write_buffer_base + ((yy + ys) * g_armwave_state.target_height);
	.loc 1 141 63 view .LVU923
	ldr	r5, [r9, #56]	@ g_armwave_state.target_height, g_armwave_state.target_height
@ armwave.c:140:                 scale_value = (word & 0xff) * g_armwave_state.vscale;
	.loc 1 140 37 view .LVU924
	uxtb	ip, r3	@ word, word
@ armwave.c:143:                 word >>= 8;
	.loc 1 143 22 view .LVU925
	lsr	r4, r3, #8	@ word, word,
@ armwave.c:142:                 *(write_buffer + scale_value) += 1;
	.loc 1 142 47 view .LVU926
...
.LVL236:
	.loc 1 143 17 is_stmt 1 view .LVU935
	.loc 1 140 17 view .LVU936
	.loc 1 141 17 view .LVU937
	.loc 1 142 17 view .LVU938
@ armwave.c:140:                 scale_value = (word & 0xff) * g_armwave_state.vscale;
	.loc 1 140 45 is_stmt 0 view .LVU939
	ldr	r5, [r9, #28]	@ g_armwave_state.vscale, g_armwave_state.vscale
@ armwave.c:141:                 write_buffer = write_buffer_base + ((yy + ys) * g_armwave_state.target_height);
	.loc 1 141 63 view .LVU940
...
@ armwave.c:142:                 *(write_buffer + scale_value) += 1;
	...
	.loc 1 143 17 is_stmt 1 view .LVU956
.LVL239:
	.loc 1 140 17 view .LVU957
	.loc 1 141 17 view .LVU958
	.loc 1 142 17 view .LVU959
@ armwave.c:140:                 scale_value = (word & 0xff) * g_armwave_state.vscale;
	.loc 1 140 45 is_stmt 0 view .LVU960
	ldr	r4, [r9, #28]	@ g_armwave_state.vscale, g_armwave_state.vscale
@ armwave.c:141:                 write_buffer = write_buffer_base + ((yy + ys) * g_armwave_state.target_height);
	.loc 1 141 63 view .LVU961
...
.LVL240:
@ armwave.c:120:         for(yy = 0; yy < height; yy += 4) {
	.loc 1 120 9 is_stmt 0 view .LVU964
	bhi	.L191		@,
	ldr	r6, [r9, #36]	@ prephitmp_178, g_armwave_state.waves
.LVL241:
.L190:
@ armwave.c:109:     for(w = 0; w < g_armwave_state.waves; w++) {
	.loc 1 109 44 view .LVU965
	add	r7, r7, #1	@ w, w,
.LVL242:
@ armwave.c:109:     for(w = 0; w < g_armwave_state.waves; w++) {
	.loc 1 109 5 view .LVU966
	cmp	r7, r6	@ w, prephitmp_178
	bcc	.L192		@,
	ldr	r5, [r9, #40]	@ _61, g_armwave_state.slice_height
.LVL243:
.L189:
	.loc 1 109 5 view .LVU967
.LBE44:
.LBE45:
@ armwave.c:448:         for(yy = 0; yy < (2048 / g_armwave_state.slice_height); yy++) {
	.loc 1 448 32 discriminator 3 view .LVU968
	mov	r1, r5	@, _61
	mov	r0, #2048	@,
.LVL244:
	.loc 1 448 32 discriminator 3 view .LVU969
	bl	__aeabi_uidiv		@
.LVL245:
@ armwave.c:448:         for(yy = 0; yy < (2048 / g_armwave_state.slice_height); yy++) {
	.loc 1 448 67 discriminator 3 view .LVU970
	add	r8, r8, #1	@ yy, yy,
.LVL246:
@ armwave.c:448:         for(yy = 0; yy < (2048 / g_armwave_state.slice_height); yy++) {
	.loc 1 448 9 discriminator 3 view .LVU971
	cmp	r0, r8	@, yy
	bhi	.L193		@,
.LVL247:
.L196:
@ armwave.c:447:     for(n = 0; n < 5000; n++) {
	.loc 1 447 5 discriminator 2 view .LVU972
	ldr	r3, [sp, #4]	@ ivtmp_191, %sfp
	subs	r3, r3, #1	@ ivtmp_191, ivtmp_191,
	str	r3, [sp, #4]	@ ivtmp_191, %sfp
	bne	.L188		@,
	mov	r0, r3	@, ivtmp_191
	.loc 1 463 5 is_stmt 1 view .LVU973
@ armwave.c:464: }
	.loc 1 464 1 is_stmt 0 view .LVU974
	add	sp, sp, #12	@,,
	.cfi_def_cfa_offset 36
	@ sp needed	@
	pop	{r4, r5, r6, r7, r8, r9, r10, fp, pc}	@
